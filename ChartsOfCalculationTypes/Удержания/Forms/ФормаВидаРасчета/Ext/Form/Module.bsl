...
Функция ОбновитьОтражениеВБухучетеИнфоНадпись(Форма)
	...
	Если Форма.ИспользоватьСтатьиФинансирования Тогда
		Если Форма.Объект.КатегорияУдержания = ПредопределенноеЗначение("Перечисление.КатегорииУдержаний.ВознаграждениеПлатежногоАгента") Тогда
			ОтражениеВБухучетеИнфоНадпись = НСтр("ru = 'Статья финансирования и статья расходов определяются по удержанию, с которого исчислено вознаграждение.'");
		ИначеЕсли Форма.Объект.КатегорияУдержания = ПредопределенноеЗначение("Перечисление.КатегорииУдержаний.ИсполнительныйЛист") Тогда
			ОтражениеВБухучетеИнфоНадпись = НСтр("ru = 'Статья финансирования и статья расходов определяются по базовым начислениям.'");
		КонецЕсли;
	Иначе
		Если Форма.Объект.КатегорияУдержания = ПредопределенноеЗначение("Перечисление.КатегорииУдержаний.ВознаграждениеПлатежногоАгента") Тогда
			ОтражениеВБухучетеИнфоНадпись = НСтр("ru = 'Статья расходов определяется по удержанию, с которого исчислено вознаграждение.'");
		ИначеЕсли Форма.Объект.КатегорияУдержания = ПредопределенноеЗначение("Перечисление.КатегорииУдержаний.ИсполнительныйЛист") Тогда
			ОтражениеВБухучетеИнфоНадпись = НСтр("ru = 'Статья расходов определяется по базовым начислениям.'");
		КонецЕсли;
	КонецЕсли;
	
	Форма.ОтражениеВБухучетеИнфоНадпись = ОтражениеВБухучетеИнфоНадпись;
...
Функция ОбновитьДоступностьНастроекБухучета(Форма)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
		"СтатьяФинансирования", "Доступность", НастройкаДоступна);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
		"СтатьяФинансирования", "АвтоОтметкаНезаполненного", НастройкаДоступна);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
		"СтатьяФинансирования", "ОтметкаНезаполненного", НастройкаДоступна И Не ЗначениеЗаполнено(Форма.Объект.СтатьяФинансирования));
	
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СтатьяРасходов", "Доступность", НастройкаДоступна);
	Если Форма.РаботаВБюджетномУчреждении Или Не Форма.ИспользоватьСтатьиФинансирования Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
			"СтатьяРасходов", "АвтоОтметкаНезаполненного", НастройкаДоступна);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
			"СтатьяРасходов", "ОтметкаНезаполненного", НастройкаДоступна И Не ЗначениеЗаполнено(Форма.Объект.СтатьяРасходов));
	Иначе
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
			"СтатьяРасходов", "АвтоОтметкаНезаполненного", Ложь);
		ПодсказкаВвода = НСтр("ru = 'ОТ'");
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
			"СтатьяРасходов", "ПодсказкаВвода", ПодсказкаВвода);
	КонецЕсли;
...
&НаСервере
Процедура БухучетПриЧтенииДанных()
	
	ОбновитьДоступностьНастроекБухучета(ЭтотОбъект);
	ОбновитьОтражениеВБухучетеИнфоНадпись(ЭтотОбъект);
	УстановитьСтраницуБухучетНастройки(ЭтотОбъект, ЕстьПоказательРасчетнаяБаза);
	
	ЗаголовокСтратегии = НСтр("ru = 'Статья расходов определяется'");
	Если ИспользоватьСтатьиФинансирования Тогда
		ЗаголовокСтратегии = НСтр("ru = 'Статья финансирования и статья расходов определяются'");
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СтатьяРасходов", "ПоложениеЗаголовка", ПоложениеЗаголовкаЭлементаФормы.Нет);
	КонецЕсли;
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СтратегияОтраженияВУчете", "Заголовок", ЗаголовокСтратегии);
