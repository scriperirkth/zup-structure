...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ЗаполнитьПрочиеБазовыеДоходы");
	Методы.Вставить("СоздатьУдержанияВзносовВНПФПриОбновлении");
	Методы.Вставить("ЗаполнитьРегистрОперативныеПоказателиДляВыявленияУдержаний");
	Методы.Вставить("УдалитьДоходВНатуральнойФормеИзРасчетнойБазыИЛ");
КонецПроцедуры
