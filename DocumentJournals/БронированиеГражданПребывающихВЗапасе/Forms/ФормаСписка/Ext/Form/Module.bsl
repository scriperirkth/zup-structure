...
&НаКлиенте
Процедура СоздатьПриказОБронированииРаботников(Команда)
	
	ОткрытьФорму("Документ.ПриказОБронированииРаботников.ФормаОбъекта", ПараметрыСозданияДокумента(), ЭтотОбъект);
	
КонецПроцедуры

&НаКлиенте
Процедура СоздатьПриказОПрекращенииБронирования(Команда)
	
	ОткрытьФорму("Документ.ПриказОПрекращенииБронирования.ФормаОбъекта", ПараметрыСозданияДокумента(), ЭтотОбъект);
	
КонецПроцедуры

&НаКлиенте
Процедура СоздатьХодатайствоОБронированииГражданПребывающихВЗапасе(Команда)
	
	ОткрытьФорму("Документ.ХодатайствоОБронированииГражданПребывающихВЗапасе.ФормаОбъекта", ПараметрыСозданияДокумента(), ЭтотОбъект);
	
КонецПроцедуры

&НаКлиенте
Процедура СоздатьБронированиеГражданПребывающихВЗапасе(Команда)
	
	ОткрытьФорму("Документ.БронированиеГражданПребывающихВЗапасе.ФормаОбъекта", ПараметрыСозданияДокумента(), ЭтотОбъект);
	
КонецПроцедуры

&НаКлиенте
Процедура СоздатьОтменаБронированияГражданПребывающихВЗапасе(Команда)
	
	ОткрытьФорму("Документ.ОтменаБронированияГражданПребывающихВЗапасе.ФормаОбъекта", ПараметрыСозданияДокумента(), ЭтотОбъект);
