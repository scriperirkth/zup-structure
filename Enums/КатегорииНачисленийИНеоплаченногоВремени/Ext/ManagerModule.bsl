...
Функция КатегорииПрямыхВыплатФСС() Экспорт
	...
	Массив.Добавить(ПособиеПоУходуЗаРебенкомДоПолутораЛет);
	Массив.Добавить(ОтпускНаСанаторноКурортноеЛечение);
	Возврат Массив;
КонецФункции

Функция КатегорииРодителейДолейРКСН(КатегорияНачисления) Экспорт
	КатегорииДенежногоСодержания = Новый Массив();
	КатегорииДенежногоСодержания.Добавить(ДенежноеСодержаниеДоплатаКомандировки);
	КатегорииДенежногоСодержания.Добавить(КомпенсацияЗаНеотработанныеДниПриУвольненииГосслужащего);
	КатегорииДенежногоСодержания.Добавить(ДоплатаДоДенежногоСодержанияЗаДниБолезни);
	КатегорииДенежногоСодержания.Добавить(ВыходноеПособиеМесячноеДенежноеСодержание);
	КатегорииДенежногоСодержания.Добавить(СохраняемоеДенежноеСодержание);
	КатегорииДенежногоСодержания.Добавить(ДенежноеСодержаниеОплатаДнейУходаЗаДетьмиИнвалидами);
	КатегорииДенежногоСодержания.Добавить(ДенежноеСодержаниеНаПериодОтпускаНаСанаторноКурортноеЛечение);
	КатегорииДенежногоСодержания.Добавить(ДенежноеСодержаниеНаПериодОтпуска);
	КатегорииДенежногоСодержания.Добавить(ДенежноеСодержаниеНаПериодКомандировки);
	КатегорииДенежногоСодержания.Добавить(ДенежноеСодержаниеКомпенсацияОтпуска);
	
	КатегорииДенежногоДовольствия = Новый Массив();
	КатегорииДенежногоДовольствия.Добавить(СохраняемоеДенежноеДовольствие);
	КатегорииДенежногоДовольствия.Добавить(ОплатаСверхурочныхВоеннослужащим);
	КатегорииДенежногоДовольствия.Добавить(ДенежноеДовольствиеКомпенсацияОтпуска);
	...
	КатегорииОплатПоСреднему.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаБольничногоЛиста);
	КатегорииОплатПоСреднему.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаБольничногоЛистаЗаСчетРаботодателя);
	КатегорииОплатПоСреднему.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаБольничногоПрофзаболевание);
	КатегорииОплатПоСреднему.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаБольничногоНесчастныйСлучайНаПроизводстве);
	КатегорииОплатПоСреднему.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаПростояПоВинеРаботодателя);

	Если КатегорияНачисления = ОплатаДолиРайонногоКоэффициентаВСДС 
		ИЛИ КатегорияНачисления = ОплатаДолиСевернойНадбавкиВСДС Тогда
		Возврат КатегорииДенежногоСодержания;
	ИначеЕсли КатегорияНачисления = ОплатаДолиРайонногоКоэффициентаВСДД 
		ИЛИ КатегорияНачисления = ОплатаДолиСевернойНадбавкиВСДД Тогда
		Возврат КатегорииДенежногоДовольствия;
	ИначеЕсли КатегорияНачисления = ОплатаДолиРайонногоКоэффициентаВСреднемЗаработке 
		ИЛИ КатегорияНачисления = ОплатаДолиСевернойНадбавкиВСреднемЗаработке Тогда
...
Функция ДействующиеКатегории() Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.УправленческаяЗарплата")
		И ПолучитьФункциональнуюОпцию("ИспользоватьУправленческуюЗарплату") Тогда
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьДоплатуЗаКомандировкиПоПостановлению1099") Тогда
		МассивКатегорий.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ДоплатаКомандировки);
		Если ИспользоватьРасчетСохраняемогоДенежногоСодержания Тогда
			МассивКатегорий.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ДенежноеСодержаниеДоплатаКомандировки);
		КонецЕсли;
	КонецЕсли;
	...
	Если ИспользоватьРасчетСохраняемогоДенежногоСодержания Тогда
		МассивКатегорий.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаДолиРайонногоКоэффициентаВСДС);
		МассивКатегорий.Добавить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаДолиСевернойНадбавкиВСДС);
...
Функция КатегорииРК() Экспорт
	...
	Массив.Добавить(ОплатаДолиРайонногоКоэффициентаВСДС);
	Массив.Добавить(ОплатаДолиРайонногоКоэффициентаВСДД);
	Возврат Массив;
КонецФункции
...
Функция КатегорииСН() Экспорт
	...
	Массив.Добавить(ОплатаДолиСевернойНадбавкиВСДС);
	Массив.Добавить(ОплатаДолиСевернойНадбавкиВСДД);
	Возврат Массив;
КонецФункции
