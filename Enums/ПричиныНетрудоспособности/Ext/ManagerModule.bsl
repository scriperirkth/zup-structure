...
// Возвращает массив причин нетрудоспособности дающих право на продление отпуска.
Функция ПричиныДающиеПравоНаПродлениеОтпуска() Экспорт
	Причины = Новый Массив;
	Причины.Добавить(ОбщееЗаболевание);
	Причины.Добавить(Профзаболевание);
	Причины.Добавить(ТравмаНаПроизводстве);
	Причины.Добавить(ПоБеременностиИРодам);
	Причины.Добавить(Протезирование);
	Причины.Добавить(ПособиеПриДолечивании);
	Возврат Причины;
КонецФункции
