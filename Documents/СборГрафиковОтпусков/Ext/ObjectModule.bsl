...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	ЭтоКорневойСбор = Не ЗначениеЗаполнено(КорневойСборГрафиков);
	
	Если ЭтоКорневойСбор И ЗначениеЗаполнено(СуществующийДокументНаУказанныйГод()) Тогда
...
Процедура УстановитьСостояниеКорневогоСбораГрафиков()
	...
	Если ЭтоКорневойСбор Тогда
		...
		ИначеЕсли СборЗапущен Тогда
			Если СборПоПодразделениям Тогда
				Состояние = Перечисления.СостоянияСбораГрафиковОтпусков.ВРаботе;
			Иначе
