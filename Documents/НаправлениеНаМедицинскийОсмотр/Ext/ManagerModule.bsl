...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Идентификатор = "ПФ_MXL_НаправлениеНаМедицинскийОсмотр";
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	// Печать направления
	ПечатнаяФорма = УправлениеПечатью.СведенияОПечатнойФорме(КоллекцияПечатныхФорм, "ПФ_MXL_НаправлениеНаМедицинскийОсмотр");
...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	ОхранаТрудаКлиентСервер.ЗаполнитьПредставлениеДокумента(Данные, Представление, НСтр("ru = 'Направление'"));
...
// Возвращаемое значение:
//  Структура - Описание для заполнения:
// * Организация - СправочникСсылка.Организации -
// * ФизическоеЛицо - СправочникСсылка.ФизическиеЛица -
// * ЛичныеДанныеКандидата - СправочникСсылка.ЛичныеДанныеКандидатов -
// * МедицинскаяОрганизация - СправочникСсылка.МедицинскиеОрганизации -
// * Подразделение - СправочникСсылка.ПодразделенияОрганизаций -
// * Должность - СправочникСсылка.Должности -
// * РабочееМесто - СправочникСсылка.РабочиеМестаОхраныТруда -
// * ТипОсмотра - ПеречислениеСсылка.ТипыМедицинскогоОсмотра -
// * ВидОсмотра - ПеречислениеСсылка.ВидыОбследований -
// * ДатаОсмотра - Дата -
// * Основание - ОпределяемыйТип.ОснованиеНаправленияНаМедицинскийОсмотр, Произвольный -
Функция ОписаниеДляЗаполнения() Экспорт
	
	Описание = Новый Структура;
	
	Описание.Вставить("Организация", Справочники.Организации.ПустаяСсылка());
	Описание.Вставить("ФизическоеЛицо", Справочники.ФизическиеЛица.ПустаяСсылка());
	Описание.Вставить("ЛичныеДанныеКандидата", Справочники.ЛичныеДанныеКандидатов.ПустаяСсылка());
	Описание.Вставить("МедицинскаяОрганизация", Справочники.МедицинскиеОрганизации.ПустаяСсылка());
	Описание.Вставить("Подразделение", Справочники.ПодразделенияОрганизаций.ПустаяСсылка());
	Описание.Вставить("Должность", Справочники.Должности.ПустаяСсылка());
	Описание.Вставить("РабочееМесто", Справочники.РабочиеМестаОхраныТруда.ПустаяСсылка());
	Описание.Вставить("ТипОсмотра", Перечисления.ТипыМедицинскогоОсмотра.Предварительный);
	Описание.Вставить("ВидОсмотра", Перечисления.ВидыОбследований.МедицинскийОсмотр);
	Описание.Вставить("ДатаОсмотра", ТекущаяДатаСеанса());
	Описание.Вставить("Основание",
		Метаданные.ОпределяемыеТипы.ОснованиеНаправленияНаМедицинскийОсмотр.Тип.ПривестиЗначение());
...
// Возвращаемое значение:
//  см. ОписаниеДляЗаполнения
Функция ДанныеЗаполненияПоОснованию(Знач Основание) Экспорт
	
	ОбщегоНазначенияКлиентСервер.ПроверитьПараметр("Документы.НаправлениеНаМедицинскийОсмотр.ДанныеЗаполненияПоОснованию",
		"Основание", Основание, Метаданные.ОпределяемыеТипы.ОснованиеНаправленияНаМедицинскийОсмотр.Тип.Типы());
	
	ДанныеЗаполнения = ОписаниеДляЗаполнения();
	ДанныеЗаполнения.Основание = Основание;
	
	МодульМенеджера = ОбщегоНазначения.МенеджерОбъектаПоСсылке(Основание);
	УстановитьПривилегированныйРежим(Истина);
	МодульМенеджера.ЗаполнитьДанныеДляНаправленияНаМедицинскийОсмотр(ДанныеЗаполнения);
...
Функция ПечатьНаправленияНаМедицинскийОсмотр(Направления, ОбъектыПечати)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы(
		"Документ.НаправлениеНаМедицинскийОсмотр.ПФ_MXL_НаправлениеНаМедицинскийОсмотр");
	
	ОбластиМакета = Новый Массив;
	ОбластиМакета.Добавить("Организация");
	ОбластиМакета.Добавить("Заголовок");
	ОбластиМакета.Добавить("НомерДата");
	ОбластиМакета.Добавить("МедицинскаяОрганизация");
	ОбластиМакета.Добавить("ФизическоеЛицо");
	ОбластиМакета.Добавить("ПоступающийРаботающий");
	ОбластиМакета.Добавить("МестоРаботы");
	ОбластиМакета.Добавить("ВредныеФакторы");
	ОбластиМакета.Добавить("Подпись");
	...
	Для Каждого ОписаниеНаправления Из ДанныеДляПечати Цикл
		...
		Для Каждого ИмяОбластиМакета Из ОбластиМакета Цикл
			Если ИмяОбластиМакета = "ВредныеФакторы" Тогда
				ПолноеИмяОбластиМакета = ИмяОбластиМакета + ?(ОписаниеНаправления.ЭтоНовыйМакет29Н, "29Н", "302Н");
			Иначе
				ПолноеИмяОбластиМакета = ИмяОбластиМакета;
			КонецЕсли;
			ОбластьМакета = Макет.ПолучитьОбласть(ПолноеИмяОбластиМакета);
