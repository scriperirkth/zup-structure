...
Функция РеквизитыДляПроведения(ДокументСсылка)
	...
	Запрос = Новый Запрос(
		"ВЫБРАТЬ
		|	НачислениеПоДоговорам.Ссылка КАК Ссылка,
		|	НачислениеПоДоговорам.Дата КАК Дата,
		|	НачислениеПоДоговорам.МесяцНачисления КАК МесяцНачисления,
		|	НачислениеПоДоговорам.Организация КАК Организация,
		|	НачислениеПоДоговорам.ПорядокВыплаты КАК ПорядокВыплаты
		|ИЗ
		...
		|ГДЕ
		|	РаспределениеПоТерриториямУсловиямТруда.Ссылка = &Ссылка
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		...
		|
		|СГРУППИРОВАТЬ ПО
		|	РаспределениеРезультатовНачислений.ПодразделениеУчетаЗатрат,
...
Функция РеквизитыДляПроведенияПустаяСтруктура()
	...
	РеквизитыДляПроведенияПустаяСтруктура = Новый Структура("Ссылка, Дата, МесяцНачисления, Организация, ПорядокВыплаты,
		|РаспределениеПоТерриториямУсловиямТруда, РаспределениеРезультатовНачислений");
