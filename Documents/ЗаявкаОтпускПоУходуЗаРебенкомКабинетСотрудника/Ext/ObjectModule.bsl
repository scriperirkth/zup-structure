...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("Структура") Тогда
		...
		Если ЗначениеЗаполнено(ОтменяемаяЗаявка) Тогда
			ДанныеОтменяемойЗаявки = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ОтменяемаяЗаявка, "Сотрудник,ТипЗаявки");
			ТипЗаявки = ДанныеОтменяемойЗаявки.ТипЗаявки;
			Сотрудник = ДанныеОтменяемойЗаявки.Сотрудник;
		Иначе
			Если ТипОбъекта = Перечисления.ТипыОбъектовИнтеграцияУправлениеПерсоналом.ОтпускПоУходуЗаРебенком Тогда
			...
			ИначеЕсли ТипОбъекта = Перечисления.ТипыОбъектовИнтеграцияУправлениеПерсоналом.ВозвратИзОтпускаПоУходуЗаРебенком Тогда
				ТипЗаявки = Перечисления.ТипыЗаявокКабинетСотрудника.ВозвратИзОтпускаПоУходуЗаРебенком;
			КонецЕсли;
