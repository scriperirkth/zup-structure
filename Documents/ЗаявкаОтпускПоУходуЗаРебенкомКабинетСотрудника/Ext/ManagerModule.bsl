...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Если Данные.ТипЗаявки = Перечисления.ТипыЗаявокКабинетСотрудника.ОтпускПоУходуЗаРебенком Тогда
		Шаблон = НСтр("ru = 'Отпуск по уходу за ребенком %1 от %2'");
	ИначеЕсли Данные.ТипЗаявки = Перечисления.ТипыЗаявокКабинетСотрудника.ВозвратИзОтпускаПоУходуЗаРебенком Тогда
		Шаблон = НСтр("ru = 'Возврат из отпуска по уходу за ребенком %1 от %2'");
	КонецЕсли;
...
Функция ОписаниеДокументаДляЗаявки(СписокОбщихПолей) Экспорт
	...
	СтрокаСвойств = "ДатаНачала,ДатаОкончания,ДатаВыходаНаРаботу";
...
Функция НаименованиеЗадачи(ДокументОбъект) Экспорт
	...
	Если ДокументОбъект.ТипЗаявки = Перечисления.ТипыЗаявокКабинетСотрудника.ОтпускПоУходуЗаРебенком Тогда
		ШаблонНаименования = НСтр("ru = 'Заявление на отпуск по уходу за ребенком'");
	ИначеЕсли ДокументОбъект.ТипЗаявки = Перечисления.ТипыЗаявокКабинетСотрудника.ВозвратИзОтпускаПоУходуЗаРебенком Тогда
		ШаблонНаименования = НСтр("ru = 'Заявление на возврат из отпуска по уходу за ребенком'");
	КонецЕсли;
...
Функция СодержаниеЗадачи(ДокументОбъект) Экспорт
	...
	ИначеЕсли ДокументОбъект.ТипЗаявки = Перечисления.ТипыЗаявокКабинетСотрудника.ВозвратИзОтпускаПоУходуЗаРебенком Тогда
		ШаблонНаименования = НСтр("ru = 'Обработать заявление на возврат из отпуска по уходу за ребенком'");
	КонецЕсли;
