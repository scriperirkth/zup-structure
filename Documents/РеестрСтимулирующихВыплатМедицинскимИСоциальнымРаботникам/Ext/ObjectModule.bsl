...
Процедура ОбработкаЗаполнения(Основание, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(Основание) = Тип("ДокументСсылка.РеестрСтимулирующихВыплатМедицинскимИСоциальнымРаботникам") Тогда
		...
		ИменаНаследуемыхРеквизитов = "Организация,ВидПособия,СоциальныеВыплатыОтдельнымКатегориямМедРаботников,РегистрационныйНомерФСС,РегистрационныйНомерСФР, КодПодчиненностиФСС";
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не ПовторяющиесяСотрудники.Пустой() Тогда
		...
		КонецЦикла;
	КонецЕсли;
	РеестрВыплатТерриториальнымОрганам = ВидПособия = Перечисления.ПолучательСтимулирующихВыплатФСС.ТерриториальныйОрганФедеральныйГосОргана;
	...
	ИначеЕсли РеестрВыплатТерриториальнымОрганам Тогда
		ИсключаемыеРеквизиты.Добавить("Сотрудники.СменКОплате");
		ИсключаемыеРеквизиты.Добавить("Сотрудники.КатегорияПолучателя");
	КонецЕсли;
	...
	Для Каждого Строка Из Сотрудники Цикл
		...
		Если (СоциальныеВыплатыОтдельнымКатегориямМедРаботников
			ИЛИ РеестрВыплатТерриториальнымОрганам)
		...
		Если (НЕ СоциальныеВыплатыОтдельнымКатегориямМедРаботников
			И НЕ РеестрВыплатТерриториальнымОрганам)
...
Функция ОбновитьДанныеСтрахователя(ПараметрыФиксации)
	...
	ИменаРеквизитовОрганизации = "РегистрационныйНомерФСС, КодПодчиненностиФСС, ОГРН, РегистрационныйНомерСФР";
