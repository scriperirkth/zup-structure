...
Функция ДанныеДляПроведения()
	...
	|	ВЫБОР
	|		КОГДА ОперацияНалоговогоУчетаПоНДФЛСведенияОДоходах.ДокументОснование = НЕОПРЕДЕЛЕНО
	|			ТОГДА ОперацияНалоговогоУчетаПоНДФЛСведенияОДоходах.Ссылка
	|		ИНАЧЕ ОперацияНалоговогоУчетаПоНДФЛСведенияОДоходах.ДокументОснование
	...
	|	ОперацияНалоговогоУчетаПоНДФЛНДФЛИсчисленныйПоСтавке13.ДокументОснование КАК ДокументОснование
	...
	|	ОперацияНалоговогоУчетаПоНДФЛСведенияОДоходах.ДокументОснование
	|ИЗ
	...
	|	СведенияОДоходахПоНДФЛ.ДокументОснование КАК ДокументОснование
	|ИЗ
