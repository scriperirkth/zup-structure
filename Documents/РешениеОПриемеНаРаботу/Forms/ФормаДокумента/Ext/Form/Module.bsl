...
Процедура ОрганизацияПриИзменении(Элемент)
	...
	ЗаполненаОрганизация = ЗначениеЗаполнено(Объект.Организация);
	УстановитьВидимостьПодразделения(Элементы, ЗаполненаОрганизация);
...
Процедура ЗаполнитьМероприятияНаСервере()
	...
	Если Не ЗначениеЗаполнено(Объект.ФизическоеЛицо)
		И Не ЗначениеЗаполнено(Объект.ЛичныеДанныеКандидата) Тогда
...
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьВидимостьПодразделения(Элементы, ЗаполненаОрганизация)
	
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "Подразделение", "Видимость", Не ЗаполненаОрганизация);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ПодразделениеОрганизации", "Видимость", ЗаполненаОрганизация);
