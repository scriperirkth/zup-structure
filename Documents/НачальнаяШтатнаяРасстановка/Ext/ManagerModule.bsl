...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ЗаполнитьНеподтвержденныеДанные");
	Методы.Вставить("ПерезаполнитьДвиженияЗанятостьПозицийШтатногоРасписания");
	Методы.Вставить("ЗаполнитьВременныеОсвобожденияСтавок");
	Методы.Вставить("ЗаполнитьНеподтвержденныеДанныеСостоянийСотрудников");
	Методы.Вставить("ЗаполнитьНеподтвержденныеДанныеГрафиковРаботы");
	Методы.Вставить("ПеренестиВременныеОсвобожденияСтавок");
КонецПроцедуры
