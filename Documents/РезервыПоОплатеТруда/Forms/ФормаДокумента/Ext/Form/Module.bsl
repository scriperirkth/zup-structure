...
Процедура ОценочныеОбязательстваПриОкончанииРедактирования(Элемент, НоваяСтрока, ОтменаРедактирования)
	...
	Если ОтменаРедактирования Или Не РезервыРассчитываютсяАвтоматически Тогда
		Возврат;
	КонецЕсли;
...
Процедура ЗаполнитьУволенными(Команда)
	...
	ЗаполнитьДанныеФормыНаКлиенте(Новый Структура("ИмяПоказателяДопОтбора, Период", "Уволен", КонецМесяца(Объект.МесяцНачисления)));
...
Процедура ЗаполнитьПереведенными(Команда)
	...
	ЗаполнитьДанныеФормыНаКлиенте(Новый Структура("ИмяПоказателяДопОтбора, Период", "Перемещен", КонецМесяца(Объект.МесяцНачисления)));
...
Процедура ЗаполнитьЗачисленными(Команда)
	...
	ЗаполнитьДанныеФормыНаКлиенте(Новый Структура("ИмяПоказателяДопОтбора, Период", "Зачислен", НачалоМесяца(Объект.МесяцНачисления)));
...
Процедура УправлениеФормой();
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
		"ПодменюЗаполнитьСтандартное",
		"Видимость",
		РезервыРассчитываютсяАвтоматически);
			
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
		"ОсновныеКомандыСтандартное",
		"Видимость",
		РезервыРассчитываютсяАвтоматически);
...
Процедура УстановитьФункциональныеОпцииФормы()
	...
	ИспользоватьОбособленныеПодразделения =
		ПолучитьФункциональнуюОпцию("ИспользоватьОбособленныеПодразделенияРасширенная", ПараметрыФО);
