...
Процедура СотрудникиСотрудникПриИзмененииНаСервере()
	...
	Документы.ДанныеОКорректировкеСведенийЗастрахованныхЛицСЗВ_КОРР.СоздатьВТПерсональныеДанныеСотрудников(
		МенеджерВременныхТаблиц, Объект.Организация, Объект.КорректируемыйПериод, ОкончаниеПериода, СписокСотрудников, Объект.Дата);
...
Процедура УстановитьСвойстваЭлементовФормы()
	...
	ЭтаФорма.Заголовок = ?(ЭтоЕФС1, "", НСтр("ru = 'Корректировка сведений о страховом стаже, СЗВ-КОРР'") + ?(ЗначениеЗаполнено(Объект.Ссылка), 
