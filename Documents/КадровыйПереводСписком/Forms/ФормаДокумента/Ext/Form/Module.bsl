		...
		Если СтрокаСотрудники.ИзменитьПодразделениеИДолжность Тогда
			...
			Если ДанныеСотрудников <> Неопределено Тогда
				...
				Если ТекущиеДанные.Количество() > 0 Тогда
					...
					Если СтрокаСотрудники.ДолжностьПоШтатномуРасписанию <> ТекущиеДанные[0].ДолжностьПоШтатномуРасписанию Тогда
						ЭлементДанных.КоличествоСтавок = - ТекущиеДанные[0].КоличествоСтавок;
					Иначе
						Если СтрокаСотрудники.КоличествоСтавок < ТекущиеДанные[0].КоличествоСтавок Тогда
							ЭлементДанных.КоличествоСтавок = СтрокаСотрудники.КоличествоСтавок - ТекущиеДанные[0].КоличествоСтавок;
						Иначе
							ЭлементДанных.КоличествоСтавок = 0;
						КонецЕсли;
					КонецЕсли;
