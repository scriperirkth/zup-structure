...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ЗаполнитьЗапросыПоСпецификации_2_41");
	Методы.Вставить("ЗаполнитьИнформациюОПерерасчете");
	Методы.Вставить("ЗаполнитьЗапросыПоСпецификации_2_36");
	Методы.Вставить("ЗаполнитьЗапросыПоСпецификации_2_45");
	Методы.Вставить("ЗаполнитьЗапросыПоСпецификации_2_34");
КонецПроцедуры
...
Процедура ПриЗаписиРегистрацииОтветаНаЗапрос(НаборРегистраций) Экспорт
	...
	ПринятыеОтветыНаЗапросы = НаборРегистраций.Выгрузить().Скопировать(Фильтр, "ИсходящийДокумент").ВыгрузитьКолонку("ИсходящийДокумент");
