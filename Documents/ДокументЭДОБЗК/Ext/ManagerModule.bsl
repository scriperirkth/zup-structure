...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ЗаполнитьНаличияСведенийОЗарплате");
	Методы.Вставить("ЗаполнитьРасширенияЭлектронныхДокументов");
	Методы.Вставить("ЗаполнитьПодписантов");
	Методы.Вставить("ЗаполнитьВариантПодписанияДокументов");
	Методы.Вставить("ЗаполнитьКодыДокументовКадровыхМероприятий");
	Методы.Вставить("ПеренестиСведенияЭлектронногоДокумента");
	Методы.Вставить("ЗаполнитьПризнакСоответствияФорматаДокументаТребованиям");
	Методы.Вставить("ПометитьНаУдалениеДокументыУдаленныхОснований");
КонецПроцедуры
