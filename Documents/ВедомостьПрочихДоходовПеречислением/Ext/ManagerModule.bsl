...
Функция БанковскиеСчетаФизическихЛиц(ФизическиеЛица, Банк) Экспорт
	...
	УчетПрочихДоходов.СоздатьВТОсновныеБанковскиеСчетаКонтрагентов(Запрос.МенеджерВременныхТаблиц, ФизическиеЛица, Банк);
	...
	Пока Выборка.Следующий() Цикл
		БанковскиеСчета.Вставить(Выборка.Контрагент, Выборка.БанковскийСчетКонтрагента);	
	КонецЦикла;	
