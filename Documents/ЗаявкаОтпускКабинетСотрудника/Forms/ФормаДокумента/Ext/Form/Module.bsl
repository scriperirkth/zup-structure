...
Процедура НовыйДокумент(Команда)
	...
	ЗаявкиСотрудниковФормыКлиент.СоздатьНовыйДокументОтпуск(ЭтаФорма);
...
Процедура ИнициализацияФормы()
	...
	Если Объект.ВариантИсправления <> Перечисления.ВариантыИсправленияЗаявокКабинетСотрудника.Отмена Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
			"ГруппаКомпенсация", "Видимость", Объект.ПредоставитьКомпенсациюОтпуска);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
			"ПредоставитьМатериальнуюПомощьПриОтпуске", "Видимость", Объект.ПредоставитьМатериальнуюПомощьПриОтпуске);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
			"ПредоставитьЕдиновременнуюВыплатуКОтпуску", "Видимость", Объект.ПредоставитьЕдиновременнуюВыплатуКОтпуску);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
			"ГруппаДнейОтпуска", "Видимость", ЗначениеЗаполнено(Объект.ДнейОтпуска));
		
		// Детальные данные по видам отпусков.
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
			"ГруппаДетальноПоВидамОтпусков", "Видимость", ЗначениеЗаполнено(Объект.ДанныеПоВидамОтпусков));
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
			"ДетальноПоВидамОтпусковДнейОтпуска", "Видимость", (Объект.ДанныеПоВидамОтпусков.Итог("ДнейОтпуска") > 0));
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
			"ДетальноПоВидамОтпусковГруппаКомпенсация", "Видимость", (Объект.ДанныеПоВидамОтпусков.Итог("КоличествоДнейКомпенсацииОтпуска") > 0));
