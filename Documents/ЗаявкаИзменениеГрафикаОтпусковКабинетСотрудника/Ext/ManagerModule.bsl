...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Если Данные.ВариантИсправления = Перечисления.ВариантыИсправленияЗаявокКабинетСотрудника.Отмена Тогда
		Шаблон = НСтр("ru = 'Отмена изменения графика отпусков %1 от %2'");
	Иначе
		Шаблон = НСтр("ru = 'Заявка на изменение графика отпусков %1 от %2'");
	КонецЕсли;
...
Функция ОписаниеДокументаДляЗаявки(СписокОбщихПолей) Экспорт
	...
	Описание = Новый Структура(СписокОбщихПолей);
	Описание.Вставить("ИсходныеПериодыОтпуска", ОписаниеИсходныеПериоды());
	Описание.Вставить("ПериодыОтпуска", ОписаниеПериодыОтпуска());
...
Функция НаименованиеЗадачи(ДокументОбъект) Экспорт
	...
	Если ДокументОбъект.ВариантИсправления = Перечисления.ВариантыИсправленияЗаявокКабинетСотрудника.Отмена Тогда
		ШаблонНаименования = НСтр("ru = 'Отмена изменения графика отпусков'");
	Иначе
		ШаблонНаименования = НСтр("ru = 'Заявка на изменение графика отпусков'");
	КонецЕсли;
...
Функция СодержаниеЗадачи(ДокументОбъект) Экспорт
	...
	Если ДокументОбъект.ВариантИсправления = Перечисления.ВариантыИсправленияЗаявокКабинетСотрудника.Отмена Тогда
		ШаблонНаименования = НСтр("ru = 'Обработать заявление на отмену изменения графика отпусков'");
	Иначе
		ШаблонНаименования = НСтр("ru = 'Обработать заявление на изменение графика отпусков'");
	КонецЕсли;
...
Функция ОписаниеИсходныеПериоды()
	...
	Таблица.Колонки.Добавить("ИсходнаяДатаНачала", Новый ОписаниеТипов("Дата"));
	
	Возврат Таблица;

КонецФункции

Функция ОписаниеПериодыОтпуска()
