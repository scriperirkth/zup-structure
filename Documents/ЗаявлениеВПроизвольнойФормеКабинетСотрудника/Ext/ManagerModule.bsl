...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Если Данные.ВариантИсправления = Перечисления.ВариантыИсправленияЗаявокКабинетСотрудника.Отмена Тогда
		Шаблон = НСтр("ru = 'Отмена заявления в произвольной форме %1 от %2'");
	Иначе
		Шаблон = НСтр("ru = 'Заявление в произвольной форме %1 от %2'");
	КонецЕсли;
...
Функция НаименованиеЗадачи(ДокументОбъект) Экспорт
	...
	Если ДокументОбъект.ВариантИсправления = Перечисления.ВариантыИсправленияЗаявокКабинетСотрудника.Отмена Тогда
		ШаблонНаименования = НСтр("ru = 'Отмена заявления в произвольной форме'");
	Иначе
		ШаблонНаименования = НСтр("ru = 'Заявление в произвольной форме'");
	КонецЕсли;
...
Функция СодержаниеЗадачи(ДокументОбъект) Экспорт
	...
	Если ДокументОбъект.ВариантИсправления = Перечисления.ВариантыИсправленияЗаявокКабинетСотрудника.Отмена Тогда
		ШаблонНаименования = НСтр("ru = 'Обработать отмену заявления в произвольной форме'");
	Иначе
		ШаблонНаименования = НСтр("ru = 'Обработать заявление в произвольной форме'");
	КонецЕсли;
...
Функция РольИсполнителяЗаявки() Экспорт
	...
	Возврат Справочники.РолиИсполнителей.ОбработкаЗаявленийВПроизвольнойФорме;
