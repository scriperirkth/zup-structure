...
Процедура ИзменитьОформлениеКнопок(Форма)
	...
	Элементы.ФормаКомандаОтправить.Видимость = НЕ ЗапретитьИзменение И НЕ СтатусОтправлено
		И НЕ Форма.ЭтоОткрытиеИзМастера И Форма.ЗаявлениеПрименяется;
...
Процедура ИнициализироватьДанные(Параметры)
	...
	ЗаявлениеПрименяется = ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отпр.ЗПЭД");
