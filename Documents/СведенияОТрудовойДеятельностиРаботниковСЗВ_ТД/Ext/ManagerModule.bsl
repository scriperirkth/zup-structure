...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ЗаполнитьСотрудниковСЗВ_ТД");
	Методы.Вставить("ОбновитьДвиженияПереданныхМероприятийНеПринятыхВПФР");
	Методы.Вставить("ЗаполнитьСотрудниковМероприятий");
	Методы.Вставить("УдалитьДанныеОбОтправкеПустыхЗаявленийОВыбореСпособаВеденияТрудовойКнижки");
	Методы.Вставить("ЗаполнитьКодПоОКЗ");
	Методы.Вставить("ЗаполнитьЯвляетсяСовместителемВМероприятиях");
	Методы.Вставить("ЗаполнитьИдМероприятий");
	Методы.Вставить("ЗаполнениеПризнакаПринятоВПФРВСтрокахСотрудников");
	Методы.Вставить("ЗаполнитьВДвиженияхПризнакПринятоВПФР");
	Методы.Вставить("УдалениеСтрокБезСотрудников");
КонецПроцедуры
