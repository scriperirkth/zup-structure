...
Функция СформироватьВыходнойФайл(ВыборкаПоШапкеДокумента, ВыборкаПоЗаписямСтажа)
	...
	Если ВыборкаПоШапкеДокумента.Дата >= ПерсонифицированныйУчет.ДатаПостановленияСЗВК2025() Тогда
...
Функция СформироватьПечатнуюФормуСЗВ_К(МассивОбъектов, ОбъектыПечати)
	...
	ДатаПостановленияСЗВК2025 = ПерсонифицированныйУчет.ДатаПостановленияСЗВК2025();
	...
	Пока ВыборкаПоШапкеДокумента.Следующий() Цикл 
		...
		ИспользоватьФорму2025 = ДатаПостановленияСЗВК2025 <= ВыборкаПоШапкеДокумента.Дата;
