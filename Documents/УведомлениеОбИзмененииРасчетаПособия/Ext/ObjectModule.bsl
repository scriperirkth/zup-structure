...
Процедура ПередУдалением(Отказ)
	МенеджерРегистра = РегистрыСведений.РегистрацииОтветовНаЗапросыФССДляРасчетаПособий;
	МенеджерРегистра.УдалитьСсылкиНаУведомлениеОбИзмененииРасчетаПособия(Ссылка);
КонецПроцедуры
...
Функция ЗаполнитьСвязанныеДокументы(ПараметрыФиксации)
	ИменаРеквизитов = "ОтветНаЗапрос,ВходящийЗапрос,ФизическоеЛицо,СНИЛС,Организация,Сотрудник";
	Если ФиксацияВторичныхДанныхВДокументах.РеквизитыШапкиЗафиксированы(ЭтотОбъект, ИменаРеквизитов) Тогда
		Возврат Ложь;
	КонецЕсли;
