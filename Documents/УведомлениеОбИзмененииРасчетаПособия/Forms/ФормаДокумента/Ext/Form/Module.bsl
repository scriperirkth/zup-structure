...
Процедура ВключитьВозможностьРедактирования(Команда)
	...
	РеквизитыБлокировки = Новый Структура(ИменаРеквизитовБлокировки());
	Для Каждого КлючИЗначение Из РеквизитыБлокировки Цикл
		Элементы[КлючИЗначение.Ключ].ТолькоПросмотр = Не РедактированиеДоступно;
	КонецЦикла;
...
Функция ИменаРеквизитовБлокировки()
	Возврат
	"Организация,
	|Страхователь,
	|ФизическоеЛицо,
	...
	|ВидУведомления,
	|ДатаСообщения,
	|МетодНазначенияИВыплатыПособия,
	|СНИЛС,
	|РасчетныйГод1,
	|РасчетныйГод2,
	|НомерПроцесса,
