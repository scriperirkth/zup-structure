...
Процедура СинхронизироватьПометкуУдаленияПрисоединенныхФайлов()  
	...
	РаботаСФайлами.ЗаполнитьПрисоединенныеФайлыКОбъекту(Ссылка, ВложенныеФайлы);  
	
	СведенияОПрисоединенныхФайлах = ОбщегоНазначения.ЗначенияРеквизитовОбъектов(ВложенныеФайлы,"ПометкаУдаления");  
