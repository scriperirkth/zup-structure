...
&НаКлиенте
Процедура УстановитьПризнакПрочтения(Команда)
...
Процедура ОбработатьПризнакПрочитано()
	...
	Элементы.УстановитьПризнакПрочтения.Доступность = Ложь;
	Элементы.УстановитьПризнакПрочтения_ВсеДействия.Доступность = Ложь; 
	Элементы.УстановитьПризнакПрочтения.Пометка = Не ПисьмоПрочитано;	 
	Элементы.УстановитьПризнакПрочтения_ВсеДействия.Пометка = Не ПисьмоПрочитано; 
	
	Если РучноеПрочтение Тогда  
		Элементы.УстановитьПризнакПрочтения.Доступность = Истина;
		Элементы.УстановитьПризнакПрочтения_ВсеДействия.Доступность = Истина;
...
Процедура ИзменитьВидимостьДоступностьЭлементов()   
	...
	Элементы.УстановитьПризнакПрочтения_ВсеДействия.Доступность = ЕстьПравоОбработкиДокументов;
	Элементы.УстановитьПризнакПрочтения.Видимость = ЕстьПравоОбработкиДокументов;
