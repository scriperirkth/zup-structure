...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЭтоНовый Тогда
		...
		Если Параметры.Свойство("БезПодписи") И Параметры.БезПодписи Тогда
			Подпись = "";
		Иначе
			Подпись = СтрШаблон("
				|
...
Процедура ДляВалютногоКонтроляПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Объект.Основание) 
		И ТипЗнч(Объект.Основание) = Тип("ДокументСсылка.ПисьмоОбменСБанками") Тогда
...
Процедура ЗаполнитьНовоеПисьмо() 
	...
	Если РеквизитыНовогоПисьма.Свойство("Тема") И ЗначениеЗаполнено(РеквизитыНовогоПисьма.Тема) Тогда
		Объект.Тема = РеквизитыНовогоПисьма.Тема;
	КонецЕсли;
	
	Если РеквизитыНовогоПисьма.Свойство("Текст") И ЗначениеЗаполнено(РеквизитыНовогоПисьма.Текст) Тогда
		Объект.Текст = РеквизитыНовогоПисьма.Текст;
	КонецЕсли;
