...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("Структура") Тогда
		...
		Иначе
			...
			КонецЕсли;
		КонецЕсли;
		Если ЗначениеЗаполнено(ДанныеЗаполнения.ВыходныеДни) Тогда
			Для каждого СтрокаТЗ Из ДанныеЗаполнения.ВыходныеДни Цикл
				ЗаполнитьЗначенияСвойств(ВыходныеДни.Добавить(), СтрокаТЗ);
			КонецЦикла;
		КонецЕсли;
	КонецЕсли;
