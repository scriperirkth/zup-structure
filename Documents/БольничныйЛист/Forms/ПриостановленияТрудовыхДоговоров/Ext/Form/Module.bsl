...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МетаданныеБольничного = Метаданные.Документы.БольничныйЛист;
	Элементы.НачалоВПериодПриостановленияТДРасширеннаяПодсказка.Заголовок = МетаданныеБольничного.Реквизиты.НачалоВПериодПриостановленияТД.Подсказка;
	РеквизитыТаблицы = МетаданныеБольничного.ТабличныеЧасти.ПриостановленияТрудовыхДоговоров.Реквизиты;
...
&НаКлиенте
Процедура НачалоВПериодПриостановленияТДПриИзменении(Элемент)
	Автозаполнение = Ложь;
КонецПроцедуры
...
Процедура ЗаполнитьНаСервере()
	...
	ДанныеУчета = УчетПособийСоциальногоСтрахования.ДанныеУчетаПриостановленийТД(ЭтотОбъект);
	Таблица.Загрузить(ДанныеУчета.ПриостановленияТД);
	НачалоВПериодПриостановленияТД = ДанныеУчета.НачалоВПериодПриостановленияТД;
	ПроверитьЗаполнение();
КонецПроцедуры
