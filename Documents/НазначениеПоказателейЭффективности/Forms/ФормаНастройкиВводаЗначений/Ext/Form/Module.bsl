...
Процедура УстановитьСвойстваЭлементовФормы()
	...
	УстановитьДоступностьКемГруппа(ЭтаФорма);
	УстановитьДоступностьОтветственныйЗаВводФактаГруппа(ЭтаФорма);
	УстановитьВидимостьМестоВводаВышестоящее(ЭтаФорма);
...
Процедура ЗаполнитьДанныеФормыИзПараметров()
	...
	ЗаполнитьЗначенияСвойств(
		ЭтаФорма, Параметры,
		"ДляПозиции, ДляСотрудника, ОбъектНазначения, Подразделение, Позиция, Сотрудник,ОтветственныйЗаВводПлана,
		|ОтветственныйЗаВводФакта, МестоВводаЗначений");
...
Процедура ЗаполнитьСписокВыбораВидМестаВводаЧислоНепосредственно()
	...
	МестоВвода = НСтр("ru = 'позиции'");
	
	Если ДляПозиции Тогда
		МестоВвода = МестоВвода;
	ИначеЕсли ДляСотрудника Тогда
		МестоВвода = НСтр("ru = 'сотруднике'");
	Иначе
		МестоВвода = НСтр("ru = 'подразделении'");
	КонецЕсли;
...
&НаСервере
Процедура УстановитьВидимостьМестоВводаВышестоящее(Форма)
