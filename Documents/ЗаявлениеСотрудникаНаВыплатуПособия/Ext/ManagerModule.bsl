...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	ДатаФорм2025 = ПрямыеВыплатыПособийСоциальногоСтрахования.ДатаВступленияВСилуФорм2025();
	...
	УправлениеПечатью.ДобавитьУсловиеВидимостиКоманды(КомандаПечати, "Дата", ДатаФорм2025, Меньше);
	УправлениеПечатью.ДобавитьУсловиеВидимостиКоманды(КомандаПечати, "ВидПособия", ПособиеПоУходуЗаРебенком);
	
	КомандаПечати = КомандыПечати.Добавить();
	КомандаПечати.Обработчик     = "УправлениеПечатьюБЗККлиент.ВыполнитьКомандуПечати";
	КомандаПечати.Идентификатор  = Макеты.ПФ_MXL_ЗаявлениеОНазначенииПособияПоУходуЗаРебенком_2025.Имя;
	КомандаПечати.Представление  = Макеты.ПФ_MXL_ЗаявлениеОНазначенииПособияПоУходуЗаРебенком_2025.Представление();
	КомандаПечати.ПроверкаПроведенияПередПечатью = Истина;
	УправлениеПечатью.ДобавитьУсловиеВидимостиКоманды(КомандаПечати, "Дата", ДатаФорм2025, БольшеИлиРавно);
	УправлениеПечатью.ДобавитьУсловиеВидимостиКоманды(КомандаПечати, "ВидПособия", ПособиеПоУходуЗаРебенком);
...
Процедура ПриФормированииПечатнойФормы(КонтекстПечати) Экспорт
	...
	Если КонтекстПечати.МетаданныеМакета = Макеты.ПФ_MXL_ЗаявлениеОНазначенииПособияПоУходуЗаРебенком_2022
		Или КонтекстПечати.МетаданныеМакета = Макеты.ПФ_MXL_ЗаявлениеОНазначенииПособияПоУходуЗаРебенком_2024
		Или КонтекстПечати.МетаданныеМакета = Макеты.ПФ_MXL_ЗаявлениеОНазначенииПособияПоУходуЗаРебенком_2025 Тогда
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ОбновитьДокументы");
КонецПроцедуры
...
Функция ТабличныйДокументСведенийОЗастрахованномЛице(МассивСсылок, ОбъектыПечати)
	...
	ИмяМакета = "ПФ_MXL_СведенияОЗастрахованномЛице_2025";
	ДанныеДляПечати = ДанныеДляПечатиСведений.Скопировать(Новый Структура("ИмяМакета", ИмяМакета));
	Если ДанныеДляПечати.Количество() > 0 Тогда
		ДанныеДляПечати.Сортировать("Дата, Ссылка");
		МетаданныеМакета = Метаданные.Документы.ЗаявлениеСотрудникаНаВыплатуПособия.Макеты[ИмяМакета];
...
Функция ДанныеДляПечатиСведений(МассивСсылок)
	...
	|		КОГДА Заявление.Дата < &ДатаФорм2025
	|			ТОГДА ""ПФ_MXL_СведенияОЗастрахованномЛице_2024""
	|		ИНАЧЕ ""ПФ_MXL_СведенияОЗастрахованномЛице_2025""
	|	КОНЕЦ КАК ИмяМакета,
