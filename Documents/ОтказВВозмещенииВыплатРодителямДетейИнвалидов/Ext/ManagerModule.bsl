...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("c4341d04-3295-11f1-8174-4cedfb43b11a");
	Обработчик.Процедура = "Документы.ОтказВВозмещенииВыплатРодителямДетейИнвалидов.ЗаполнитьТипСообщения";
	Обработчик.Комментарий = НСтр("ru = 'СЭДО ЕЦП: Заполнение типа сообщений в документах ""Отказ СФР в возмещении выплат родителям детей инвалидов"".'");
	...
	Пока Выборка.Следующий() Цикл
		Если ОбработчикОтложенный Тогда
			Если Не ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ПодготовитьОбновлениеДанных(
					ПараметрыОбновления,
					"Документ.ОтказВВозмещенииВыплатРодителямДетейИнвалидов",
					"Ссылка",
		...
		Если ДокументОбъект.ТипСообщения = 0 Тогда
			ДокументОбъект.ТипСообщения = 122;
		КонецЕсли;
...
Функция ТипСообщения(Документ) Экспорт
	Возврат ?(Документ = Неопределено Или Документ.ТипСообщения = 0, 122, Документ.ТипСообщения);
КонецФункции
