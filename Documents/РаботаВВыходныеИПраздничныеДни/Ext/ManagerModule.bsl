...
Функция СторнироватьПоУчетам(Движения, Регистратор, ИсправленныйДокумент, СтруктураВидовУчета, ДополнительныеПараметры) Экспорт
	...
	Запрос.УстановитьПараметр("ИсправленныйДокумент", ИсправленныйДокумент);
		...
		|ГДЕ
		|	РаботаВВыходныеИПраздничныеДниСотрудники.Ссылка = &ИсправленныйДокумент";	
	...
	Если ДополнительныеПараметры.ОтменаДокумента Тогда
		...
		РеквизитыДляПроведения.Вставить("Сотрудники", Сотрудники);
	Иначе 
		ОбщегоНазначенияКлиентСервер.ДополнитьМассив(Сотрудники, РеквизитыДляПроведения.Сотрудники, Истина);
	КонецЕсли;
