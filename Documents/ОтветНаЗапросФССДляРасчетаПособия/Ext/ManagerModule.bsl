...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ОбновитьДанныеПодписи");
	Методы.Вставить("ЗафиксироватьОтказы");
КонецПроцедуры
...
Процедура ЗарегистрироватьРезультатОтправки(РезультатОтправки) Экспорт
	...
	ДокументОбъект.ДополнительныеСвойства.Вставить("ЗначенияРеквизитовДоЗаписи", ДокументОбъект.ЗначенияРеквизитовДоЗаписи());
	...
	НаборРегистраций = РегистрыСведений.РегистрацииОтветовНаЗапросыФССДляРасчетаПособий.ЗаполнитьПоДокументу(ДокументОбъект,
		РезультатОтправки);
	
	// Обновление уведомлений.
	Документы.УведомлениеОбОтсутствииОтветаСЭДО.ПриЗаписиОтветаНаЗапрос(ДокументОбъект, НаборРегистраций);
...
Процедура ЗагрузитьРезультатДоставкиСообщения101(Страхователь, Сообщение, Результат) Экспорт
	...
	Для Каждого СтрокаТаблицы Из Таблица Цикл
		...
		// Затем записывается транспортный регистр,
		// который при записи запускает обновление остальных регистров, зависящих от состояния отправки.
		НаборРегистраций = РегистрыСведений.РегистрацииОтветовНаЗапросыФССДляРасчетаПособий.ЗаполнитьПоРезультатуДоставки(
