...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	Оповестить("Запись_СведенияОПодлежащихВоинскомуУчетуГражданах", ПараметрыЗаписи, Объект.Ссылка);
...
Процедура ЗаполнитьДанныеСтрокиСотрудника(СтрокаСотрудника, КадровыеДанные)
	...
	Документы.СведенияОПодлежащихВоинскомуУчетуГражданах.ЗаполнитьДанныеСтрокиСотрудника(СтрокаСотрудника, КадровыеДанные, Объект.Дата);
...
Функция КадровыеДанныеСотрудников(СписокСотрудников)
	...
	КадровыеДанные = Документы.СведенияОПодлежащихВоинскомуУчетуГражданах.КадровыеДанныеСотрудников(ОсновныеСотрудники);
...
Процедура ЗаполнитьНаСервере()
	...
	ПараметрыПолученияСотрудников.КадровыеДанные = "Организация, ФИОПолные, ВоинскийУчетОтношениеКВоинскомуУчету, ВоинскийУчетПериодРегистрации, ВоинскийУчетВоенкомат";
	...
	ЗарплатаКадрыОбщиеНаборыДанных.ДобавитьВКоллекциюОтбор(
		ПараметрыПолученияСотрудников.Отборы, "ВоинскийУчетОтношениеКВоинскойОбязанности", "В", "ЗНАЧЕНИЕ(Перечисление.ОтношениеКВоинскойОбязанности.Военнообязанный), ЗНАЧЕНИЕ(Перечисление.ОтношениеКВоинскойОбязанности.Призывник)");
	
	ЗарплатаКадрыОбщиеНаборыДанных.ДобавитьВКоллекциюОтбор(
		ПараметрыПолученияСотрудников.Отборы, "ВоинскийУчетОтношениеКВоинскомуУчету", "НЕ В", "ЗНАЧЕНИЕ(Перечисление.ОтношениеКВоинскомуУчету.СнятПоВозрасту), ЗНАЧЕНИЕ(Перечисление.ОтношениеКВоинскомуУчету.СнятПоСостояниюЗдоровья)");
		
	Если ЗначениеЗаполнено(Объект.Военкомат) Тогда 
		ЗарплатаКадрыОбщиеНаборыДанных.ДобавитьВКоллекциюОтбор(
			ПараметрыПолученияСотрудников.Отборы, "ВоинскийУчетВоенкомат", "=", Объект.Военкомат);
	КонецЕсли;
	...
	КадровыеДанныеФизическихЛиц = Документы.СведенияОПодлежащихВоинскомуУчетуГражданах.КадровыеДанныеСотрудников(ОсновныеСотрудники);
