...
Процедура ПриПолученииДанныхНаСервере()
	...
	РезервОтпусковПереопределяемый.РезервыРассчитываютсяАвтоматически(РезервыРассчитываютсяАвтоматически); 
...
Процедура УправлениеФормой()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		"ОсновныеКоманды",
		"Видимость",
		РезервыРассчитываютсяАвтоматически И НЕ Объект.КорректировкаОбязательств);
