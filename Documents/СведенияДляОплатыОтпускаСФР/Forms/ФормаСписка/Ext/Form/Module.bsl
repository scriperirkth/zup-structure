...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	Если ИмяСобытия = "Запись_СведенияДляОплатыОтпускаСФР"
		Или ИмяСобытия = "Запись_РегистрацииСведенийДляОплатыОтпускаСФР"
...
Процедура ОбновитьНадписьСообщенияОжидаемыеОтСФР()
	КоличествоОжидаемыхСообщений = Документы.СведенияДляОплатыОтпускаСФР.КоличествоОжидаемыхСообщений(
		ГоловнаяОрганизация,
	...
	Иначе
		...
		Элементы.НадписьСообщенияОжидаемыеОтСФР.Заголовок = СтроковыеФункцииКлиентСервер.СтрокаСЧисломДляЛюбогоЯзыка(
			НСтр("ru = ';Ожидается %1 ответ на запрос СФР для расчета пособия;;Ожидается %1 ответа на запросы СФР для расчета пособий;Ожидается %1 ответов на запросы СФР для расчета пособий;'"),
