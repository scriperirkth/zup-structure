...
// 
// Параметры:
//  ДокументСсылка	- ДокументСсылка.РеестрДСВ_3 - Ссылка на документ.
...
Процедура ПровестиПоУчетам(ДокументСсылка, РежимПроведения, Отказ, ВидыУчетов = Неопределено, Движения = Неопределено, Объект = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	...
	КонецЕсли;
	Объект.ЗаполнитьДвиженияПоУчетам(Движения, Отказ, СтруктураВидовУчета);
...
Функция СформироватьЗапросПоШапкеДляПечати(МассивОбъектов)
	...
	|	СведенияОбОрганизациях.КатегорияСтрахователяФизическогоЛица,
	...
	|	РеестрДСВ_3.КатегорияСтрахователяФизическогоЛица КАК КатегорияСтрахователяФизическогоЛица,
