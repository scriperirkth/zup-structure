...
&НаКлиенте
Процедура Подключаемый_ЛьготыОтменитьИсправление(Команда)
	
	РасчетЗарплатыКлиент.ОтменитьИсправление(ЭтотОбъект, ОписаниеТаблицыЛьгот(ЭтотОбъект));
	
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_ЛьготыОтменитьВсеИсправления(Команда)
	
	РасчетЗарплатыКлиент.ОтменитьВсеИсправления(ЭтотОбъект, ОписаниеТаблицыЛьгот(ЭтотОбъект));
...
Функция ДанныеДокументаФизическихЛиц(ФизическиеЛица)
	...
	СтруктураНачисленийУдержаний = Новый ФиксированнаяСтруктура("Период,Регистратор,Организация,ФизическоеЛицо,Сотрудник,
		...
		|ДатаОкончания,Сумма,ОтработаноДней,ОтработаноЧасов,ОплаченоДней,ОплаченоЧасов,ВремяВЧасах,ИдентификаторСтроки");
