...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.Наставничество") Тогда
		...
		МодульНаставничество.ПриСозданииНаСервереФормыДокумента(ЭтотОбъект, Ложь);
	КонецЕсли;
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыПриложения.МатериальноОтветственныеЛица") Тогда
		Если ПараметрыЗаписи.РежимЗаписи = РежимЗаписиДокумента.Проведение
			И ОграниченияНаУровнеЗаписей.ИзменениеКадровыхДанных Тогда
			Сотрудники = ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Объект.Сотрудник);
			МодульМатериальноОтветственныеЛицаКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("МатериальноОтветственныеЛицаКлиент");
			МодульМатериальноОтветственныеЛицаКлиент.ПроверитьМатериальнуюОтветственность(Объект.Организация, Сотрудники, ЭтаФорма, Отказ, ПараметрыЗаписи);
			Если Отказ Тогда
				Возврат;
			КонецЕсли;
		КонецЕсли;
...
Процедура ОбработчикОжиданияДнейЧасовВыходногоПособияПриИзменении()
	...
	ВыполнитьРасчетНачислений();
	УстановитьВидимостьБухучетВыходногоПособия(ЭтотОбъект);
...
Процедура ОбработчикОжиданияКоличествоМесяцевВыплатыДенежногоСодержанияПриИзменении()
	...
	ВыполнитьРасчетНачислений();
	УстановитьВидимостьБухучетМесячноеДенежноеСодержание(ЭтотОбъект);
...
Процедура ПризнакКомпенсацииОтпускаПриИзменении(Элемент)
	...
	ВыполнитьРасчетНачислений();
	УстановитьВидимостьБухучетКомпенсацияОтпуска(ЭтотОбъект);
...
Процедура Подключаемый_ВыплачиватьКомпенсациюНеотработанныхДнейЧасовПриУвольненииПриИзменении(Элемент)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.КадровыйУчет.ДосрочноеУвольнение") Тогда
		...
		УстановитьВидимостьБухучетКомпенсацияПриУвольнении(ЭтотОбъект);
	КонецЕсли;
...
&НаКлиенте
Процедура ВыходноеПособиеВариантУказанияБухучетаПриИзменении(Элемент)
	
	УстановитьСтраницуНастроекБухучета(ЭтотОбъект, "ВыходноеПособие", ВыходноеПособиеВариантУказанияБухучета);
	ОбновитьБухучетРезультатовРасчета();
	
КонецПроцедуры

&НаКлиенте
Процедура МесячноеДСВариантУказанияБухучетаПриИзменении(Элемент)
	
	УстановитьСтраницуНастроекБухучета(ЭтотОбъект, "МесячноеДС", МесячноеДСВариантУказанияБухучета);
	ОбновитьБухучетРезультатовРасчета();
	
КонецПроцедуры

&НаКлиенте
Процедура КомпенсацияОтпускаВариантУказанияБухучетаПриИзменении(Элемент)
	
	УстановитьСтраницуНастроекБухучета(ЭтотОбъект, "КомпенсацияОтпуска", КомпенсацияОтпускаВариантУказанияБухучета);
	ОбновитьБухучетРезультатовРасчета();
	
КонецПроцедуры

&НаКлиенте
Процедура КомпенсацияПриУвольненииВариантУказанияБухучетаПриИзменении(Элемент)
	
	УстановитьСтраницуНастроекБухучета(ЭтотОбъект, "КомпенсацияПриУвольнении",КомпенсацияПриУвольненииВариантУказанияБухучета);
	ОбновитьБухучетРезультатовРасчета();
	
КонецПроцедуры

&НаКлиенте
Процедура КомпенсацияОтгуловВариантУказанияБухучетаПриИзменении(Элемент)
	
	УстановитьСтраницуНастроекБухучета(ЭтотОбъект, "КомпенсацияОтгулов", КомпенсацияОтгуловВариантУказанияБухучета);
	ОбновитьБухучетРезультатовРасчета();
	
КонецПроцедуры

&НаКлиенте
Процедура НастройкаБухучетаПриИзменении(Элемент)
	ОбновитьБухучетРезультатовРасчета()
КонецПроцедуры

&НаКлиенте
Процедура ВыходноеПособиеНастройкиБухучетаПредставлениеНажатие(Элемент)
	
	ОткрытьФормуРедактированияРаспределенияБухучетаДокумента(ВыходноеПособиеНастройкиБухучета, "ВыходноеПособиеНастройкиБухучета");
	
КонецПроцедуры

&НаКлиенте
Процедура МесячноеДСНастройкиБухучетаПредставлениеНажатие(Элемент)
	
	ОткрытьФормуРедактированияРаспределенияБухучетаДокумента(МесячноеДСНастройкиБухучета, "МесячноеДСНастройкиБухучета");
	
КонецПроцедуры

&НаКлиенте
Процедура КомпенсацияОтпускаНастройкиБухучетаПредставлениеНажатие(Элемент)
	
	ОткрытьФормуРедактированияРаспределенияБухучетаДокумента(КомпенсацияОтпускаНастройкиБухучета, "КомпенсацияОтпускаНастройкиБухучета");
	
КонецПроцедуры

&НаКлиенте
Процедура КомпенсацияПриУвольненииНастройкиБухучетаПредставлениеНажатие(Элемент)
	
	ОткрытьФормуРедактированияРаспределенияБухучетаДокумента(КомпенсацияПриУвольненииНастройкиБухучета, "КомпенсацияПриУвольненииНастройкиБухучета");
	
КонецПроцедуры

&НаКлиенте
Процедура КомпенсацияОтгуловНастройкиБухучетаПредставлениеНажатие(Элемент)
	
	ОткрытьФормуРедактированияРаспределенияБухучетаДокумента(КомпенсацияОтгуловНастройкиБухучета, "КомпенсацияОтгуловНастройкиБухучета");
...
#Область ОбработчикиСобытийЭлементовТаблицыНаставничество
...
Процедура Подключаемый_НаставничествоДокументОснованиеПриИзменении(Элемент)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.Наставничество") Тогда
		МодульНаставничествоКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("НаставничествоКлиент");
		МодульНаставничествоКлиент.ДокументОснованиеПриИзменении(ЭтотОбъект, Ложь);
	КонецЕсли;
...
Процедура Подключаемый_НаставничествоПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.Наставничество") Тогда
		МодульНаставничествоКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("НаставничествоКлиент");
		МодульНаставничествоКлиент.НаставничествоПриНачалеРедактирования(ЭтотОбъект, Элемент, НоваяСтрока, Копирование, Объект.ДатаУвольнения);
	КонецЕсли;
...
Процедура Подключаемый_НаставничествоНаставникПриИзменении(Элемент)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.Наставничество") Тогда
		МодульНаставничествоКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("НаставничествоКлиент");
		МодульНаставничествоКлиент.НаставничествоНаставникПриИзменении(ЭтотОбъект, Ложь);
	КонецЕсли;
...
Процедура Подключаемый_НаставничествоДокументОснованиеНачалоВыбораИзСпискаНаСервере(ИсходныйНомерСтроки, ДействующиеНазначения) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.Наставничество") Тогда
		МодульНаставничество = ОбщегоНазначения.ОбщийМодуль("Наставничество");
		МодульНаставничество.НаставничествоДокументОснованиеНачалоВыбораИзСпискаНаСервере(Объект, ИсходныйНомерСтроки, Объект.ДатаУвольнения, ДействующиеНазначения);
	КонецЕсли;
...
&НаСервере
Функция ПодготовитьСтруктуруОбъектаДляРасчетаДенежногоСодержания() Экспорт 
...
Процедура РассчитатьНачисленияНаКлиенте()
	...
	Если ПодключенОбработчикОжидания("РассчитатьНачисленияНаКлиенте") 
		И Не ПодключенОбработчикОжидания("ОбработчикОжиданияКоличествоМесяцевВыплатыДенежногоСодержанияПриИзменении") Тогда
...
Процедура ЗаполнитьНаСервере()
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ГосударственнаяСлужба.РасчетДенежногоСодержания") Тогда 
		...
		ЗначенияПоказателейДляКомпенсаций = МодульРасчетДенежногоСодержания.ЗначенияПоказателейСохраняемогоДенежногоСодержанияПоНазначению(ЗначенияПоказателейСохраняемогоДенежногоСодержания, "ВыходноеПособие");
	КонецЕсли;
...
Процедура ЗаполнитьНастройкиМенеджераРасчета(МенеджерРасчета)
	...
	ДокументОбъект = РеквизитФормыВЗначение("Объект");
	НастройкиБухучетаРеквизитыВДанные(ДокументОбъект);
	МенеджерРасчета.НастройкиБухучета.НастройкиБухучетаДокумента = Документы.Увольнение.ДанныеДляБухучетаЗарплатыПервичныхДокументов(ДокументОбъект)["ТаблицаБухучетЗарплаты"];
...
Процедура ЗаполнитьВыходноеПособие(ТаблицаНачислений, МенеджерРасчета, ДополнительныеВидыРасчета, ЗначенияПоказателейВыходногоПособия = Неопределено)
	...
	Если ЗначениеЗаполнено(Объект.ДнейЧасовВыходногоПособия) Тогда
		...
		МенеджерРасчета.ДобавитьИзвестноеЗначениеПоказателя(НоваяСтрока, ПоказательИндексируемыйЗаработок, ЗначенияПоказателейСреднегоЗаработка.СреднийЗаработокИндексируемый);	
		МенеджерРасчета.ДобавитьИзвестноеЗначениеПоказателя(НоваяСтрока, ПоказательНеиндексируемыйЗаработок, ЗначенияПоказателейСреднегоЗаработка.СреднийЗаработокНеиндексируемый);
...
Процедура ДанныеВРеквизиты()
	...
	Если ИспользуетсяРасчетЗарплаты Тогда
		...
		НастройкиБухучетаДанныеВРеквизиты();
		УстановитьДоступностьВидимостьНастроекБухучета();
...
Процедура РеквизитыВДанные(ТекущийОбъект)
	...
	Если ИспользуетсяРасчетЗарплаты Тогда
		...
		НастройкиБухучетаРеквизитыВДанные(ТекущийОбъект);
...
Процедура ОрганизацияПриИзмененииНаСервере()
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.Наставничество") Тогда
		МодульНаставничество = ОбщегоНазначения.ОбщийМодуль("Наставничество");
		МодульНаставничество.ПриИзмененииСотрудникаДокументаУвольнение(ЭтотОбъект);
	КонецЕсли;
...
Процедура СотрудникПриИзмененииНаСервере()
	...
	УстановитьВидимостьНастроекБухучета();
...
Процедура РассчитатьКоличествоЧасовКомпенсацииСуммированногоУчетаНаСервере()
	...
	Если ТаблицаСотрудников.Количество() > 0 Тогда
		Объект.Сверхурочно1_5 = ?(ТаблицаСотрудников[0].Переработки1_5 < 0, 0, ТаблицаСотрудников[0].Переработки1_5);
		Объект.Сверхурочно2 = ?(ТаблицаСотрудников[0].Переработки - ТаблицаСотрудников[0].Переработки1_5 < 0, 0, ТаблицаСотрудников[0].Переработки - ТаблицаСотрудников[0].Переработки1_5);
	КонецЕсли;
...
Процедура ДниНакопленныхОтгуловПриИзменении(Элемент)
	...
	УстановитьВидимостьБухучетКомпенсацияОтгулов(ЭтотОбъект);
...
Функция СписокВыбораНаставников() Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.Наставничество") Тогда
		МодульНаставничество = ОбщегоНазначения.ОбщийМодуль("Наставничество");
		Возврат МодульНаставничество.СписокВыбораНаставников(ЭтотОбъект);
	КонецЕсли;
...
Процедура ЗаполнитьТаблицуНаставничестваНаСервере() Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.Наставничество") Тогда
		МодульНаставничество = ОбщегоНазначения.ОбщийМодуль("Наставничество");
		МодульНаставничество.ЗаполнитьТаблицуНаставничестваНаСервере(ЭтотОбъект, Объект.Организация, Объект.ДатаУвольнения,, Ложь);
	КонецЕсли;
...
Функция АдресВХранилищеНачисленийИУдержаний(Наставник, ВремяРегистрации) Экспорт
	...
	МассивНачислений = Объект.Начисления.Выгрузить().НайтиСтроки(Новый Структура("Сотрудник", Наставник));
	...
	Возврат ПоместитьВоВременноеХранилище(ПараметрыОткрытия, ЭтотОбъект.УникальныйИдентификатор);
...
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьСтраницуНастроекБухучета(Форма, ИмяНастройки, ВариантУказанияБухучета)

	Если ВариантУказанияБухучета = 0 Тогда
		Форма.Элементы[СтрШаблон("%1%2",ИмяНастройки,"СтраницыБухучет")].ТекущаяСтраница = Форма.Элементы[СтрШаблон("%1%2",ИмяНастройки,"СтраницаБухучет")];
	Иначе
		Форма.Элементы[СтрШаблон("%1%2",ИмяНастройки,"СтраницыБухучет")].ТекущаяСтраница = Форма.Элементы[СтрШаблон("%1%2",ИмяНастройки,"СтраницаБухучетРаспределение")];
	КонецЕсли;

КонецПроцедуры

&НаКлиенте
Процедура ОткрытьФормуРедактированияРаспределенияБухучетаДокумента(ТекущиеНастройкиБухучета, ИмяТаблицы)
	
	ПараметрыЗавершения = Новый Структура("ИмяТаблицы", ИмяТаблицы);
	ОповещениеОЗакрытии = Новый ОписаниеОповещения("ИзменитьБухучетРаспределениеЗавершение", ЭтотОбъект, ПараметрыЗавершения);
	ПараметрыОткрытия = Новый Структура("НастройкиБухучета,Организация,ЕстьПодразделение", ТекущиеНастройкиБухучета, Объект.Организация, Истина);
...
&НаСервере
Процедура НастройкиБухучетаДанныеВРеквизиты()
	
	Если Не РегистрацияНачисленийДоступна Тогда
		Возврат;
	КонецЕсли;
	
	ИменаСвойств = "СтатьяФинансирования,СтатьяРасходов,СпособОтраженияЗарплатыВБухучете,ДоляРаспределения,ПодразделениеУчетаЗатрат,КодСтатьиФинансирования";
	
	НастройкиБухучета = Объект.НастройкиБухучета.Выгрузить();
	ОтражениеЗарплатыВБухучетеРасширенный.ДополнитьТаблицуРаспределенияКодомСтатьиФинансирования(НастройкиБухучета);
	
	ОписаниеНастроекБухучета = Новый Структура("ВыходноеПособие,МесячноеДС,КомпенсацияОтпуска,КомпенсацияПриУвольнении,КомпенсацияОтгулов");
	Для каждого КлючИЗначение Из ОписаниеНастроекБухучета Цикл
		ИмяНастройки = КлючИЗначение.Ключ;
		ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"СтатьяФинансирования")] = "";
		ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"СтатьяРасходов")] = "";
		ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"СпособОтраженияЗарплатыВБухучете")] = "";
		ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"ПодразделениеУчетаЗатрат")] = "";
		ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"НастройкиБухучета")] = Новый ФиксированныйМассив(Новый Массив);
		ОписаниеНастроекБухучета.Вставить(ИмяНастройки, Новый Массив);
	КонецЦикла;
	
	ВРКомпенсацииОтпуска = Новый Массив;
	Если Объект.ПризнакКомпенсацииУдержанияОтпуска = Перечисления.КомпенсацияУдержаниеОтпускаПриУвольнении.КомпенсироватьНеИспользованные
		И ЗначениеЗаполнено(Объект.ВидРасчетаКомпенсацииУдержанияОтпуска) Тогда
		ВРКомпенсацииОтпуска.Добавить(Объект.ВидРасчетаКомпенсацииУдержанияОтпуска);
	КонецЕсли;
	Для каждого СтрокаТЧ Из Объект.ДополнительныеОтпуска Цикл
		Если СтрокаТЧ.ПризнакКомпенсацииУдержания = Перечисления.КомпенсацияУдержаниеОтпускаПриУвольнении.КомпенсироватьНеИспользованные
			И ЗначениеЗаполнено(СтрокаТЧ.ВидРасчетаКомпенсацииУдержания) Тогда
			ВРКомпенсацииОтпуска.Добавить(СтрокаТЧ.ВидРасчетаКомпенсацииУдержания);
		КонецЕсли;
	КонецЦикла;
	
	ВРКомпенсацииОтгулов = Новый Массив;
	Если ЗначениеЗаполнено(Объект.ВидРасчетаКомпенсацияНеИспользованныхДнейОтдыха) Тогда
		ВРКомпенсацииОтгулов.Добавить(Объект.ВидРасчетаКомпенсацияНеИспользованныхДнейОтдыха);
	КонецЕсли;
	Если ЗначениеЗаполнено(Объект.ВидРасчетаКомпенсацияНеИспользованныхЧасовОтдыха) Тогда
		ВРКомпенсацииОтгулов.Добавить(Объект.ВидРасчетаКомпенсацияНеИспользованныхЧасовОтдыха);
	КонецЕсли;
	
	Отбор = Новый Структура("Начисление");
	Для каждого Начисление Из ВРКомпенсацииОтпуска Цикл
		Отбор.Начисление = Начисление;
		НайденныеСтроки = НастройкиБухучета.НайтиСтроки(Отбор);
		Если НайденныеСтроки.Количество() > 0 Тогда
			Для каждого СтрокаТЧ Из НайденныеСтроки Цикл
				СтрокаНастроек = Новый Структура(ИменаСвойств);
				ЗаполнитьЗначенияСвойств(СтрокаНастроек, СтрокаТЧ);
				ОписаниеНастроекБухучета.КомпенсацияОтпуска.Добавить(Новый ФиксированнаяСтруктура(СтрокаНастроек));
			КонецЦикла;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	
	Для каждого Начисление Из ВРКомпенсацииОтгулов Цикл
		Отбор.Начисление = Начисление;
		НайденныеСтроки = НастройкиБухучета.НайтиСтроки(Отбор);
		Если НайденныеСтроки.Количество() > 0 Тогда
			Для каждого СтрокаТЧ Из НайденныеСтроки Цикл
				СтрокаНастроек = Новый Структура(ИменаСвойств);
				ЗаполнитьЗначенияСвойств(СтрокаНастроек, СтрокаТЧ);
				ОписаниеНастроекБухучета.КомпенсацияОтгулов.Добавить(Новый ФиксированнаяСтруктура(СтрокаНастроек));
			КонецЦикла;
			Прервать;
		КонецЕсли;
	КонецЦикла;
	...
	Для каждого СтрокаТЧ Из НастройкиБухучета Цикл
		СтрокаНастроек = Новый Структура(ИменаСвойств);
		ЗаполнитьЗначенияСвойств(СтрокаНастроек, СтрокаТЧ);
		Если СтрокаТЧ.Начисление = Объект.ВыходноеПособие Тогда
			ОписаниеНастроекБухучета.ВыходноеПособие.Добавить(Новый ФиксированнаяСтруктура(СтрокаНастроек));
		ИначеЕсли СтрокаТЧ.Начисление = Объект.ВидРасчетаМесячноеДенежноеСодержание Тогда
			ОписаниеНастроекБухучета.МесячноеДС.Добавить(Новый ФиксированнаяСтруктура(СтрокаНастроек));
		ИначеЕсли СтрокаТЧ.Начисление = Объект.КомпенсацияЗаНеотработанныеДниЧасыПриУвольнении Тогда
			ОписаниеНастроекБухучета.КомпенсацияПриУвольнении.Добавить(Новый ФиксированнаяСтруктура(СтрокаНастроек));
		КонецЕсли;
	КонецЦикла;
	...
	Для каждого КлючИЗначение Из ОписаниеНастроекБухучета Цикл
		...
		ИмяНастройки = КлючИЗначение.Ключ;
		НастройкиБухучета = ОписаниеНастроекБухучета[ИмяНастройки];
		ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"ВариантУказанияБухучета")] = ?(НастройкиБухучета.Количество() > 1, 1, 0);
		
		Если НастройкиБухучета.Количество() = 1 Тогда
			ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"СтатьяФинансирования")] 				= НастройкиБухучета[0].СтатьяФинансирования;
			ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"СтатьяРасходов")] 					= НастройкиБухучета[0].СтатьяРасходов;
			ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"СпособОтраженияЗарплатыВБухучете")] 	= НастройкиБухучета[0].СпособОтраженияЗарплатыВБухучете;
			ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"ПодразделениеУчетаЗатрат")] 			= НастройкиБухучета[0].ПодразделениеУчетаЗатрат;
		Иначе
			ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"НастройкиБухучета")] = Новый ФиксированныйМассив(НастройкиБухучета);
		КонецЕсли;
		
		Элементы[СтрШаблон("%1%2",ИмяНастройки,"НастройкиБухучетаПредставление")].Заголовок = 
			ОтражениеЗарплатыВБухучетеРасширенный.ПредставлениеРаспределенияБухучетаДокумента(ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"НастройкиБухучета")], Истина);
...
&НаСервере
Процедура НастройкиБухучетаРеквизитыВДанные(ТекущийОбъект)
	
	Если Не РегистрацияНачисленийДоступна Тогда
		Возврат;
	КонецЕсли;
	
	ТекущийОбъект.НастройкиБухучета.Очистить();
	
	ОписаниеНастроекБухучета = Новый Структура("ВыходноеПособие,МесячноеДС,КомпенсацияОтпуска,КомпенсацияПриУвольнении,КомпенсацияОтгулов");
	ОписаниеНастроекБухучета.ВыходноеПособие = Объект.ВыходноеПособие;
	
	Если Объект.РасчетДенежногоСодержания Тогда
		ОписаниеНастроекБухучета.МесячноеДС = Объект.ВидРасчетаМесячноеДенежноеСодержание;
	КонецЕсли;
	
	Если Объект.ВыплачиватьКомпенсациюНеотработанныхДнейЧасовПриУвольнении Тогда
		ОписаниеНастроекБухучета.КомпенсацияПриУвольнении = Объект.КомпенсацияЗаНеотработанныеДниЧасыПриУвольнении;
	КонецЕсли;
	
	ВидыРасчетов = Новый Массив;
	Если Объект.ДниНакопленныхОтгулов > 0 Тогда
		ВидыРасчетов.Добавить(Объект.ВидРасчетаКомпенсацияНеИспользованныхДнейОтдыха);
	КонецЕсли;
	Если Объект.ЧасыНакопленныхОтгулов > 0 Тогда
		ВидыРасчетов.Добавить(Объект.ВидРасчетаКомпенсацияНеИспользованныхЧасовОтдыха);
	КонецЕсли;
	ОписаниеНастроекБухучета.КомпенсацияОтгулов = ВидыРасчетов;
	
	ВидыРасчетов = Новый Массив;
	Если Объект.ПризнакКомпенсацииУдержанияОтпуска = Перечисления.КомпенсацияУдержаниеОтпускаПриУвольнении.КомпенсироватьНеИспользованные Тогда
		ВидыРасчетов.Добавить(Объект.ВидРасчетаКомпенсацииУдержанияОтпуска);
	КонецЕсли;
	Для каждого СтрокаТЧ Из Объект.ДополнительныеОтпуска Цикл
		Если СтрокаТЧ.ПризнакКомпенсацииУдержания = Перечисления.КомпенсацияУдержаниеОтпускаПриУвольнении.КомпенсироватьНеИспользованные Тогда
			ВидыРасчетов.Добавить(СтрокаТЧ.ВидРасчетаКомпенсацииУдержания);
		КонецЕсли;
	КонецЦикла;
	ОписаниеНастроекБухучета.КомпенсацияОтпуска = ВидыРасчетов;
	
	Для каждого КлючИЗначение Из ОписаниеНастроекБухучета Цикл
		
		ИмяНастройки = КлючИЗначение.Ключ;
		Если ТипЗнч(КлючИЗначение.Значение) <> Тип("Массив") Тогда
			ВидыРасчетов = ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(КлючИЗначение.Значение);
		Иначе
			ВидыРасчетов = КлючИЗначение.Значение;
		КонецЕсли;
		
		Для каждого ВидРасчета Из ВидыРасчетов Цикл
			Если ЗначениеЗаполнено(ВидРасчета) Тогда
				Если ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"ВариантУказанияБухучета")] = 0 Тогда
					Если ЗначениеЗаполнено(ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"СтатьяФинансирования")])
						Или ЗначениеЗаполнено(ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"СтатьяРасходов")])
						Или ЗначениеЗаполнено(ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"СпособОтраженияЗарплатыВБухучете")])
						Или ЗначениеЗаполнено(ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"ПодразделениеУчетаЗатрат")]) Тогда
						НоваяСтрока = ТекущийОбъект.НастройкиБухучета.Добавить();
						НоваяСтрока.Начисление 							= ВидРасчета;
						НоваяСтрока.ДоляРаспределения 					= 0;
						НоваяСтрока.СтатьяФинансирования 				= ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"СтатьяФинансирования")];
						НоваяСтрока.СтатьяРасходов 						= ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"СтатьяРасходов")];
						НоваяСтрока.СпособОтраженияЗарплатыВБухучете 	= ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"СпособОтраженияЗарплатыВБухучете")];
						НоваяСтрока.ПодразделениеУчетаЗатрат 			= ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"ПодразделениеУчетаЗатрат")];
					КонецЕсли;
				Иначе
					Для каждого СтрокаРаспределения Из ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"НастройкиБухучета")] Цикл
						НоваяСтрока = ТекущийОбъект.НастройкиБухучета.Добавить();
...
&НаКлиенте
Процедура ИзменитьБухучетРаспределениеЗавершение(Результат, ПараметрыЗавершения) Экспорт

	Если Результат = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	ИзменитьБухучетРаспределениеЗавершениеНаСервере(Результат, ПараметрыЗавершения);
	
КонецПроцедуры

&НаСервере
Процедура ИзменитьБухучетРаспределениеЗавершениеНаСервере(Результат, ПараметрыЗавершения)
	
	ПрежнееРаспределение = ЭтотОбъект[ПараметрыЗавершения.ИмяТаблицы];
	НастройкаИзменилась = Не ОбщегоНазначения.КоллекцииИдентичны(ПрежнееРаспределение, Результат.НастройкиБухучета);
	Если НастройкаИзменилась Тогда
		Модифицированность = Истина;
	КонецЕсли;
	ЭтотОбъект[ПараметрыЗавершения.ИмяТаблицы] = ОбщегоНазначения.СкопироватьРекурсивно(Результат.НастройкиБухучета);
	
	ИмяЭлемента = СтрШаблон("%1%2", ПараметрыЗавершения.ИмяТаблицы, "Представление");
	Элементы[ИмяЭлемента].Заголовок = ОтражениеЗарплатыВБухучетеРасширенный.ПредставлениеРаспределенияБухучетаДокумента(ЭтотОбъект[ПараметрыЗавершения.ИмяТаблицы], Истина);
...
&НаСервере
Процедура УстановитьДоступностьВидимостьНастроекБухучета()
	...
	РегистрироватьБухучетДокументовКакРаспределение = ПолучитьФункциональнуюОпцию("РегистрироватьБухучетДокументовКакРаспределение");
	ОписаниеНастроекБухучета = Новый Структура("ВыходноеПособие,МесячноеДС,КомпенсацияОтпуска,КомпенсацияПриУвольнении,КомпенсацияОтгулов");
	Для каждого КлючИЗначение Из ОписаниеНастроекБухучета Цикл
		
		ИмяНастройки = КлючИЗначение.Ключ;
		
		УстановитьСтраницуНастроекБухучета(ЭтотОбъект, ИмяНастройки, ЭтотОбъект[СтрШаблон("%1%2",ИмяНастройки,"ВариантУказанияБухучета")]);
		
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы,
			СтрШаблон("%1%2",ИмяНастройки,"СтатьяРасходов"),
			"Видимость",
			РаботаВБюджетномУчреждении);
			
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы,
			СтрШаблон("%1%2",ИмяНастройки,"ВариантУказанияБухучета"),
			"Видимость",
			РегистрироватьБухучетДокументовКакРаспределение);
			
		ОтражениеЗарплатыВБухучетеРасширенный.УстановитьСписокВыборкаВариантУказанияБухучета(Элементы[СтрШаблон("%1%2",ИмяНастройки,"ВариантУказанияБухучета")].СписокВыбора);
...
&НаСервере
Процедура УстановитьВидимостьНастроекБухучета()
...
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьВидимостьБухучетКомпенсацияПриУвольнении(Форма)
	
	КомпенсацияДоступна = Форма.Объект.ВыплачиватьКомпенсациюНеотработанныхДнейЧасовПриУвольнении;
	
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Форма.Элементы,
		"ГруппаКомпенсацияПриУвольнении",
		"Видимость",
		КомпенсацияДоступна);
...
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьВидимостьБухучетКомпенсацияОтгулов(Форма)
	
	КомпенсацияДоступна = Форма.Объект.ДниНакопленныхОтгулов > 0
		Или Форма.Объект.ЧасыНакопленныхОтгулов > 0;
	
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Форма.Элементы,
		"ГруппаКомпенсацияОтгулов",
		"Видимость",
		КомпенсацияДоступна);
...
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьВидимостьБухучетМесячноеДенежноеСодержание(Форма)
	
	МесячноеДСДоступно = Форма.Объект.РасчетДенежногоСодержания И Форма.Объект.КоличествоМесяцевВыплатыДенежногоСодержания > 0;
...
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьВидимостьБухучетКомпенсацияОтпуска(Форма)
	
	КомпенсацияДоступна = Ложь;
	ПризнакКомпенсации = ПредопределенноеЗначение("Перечисление.КомпенсацияУдержаниеОтпускаПриУвольнении.КомпенсироватьНеИспользованные");
	Если Форма.Объект.ПризнакКомпенсацииУдержанияОтпуска = ПризнакКомпенсации Тогда
		КомпенсацияДоступна = Истина;
	КонецЕсли;
	Если Не КомпенсацияДоступна Тогда
		Для каждого СтрокаТЧ Из Форма.Объект.ДополнительныеОтпуска Цикл
			Если СтрокаТЧ.ПризнакКомпенсацииУдержания = ПризнакКомпенсации Тогда
				КомпенсацияДоступна = Истина;
				Прервать;
			КонецЕсли;
		КонецЦикла;
...
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьВидимостьБухучетВыходногоПособия(Форма)
	
	ВыходноеПособиеДоступно = (Форма.Объект.СреднемесячноеКоличествоДнейЧасов > 0 И Форма.Объект.КратностьВыходногоПособия > 0)
		Или Форма.Объект.ДнейЧасовВыходногоПособия > 0 ;
	
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Форма.Элементы,
		"ГруппаВыходноеПособиеБухучет",
		"Видимость",
		ВыходноеПособиеДоступно);
