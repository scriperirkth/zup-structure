	...
	Для каждого БазовыеДанныеДокумента Из БазовыеДанныеДокументов Цикл
		...
		Если Выборка.НайтиСледующий(Отбор) Тогда
			...
			Пока ВыборкаВидыОтпусков.НайтиСледующий(Отбор) Цикл
				...
				Если ОснованиеОтпуска.Найти(ВыборкаВидыОтпусков.Основание) = Неопределено Тогда 
					ОснованиеОтпуска.Добавить(ВыборкаВидыОтпусков.Основание);
				КонецЕсли;
			КонецЦикла;
			ДанныеДокумента.РеквизитыДокумента.НаименованиеСобытия = НаименованиеСобытия;
			ДанныеДокумента.РеквизитыДокумента.Основание = СтрСоединить(ОснованиеОтпуска, ", ");
		КонецЕсли;
