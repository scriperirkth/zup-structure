...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустая() Тогда
		...
		Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.ОбучениеПоОхранеТруда") Тогда
			МодульОбучениеПоОхранеТрудаФормы = ОбщегоНазначения.ОбщийМодуль("ОбучениеПоОхранеТрудаФормы");
			МодульОбучениеПоОхранеТрудаФормы.ДокументОтстраненияПриСозданииНаСервере(ЭтотОбъект);
		КонецЕсли;
...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.ОбучениеПоОхранеТруда") Тогда
		МодульОбучениеПоОхранеТрудаФормы = ОбщегоНазначения.ОбщийМодуль("ОбучениеПоОхранеТрудаФормы");
		МодульОбучениеПоОхранеТрудаФормы.ДокументОтстраненияПриЧтенииНаСервере(ЭтотОбъект);
	КонецЕсли;
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыПриложения.МатериальноОтветственныеЛица") Тогда
		Если ПараметрыЗаписи.РежимЗаписи = РежимЗаписиДокумента.Проведение
			...
			Сотрудники = ОбщегоНазначенияБЗККлиентСервер.ВыгрузитьКолонку(Объект.Сотрудники, "Сотрудник", Истина);
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.ОбучениеПоОхранеТруда") Тогда
		МодульОбучениеПоОхранеТрудаФормы = ОбщегоНазначения.ОбщийМодуль("ОбучениеПоОхранеТрудаФормы");
		МодульОбучениеПоОхранеТрудаФормы.ДокументОтстраненияПередЗаписьюНаСервере(ЭтотОбъект, ТекущийОбъект);
	КонецЕсли;
...
&НаСервере
Процедура Подключаемый_ДобавитьСотрудников(Сотрудники) Экспорт
	СотрудникиОбработкаВыбораНаСервере(Сотрудники);
КонецПроцедуры
