...
Процедура ЗаполнитьСвязанныеДокументы()
	...
	|ПОМЕСТИТЬ ВТПроведенныеПереносыОтбор
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ПроведенныеПереносыОтбор.НомерСтроки КАК НомерСтроки,
	|	МАКСИМУМ(ПереносОтпуска.Ссылка) КАК Перенос
	|ПОМЕСТИТЬ ВТПроведенныеПереносы
	|ИЗ
	|	ВТПроведенныеПереносыОтбор КАК ПроведенныеПереносыОтбор
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПереносОтпуска КАК ПереносОтпуска
	|		ПО ПроведенныеПереносыОтбор.Сотрудник = ПереносОтпуска.Сотрудник
	|			И ПроведенныеПереносыОтбор.ВидОтпуска = ПереносОтпуска.ВидОтпуска
	|			И ПроведенныеПереносыОтбор.ДатаНачала = ПереносОтпуска.ИсходнаяДатаНачала
	|			И ПроведенныеПереносыОтбор.Дата = ПереносОтпуска.Дата
	|			И (ПереносОтпуска.Проведен)
	|
	|СГРУППИРОВАТЬ ПО
	|	ПроведенныеПереносыОтбор.НомерСтроки
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|	ДанныеДокумента.ДатаНачала КАК ДатаНачала,
	|	МАКСИМУМ(ПереносОтпуска.Дата) КАК Дата
	|ПОМЕСТИТЬ ВТНепроведенныеПереносыОтбор
	|ИЗ
	|	ВТДанныеДокумента КАК ДанныеДокумента
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПереносОтпуска КАК ПереносОтпуска
	|		ПО ДанныеДокумента.Сотрудник = ПереносОтпуска.Сотрудник
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	НепроведенныеПереносыОтбор.НомерСтроки КАК НомерСтроки,
	|	МАКСИМУМ(ПереносОтпуска.Ссылка) КАК Перенос
	|ПОМЕСТИТЬ ВТНепроведенныеПереносы
	|ИЗ
	|	ВТНепроведенныеПереносыОтбор КАК НепроведенныеПереносыОтбор
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПереносОтпуска КАК ПереносОтпуска
	|		ПО НепроведенныеПереносыОтбор.Сотрудник = ПереносОтпуска.Сотрудник
	|			И НепроведенныеПереносыОтбор.ВидОтпуска = ПереносОтпуска.ВидОтпуска
	|			И НепроведенныеПереносыОтбор.ДатаНачала = ПереносОтпуска.ИсходнаяДатаНачала
	|			И НепроведенныеПереносыОтбор.Дата = ПереносОтпуска.Дата
	|			И (НЕ ПереносОтпуска.Проведен)
	|			И (НЕ ПереносОтпуска.ПометкаУдаления)
	|
	|СГРУППИРОВАТЬ ПО
	|	НепроведенныеПереносыОтбор.НомерСтроки
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
