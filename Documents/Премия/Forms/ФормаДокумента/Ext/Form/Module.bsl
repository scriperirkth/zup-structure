...
Функция КлючевыеРеквизитыЗаполненияФормыОписаниеКлючевыхРеквизитов() Экспорт
	...
	Массив.Добавить(Новый Структура("ЭлементФормы, Представление, ПредупреждениеПриРедактировании", "ВидПремии", НСтр("ru = 'месяца начисления'"), НСтр("ru = 'Редактирование вида премии приведет к перезаполнению табличных частей документа'")));
...
Функция ОписаниеДокумента(Форма)
	...
	Описание.ФиксБазовыйПериодИмя = "ФиксБазовыйПериод";
...
Процедура ЗаполнитьБазовыйПериод()
	Документы.Премия.ЗаполнитьБазовыйПериод(Объект);
КонецПроцедуры
