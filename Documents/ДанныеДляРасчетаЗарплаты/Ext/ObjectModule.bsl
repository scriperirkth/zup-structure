...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Документы.ДанныеДляРасчетаЗарплаты.ЗаполнитьДатуЗапретаРедактирования(ЭтотОбъект);
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	РеквизитыДляПроведения = Документы.ДанныеДляРасчетаЗарплаты.РеквизитыДляПроведения(ЭтотОбъект);
