...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустая() Тогда
		...
		ЗаполнитьДокументПоОрганизацииИПодразделению(Ложь);
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	УправлениеШтатнымРасписаниемФормы.ПоместитьДанныеОбъектаВДанныеФормы(ЭтотОбъект, Объект.МесяцВступленияВСилу, ТекущийОбъект);
	ЗаполнитьИтоговыйФОТПоПозициям();
...
Процедура ПриПолученииДанныхНаСервере()
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ОрганизационнаяСтруктура") Тогда
		...
		МодульОрганизационнаяСтруктура.ДополнитьФормуДокументовИзмененияШтатногоРасписания(ЭтотОбъект, "Объект.МесяцВступленияВСилу");
	КонецЕсли;
...
&НаСервере
Процедура ЗаполнитьДокументПоОрганизацииИПодразделению(ПрочитатьТекущиеДанные = Истина) Экспорт
	
	ЗарплатаКадрыКлиентСервер.ЗаполнитьМесяцПоДате(ЭтотОбъект, "Объект.МесяцВступленияВСилу", "МесяцВступленияВСилуСтрока");
	
	УправлениеШтатнымРасписаниемФормы.ОчиститьДанныеТабличныхЧастейОбъектаФормы(ЭтотОбъект);
	
	ЗаполнитьДокументНаСервере(ПрочитатьТекущиеДанные);
	ЗаполнитьДанныеФормыПоОрганизации();
...
&НаСервере
Процедура ЗаполнитьДокументНаСервере(ПрочитатьТекущиеДанные = Истина)
	...
	УправлениеШтатнымРасписаниемФормы.ЗаполнитьНовыйДокумент(ЭтотОбъект, Объект.МесяцВступленияВСилу, ПрочитатьТекущиеДанные);
