...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Если Данные.ВариантИсправления = Перечисления.ВариантыИсправленияЗаявокКабинетСотрудника.Отмена Тогда
		Шаблон = НСтр("ru = 'Отзыв отчета по командировке %1 от %2'");
	Иначе
		Шаблон = НСтр("ru = 'Отчет по командировке %1 от %2'");
	КонецЕсли;
...
Функция ОписаниеДокументаДляЗаявки(СписокОбщихПолей) Экспорт
	...
	СтрокаСвойств = "ИдентификаторЗаявкиНаКомандировку, ТекстОтчета";
...
Функция НаименованиеЗадачи(ДокументОбъект) Экспорт
	...
	Если ДокументОбъект.ВариантИсправления = Перечисления.ВариантыИсправленияЗаявокКабинетСотрудника.Отмена Тогда
		ШаблонНаименования = НСтр("ru = 'Отзыв отчета по командировке'");
	Иначе
		ШаблонНаименования = НСтр("ru = 'Отчет по командировке'");
	КонецЕсли;
...
Функция СодержаниеЗадачи(ДокументОбъект) Экспорт
	...
	Если ДокументОбъект.ВариантИсправления = Перечисления.ВариантыИсправленияЗаявокКабинетСотрудника.Отмена Тогда
		ШаблонНаименования = НСтр("ru = 'Обработать отзыв отчета по командировке'");
	Иначе
		ШаблонНаименования = НСтр("ru = 'Принять отчет по командировке'");
	КонецЕсли;
...
Функция РольИсполнителяЗаявки() Экспорт
	...
	Возврат Справочники.РолиИсполнителей.ОтветственныйЗаОтчетыПоКомандировкам;
