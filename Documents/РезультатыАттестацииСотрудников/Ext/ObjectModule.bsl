...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.КадровыйРезерв") Тогда 
		...
		МодульКадровыйРезерв.СформироватьДвиженияИсторииКадровогоРезерва(Движения, ДанныеДляПроведения.ДвиженияДокумента,
			"ДвиженияИсторииКадровогоРезерва");
		МодульКадровыйРезерв.СформироватьДвиженияСтатусыГотовностиРезервистов(Движения, ДанныеДляПроведения.ДвиженияДокумента,
...
Процедура СоздатьВТРезультатыАттестацийСотрудников(Запрос, ДанныеДляПроведения)
	...
	|	ТЧРезультатыАттестации.СтатусГотовности КАК СтатусГотовности,
	|	ТЧРезультатыАттестации.ДатаАттестации КАК Период,
...
Процедура ДобавитьДанныеДляПроведенияПоКадровомуРезерву(ДанныеДляПроведения)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.КадровыйРезерв") Тогда 
		МодульКадровыйРезерв = ОбщегоНазначения.ОбщийМодуль("КадровыйРезерв");
		МодульКадровыйРезерв.ДобавитьДанныеКадровогоРезерваДляРезультатовАттестацииСотрудников(ДанныеДляПроведения);
	КонецЕсли;
