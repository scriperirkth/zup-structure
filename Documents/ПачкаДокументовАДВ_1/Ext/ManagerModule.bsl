...
Функция СформироватьЗапросПоСотрудникам(Ссылка)
	...
	Запрос.УстановитьПараметр("ДатаПостановленияАДВ2025", ПерсонифицированныйУчетКлиентСервер.ДатаПостановленияАДВ2025());
...
Функция СформироватьВыходнойФайл(ВыборкаПоШапкеДокумента, ВыборкаСотрудники)
	...
	Если ВыборкаПоШапкеДокумента.Дата >= ПерсонифицированныйУчетКлиентСервер.ДатаПостановленияАДВ2025() Тогда 
...
Функция СформироватьПечатнуюФормуАДВ1(МассивОбъектов, ОбъектыПечати)
	...
	ДатаПостановленияАДВ2025 = ПерсонифицированныйУчетКлиентСервер.ДатаПостановленияАДВ2025();
