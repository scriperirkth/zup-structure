...
Процедура УстановитьСвойстваЭлементовФормы()
	...
	Если ОтображатьСписокСотрудников Тогда 
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "КодЗАГС", "ТолькоПросмотр", ВидДокумента <> Справочники.ВидыДокументовФизическихЛиц.СвидетельствоОРождении);
