...
Функция ДанныеДляПроведения(РеквизитыДляПроведения, СтруктураВидовУчета)
	...
	ЗаполнитьНачисленияИВзносы(РеквизитыДляПроведения, ИсправленныеСтроки, ДанныеДляПроведения, Сотрудники, ПоляВзносов, СтруктураВидовУчета);
...
Процедура ЗаполнитьНачисленияИВзносы(РеквизитыДляПроведения, ИсправленныеСтроки, ДанныеДляПроведения, Сотрудники, ПоляВзносов, СтруктураВидовУчета)
	...
	Для каждого ИдентификаторСтроки Из ИсправленныеСтроки Цикл
		...
		Если СтруктураВидовУчета.ОстальныеВидыУчета И ДоляНачислений <> 0 Тогда
		...
		Если СтруктураВидовУчета.СтраховыеВзносы И ДоляВзносов <> 0 Тогда
...
Функция НДФЛПоСотрудникам(РеквизитыДляПроведения, Сотрудники, НачисленияСотрудников)
	...
	ИсходныеДанные.ПерваяПоловинаМесяца 		= Ложь;
