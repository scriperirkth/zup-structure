...
Функция ДанныеДляПроведения()
	...
	УсловияДоговора.Вставить("ПорядокВыделенияРайонногоКоэффициентаСевернойНадбавки", ПорядокВыделенияРайонногоКоэффициентаСевернойНадбавки);
	УсловияДоговора.Вставить("РайонныйКоэффициент", РайонныйКоэффициент);
	УсловияДоговора.Вставить("РайонныйКоэффициентРазмер", РайонныйКоэффициентРазмер);
	УсловияДоговора.Вставить("СевернаяНадбавкаРазмер", СевернаяНадбавкаРазмер);
