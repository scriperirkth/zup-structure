...
Процедура ЗаполнитьНастройкиМенеджераРасчета(ФизическиеЛица, МенеджерРасчета, ПараметрыРасчета) Экспорт
	...
	ДанныеДляБухучетаЗарплаты = Документы.ДоходВНатуральнойФорме.ДанныеДляБухучетаЗарплатыПервичныхДокументов(ЭтотОбъект);
	МенеджерРасчета.НастройкиБухучета.НастройкиБухучетаДокумента = ДанныеДляБухучетаЗарплаты["ТаблицаБухучетЗарплаты"];
	МенеджерРасчета.НастройкиБухучета.НастройкиБухучетаНДФЛДокумента = ДанныеДляБухучетаЗарплаты["НастройкиБухучетаНДФЛ"];
