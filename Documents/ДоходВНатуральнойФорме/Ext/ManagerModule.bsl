...
Функция ДанныеДляБухучетаЗарплатыПервичныхДокументов(Объект) Экспорт
	...
	ДанныеДляБухучета.Вставить("НастройкиБухучетаНДФЛ", НастройкиБухучетаНДФЛ(Объект));
...
Функция НастройкиБухучетаНДФЛ(Объект)

	Настройки = Новый Структура("СтатьяФинансирования,СтатьяРасходов");
	
	СтатьяОплатаТруда = ОтражениеЗарплатыВБухучетеРасширенный.СтатьяОплатаТруда();
	Настройки.СтатьяРасходов = ?(ЗначениеЗаполнено(Объект.СтатьяРасходовНДФЛ), Объект.СтатьяРасходовНДФЛ, СтатьяОплатаТруда);
	Настройки.СтатьяФинансирования = Объект.СтатьяФинансированияНДФЛ;
