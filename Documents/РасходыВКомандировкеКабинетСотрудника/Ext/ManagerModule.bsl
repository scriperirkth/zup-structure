...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Если Данные.ВариантИсправления = Перечисления.ВариантыИсправленияЗаявокКабинетСотрудника.Отмена Тогда
		Шаблон = НСтр("ru = 'Отзыв отчета о расходах в командировке %1 от %2'");
	Иначе
		Шаблон = НСтр("ru = 'Отчет о расходах в командировке %1 от %2'");
	КонецЕсли;
...
Функция ОписаниеДокументаДляЗаявки(СписокОбщихПолей) Экспорт
	...
	СтрокаСвойств = "ИдентификаторЗаявкиНаКомандировку,Расходы,ЕстьРасходыВВалюте";
...
Функция НаименованиеЗадачи(ДокументОбъект) Экспорт
	...
	Если ДокументОбъект.ВариантИсправления = Перечисления.ВариантыИсправленияЗаявокКабинетСотрудника.Отмена Тогда
		ШаблонНаименования = НСтр("ru = 'Отзыв отчета о расходах в командировке'");
	Иначе
		ШаблонНаименования = НСтр("ru = 'Отчет о расходах в командировке'");
	КонецЕсли;
...
Функция СодержаниеЗадачи(ДокументОбъект) Экспорт
	...
	Если ДокументОбъект.ВариантИсправления = Перечисления.ВариантыИсправленияЗаявокКабинетСотрудника.Отмена Тогда
		ШаблонНаименования = НСтр("ru = 'Обработать отзыв отчета о расходах в командировке'");
	Иначе
		ШаблонНаименования = НСтр("ru = 'Принять отчет о расходах в командировке'");
	КонецЕсли;
...
Функция РольИсполнителяЗаявки() Экспорт
	...
	Возврат Справочники.РолиИсполнителей.ОтветственныйЗаОтчетыПоРасходамВКомандировках;
...
Функция ОписаниеТаблицыРасходы()
	...
	Таблица.Колонки.Добавить("ИдентификаторСтроки", Новый ОписаниеТипов("Строка"));
	...
	Таблица.Колонки.Добавить("ДатаРасхода", 		Новый ОписаниеТипов("Дата"));
