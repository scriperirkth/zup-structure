...
Процедура НовыйДокумент(Команда)
	...
	ЗаявкиСотрудниковФормыКлиент.СоздатьНовыйДокументОтпускБезОплаты(ЭтаФорма);
...
Функция ЗначенияДляВыбораВидаДокумента()
	...
	Возврат ЗаявкиСотрудниковФормы.ЗначенияДляВыбораВидаДокумента(Метаданные.ОпределяемыеТипы.ДокументОтпускБезСохраненияОплатыКабинетСотрудника);
