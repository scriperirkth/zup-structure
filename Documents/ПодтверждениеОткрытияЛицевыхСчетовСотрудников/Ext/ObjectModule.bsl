...
Функция ЛицевыеСчетаФизическихЛицДляРегистрации()
	...
	|	ПодтверждениеОткрытияЛицевыхСчетовСотрудников.Организация КАК Организация,
	|	ЗарплатныеПроекты.Ссылка КАК ЗарплатныйПроект,
	|	СотрудникиПодтверждениеОткрытияЛицевыхСчетовСотрудников.ФизическоеЛицо КАК ФизическоеЛицо,
	|	ВЫБОР
	|		КОГДА СотрудникиПодтверждениеОткрытияЛицевыхСчетовСотрудников.БИК = """"
	|			ТОГДА СотрудникиПодтверждениеОткрытияЛицевыхСчетовСотрудников.НомерЛицевогоСчета
	|		ИНАЧЕ """"
	...
	|	СотрудникиПодтверждениеОткрытияЛицевыхСчетовСотрудников.БИК КАК БИК
	|ИЗ
