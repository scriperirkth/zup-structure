...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		"Видимость",
		Не Параметры.БухучетУказываетсяРаспределением И ПолучитьФункциональнуюОпцию("ИспользоватьСтатьиФинансированияЗарплатаРасширенный"));
		
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
		"ГруппаСтатьяРасходов", 
		"Видимость",
		Не Параметры.БухучетУказываетсяРаспределением И ПолучитьФункциональнуюОпцию("РаботаВБюджетномУчреждении"));
		
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
		"ГруппаЕНВД", 
		"Видимость",
		Не Параметры.БухучетУказываетсяРаспределением И ОтражениеЗарплатыВБухучете.ИспользуетсяЕНВД(?(РазныеДатыДляСотрудников, ДатаПараметр, ДатаНачалаПараметр)));
		
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
		"ГруппаСпособОтражения",
		"Видимость",
		Не Параметры.БухучетУказываетсяРаспределением);
