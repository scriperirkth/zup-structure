...
Процедура ЗаполнитьДанныеОбИспользованииОтгулов(РеквизитыДляПроведения, ДанныеДляПроведения)
	...
	Запрос.Текст =
		"ВЫБРАТЬ
		|	ОтгулОтработанныеДни.Ссылка.ДатаНачала КАК Период,
		|	ЗНАЧЕНИЕ(ВидДвиженияНакопления.Расход) КАК ВидДвижения,
		|	ОтгулОтработанныеДни.Ссылка.Организация КАК Организация,
		|	ОтгулОтработанныеДни.Ссылка.Сотрудник КАК Сотрудник,
		|	ОтгулОтработанныеДни.Дата КАК ОтработанныйДень,
		|	ВЫБОР
		|		КОГДА ОтгулОтработанныеДни.Часы = 0
		|			ТОГДА 1
		|		ИНАЧЕ 0
		|	КОНЕЦ КАК Дни,
		|	ОтгулОтработанныеДни.Часы КАК Часы
		|ИЗ
		|	Документ.Отгул.ОтработанныеДни КАК ОтгулОтработанныеДни
		|ГДЕ
		|	ОтгулОтработанныеДни.Ссылка = &Ссылка";
