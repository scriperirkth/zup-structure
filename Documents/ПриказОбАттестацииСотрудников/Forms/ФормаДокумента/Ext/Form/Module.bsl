...
Процедура ЗаседанияКомиссииМестоПроведенияЗаседанияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ТекущиеДанные = Элементы.ЗаседанияКомиссии.ТекущиеДанные;
	...
	ОткрытьФорму("Справочник.ТерриторииИПомещения.ФормаВыбора",
		ПараметрыФормы,
		ЭтотОбъект,
...
&НаКлиенте
Процедура ЗаседанияКомиссииМестоПроведенияЗаседанияОткрытие(Элемент, СтандартнаяОбработка)
...
Процедура ЗаседанияКомиссииМестоПроведенияЗаседанияОкончаниеВвода(Знач ВведенныйТекст, Знач ДополнительныеПараметры) Экспорт
	...
	Если НЕ Строка = Неопределено Тогда
		СтрокаМеста = ВведенныйТекст;
		Если ТипЗнч(ВведенныйТекст) = Тип("СправочникСсылка.ТерриторииИПомещения") Тогда
			СтрокаМеста = ТерриторииИПомещенияВызовСервера.ПолучитьПолныйПутьКПомещению(ВведенныйТекст);
		КонецЕсли;
		
		Строка.МестоПроведенияЗаседания = СтрокаМеста;
