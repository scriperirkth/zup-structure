...
Функция ДанныеДляПроведения()
	...
	Запрос.Текст =
		...
		|				И ВЫБОР
		|					КОГДА ЗанятостьПозицийШтатногоРасписания.ПериодВозвратногоСобытия = ДАТАВРЕМЯ(1, 1, 1)
		|						ТОГДА ИСТИНА
		|					ИНАЧЕ ЗанятостьПозицийШтатногоРасписания.ПериодВозвратногоСобытия > ОтменаСовмещения.ДатаОтмены
		|				КОНЕЦ)";
