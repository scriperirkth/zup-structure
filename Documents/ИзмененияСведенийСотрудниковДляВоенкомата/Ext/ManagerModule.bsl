...
Функция СформироватьВыходнойФайл(Ссылка)
	...
	Пока ВыборкаПоРаботникам.Следующий() Цикл 
		...
		СодержаниеИзменений = СтрЗаменить(ВыборкаПоРаботникам.СодержаниеИзменений, Символы.ПС, " ");
		СодержаниеИзменений = СтрЗаменить(СодержаниеИзменений, ";", " ");
		ДанныеСтроки.Добавить(СодержаниеИзменений);
