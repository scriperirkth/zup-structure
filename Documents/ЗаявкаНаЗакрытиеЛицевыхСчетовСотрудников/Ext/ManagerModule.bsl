...
Функция ДанныеЗаполненияСотрудников(СтруктураПараметровДокумента) Экспорт
	
	Запрос = Новый Запрос;
	Запрос.МенеджерВременныхТаблиц = Новый МенеджерВременныхТаблиц;
	ОбменСБанкамиПоЗарплатнымПроектам.СоздатьВТЗакрытиеЛицевыхСчетов(
		Запрос.МенеджерВременныхТаблиц, СтруктураПараметровДокумента.Ссылка, СтруктураПараметровДокумента.Организация,
		СтруктураПараметровДокумента.ЗарплатныйПроект, СтруктураПараметровДокумента.Подразделение, СтруктураПараметровДокумента.Дата);
		
	Возврат ОбменСБанкамиПоЗарплатнымПроектам.ДанныеСотрудниковДляЗакрытияЛицевыхСчетов(Запрос.МенеджерВременныхТаблиц);
