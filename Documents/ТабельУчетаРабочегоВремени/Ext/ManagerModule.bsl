...
Функция СформироватьЗапросДляПечати(МассивОбъектов)
	...
	ТекстЗапроса =
		...
		|		ПО ДанныеДокументов.Ответственный = Пользователи.Ссылка
		|
		|УПОРЯДОЧИТЬ ПО
...
Функция ПустоеДеревоЗначенийДанныхОВремени()
	...
	ДанныеОВремени.Колонки.Добавить("ПараметрыДанныхОтветственный", Новый ОписаниеТипов("СправочникСсылка.ФизическиеЛица"));
...
Функция ДанныеНовогоДокумента() Экспорт
	...
	ДанныеДокумента.Вставить("ДатаНачалаПериода", НачалоМесяца(ТекущаяДатаСеанса()));
	ДанныеДокумента.Вставить("ДатаОкончанияПериода", КонецМесяца(ТекущаяДатаСеанса()));
	ДанныеДокумента.Вставить("ИсправленныйДокумент", Документы.ТабельУчетаРабочегоВремени.ПустаяСсылка());
	ДанныеДокумента.Вставить("Руководитель", Неопределено);
	ДанныеДокумента.Вставить("ДолжностьРуководителя", Неопределено);
	ДанныеДокумента.Вставить("ОснованиеПодписиРуководителя", "");
	ДанныеДокумента.Вставить("РаботникКадровойСлужбы", Неопределено);
	ДанныеДокумента.Вставить("ДолжностьРаботникаКадровойСлужбы", Неопределено);
	ДанныеДокумента.Вставить("ОснованиеПодписиРаботникаКадровойСлужбы", "");
	ДанныеДокумента.Вставить("Исполнитель", Неопределено);
	ДанныеДокумента.Вставить("ДолжностьИсполнителя", Неопределено);
	ДанныеДокумента.Вставить("ОснованиеПодписиИсполнителя", "");
	ДанныеДокумента.Вставить("Сотрудники", Неопределено);
	ДанныеДокумента.Вставить("Ответственный", Неопределено);
