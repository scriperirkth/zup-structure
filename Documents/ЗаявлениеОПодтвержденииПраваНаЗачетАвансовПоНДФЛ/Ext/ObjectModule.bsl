...
Функция ТекстФайла(ИмяФайла)
	...
	Если ЗначениеЗаполнено(Сведения.Представитель) Тогда // Представитель
		...
		НаборЗаписейПодписант.ПрПодп.Значение = "3";
			
		НаборЗаписейСвПред = НаборЗаписейПодписант.СвПред.Значение;
		НаборЗаписейСвПред.НаимДок = СокрЛП(Сведения.ДокументПредставителя);
		Если РегламентированнаяОтчетность.ПредставительЯвляетсяФизЛицом(Сведения.Представитель) Тогда
			ИННПредставителя = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Сведения.Представитель,"ИНН");
			НаборЗаписейПодписант.ФИО.Значение.Фамилия	= ДанныеФЛ.Фамилия;
			НаборЗаписейПодписант.ФИО.Значение.Имя		= ДанныеФЛ.Имя;
			НаборЗаписейПодписант.ФИО.Значение.Отчество	= ДанныеФЛ.Отчество;
		Иначе
			РеквизитыПредставителя = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Сведения.Представитель,"ИНН,НаименованиеПолное");
			ИННПредставителя = РеквизитыПредставителя.ИНН;
			ДанныеФЛ = РегламентированнаяОтчетность.РазложитьФИО(Сведения.УполномоченноеЛицоПредставителя);
			НаборЗаписейПодписант.ФИО.Значение.Фамилия	= ДанныеФЛ.Фамилия;
			НаборЗаписейПодписант.ФИО.Значение.Имя		= ДанныеФЛ.Имя;
			НаборЗаписейПодписант.ФИО.Значение.Отчество	= ДанныеФЛ.Отчество;
			НаборЗаписейСвПред.НаимОрг = РеквизитыПредставителя.НаименованиеПолное;
		КонецЕсли;
		Если НЕ ЗначениеЗаполнено(ИННПредставителя) Тогда
			НаборЗаписейПодписант.Удалить("ИННФЛ");
		Иначе
			НаборЗаписейПодписант.ИННФЛ.Значение = ИННПредставителя;
		КонецЕсли;
	Иначе
