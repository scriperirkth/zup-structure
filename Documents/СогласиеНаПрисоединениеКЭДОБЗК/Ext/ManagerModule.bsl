...
Функция СтруктураПоляСПадежами(ИмяПоля, Представление, СклоняемыйОбъект, Пол = Неопределено)
	...
	Если ТипЗнч(СклоняемыйОбъект) = Тип("СправочникСсылка.ФизическиеЛица") Тогда
		СтруктураПоляСПадежами.Вставить(ИмяПоля+"Именительный",	СклонениеПредставленийОбъектов.ПросклонятьФИО(Представление, 1, , ПолЧислом));
		СтруктураПоляСПадежами.Вставить(ИмяПоля+"Родительный",	СклонениеПредставленийОбъектов.ПросклонятьФИО(Представление, 2, , ПолЧислом));
		СтруктураПоляСПадежами.Вставить(ИмяПоля+"Дательный",	СклонениеПредставленийОбъектов.ПросклонятьФИО(Представление, 3, , ПолЧислом));
		СтруктураПоляСПадежами.Вставить(ИмяПоля+"Винительный", 	СклонениеПредставленийОбъектов.ПросклонятьФИО(Представление, 4, , ПолЧислом));
		СтруктураПоляСПадежами.Вставить(ИмяПоля+"Творительный", СклонениеПредставленийОбъектов.ПросклонятьФИО(Представление, 5, , ПолЧислом));
		СтруктураПоляСПадежами.Вставить(ИмяПоля+"Предложный", 	СклонениеПредставленийОбъектов.ПросклонятьФИО(Представление, 6, , ПолЧислом));
		
	Иначе
		
		СтруктураПоляСПадежами.Вставить(ИмяПоля+"Именительный",	СклонениеПредставленийОбъектов.ПросклонятьПредставление(Представление, 1));
		СтруктураПоляСПадежами.Вставить(ИмяПоля+"Родительный",	СклонениеПредставленийОбъектов.ПросклонятьПредставление(Представление, 2));
		СтруктураПоляСПадежами.Вставить(ИмяПоля+"Дательный",	СклонениеПредставленийОбъектов.ПросклонятьПредставление(Представление, 3));
		СтруктураПоляСПадежами.Вставить(ИмяПоля+"Винительный", 	СклонениеПредставленийОбъектов.ПросклонятьПредставление(Представление, 4));
		СтруктураПоляСПадежами.Вставить(ИмяПоля+"Творительный", СклонениеПредставленийОбъектов.ПросклонятьПредставление(Представление, 5));
		СтруктураПоляСПадежами.Вставить(ИмяПоля+"Предложный", 	СклонениеПредставленийОбъектов.ПросклонятьПредставление(Представление, 6));
