...
Функция ДанныеОткрытияЛицевыхСчетов(МассивДокументов, ДатаПолученияДанных) Экспорт
	...
	|	ЗаявкаНаОткрытиеЛицевыхСчетовСотрудники.Банк.Код КАК БИК
	...
	|	ЗаявкаНаОткрытиеЛицевыхСчетовСотрудники.Банк.Код
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ
	...
	|	ЗаявкаНаОткрытиеЛицевыхСчетовСотрудниковСотрудники.НомерСтроки КАК НомерСтроки,
