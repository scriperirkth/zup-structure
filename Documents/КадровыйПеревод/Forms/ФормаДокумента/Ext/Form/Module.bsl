...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.КадровыеРешения") Тогда
		МодульКадровыеРешенияФормыРасширенный = ОбщегоНазначения.ОбщийМодуль("КадровыеРешенияФормыРасширенный");
		МодульКадровыеРешенияФормыРасширенный.КадровыйПереводПриСозданииФормыНаСервере(ЭтотОбъект, Отказ, СтандартнаяОбработка);
	КонецЕсли;
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "ЗаписанИндивидуальныйГрафикСотрудника" Тогда
		...
		КонецЕсли;
	ИначеЕсли ИмяСобытия = "ИзмененыЕжегодныеОтпуска" И Источник = ЭтотОбъект Тогда
...
Процедура УстановитьДанныеРабочегоМеста(УстановитьИзменениеНачислений = Истина)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.РабочиеМестаОхраныТруда") Тогда
		МодульРабочиеМестаОхраныТрудаФормы = ОбщегоНазначения.ОбщийМодуль("РабочиеМестаОхраныТрудаФормы");
		МодульРабочиеМестаОхраныТрудаФормы.УстановитьЗначениеРабочегоМестаВФормеДокумента(
			ЭтотОбъект, Истина, УстановитьИзменениеНачислений);
	КонецЕсли;
...
Процедура ОбработатьИзменениеОрганизации(Перезаполнить)
	...
	Если ЗначениеЗаполнено(Объект.Организация) Тогда
		...
		Если Перезаполнить Тогда
			...
			Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.РабочиеМестаОхраныТруда") Тогда
				МодульРабочиеМестаОхраныТрудаФормы = ОбщегоНазначения.ОбщийМодуль("РабочиеМестаОхраныТрудаФормы");
				МодульРабочиеМестаОхраныТрудаФормы.ПриИзмененииОрганизацииВКадровомПереводе(ЭтотОбъект);
			КонецЕсли;
		КонецЕсли;
...
Процедура ДатаНачалаПриИзмененииНаСервере()
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ТрудоустройствоПоКвотам") Тогда
		МодульТрудоустройствоПоКвотамФормы = ОбщегоНазначения.ОбщийМодуль("ТрудоустройствоПоКвотамФормы");
		МодульТрудоустройствоПоКвотамФормы.УстановитьЭлементыФормыДокумента(ЭтотОбъект, Истина);
	КонецЕсли;
...
Процедура ЗаполнитьСоставДействующихНачисленийСотрудника(ПересчитатьФОТ = Истина)
	...
	ИсключаемыйРегистратор = ИсправлениеДокументовЗарплатаКадры.ИсключаемыйРегистраторДляДействующихДанных(ЭтаФорма);
...
Процедура ЗаполнитьПоложеннымиПравамиСотрудникаНаСервере()
	...
	ДанныеДокумента.Регистратор = ИсправлениеДокументовЗарплатаКадры.ИсключаемыйРегистраторДляДействующихДанных(ЭтаФорма);
...
Процедура ИзменитьКвотуПриИзмененииНаСервере()
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ТрудоустройствоПоКвотам") Тогда
		МодульТрудоустройствоПоКвотамФормы = ОбщегоНазначения.ОбщийМодуль("ТрудоустройствоПоКвотамФормы");
		МодульТрудоустройствоПоКвотамФормы.ПриИзмененииЭлементаФормыКадровогоПриказа(ЭтотОбъект, "ИзменитьКвоту", Истина, Истина);
	КонецЕсли;
