...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		УстановитьОсновнойБанковскийСчетКонтрагента();
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.БазовыеСправочныеДанныеРасширенная") Тогда
		...
		МодульОсновныеБанковскиеСчета.ЗаписатьОсновнойБанковскийСчет(ТекущийОбъект.Ссылка, ОсновнойСчет);
	КонецЕсли;
...
&НаСервере
Процедура УстановитьОсновнойБанковскийСчетКонтрагента()

	ОсновнойСчет = (Объект.Ссылка = УчетПрочихДоходов.ОсновнойБанковскийСчетКонтрагента(Объект.Владелец)); 
