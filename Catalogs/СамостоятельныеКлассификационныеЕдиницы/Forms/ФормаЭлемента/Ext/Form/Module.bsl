...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПрочитатьСтавкуВзносаНаСтрахованиеОтНесчастныхСлучаевДляОрганизации();
...
&НаСервере
Процедура ПрочитатьСтавкуВзносаНаСтрахованиеОтНесчастныхСлучаевДляОрганизации()
	
	Если Не ПравоДоступа("Чтение", Метаданные.РегистрыСведений.СтавкаВзносаНаСтрахованиеОтНесчастныхСлучаев) Тогда
		Возврат;
	КонецЕсли;
	
	МенеджерЗаписи = РедактированиеПериодическихСведений.МенеджерПоследнейЗаписи("СтавкаВзносаНаСтрахованиеОтНесчастныхСлучаев", Новый Структура("Организация", Объект.Владелец));
	ЭтаФорма.ЗначениеВРеквизитФормы(МенеджерЗаписи, "СтавкаВзносаНаСтрахованиеОтНесчастныхСлучаевОрганизации");
...
Процедура ОбновитьПолеИтоговыйТариф(Форма) 
	ДанныеТарифа = Новый Структура("Период,Ставка,Скидка,Надбавка");
	ЗаполнитьЗначенияСвойств(ДанныеТарифа, Форма.СтавкаВзносаНаСтрахованиеОтНесчастныхСлучаевОрганизации);
	ЗаполнитьЗначенияСвойств(ДанныеТарифа, Форма.СтавкаВзносаНаСтрахованиеОтНесчастныхСлучаев,"Ставка");
	ДанныеТарифа.Ставка = Форма.СтавкаВзносаНаСтрахованиеОтНесчастныхСлучаев.Ставка;
	Форма.Элементы.ДекорацияИтоговыйТариф.Заголовок = УчетСтраховыхВзносовКлиентСервер.ТекстИтоговогоТарифаНСиПЗ(ДанныеТарифа)
КонецПроцедуры
