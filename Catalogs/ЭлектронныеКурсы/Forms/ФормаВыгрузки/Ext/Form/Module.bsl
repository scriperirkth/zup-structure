...
Процедура ВыгрузитьНаДиск(Команда)	
	...
	Если МожноВыгружатьВКаталогНаКлиенте И ЗначениеЗаполнено(ПутьККаталогуВыгрузокНаКлиенте) Тогда
		РезультатВыгрузки = ВыгрузитьНаДискНаКлиенте(МассивЭлектронныхКурсов);
	Иначе
		РезультатВыгрузки = ВыгрузитьНаДискНаСервере(МассивЭлектронныхКурсов);
	КонецЕсли;
...
&НаСервере
Функция ВыгрузитьНаДискНаСервере(МассивЭлектронныхКурсов)
...
&НаКлиенте
Функция ВыгрузитьНаДискНаКлиенте(МассивЭлектронныхКурсов)
	
	Возврат РазработкаЭлектронныхКурсовСлужебныйКлиент.ВыгрузитьНаДиск(МассивЭлектронныхКурсов, ФорматВыгрузки, ПутьККаталогуВыгрузокНаКлиенте);
