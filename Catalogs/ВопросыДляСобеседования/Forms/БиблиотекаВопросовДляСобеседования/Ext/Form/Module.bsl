	...
	Для каждого НомерСтроки Из ВыбранныеСтроки Цикл
		...
		Для Каждого ТекущаяСтрока Из СтрокиКлючевыхВопросов Цикл
			...
			Для Каждого СтрокаКлючей Из СтрокиКлючей Цикл
				...
				СтруктураХарактеристики = ХарактеристикиПерсонала.ХарактеристикаИзМакета(СтрокаКлючей.ХарактеристикаПерсонала, 
					СтрокаКлючей.ЗначениеХарактеристики, БиблиотекаХарактеристикТаблица, СвойстваХарактеристики);
