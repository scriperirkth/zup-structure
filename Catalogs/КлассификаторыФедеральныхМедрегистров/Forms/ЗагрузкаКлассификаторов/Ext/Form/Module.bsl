...
&НаКлиенте
Процедура ЗагружатьИз1СФНСИПриИзменении(Элемент)
	Элементы.Токен.Видимость = Не ЗагружатьИз1СФНСИ;
	ЗагружатьИз1СФНСИПриИзмененииНаСервере(Организация, ЗагружатьИз1СФНСИ);
КонецПроцедуры
...
Процедура Загрузить(Команда)
	...
	Если ЗагружатьИз1СФНСИ Тогда 
		ЗагрузкаПриНаличииПодключения = Новый ОписаниеОповещения("ЗагрузитьНаКлиенте", ЭтотОбъект);
		ИнтернетПоддержкаПользователейКлиент.НачатьПроверкуИПодключениеИнтернетПоддержкиПользователей(ЗагрузкаПриНаличииПодключения);
    Иначе 
		ЗагрузитьНаКлиенте(Истина);
	КонецЕсли;     
	
КонецПроцедуры

&НаКлиенте
Процедура ЗагрузитьНаКлиенте(Знач ЗагрузкаВозможна, Знач ДополнительныеПараметры = Неопределено) Экспорт
...
Функция РезультатВыполненияВДлительнойОперации()
	...
	СтруктураПараметров.Вставить("ЗагружатьИз1СФНСИ", ЗагружатьИз1СФНСИ);
...
Процедура Далее(Команда)    
	...
	Если Элементы.ШагиЗагрузки.ТекущаяСтраница = Элементы.СтраницаИсточник Тогда
		...
		КонецЕсли;
		Если Не ЗагружатьИз1СФНСИ И ПустаяСтрока(Токен) Тогда
...
&НаСервереБезКонтекста
Процедура ЗагружатьИз1СФНСИПриИзмененииНаСервере(Организация, ЗагружатьИз1СФНСИ = Неопределено)
	...
	НастройкиОрганизации = МедицинскиеРегистры.СоздатьПустыеНастройкиОрганизации();
	НастройкиОрганизации.ЗагружатьИз1СФНСИ = ЗагружатьИз1СФНСИ;
...
Процедура ЗаполнитьУИДОрганизацииИТокен(Организация)
	...
	ЗагружатьИз1СФНСИ = ДополнительныеСведенияОрганизации.ЗагружатьИз1СФНСИ;
