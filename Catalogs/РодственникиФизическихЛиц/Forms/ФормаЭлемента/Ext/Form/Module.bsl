...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СотрудникиКлиентСервер.ОбработатьОтображениеПоляСтраховойНомерПФР(Объект.СНИЛС, Элементы.СНИЛС, ЭтотОбъект);
...
Процедура СНИЛСПриИзменении(Элемент)
	СотрудникиКлиентСервер.ОбработатьОтображениеПоляСтраховойНомерПФР(Объект.СНИЛС, Элемент, ЭтотОбъект);
КонецПроцедуры
...
Процедура ОбновитьНаименование(Форма)
	Форма.Объект.Наименование = ФизическиеЛицаЗарплатаКадрыКлиентСервер.ФИОИзЧастей(Форма.Объект);
КонецПроцедуры
