...
&НаСервереБезКонтекста
Функция ЗагрузитьФайлыИзФайлаОбменаВИБ(ОбъектСсылка, Знач ПолноеИмяФайлаОбмена, МассивИменЗагружаемыхФайлов)
	...
	Попытка
		...
		РегламентированнаяОтчетностьКлиентСервер.ПроверитьПолноеИмяВременногоФайла(
			ПолноеИмяФайлаОбмена, "ПолноеИмяФайлаОбмена", "ЗагрузитьФайлыИзФайлаОбменаВИБ");		
		...
		Для каждого ИмяЗагружаемогоФайла Из МассивИменЗагружаемыхФайлов Цикл
			...
			РегламентированнаяОтчетностьКлиентСервер.ПроверитьИмяФайла(ИмяЗагружаемогоФайла);
			...
			//@skip-check 1c-fresh-audit
			НоваяЗапись.Данные = Новый ХранилищеЗначения(
				Новый ДвоичныеДанные(ПолноеИмяЗагружаемогоФайла), Новый СжатиеДанных(9));;
		...
		ОперацииСФайламиЭДКО.УдалитьВременныйФайл(КаталогОбмена);
		ОперацииСФайламиЭДКО.УдалитьВременныйФайл(ПолноеИмяФайлаОбмена);
