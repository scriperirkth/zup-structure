...
Процедура УправлениеФормой(Форма)
	...
	Элементы.УчитыватьМРОТПриОплатеПоСреднемуЗаработку.Видимость = Форма.ЭтоРасчетОтпуска;
	...
	Элементы.УчитыватьМРОТПриОплатеПоСреднемуЗаработкуНормативныйМетодБУ.Видимость = Форма.ЭтоРасчетОтпуска;
	...
	КонецЕсли;
	Элементы.УчитыватьМРОТПриОплатеПоСреднемуЗаработкуНормативныйМетодНУ.Видимость = Форма.ЭтоРасчетОтпуска;
	...
	Элементы.УчитыватьМРОТПриОплатеПоСреднемуЗаработкуНУ.Видимость = Форма.ЭтоРасчетОтпуска;
