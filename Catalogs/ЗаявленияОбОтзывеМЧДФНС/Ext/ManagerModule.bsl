...
// Считывает и анализирует данные заявления об отзыве МЧД ФНС из XML-файла обмена, включая сведения о доверителе, представителях и подписанте.
//
// Параметры:
//   ВходящиеДанные - ДвоичныеДанные, Строка - данные XML-файла или адрес временного хранилища
//   ОбновлятьСуществующийИлиСсылка - Булево - признак обновления существующего элемента или ссылка на него
//   Подпись - ДвоичныеДанные, Строка, Неопределено - данные подписи или адрес временного хранилища
//
// Возвращаемое значение:
//   Структура:
//     * ДанныеВыгрузки - ДвоичныеДанные, Строка - исходные данные файла обмена
//     * ДанныеПодписи - ДвоичныеДанные, Строка - данные подписи
//     * ИмяФайлаВыгрузки - Строка - имя файла выгрузки с расширением .xml
//     * ВерсияФормата - Строка - версия формата файла обмена
//     * НомерДоверенности - Строка - номер доверенности
//     * РегистрационныйНомерДоверенности - Строка - регистрационный номер доверенности (для версии 5.02)
//     * УникальныйИдентификаторДоверенности - Строка - уникальный идентификатор доверенности (для версии до 5.02)
//     * ДатаВыдачи - Дата - дата выдачи доверенности
//     * ДатаОтзыва - Дата - дата отзыва доверенности
//     * СведенияОбИнформационнойСистеме - Строка - сведения об информационной системе
//     * ПричинаОтзыва - Строка - причина отзыва
//     * КодНалоговогоОрганаПредставления - Строка - код налогового органа представления
//     * ТипОрганизации - Строка - тип организации доверителя ("ЮЛ", "ФЛ", "ИО", "П")
//     * ДоверительВыданаВПорядкеПередоверия - Булево - признак выдачи доверенности в порядке передоверия
//     * ФИО - Массив из Структура - массив структур с ФИО подписантов
//     * УдостоверенияЛичности - Массив из Структура - массив структур с данными удостоверений личности
//     * Представители - Массив из Структура - массив структур с данными представителей (для версии 5.02)
//     * Доверитель - СправочникСсылка.Организации, Строка, Неопределено - ссылка на доверителя или наименование
//     * Организация - СправочникСсылка.Организации, СправочникСсылка.Контрагенты - организация
