...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтотОбъект.РольДоступнаАдминистратор = ОбработкаНовостейСлужебный.ЭтоАдминистратор();
...
#Область ИнициализацияМетода
	...
	НаименованиеМетода = "Справочник.ЛентыНовостей.ФормаСписка.ДекорацияТребуетсяОбновлениеССервераОбработкаНавигационнойСсылкиСервер"; // АПК:1297 Это идентификатор.
...
#Область Обработка
	...
	НачатьШагВыполнения(КонтекстВыполнения, НаименованиеМетода + "/Обработки.УправлениеНовостями.ОбновитьСтандартныйСписокССервера");
		...
		Обработки.УправлениеНовостями.ОбновитьСтандартныйСписокССервера(
			"Список лент новостей", // АПК:1297 Это идентификатор.
