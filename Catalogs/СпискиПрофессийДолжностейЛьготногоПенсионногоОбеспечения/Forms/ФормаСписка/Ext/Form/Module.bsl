...
Процедура ПодобратьИзКлассификатора()
	...
	ПараметрыПодбора.ИмяСправочника = "СпискиПрофессийДолжностейЛьготногоПенсионногоОбеспечения";
	ПараметрыПодбора.Заголовок = НСтр("ru='Списки производств, работ, профессий, должностей и показателей, дающих право на льготное пенсионное обеспечение'");
	ПараметрыПодбора.ПолныйПутьКМакету = "Справочник.СпискиПрофессийДолжностейЛьготногоПенсионногоОбеспечения.КлассификаторПрофессийДолжностейЛьготногоПенсионногоОбеспечения";
