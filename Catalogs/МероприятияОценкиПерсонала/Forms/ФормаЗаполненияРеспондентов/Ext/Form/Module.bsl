...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ВключатьРольСамооценка") Тогда
		ВключатьРольСамооценка = Параметры.ВключатьРольСамооценка;
		Элементы.ВключатьСтатусСамооценка.Видимость = Параметры.ВключатьРольСамооценка;
	Иначе
...
Функция ТаблицаРеспондентовИндивидуальныйНабор()
	...
	Запрос.Текст =
		...
		|	ЕСТЬNULL(ТекущиеКадровыеДанныеСотрудников.Подразделение,
