...
Процедура ОбработатьАктивизациюСтрокиОсновнойТаблицы()
	...
	Если ТекДанные = Неопределено
		...
		И ТекДанные_ВидОтчета <> ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.ДокументацияПоКонтролируемымСделкам")
	...
	ИначеЕсли ТекДанные_ВидОтчета_ТипДокумента = ПредопределенноеЗначение("Перечисление.ТипыОтправляемыхДокументов.ИсходящееУведомлениеФНС")
		...
		ИЛИ ТекДанные_ВидОтчета = ПредопределенноеЗначение("Справочник.ВидыОтправляемыхДокументов.ДокументацияПоКонтролируемымСделкам")
