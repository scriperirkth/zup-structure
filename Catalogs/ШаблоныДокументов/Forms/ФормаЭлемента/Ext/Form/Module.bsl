...
Процедура УстановитьОтображениеЭлементов(УправляемаяФорма)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		"Доступность",
		УправляемаяФорма.ТребуетПодписания);
...
Процедура ОбновитьДанныеФормыПоВидуДокумента()
	...
	Если ЗначениеЗаполнено(Объект.ВидДокумента) Тогда
		ВариантПодписания = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.ВидДокумента, "ВариантПодписания");
		ТребуетПодписания = ВариантПодписания = Перечисления.ВариантыПодписанияДокументовЭДОБЗК.Требуется;
	Иначе
		ТребуетПодписания = Ложь;
	КонецЕсли;
	Если Не ТребуетПодписания Тогда
