...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ОбновитьШаблонДокументаОтсутствие_3_0_1");
	Методы.Вставить("ЗаполнитьТребуетПодписания");
	Методы.Вставить("ОбновитьПредопределенныеШаблоны_3_4_0");
	Методы.Вставить("ЗаполнитьОбязательныеРеквизитыВариантовОтчетов");
	Методы.Вставить("ОбновитьПредопределенныеШаблоны_3_1_0");
	Методы.Вставить("ОбновитьВерсииШаблонов");
	Методы.Вставить("ОбновитьШаблоны");
	Методы.Вставить("ВосстановитьНастройкиШаблонов");
	Методы.Вставить("ОбновитьПредопределенныеШаблоны_3_2_0");
	Методы.Вставить("ОбновитьШаблоныДокументовЗаказаСправок_3_0_1");
КонецПроцедуры
