...
Процедура НаименованиеПриИзменении(Элемент)
	УстановитьПолноеНаименование();
КонецПроцедуры

&НаКлиенте
Процедура ПолноеНаименованиеНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
...
&НаКлиенте
Процедура УстановитьПолноеНаименование()

	Если Не ПустаяСтрока(Объект.Наименование)
		И (ПустаяСтрока(Объект.ПолноеНаименование)
		ИЛИ Лев(Объект.Наименование, 30) = Лев(Объект.ПолноеНаименование, 30)) Тогда
