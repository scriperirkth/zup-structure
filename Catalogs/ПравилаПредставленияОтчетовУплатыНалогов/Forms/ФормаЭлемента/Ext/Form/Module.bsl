...
Процедура УправлениеФормой(Форма)
	...
	Уведомление  = ПредопределенноеЗначение("Перечисление.ВидыДействийКалендаряБухгалтера.Уведомление");
	...
	Иначе
		...
		ЭтоДействиеОтчет = (Форма.Объект.Действие = ПредопределенноеЗначение("Перечисление.ВидыДействийКалендаряБухгалтера.Отчет")
			Или Форма.Объект.Действие = ПредопределенноеЗначение("Перечисление.ВидыДействийКалендаряБухгалтера.Уведомление"));
	...
	Форма.Элементы.ВыполняетсяЕдинымПомощников.Доступность =
		Форма.Объект.Действие = УплатаНалога Или Форма.Объект.Действие = Уведомление;
