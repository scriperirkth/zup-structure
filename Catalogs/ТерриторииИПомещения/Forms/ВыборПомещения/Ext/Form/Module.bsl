...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоступноБронирование = ТерриторииИПомещения.ИспользоватьБронированиеПомещений();
...
Процедура ТерриторииВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле = Элементы.ТерриторииДоступнаСхема Тогда
		СтандартнаяОбработка = Ложь;
		ТерриторииИПомещенияКлиент.ПоказатьСхемуТерритории(ДанныеСтроки.Ссылка);
		Возврат;
	КонецЕсли;
...
Процедура УстановитьУсловноеОформление()
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.БронированиеПомещений") Тогда
		...
		МодульБронированиеПомещений.УстановитьУсловноеОформлениеТерритории(УсловноеОформление);
	КонецЕсли;
...
Процедура ЗаполнитьДеревоТерриторий();
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.БронированиеПомещений") Тогда
		МодульБронированиеПомещений = ОбщегоНазначения.ОбщийМодуль("БронированиеПомещений");
		МодульБронированиеПомещений.ЗаполнитьДеревоТерриторий(
