...
// Читает данные из файла обмена с машинночитаемой доверенностью ФНС формата XML и заполняет структуру с реквизитами доверенности.
// Поддерживает форматы версии 5.02 и более ранние, а также передоверия.
//
// Параметры:
//   ВходящиеДанные - ДвоичныеДанные
//                  - Строка - адрес временного хранилища
//   ОбновлятьСуществующийИлиСсылка - Булево - признак обновления существующей доверенности или ссылка
//   Подпись - ДвоичныеДанные
//            - Строка - адрес временного хранилища
//            - Неопределено - данные подписи доверенности (опционально)
//
// Возвращаемое значение:
//   Структура:
//     * ДанныеВыгрузки - ДвоичныеДанные - исходные данные файла доверенности
//     * ДанныеПодписи - ДвоичныеДанные - данные подписи
//     * ИмяФайлаВыгрузки - Строка - имя файла с расширением .xml
...
//     * ПередовериеВозможно - Булево - признак возможности передоверия
//     * НомерРодительскойДоверенности - Строка - номер родительской доверенности
//     * РегистрационныйНомерДоверенности - Строка - регистрационный номер доверенности
//     * КодНалоговогоОрганаПредставления - Строка - код налогового органа представления
//     * НалоговыеОрганыДействия - Массив из Структура - налоговые органы действия
//       ** КодНалоговогоОргана - Строка - код налогового органа
//     * ФИО - Массив из Структура - ФИО участников доверенности
//       ** Фамилия - Строка
//       ** Имя - Строка
//       ** Отчество - Строка
//       ** Владелец - Перечисление - субъект доверенности
//     * ПолномочияПредставителя - Массив из Структура - полномочия представителя
//     * УдостоверенияЛичности - Массив из Структура - удостоверения личности
//     * ТипОрганизации - Строка - тип организации ("ЮЛ", "ФЛ", "ИО", "")
//     * ДоверительЮЛ_НаимОрг - Строка - наименование организации-доверителя
//     * ДоверительЮЛ_ИНН - Строка - ИНН организации-доверителя
//     * ДоверительЮЛ_КПП - Строка - КПП организации-доверителя
//     * ДоверительЮЛ_ОГРН - Строка - ОГРН организации-доверителя
//     * ДоверительФЛ_ИНН - Строка - ИНН физического лица-доверителя
//     * ДоверительФЛ_НомЕРН - Строка - номер ЕРН физического лица
//     * ДоверительФЛ_ОГРН - Строка - ОГРНИП физического лица
//     * ДоверительФЛ_СНИЛС - Строка - СНИЛС физического лица
//     * ДоверительФЛ_Гражданство - СправочникСсылка.СтраныМира - гражданство физического лица
//     * ДоверительФЛ_ДатаРождения - Дата - дата рождения физического лица
//     * ДоверительФЛ_Фамилия - Строка - фамилия физического лица
//     * ДоверительФЛ_Имя - Строка - имя физического лица
//     * ДоверительФЛ_Отчество - Строка - отчество физического лица
//     * Доверитель - СправочникСсылка.Организации
//                   - Строка - наименование доверителя
//     * Представитель - СправочникСсылка.Организации
//                     - СправочникСсылка.Контрагенты
//                     - СправочникСсылка.ФизическиеЛица
//                     - Строка - наименование представителя
//     * Организация - СправочникСсылка.Организации
//                   - СправочникСсылка.Контрагенты
//                   - СправочникСсылка.ФизическиеЛица
//                   - Строка - организация для доверенности
//     * РодительскиеДоверенности - Массив из Структура - сведения о родительских доверенностях
//       ** ЭтоКорневаяДоверенность - Булево
...
//       ** ДоверительФЛ_Фамилия - Строка
//       ** ДоверительФЛ_Имя - Строка
//       ** ДоверительФЛ_Отчество - Строка
//       ** ДоверительФЛ_СерДок - Строка - серия документа
//       ** ДоверительФЛ_НомДок - Строка - номер документа
//       ** ДоверительФЛ_ДатаДок - Дата - дата документа
//       ** ДоверительФЛ_ВыдДок - Строка - кем выдан документ
//       ** ДоверительФЛ_КодВыдДок - Строка - код выдавшего документа
//       ** ДоверительФЛ_ВидДок - СправочникСсылка.ВидыДокументовФизическихЛиц - вид документа
//     * Представители - Массив из Структура - список представителей (для версии 5.02)
...
//                        - СправочникСсылка.ФизическиеЛица
//                        - Строка
//       ** ПредставительЯвляетсяСотрудником - Булево - признак, что представитель является сотрудником доверителя
//       ** Идентификатор - УникальныйИдентификатор - идентификатор представителя
//     * РодительскаяДоверенность - СправочникСсылка.МашиночитаемыеДоверенностиФНС - ссылка на родительскую доверенность
//     * КорневаяДоверенность - СправочникСсылка.МашиночитаемыеДоверенностиФНС - ссылка на корневую доверенность
Функция ДанныеИзФайлаОбмена(ВходящиеДанные,
