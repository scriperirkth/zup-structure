...
Процедура ПараметрДействия_Оповещение_ИмяСобытияПриИзменении(Элемент)
	...
	Если ПараметрДействия_Оповещение_ИмяСобытия = "Новости. Скрыть показать блок" Тогда
		...
		Для Каждого ТекущийЭлементСписка Из ПараметрДействия_Оповещение_Параметры Цикл
			Если ТекущийЭлементСписка.Представление = "УИНБлока" Тогда // АПК:1297 Это идентификатор.
				УИНБлока         = ТекущийЭлементСписка.Значение;
			ИначеЕсли ТекущийЭлементСписка.Представление = "УИНМаркера" Тогда // АПК:1297 Это идентификатор.
				УИНМаркера       = ТекущийЭлементСписка.Значение;
			ИначеЕсли ТекущийЭлементСписка.Представление = "МаркерРазвернуто" Тогда // АПК:1297 Это идентификатор.
				МаркерРазвернуто = ТекущийЭлементСписка.Значение;
			ИначеЕсли ТекущийЭлементСписка.Представление = "МаркерСвернуто" Тогда // АПК:1297 Это идентификатор.
...
Процедура ПараметрДействия_Оповещение_ПараметрыЗначениеПараметраНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ТекущиеДанные <> Неопределено Тогда
		Если ТекущиеДанные.ИмяПараметра = "УИНБлока" Тогда // АПК:1297 Это идентификатор.
			Если ТипЗнч(СписокРазделовДляСвертки) = ТипСписокЗначений Тогда
				...
				СтандартнаяОбработка = Ложь;
			КонецЕсли;
		ИначеЕсли ТекущиеДанные.ИмяПараметра = "УИНМаркера" Тогда // АПК:1297 Это идентификатор.
			Если ТипЗнч(СписокРазделовДляМаркеровСостояния) = ТипСписокЗначений Тогда
				...
				СтандартнаяОбработка = Ложь;
			КонецЕсли;
		ИначеЕсли ТекущиеДанные.ИмяПараметра = "МаркерРазвернуто" Тогда // АПК:1297 Это идентификатор.
			СтандартнаяОбработка = Ложь;
			ДанныеВыбора = Новый СписокЗначений;
			ДанныеВыбора.Добавить(НСтр("ru='развернуто'"));
			ДанныеВыбора.Добавить(НСтр("ru='свернуть'"));
			ДанныеВыбора.Добавить("[-]");
		ИначеЕсли ТекущиеДанные.ИмяПараметра = "МаркерСвернуто" Тогда // АПК:1297 Это идентификатор.
			СтандартнаяОбработка = Ложь;
			ДанныеВыбора = Новый СписокЗначений;
