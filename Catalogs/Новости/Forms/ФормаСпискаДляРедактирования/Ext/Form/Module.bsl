...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.РазделениеВключено() Тогда
		...
		Если ИнтернетПоддержкаПользователей.СеансЗапущенБезРазделителей() Тогда
			...
			лкВариантСпискаЛентНовостей = "Только для администратора"; // АПК:1297 Это идентификатор.
		Иначе
	...
	Иначе
		...
		лкВариантСпискаЛентНовостей = "Для администратора или редактора новостей"; // АПК:1297 Это идентификатор.
	КонецЕсли;
	...
	Если лкВариантСпискаЛентНовостей = "Только для администратора" Тогда // АПК:1297 Это идентификатор.
		Если (ПараметрыТекущегоПользователя.ЕстьРольПолныеПрава = Истина)
			...
			КонецЕсли;
		КонецЕсли;
	ИначеЕсли лкВариантСпискаЛентНовостей = "Для администратора или редактора новостей" Тогда // АПК:1297 Это идентификатор.
		Если (ПараметрыТекущегоПользователя.ЕстьРольПолныеПрава = Истина)
				И (ПараметрыТекущегоПользователя.ЕстьРольАдминистраторСистемы = Истина) Тогда
			Запрос = Новый Запрос;
			Запрос.Текст = "
...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	КонецЦикла;
	Оповестить(
		"БуферОбмена: скопировано значение", // АПК:1297 Это идентификатор.
		ТекущийБуферОбмена,
...
Процедура ПересчетСлужебныхДанныхНаСервере()
	...
	НаименованиеМетода = "Новости.ФормаСпискаДляРедактирования.ПересчетСлужебныхДанныхНаСервере"; // АПК:1297 Это идентификатор.
