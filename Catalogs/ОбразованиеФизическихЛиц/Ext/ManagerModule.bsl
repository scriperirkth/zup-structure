...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Если Данные.ВидОбразования = ПослевузовскоеОбразование Тогда
		Если Данные.ВидПослевузовскогоОбразования.Пустая() Тогда
...
Функция ОбразованиеФизическогоЛица(ФизическоеЛицо) Экспорт
	...
	Запрос = Новый Запрос(
		...
		|	ОбразованиеФизическихЛиц.СОтличием КАК СОтличием
		|ИЗ
...
Функция НовыеДанныеОбОбразовании() Экспорт
	...
	ДанныеОбОбразовании.Колонки.Добавить("Начало", ОбщегоНазначения.ОписаниеТипаДата(ЧастиДаты.Дата));
	...
	ДанныеОбОбразовании.Колонки.Добавить("СкрыватьВТ2", Новый ОписаниеТипов("Булево"));
	ДанныеОбОбразовании.Колонки.Добавить("СОтличием", Новый ОписаниеТипов("Булево"));
	ДанныеОбОбразовании.Колонки.Добавить("ВидДокумента",
		Новый ОписаниеТипов("СправочникСсылка.ВидыДокументовОбОбразовании"));
	ДанныеОбОбразовании.Колонки.Добавить("Серия", ОбщегоНазначения.ОписаниеТипаСтрока(100));
	ДанныеОбОбразовании.Колонки.Добавить("Номер", ОбщегоНазначения.ОписаниеТипаСтрока(100));
	ДанныеОбОбразовании.Колонки.Добавить("ДатаВыдачи", ОбщегоНазначения.ОписаниеТипаДата(ЧастиДаты.Дата));
