...
Функция ДанныеРабочегоМеста(РабочееМесто) Экспорт
	...
	Запрос = Новый Запрос(
		...
		|	РабочиеМестаОхраныТруда.ВыплачиваетсяНадбавкаЗаВредность КАК ВыплачиваетсяНадбавкаЗаВредность,
		|	РабочиеМестаОхраныТруда.ПроцентНадбавкиЗаВредность КАК ПроцентНадбавкиЗаВредность,
		|	РабочиеМестаОхраныТруда.КоличествоДнейДополнительногоОтпускаВГод КАК КоличествоДнейДополнительногоОтпускаВГод
		|ИЗ
