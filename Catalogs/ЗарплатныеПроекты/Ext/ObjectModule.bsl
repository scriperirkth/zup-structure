...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ИспользоватьЭлектронныйДокументооборотСБанком Тогда
		...
		Если ОбменСБанкамиПоЗарплатнымПроектам.ИспользоватьТиповойЭОИСБанком(Ссылка) Тогда
			...
			Если ДляПеречисленийВЦифровыхРублях Тогда
...
Процедура ПередЗаписью(Отказ)
	...
	Если ДляПеречисленийНаКартыМир Тогда
		...
		ДляПеречисленийВЦифровыхРублях = Ложь;
	ИначеЕсли ДляПеречисленийВЦифровыхРублях Тогда
		НомерДоговора = "";
		ДатаДоговора = Дата(1,1,1);
		ОтделениеБанка = "";
		ФилиалОтделенияБанка = "";
		РасчетныйСчет = "";
		ДляПеречисленийНаКартыМир = Ложь;
	КонецЕсли;
