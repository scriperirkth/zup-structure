...
&НаКлиенте
Процедура ВыполняетсяОтветственнымПриИзменении(Элемент)
...
Процедура ПриИзмененииВидаИсполнителя()
	...
	Объект.ИсполняетсяОтветственным = (КемВыполняется = ВидыИсполнителей().Ответственный);
...
Процедура ДанныеВРеквизиты()
	...
	ИначеЕсли Объект.ИсполняетсяОтветственным Тогда
		КемВыполняется = ВидыИсполнителей().Ответственный;
	Иначе
...
Функция ЕстьОшибкиЗаполнения()
	...
	Если Выполняется Тогда
		...
		Если Не Объект.ИсполняетсяСотрудником
			...
			И Не Объект.ИсполняетсяОтветственным
...
Функция ВидыИсполнителей()
	...
	ВидыИсполнителей.Вставить("Ответственный", 3);
