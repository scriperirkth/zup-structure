...
&НаКлиенте
Процедура НачислениеЗарплатыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	СтруктураОтбора = Новый Структура("Сотрудник");
	СтруктураОтбора.Сотрудник = СотрудникСсылка;
...
Процедура ПрочитатьНачисления()
	...
	ФОТ = ЗарплатаКадрыРасширенныйКлиентСервер.ИтогиПоФОТ(ЭтаФорма, ОписаниеТаблицыВидовРасчета);
