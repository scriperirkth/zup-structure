...
Процедура Подключаемый_ВыполнитьКомандуИнтеграцииС1САрхивом(Команда)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ИнтеграцияС1САрхивом") Тогда
		...
		МодульОбменСАрхивомКлиент.ВыполнитьПодключаемуюКоманду(Команда, ЭтотОбъект, Сотрудник);
	КонецЕсли;
...
Процедура Подключаемый_Наставничество(Команда)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.Наставничество") Тогда
		...
		МодульНаставничествоКлиент.ОткрытьФормуНаставничество(ЭтотОбъект, СотрудникСсылка);
	КонецЕсли;
...
Процедура Подключаемый_ОхранаТруда(Команда)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда") Тогда
		...
		МодульКлиент.ОткрытьФормуПоОхранеТруда(ЭтотОбъект, Истина);
	КонецЕсли;
...
&НаКлиенте
Процедура Подключаемый_МатериальнаяОтветственность(Команда)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыПриложения.МатериальноОтветственныеЛица") Тогда
		...
		МодульМатериальноОтветственныеЛицаКлиент.ОткрытьФормуМатериальнаяОтветственность(ЭтотОбъект, ТекущаяОрганизация, ФизическоеЛицоСсылка, Истина);
	КонецЕсли;
...
&НаКлиенте
Процедура Подключаемый_АттестацииСотрудника(Команда)
	
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыПриложения.АттестацииСотрудников") Тогда
		МодульКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("АттестацииСотрудниковКлиент");
		МодульКлиент.ОткрытьФормуАттестацииСотрудников(ЭтотОбъект, ФизическоеЛицо, , Истина);
	КонецЕсли;

КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_ДисциплинарныеВзыскания(Команда)
	
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ДисциплинарныеВзыскания") Тогда
		МодульКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("ДисциплинарныеВзысканияКлиент");
		МодульКлиент.ОткрытьФормуДисциплинарныеВзысканияСотрудников(ЭтотОбъект, ФизическоеЛицо, , Истина);
	КонецЕсли;
