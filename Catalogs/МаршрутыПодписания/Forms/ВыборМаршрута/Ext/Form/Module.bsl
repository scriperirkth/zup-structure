...
Функция ОтборСертификатовКорректный(Сертификат, СписокПодписантовДляОтбора, ДоступныеСертификаты)
	...
	ЗначениеРеквизитовСертификата = КриптографияБЭД.ЗначениеРеквизитовСертификата(Сертификат, "Пользователь");
	
	Возврат СписокПодписантовДляОтбора.НайтиПоЗначению(ЗначениеРеквизитовСертификата.Пользователь) <> Неопределено
