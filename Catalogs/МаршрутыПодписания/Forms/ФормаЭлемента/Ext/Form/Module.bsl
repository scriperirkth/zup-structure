...
Функция ОтборСертификатовКорректный(Сертификат, СписокПодписантовДляОтбора, Организация)
	...
	РеквизитыСертификата = КриптографияБЭД.ЗначениеРеквизитовСертификата(Сертификат, "Пользователь, Организация");
	
	Возврат СписокПодписантовДляОтбора.НайтиПоЗначению(РеквизитыСертификата.Пользователь) <> Неопределено
		И РеквизитыСертификата.Организация = Организация;
