...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ОбновлениеДляИспользованияЭДОБЗК");
	Методы.Вставить("ЗаполнитьСодержимоеДокументаЭДОБЗКЗаявокСотрудников");
	Методы.Вставить("ПеренестиПрисоединенныеФайлыВложений");
	Методы.Вставить("ПеренестиСогласователейЗаявкиВРегистр");
КонецПроцедуры
...
Процедура ОбновлениеДляИспользованияЭДОБЗК(ПараметрыОбновления = Неопределено) Экспорт
	...
	РезультатЗапроса = БизнесПроцессыЗаявокСотрудников.РезультатЗапросаЗаявокОбновлениеДляИспользованияЭДОБЗК("БизнесПроцесс.ЗаявкаСотрудникаОтсутствие");
