...
Процедура КомандаНастроитьЗначенияОтборов(Команда)
	...
	Если (Элементы.ОтборыПоЛентамНовостейПользовательские.ТекущиеДанные.РазрешеноНастраиватьПользователям = Ложь) 
			ИЛИ (Элементы.ОтборыПоЛентамНовостейПользовательские.ТекущиеДанные.ЗаполняетсяАвтоматически = Истина) Тогда
		Возврат;
	КонецЕсли;
