...
Процедура ПрочитатьДанные()
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ГосударственнаяСлужба") Тогда
		...
		Модуль.ДополнитьФормуОрганизацияБухучетИВыплатаЗарплаты(ЭтотОбъект);
		Модуль.ПрочитатьДополнительныеДанныеОрганизации(ЭтотОбъект, ОрганизацияСсылка, Ложь, "ИспользоватьВоеннуюСлужбу");
	КонецЕсли;
КонецПроцедуры
...
Процедура СохранитьДанныеНаСервере(Отказ)
	...
	Если ПроверитьЗаполнение() Тогда
		...
		Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ГосударственнаяСлужба") Тогда
			Модуль = ОбщегоНазначения.ОбщийМодуль("ГосударственнаяСлужба");
			Модуль.ЗаписатьДополнительныеДанныеОрганизации(
				ЭтотОбъект, ЭтотОбъект.ОрганизацияСсылка, "ДнейДоВыплатыОтпускаВоеннослужащего", "ИспользоватьВоеннуюСлужбу");
		КонецЕсли;
