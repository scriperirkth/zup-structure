...
&НаКлиенте
Процедура ДанныеВоинскогоУчетаОрганизацийВедетсяТолькоВоинскийУчетПриИзменении(Элемент)
...
Процедура ПрочитатьДанные()
	...
	ДанныеВоинскогоУчета = РегистрыСведений.ДанныеВоинскогоУчетаОрганизаций.СоздатьМенеджерЗаписи();
	ДанныеВоинскогоУчета.Организация = ОрганизацияСсылка;
	ДанныеВоинскогоУчета.Прочитать();
	
	ЗначениеВРеквизитФормы(ДанныеВоинскогоУчета, "ДанныеВоинскогоУчетаОрганизаций");
...
Процедура СохранитьДанныеНаСервере()
	...
	ДанныеВоинскогоУчета = РегистрыСведений.ДанныеВоинскогоУчетаОрганизаций.СоздатьМенеджерЗаписи();
	ЗаполнитьЗначенияСвойств(ДанныеВоинскогоУчета, ДанныеВоинскогоУчетаОрганизаций);
	ДанныеВоинскогоУчета.Организация = ОрганизацияСсылка;
	ДанныеВоинскогоУчета.Записать();
...
Процедура УстановитьСвойстваЭлементовФормы()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
		"ПараметрыБронированияСотрудниковОрганизацийПериод", 
		"ТолькоПросмотр", 
		ДанныеВоинскогоУчетаОрганизаций.ВедетсяТолькоВоинскийУчет);
		
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
		"ПараметрыБронированияСотрудниковОрганизацийВоенкомат", 
		"ТолькоПросмотр", 
		ДанныеВоинскогоУчетаОрганизаций.ВедетсяТолькоВоинскийУчет);
		
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
		"ПараметрыБронированияСотрудниковОрганизацийНормаБронирования", 
		"ТолькоПросмотр", 
		ДанныеВоинскогоУчетаОрганизаций.ВедетсяТолькоВоинскийУчет);
		
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
		"ПараметрыБронированияСотрудниковОрганизацийВидОснованияДляБронирования", 
		"ТолькоПросмотр", 
		ДанныеВоинскогоУчетаОрганизаций.ВедетсяТолькоВоинскийУчет);
		
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы,
		"ПараметрыБронированияСотрудниковОрганизацийРеквизитыОснованияДляБронирования", 
		"ТолькоПросмотр", 
		ДанныеВоинскогоУчетаОрганизаций.ВедетсяТолькоВоинскийУчет);
