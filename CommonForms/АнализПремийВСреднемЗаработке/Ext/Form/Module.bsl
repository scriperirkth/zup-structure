...
Процедура ЗаполнитьФорму(ДанныеОПремиях, ДанныеНачислений)
	...
	Если ИмяВарианта = УчетСреднегоЗаработка.ИмяВариантаИсключенияПремийБезИсключения() Тогда
		Элементы.КартинкаПолитики.Видимость = Истина;
		Элементы.ОписаниеПолитики.АвтоМаксимальнаяШирина = Ложь;
	Иначе
		Элементы.КартинкаПолитики.Видимость = Ложь;
	КонецЕсли;
