...
Процедура ЗаполнитьПодписываемыеФайлы(СписокФайлов)
	...
	ПодписываемыеФайлы.Загрузить(ЭДОБЗК.ДанныеФайловПечатныхФормКОтправкеПоЭлектроннойПочте(СписокФайлов));
...
Процедура ЗаполнитьПолучателей()
	...
	Получатели.Загрузить(ЭДОБЗК.ПолучателиЭлектронныхПисем(ПодписываемыеФайлы));
...
Функция УчетнаяЗапись()
	...
	Возврат ЭДОБЗК.УчетнаяЗаписьЭлектроннойПочты();
...
Процедура ОтправитьПисьмаПолучателям(ДанныеПолучателей)
	...
	ОтправленныеПолучатели = ЭДОБЗК.ОтправитьПисьмаПолучателям(
