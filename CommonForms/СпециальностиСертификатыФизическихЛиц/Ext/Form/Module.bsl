...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СотрудникиФормы.ПрочитатьНаборЗаписей(ЭтаФорма, "СертификатыПоСпециальностиФизическихЛиц");
...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	СотрудникиФормы.СохранитьНаборЗаписей(ЭтаФорма, "СертификатыПоСпециальностиФизическихЛиц");	
