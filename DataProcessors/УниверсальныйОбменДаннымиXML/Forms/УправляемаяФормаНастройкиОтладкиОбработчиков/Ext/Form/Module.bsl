...
Процедура ПроверитьДоступностьНаСервере()
	...
	Если ОбменДаннымиСлужебный.ПутьКФайлуСодержитНедопустимыеСимволы(Объект.ИмяФайлаВнешнейОбработкиОбработчиковСобытий) Тогда
		Возврат;
	КонецЕсли;
...
Функция ОбработчикиСобытий()
	...
	// Защита от Path Traversal атаки
	Если ОбменДаннымиСлужебный.ПутьКФайлуСодержитНедопустимыеСимволы(Объект.ИмяВременногоФайлаОбработчиковСобытий) Тогда
...
Функция ПротоколОбмена()
	...
	// Защита от Path Traversal атаки
	Если ОбменДаннымиСлужебный.ПутьКФайлуСодержитНедопустимыеСимволы(Объект.ИмяВременногоФайлаПротоколаОбмена) Тогда
