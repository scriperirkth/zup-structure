...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ПолучитьДанныеМонитора", Истина);
	Методы.Вставить("ПолучитьДеталиДанныхМонитора", Истина);
	Методы.Вставить("ПолучитьДеталиИнформацияОДоступномОбновлении", Истина);
