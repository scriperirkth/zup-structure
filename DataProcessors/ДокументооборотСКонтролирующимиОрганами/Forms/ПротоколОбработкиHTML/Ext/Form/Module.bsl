...
Процедура УведомленияОРазмереСтраховыхВзносовНажатие(Элемент)
	...
	ТипыСЭДО = ДокументооборотСФССКлиентСервер.ТипыСообщенийСЭДО();
	ТипУведомления = ТипыСЭДО.ТипСообщенияУведомлениеОРазмереСтраховыхВзносов; // тип 31.
	
	ПараметрыОтбора = Новый Структура("Тип, Организация", ТипУведомления, Организация);
