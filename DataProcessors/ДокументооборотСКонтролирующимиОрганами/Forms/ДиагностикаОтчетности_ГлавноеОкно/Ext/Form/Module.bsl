...
&НаСервереБезКонтекста
Функция ИзвлечьСведенияИзЗашифрованногоПакета(Знач ИмяФайла, Знач РабочийКаталог, РазмерДокумента)
	...
	РегламентированнаяОтчетностьКлиентСервер.ПроверитьИмяФайла(ИмяФайла);
	РегламентированнаяОтчетностьКлиентСервер.ПроверитьПолноеИмяВременногоФайла(
		РабочийКаталог, "РабочийКаталог", "ИзвлечьСведенияИзЗашифрованногоПакета");
