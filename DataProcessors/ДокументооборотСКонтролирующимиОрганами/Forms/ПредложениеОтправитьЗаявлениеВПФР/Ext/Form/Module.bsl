...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.НастройкаМашиночитаемыхДоверенностейДляПФР.Видимость =
		ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Исп.МЧД для ЕЦП", Истина);
...
&НаКлиенте
Процедура НастройкаМашиночитаемыхДоверенностейДляПФРПриОжиданииНажатие(Элемент)
...
Процедура ИзменитьОформлениеСтраницыОжидаетсяРезультатРассмотрения(Форма)
	...
	Элементы.НастройкаМашиночитаемыхДоверенностейДляПФРПриОжидании.Видимость = НЕ Форма.ЭтоПредупреждениеИзОтправки;
