...
Процедура СформироватьТаблицу()
	...
	Запрос.Текст = 
		...
		|			ИЛИ ЖурналОтчетовСтатусы.Статус = &СтатусСданоТребуетУточнения)
	...
	Запрос.УстановитьПараметр("СтатусСданоТребуетУточнения", ДокументооборотСКОКлиентСервер.СтатусСданоТребуетУточнения());
