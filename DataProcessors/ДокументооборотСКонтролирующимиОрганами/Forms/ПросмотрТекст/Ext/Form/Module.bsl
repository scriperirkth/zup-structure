...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипСодержимого = Тип("ДвоичныеДанные") Тогда
		РегламентированнаяОтчетностьКлиентСервер.ПроверитьИмяФайла(Параметры.ИмяФайла);
		...
		Если НЕ Параметры.Свойство("КодировкаТекста") ИЛИ НЕ ЗначениеЗаполнено(Параметры.КодировкаТекста) Тогда
			Если ВРЕГ(Лев(Параметры.ИмяФайла, 4)) = "ПФР_" ИЛИ ВРЕГ(Лев(Параметры.ИмяФайла, 4)) = "СФР_" Тогда
				//@skip-check 1c-fresh-audit
