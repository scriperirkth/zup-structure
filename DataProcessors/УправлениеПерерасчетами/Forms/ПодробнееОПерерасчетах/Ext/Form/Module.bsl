...
Процедура ПрочитатьПерерасчеты()
	...
	Запрос.Текст =
		...
		|	ПерерасчетЗарплаты.Основание.Дата КАК Дата,
		|	ПерерасчетЗарплаты.Основание.Ссылка КАК Ссылка
		|ИЗ
		...
		|
		|ВЫБРАТЬ РАЗЛИЧНЫЕ
		|	ПерерасчетДоговоров.Основание,
		|	ПерерасчетДоговоров.Основание.Дата,
		|	ПерерасчетДоговоров.Основание.Ссылка
		|ИЗ
		|	РегистрСведений.ПерерасчетДоговоров КАК ПерерасчетДоговоров
		|ГДЕ
		|	ПерерасчетДоговоров.Сотрудник = &Сотрудник
