...
Функция СтруктураОтбора()
	...
	// Функция ИнтеграцияС1СДокументооборот3КлиентСервер.ПредставлениеТипаОбъектаXDTO не используется, т.к. тут
	// заполняются синонимы реквизитов на форме, а не представления объектов ДО.
