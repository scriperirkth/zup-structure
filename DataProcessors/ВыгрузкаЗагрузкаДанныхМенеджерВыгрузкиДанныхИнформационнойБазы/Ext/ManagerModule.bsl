...
Функция НовыеПараметрыПроцессаВыгрузкиДанныхИнформационнойБазы(
	...
	Иначе
		...
		УзлыРК = ПолучитьУзлыРезервногоКопирования(Контейнер, ИсключаемыеТипы);
		...
		ПараметрыПроцессаВыгрузки.Вставить("ОсновнойУзел", УзлыРК.ОсновнойУзел);
		ПараметрыПроцессаВыгрузки.Вставить("ДополнительныйУзел", УзлыРК.ДополнительныйУзел);
...
Функция ПолучитьУзлыРезервногоКопирования(Контейнер, ИсключаемыеТипы)
	...
	//   - без монопольного режима: сначала выгружаются все данные, потом из дополнительного узла.
	...
	Если Не РаботаВМоделиСервиса.УстановленМонопольныйРежим() Тогда
