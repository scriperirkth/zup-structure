...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого Элемент Из Параметры.КоллекцияОшибок Цикл
		...
		Если ЗначениеЗаполнено(ЗначениеРеквизитов.Банк) Тогда
			ДанныеНастройки.НаименованиеБанка = ОбменСБанкамиСлужебный.НаименованиеБанка(ЗначениеРеквизитов.Банк);
		КонецЕсли;
		...
		Если ЗначениеРеквизитов.ПрограммаБанка = Перечисления.ПрограммыБанка.СбербанкОнлайн Тогда
			...
			ОбменСБанкамиСлужебный.ОбработатьОшибку(НСтр("ru = 'Ошибка сетевой доступности при обращении к серверу банка'"),
				НастройкиПоТипамОшибок.ТипОшибки.КраткоеПредставлениеТипаОшибки, "", Элемент.НастройкаОбмена);
