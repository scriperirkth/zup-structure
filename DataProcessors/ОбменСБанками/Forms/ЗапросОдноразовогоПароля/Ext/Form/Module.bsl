...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("НастройкаОбмена") 
		И ЗначениеЗаполнено(Параметры.НастройкаОбмена) Тогда
		
		Банк = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Параметры.НастройкаОбмена, "Банк");
		Если ЗначениеЗаполнено(Банк) Тогда
			НаименованиеБанка = ОбменСБанкамиСлужебный.НаименованиеБанка(Банк);
			Элементы.ДекорацияНаименованиеБанка.Заголовок = НаименованиеБанка;
			Элементы.ДекорацияНаименованиеБанка.Видимость = Истина;
		КонецЕсли;
	КонецЕсли;
