...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИмяСобытия = НСтр("ru = '%1.Журнал'", ОбщегоНазначения.КодОсновногоЯзыка());
	ИмяСобытия = СтрШаблон(ИмяСобытия, ОбменСБанками.ИмяСобытияЖурналаРегистрации());
	...
	Если ОбменСБанкамиДепозитыСлужебный.НастройкаПоддерживаетОбменДепозитами(Параметры.НастройкаОбмена) Тогда
		
		РеквизитыНастройкиОбмена = Новый Структура("Банк");
		...
		СписокОтбора.Добавить(Параметры.НастройкаОбмена);
		СписокОтбора.Добавить(РеквизитыНастройкиОбмена.Банк);
		ОтборЖурналаРегистрации.Вставить("Данные", СписокОтбора);
