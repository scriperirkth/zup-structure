...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗначенияРеквизитовНастройки = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(НастройкаОбмена,
		"Банк, ПрограммаБанка, ИмяПользователя");
	
	НаименованиеБанка = ОбменСБанкамиСлужебный.НаименованиеБанка(ЗначенияРеквизитовНастройки.Банк);
	Элементы.ДекорацияНаименованиеБанка.Заголовок = НаименованиеБанка;
...
&НаКлиенте
Процедура ПарольАвторизацииНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	
	ОбменСБанкамиСлужебныйКлиент.ОтобразитьСекретныеДанные(ЭтотОбъект, Элемент, "ПарольПользователя",
