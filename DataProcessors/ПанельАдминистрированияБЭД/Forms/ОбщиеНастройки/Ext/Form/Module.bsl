...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЕстьОбменСКонтрагентами Тогда
		...
		Элементы.ГруппаИспользоватьВнутренниеДокументы.Видимость = 
			МодульИнтеграцияЭДО.ДоступноИспользованиеВнутреннегоЭДО();
			
		Если МодульНастройкиЭДО.ИспользуетсяОбменБезПриглашений() Тогда
			
			Элементы.Константа_СоздаватьКонтрагентовАвтоматически.Доступность = Ложь;
			Элементы.Константа_СоздаватьКонтрагентовАвтоматически.Подсказка = 
				НСтр("ru = 'При обмене без приглашений, контрагенты создаются автоматически'");
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыСервисыДоставки
