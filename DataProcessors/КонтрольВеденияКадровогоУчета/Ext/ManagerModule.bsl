...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ПроверкаНаличияСтатусаФизическихЛицКакНалогоплательщиковНДФЛ");
	Методы.Вставить("ПроверкаЗаполненностиПола");
	Методы.Вставить("ПроверкаНаличияСтатусаЗастрахованныхФизическихЛиц");
	Методы.Вставить("ПроверкаЗаполненностиПаспортныхДанных");
	Методы.Вставить("ПроверкаЗаполненностиИНН");
	Методы.Вставить("ПроверитьКорректностьВидовЗанятостиСотрудников");
	Методы.Вставить("ПроверкаЗаполненностиСНИЛС");
	Методы.Вставить("ПроверкаПоследовательностиКадровыхСобытийСотрудников");
	Методы.Вставить("ПроверкаЗаполненностиДатыРождения");
	Методы.Вставить("ПроверкаЗаполненностиГражданства");
	Методы.Вставить("ПроверкаАктуальностиПаспортныхДанных");
	Методы.Вставить("ПроверкаПроведенияИлиУдаленияДокументов");
КонецПроцедуры
