...
Функция АттестационныеЛистыМедицинскихРаботников(ПриказыОбАттестации, ОбъектыПечати) Экспорт
	...
	ВсеОбразованияФизическихЛиц = Обработки.ПечатьФормАттестацииСотрудников.ОбразованияФизическихЛицДляПечатиАттестационногоЛистаПодтверждениеКвалификации(МенеджерВременныхТаблиц);
	...
	Пока ДанныеДляПечати.Следующий() Цикл
		...
		КомплектДанных = КомплектДанныхДляПечатиАттестационногоЛистаПодтверждениеКвалификации(ДанныеДляПечати, ВсеОбразованияФизическихЛиц, ТрудоваяДеятельностьФизическихЛиц, СпециальностиФизическихЛиц, СоставыКомиссий);
...
Функция КомплектДанныхДляПечатиАттестационногоЛистаПодтверждениеКвалификации(ДанныеДляПечати, ВсеОбразованияФизическихЛиц, ТрудоваяДеятельностьФизическихЛиц, СпециальностиФизическихЛиц, СоставыКомиссий)
	...
	КомплектДанных.Вставить("ДанныеДляПечати", 						ДанныеДляПечати);
	КомплектДанных.Вставить("ОбразованияФизическогоЛица", 			ВсеОбразованияФизическихЛиц.НайтиСтроки(Отбор));
