...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, Параметры, 
		"Заголовок, ФизическоеЛицо, ЗакрыватьПриЗакрытииВладельца");
...
Процедура НачатьОтправкуСотрудника()
	...
	ДлительнаяОперация = НачатьОтправкуСотрудникаНаСервере(
		УникальныйИдентификатор, СистемаБронирования, ФизическоеЛицо);
...
Процедура НачатьПолучениеДанныхСтатусаОтправкиСотрудникаПоУсловию()
	...
	ДлительнаяОперация = НачатьПолучениеДанныхСтатусаОтправкиСотрудникаПоУсловиюНаСервере(УникальныйИдентификатор, ФизическоеЛицо, 
		СистемаБронирования);
