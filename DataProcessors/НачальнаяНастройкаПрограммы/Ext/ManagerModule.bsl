...
Функция ПечатнаяФормаНачальнаяНастройкаПрограммы(ЗаголовокСписка, ОбъектыПечати)
	...
	// настройки программы
	НастройкиПриложения = ДанныеДляПечати.НастройкиПриложения;
	...
	НачальнаяНастройкаПрограммы.ВывестиНастройкиПрограммы(НастройкиПриложения, ТабДокумент);
	
	// Штатное расписание и кадровый учет.
	НастройкиШтатногоРасписания = НастройкиПриложения.НастройкиШтатногоРасписания;
	ЗаполнитьЗначенияСвойств(ОбластьКадровыйУчетШтатноеРасписание.Параметры, НастройкиШтатногоРасписания);
	
	НастройкиКадровогоУчета = НастройкиПриложения.НастройкиКадровогоУчета;
	...
	// Воинский учет
	НастройкиВоинскогоУчета = НастройкиПриложения.НастройкиВоинскогоУчета;
	...
	НастройкиЗаймовСотрудникам = НастройкиПриложения.НастройкиЗаймовСотрудникам;
	ЗаполнитьЗначенияСвойств(ОбластьНастройкиРасчетаЗарплаты.Параметры, НастройкиЗаймовСотрудникам);
	
	НастройкиРасчетаЗарплаты = НастройкиПриложения.НастройкиРасчетаЗарплаты;
	...
	НастройкиУчетаВремени = НастройкиПриложения.НастройкиУчетаВремени;
...
Функция ПолучитьДанныеОНачальныхНастройках()
	...
	НастройкиПриложения.Вставить("НастройкиШтатногоРасписания", СтруктураНастроек);
	...
	НастройкиПриложения.Вставить("НастройкиКадровогоУчета", СтруктураНастроек);
	...
	НастройкиПриложения.Вставить("НастройкиВоинскогоУчета", СтруктураНастроек);
	...
	НастройкиПриложения.Вставить("НастройкиЗаймовСотрудникам", СтруктураНастроек);
	...
	НастройкиПриложения.Вставить("НастройкиРасчетаЗарплаты", СтруктураНастроек);
	...
	НастройкиПриложения.Вставить("НастройкиУчетаВремени", СтруктураНастроек);
	
	НачальнаяНастройкаПрограммы.ПолучитьНастройкиПрограммы(НастройкиПриложения);
	
	ДанныеОНастройках.НастройкиПриложения = НастройкиПриложения;
