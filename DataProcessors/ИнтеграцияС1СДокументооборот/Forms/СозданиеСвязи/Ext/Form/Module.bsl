...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТипыXDTO.Добавить("DMInternalDocument");
	ТипыXDTO.Добавить("DMIncomingDocument");
	ТипыXDTO.Добавить("DMOutgoingDocument");
	
	Для Каждого ТипXDTO Из ТипыXDTO Цикл
		СтрокаЭлемент = ЭлементыГруппы.Добавить();
		СтрокаЭлемент.Тип = ТипXDTO;
		СтрокаЭлемент.Представление = ИнтеграцияС1СДокументооборотКлиентСервер.ПредставлениеТипаОбъектаXDTO(ТипXDTO);
	КонецЦикла;
