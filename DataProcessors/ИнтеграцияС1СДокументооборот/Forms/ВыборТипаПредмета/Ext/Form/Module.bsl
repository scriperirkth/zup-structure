...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ДоступноДобавлениеДругихПредметов Тогда
		...
		ДобавитьСтроку(ЗаголовокДО, "DMFile");
		ДобавитьСтроку(ЗаголовокДО, "DMInternalDocument");
		ДобавитьСтроку(ЗаголовокДО, "DMIncomingDocument");
		ДобавитьСтроку(ЗаголовокДО, "DMOutgoingDocument");
		Если ИнтеграцияС1СДокументооборотБазоваяФункциональностьПовтИсп.ДоступенФункционалВерсииСервиса("1.3.2.3.CORP") Тогда
			ДобавитьСтроку(ЗаголовокДО, "DMProject");
		КонецЕсли;
		ДобавитьСтроку(ЗаголовокДО, "DMCorrespondent");
...
Функция ДобавитьСтроку(Дерево, Вариант, Представление = "", Отбор = Неопределено)
	...
	Если Не ЗначениеЗаполнено(Представление) Тогда
		Представление = ИнтеграцияС1СДокументооборотКлиентСервер.ПредставлениеТипаОбъектаXDTO(Вариант);
	КонецЕсли;
