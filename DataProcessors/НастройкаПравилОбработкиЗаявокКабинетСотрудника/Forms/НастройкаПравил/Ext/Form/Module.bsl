	...
	Иначе
		...
		Иначе
			...
			Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ОрганизационнаяСтруктура") Тогда
				...
				ПараметрыУточнения = МодульОрганизационнаяСтруктура.ПараметрыУточненияЗапросаПоСостояниюСтруктурыПредприятия();
				ПараметрыУточнения.ИмяПараметраДаты = "ДатаАктуальности";
				ПараметрыУточнения.ИмяПараметраПоказыватьРасформированные = "ПоказыватьРасформированные";
				МодульОрганизационнаяСтруктура.УточнитьЗапросПоСостояниюСтруктурыПредприятия(Запрос, ПараметрыУточнения);
			КонецЕсли;
		КонецЕсли;
