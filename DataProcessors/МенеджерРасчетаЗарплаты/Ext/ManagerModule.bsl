...
Функция ТаблицаПоказателей() Экспорт
	...
	Показатели.Колонки.Добавить("Дополнительно", Новый ОписаниеТипов("Структура"));
...
// Конструктор строки таблицы начислений по договорам коллекции типа Зарплата.НачисленияПоДоговорам.
//
// Параметры
//	ТаблицаНачислений - тип ТаблицаЗначений, таблица, в которой создается строка.
//		Должна быть создана конструктором ТаблицаНачислений().
//
Функция СтрокаТаблицыНачисленийПоДоговорам(ТаблицаНачислений) Экспорт
...
Функция ТаблицаНачислений() Экспорт
	...
	Начисления.Колонки.Добавить("ОтработаноЧасов", Новый ОписаниеТипов("Число", , , Новый КвалификаторыЧисла(6, 2)));
	Начисления.Колонки.Добавить("ОплаченоДней", Новый ОписаниеТипов("Число", , , Новый КвалификаторыЧисла(5, 2)));
	Начисления.Колонки.Добавить("ОплаченоЧасов", Новый ОписаниеТипов("Число", , , Новый КвалификаторыЧисла(6, 2)));
...
Функция ТаблицаНачисленияПоДоговорам() Экспорт
	...
	НачисленияПоДоговорам.Колонки.Добавить("СуммаВычетаДополнительная", ОписаниеТиповСуммаРезультат());
	НачисленияПоДоговорам.Колонки.Добавить("СкидкаПоВзносам", ОписаниеТиповСуммаРезультат());
	НачисленияПоДоговорам.Колонки.Добавить("ДокументОснование", ДоговорыГПХРасширенный.ОписаниеТиповДокументыДоговоры());
	...
	НачисленияПоДоговорам.Колонки.Добавить("Сторно", Новый ОписаниеТипов("Булево"));
	НачисленияПоДоговорам.Колонки.Добавить("ФиксСторно", Новый ОписаниеТипов("Булево"));
	НачисленияПоДоговорам.Колонки.Добавить("СторнируемыйДокумент", Документы.ТипВсеСсылки());
	
	НачисленияПоДоговорам.Колонки.Добавить("Владелец");
