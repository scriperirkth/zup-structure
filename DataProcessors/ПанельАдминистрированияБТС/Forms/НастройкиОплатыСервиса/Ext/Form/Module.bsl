...
&НаКлиенте
Процедура ПарольПользователяУчетнойСистемыПриИзменении(Элемент)
	
	ПарольПользователяУчетнойСистемыПриИзмененииНаСервере();
...
&НаСервере
Процедура ПарольПользователяУчетнойСистемыПриИзмененииНаСервере()
