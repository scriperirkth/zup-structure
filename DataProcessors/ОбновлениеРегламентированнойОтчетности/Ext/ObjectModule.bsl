...
Функция ПоискЭлементаПоРеквизитам(Наименование, Источник = "", ЭтоГруппа = Ложь)
	...
	Если ЭтоГруппа Тогда
		НайденнаяГруппа = НайтиГруппуСправочникаОтчетовПоНаименованию(Наименование);
...
Функция НайтиГруппуСправочникаОтчетовПоНаименованию(Наименование)
	...
	Запрос.Текст =
		...
		|	И РегламентированныеОтчеты.Наименование = &Наименование";
