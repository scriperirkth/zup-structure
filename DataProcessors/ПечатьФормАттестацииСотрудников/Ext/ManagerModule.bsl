...
Функция АттестационныеЛистыПодтверждениеКвалификации(ПриказыОбАттестации, ОбъектыПечати)
	...
	СоставыКомиссий = АттестацииСотрудников.СоставыАттестационныхКомиссийПриказовОбАттестации(ПриказыОбАттестации);
	ОбразованияФизическихЛицДляПечати = ОбразованияФизическихЛицДляПечатиАттестационногоЛистаПодтверждениеКвалификации(МенеджерВременныхТаблиц);
	ТрудоваяДеятельностьФизическихЛицДляПечати = ТрудоваяДеятельностьФизическихЛицДляПечатиАттестационногоЛистаПодтверждениеКвалификации(МенеджерВременныхТаблиц);
	СпециальностиФизическихЛицДляПечати = СпециальностиФизическихЛицДляПечатиАттестационногоЛистаПодтверждениеКвалификации(МенеджерВременныхТаблиц);
	...
	Пока ДанныеДляПечати.Следующий() Цикл
		...
		КомплектДанных = КомплектДанныхДляПечатиАттестационногоЛистаПодтверждениеКвалификации(ДанныеДляПечати, ОбразованияФизическихЛицДляПечати, 
				ТрудоваяДеятельностьФизическихЛицДляПечати, СпециальностиФизическихЛицДляПечати, СоставыКомиссий);
