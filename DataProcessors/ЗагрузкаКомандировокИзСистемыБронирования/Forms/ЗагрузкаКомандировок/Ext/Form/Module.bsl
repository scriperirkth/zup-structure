...
Функция ЗагрузитьНовыеПоездкиНаСервере()
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("БронированиеКомандировокКорпоративный.ЗагрузитьНовыеПоездкиДлительнаяОперация", ПараметрыПроцедуры, ПараметрыВыполнения);
...
Функция ЗагрузитьПоездкиЗаПериодНаСервере(Период)
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("БронированиеКомандировокКорпоративный.ЗагрузитьПоездкиЗаПериодДлительнаяОперация", ПараметрыПроцедуры, ПараметрыВыполнения);
...
Функция СформироватьПриказыНаСервере()
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("БронированиеКомандировокКорпоративный.СформироватьПриказыДлительнаяОперация", ПараметрыПроцедуры, ПараметрыВыполнения);
...
Процедура ЗаписатьВерсиюПоследнегоЗаказа()
	...
	БронированиеКомандировокКорпоративный.ЗаписатьВерсиюПоследнегоЗаказа(Версия, СистемаБронирования, Организация);
