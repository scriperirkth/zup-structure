...
Функция ЗаписьСоответствуетОтборуРазовыхНачисленийРегистратору(РассчитываемаяЗапись, БазоваяЗапись)
	...
	Если ЗависимостиКаскадногоРасчета <> Неопределено
		И ЗависимостиКаскадногоРасчета[РассчитываемаяЗапись.ВидРасчета] <> Неопределено
		И КэшТребованияНормируемыхПоВремениНачислений <> Неопределено Тогда
		ВидРасчетаИнфо = КэшТребованияНормируемыхПоВремениНачислений[РассчитываемаяЗапись.ВидРасчета];
		Возврат ВидРасчетаИнфо <> Неопределено
