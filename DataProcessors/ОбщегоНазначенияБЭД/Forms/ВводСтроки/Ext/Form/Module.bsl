...
Процедура ПриОткрытии(Отказ)
	Если ЗначениеЗаполнено(Строка) Тогда
		...
		Элементы.Строка.УстановитьГраницыВыделения(ДлинаСтроки + 1, ДлинаСтроки + 1);
	КонецЕсли;
КонецПроцедуры
...
Процедура Инициализировать()
	...
	Если ЗначениеЗаполнено(Параметры.ДополнительноеОписание) Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ДополнительноеОписание",
			"Высота", Параметры.КоличествоСтрокДополнительногоОписания);
	...
	Элементы.Строка.АвтоОтметкаНезаполненного = Обязательность;
