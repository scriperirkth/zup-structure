...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ЗаписатьНастройки", Истина);
КонецПроцедуры
...
Функция СтруктураПараметровНастроек() Экспорт
	...
	ПараметрыНастроек.Вставить("ПрекращатьДополнительныеОтпускаПриПриостановкеТрудовогоДоговора", Ложь);
	ПараметрыНастроек.Вставить("ПересчитыватьПродолжительностьВидовОтпусковПриИсправленииОтпуска", Ложь);
	...
	ПараметрыНастроек.Вставить("ИспользоватьНаставничество", Ложь);
	...
	ПараметрыНастроек.Вставить("ИспользоватьБронированиеКомандировок", Ложь);
	...
	|ИспользоватьОбразовательныеСертификаты,
	|КонтролироватьОстаткиПоказателейДПО");
	...
	|ПрекращатьДополнительныеОтпускаПриПриостановкеТрудовогоДоговора,
...
Процедура ЗаписатьНастройки(Параметры, АдресХранилища) Экспорт
	...
	Если ПараметрыНастроек.ПрекращатьДополнительныеОтпускаПриПриостановкеТрудовогоДоговора Тогда
		Константы.ПрекращатьДополнительныеОтпускаПриПриостановкеТрудовогоДоговора.Установить(Параметры.ПрекращатьДополнительныеОтпускаПриПриостановкеТрудовогоДоговора);
	КонецЕсли;
	
	Если ПараметрыНастроек.ПересчитыватьПродолжительностьВидовОтпусковПриИсправленииОтпуска Тогда
		Константы.ПересчитыватьПродолжительностьВидовОтпусковПриИсправленииОтпуска.Установить(Параметры.ПересчитыватьПродолжительностьВидовОтпусковПриИсправленииОтпуска);
	КонецЕсли;
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ГосударственнаяСлужба") Тогда
		...
		Если ПараметрыНастроек.НастройкиГосслужбы Тогда
			...
			Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ОбучениеРазвитие.ОбразованиеГосслужащих") Тогда
				Модуль = ОбщегоНазначения.ОбщийМодуль("ОбразованиеГосслужащих");
				Модуль.ЗаписатьНастройкиОбразованиеГосслужащих(Параметры.НастройкиГосслужбы);
			КонецЕсли;
	...
	Если ПараметрыНастроек.ИспользоватьБронированиеКомандировок Тогда
		Константы.ИспользоватьБронированиеКомандировок.Установить(
			Параметры.ИспользоватьБронированиеКомандировок);
	КонецЕсли;
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.Наставничество") Тогда 
		...
		МодульНаставничество.ПанельУправлениеПерсоналомЗаписатьНастройки(Параметры, ПараметрыНастроек);
	КонецЕсли;
