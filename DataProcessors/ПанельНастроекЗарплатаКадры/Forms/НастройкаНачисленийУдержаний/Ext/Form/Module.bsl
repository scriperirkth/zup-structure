...
Процедура ИспользоватьУчетВремениСотрудниковВЧасахПриИзменении(Элемент)
	...
	Если НастройкиРасчетаЗарплаты.ИспользоватьУчетВремениСотрудниковВЧасах Тогда
		...
		НастройкиРасчетаЗарплаты.ИспользоватьПодробныйВводВремениСверхурочных     = НастройкиРасчетаЗарплатыПрежняя.ИспользоватьПодробныйВводВремениСверхурочных;
	...
	Иначе
		...
		НастройкиРасчетаЗарплатыПрежняя.ИспользоватьПодробныйВводВремениСверхурочных     = НастройкиРасчетаЗарплаты.ИспользоватьПодробныйВводВремениСверхурочных;
		...
		НастройкиРасчетаЗарплаты.ИспользоватьПодробныйВводВремениСверхурочных	  = Ложь;
...
Процедура ИспользоватьОплатуСверхурочныхПриИзменении(Элемент)
	...
	ОбновитьДоступностьИспользоватьОтгулы(ЭтаФорма);
	ОбновитьДоступностьИспользоватьПодробныйВводВремениСверхурочных(ЭтаФорма);
...
Процедура ИспользоватьОплатуПраздничныхИВыходныхПриИзменении(Элемент)
	...
	ОбновитьДоступностьИспользоватьОтгулы(ЭтаФорма);
	ОбновитьДоступностьИспользоватьПодробныйВводВремениПраздничныхИВыходных(ЭтаФорма);
...
&НаКлиентеНаСервереБезКонтекста
Процедура ОбновитьДоступностьИспользоватьПодробныйВводВремениПраздничныхИВыходных(Форма)
	
	НастройкаДоступна = Форма.НастройкиРасчетаЗарплаты.ИспользоватьОплатуПраздничныхИВыходных;
	
	Форма.Элементы.ИспользоватьПодробныйВводВремениПраздничныхИВыходных.Доступность = НастройкаДоступна;
	
	Если НастройкаДоступна Тогда
		Форма.НастройкиРасчетаЗарплаты.ИспользоватьПодробныйВводВремениПраздничныхИВыходных = Форма.НастройкиРасчетаЗарплатыПрежняя.ИспользоватьПодробныйВводВремениПраздничныхИВыходных;
	Иначе
		Форма.НастройкиРасчетаЗарплатыПрежняя.ИспользоватьПодробныйВводВремениПраздничныхИВыходных = Форма.НастройкиРасчетаЗарплаты.ИспользоватьПодробныйВводВремениПраздничныхИВыходных;
		Форма.НастройкиРасчетаЗарплаты.ИспользоватьПодробныйВводВремениПраздничныхИВыходных = Ложь;
	КонецЕсли;
	
КонецПроцедуры

&НаКлиентеНаСервереБезКонтекста
Процедура ОбновитьДоступностьИспользоватьПодробныйВводВремениСверхурочных(Форма)
	
	НастройкаДоступна = Форма.НастройкиРасчетаЗарплаты.ИспользоватьОплатуСверхурочных;
	
	Форма.Элементы.ИспользоватьПодробныйВводВремениСверхурочных.Доступность = НастройкаДоступна;
	
	Если НастройкаДоступна Тогда
		Форма.НастройкиРасчетаЗарплаты.ИспользоватьПодробныйВводВремениСверхурочных = Форма.НастройкиРасчетаЗарплатыПрежняя.ИспользоватьПодробныйВводВремениСверхурочных;
	Иначе
		Форма.НастройкиРасчетаЗарплатыПрежняя.ИспользоватьПодробныйВводВремениСверхурочных = Форма.НастройкиРасчетаЗарплаты.ИспользоватьПодробныйВводВремениСверхурочных;
		Форма.НастройкиРасчетаЗарплаты.ИспользоватьПодробныйВводВремениСверхурочных = Ложь;
	КонецЕсли;
...
Процедура ОбновитьФормуПриИзмененииУчетаВремени(Форма)
	...
	Элементы.ГруппаСверхурочные.Доступность = ИспользоватьУчетВремени;
