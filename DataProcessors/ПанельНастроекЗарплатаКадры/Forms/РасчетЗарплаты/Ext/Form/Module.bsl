...
Процедура ОбновитьФормуПоНастройкам(ПрочиеНастройки)
	...
	Если ЗарплатаКадры.ЭтоБазоваяВерсияКонфигурации() Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
					Элементы,
					"ГруппаРассчитыватьВзысканныеСуммыПропорциональноВыплате",
					"Видимость",
					Ложь);
...
&НаКлиенте
Процедура РассчитыватьВзысканныеСуммыПропорциональноВыплатеПриИзменении(Элемент) 
	
	НастройкиРасчетаЗарплаты.РассчитыватьВзысканныеСуммыПропорциональноВыплате = РассчитыватьВзысканныеСуммыПропорциональноВыплате;
	НастройкиРасчетаЗарплатыПрежняя.РассчитыватьВзысканныеСуммыПропорциональноВыплате = НастройкиРасчетаЗарплаты.РассчитыватьВзысканныеСуммыПропорциональноВыплате;
...
Процедура ПрочитатьНастройки()
	...
	СтрокаСвойствНастройкиРасчетаЗарплаты = "ИспользоватьВыплатыБывшимСотрудникам,ИспользоватьИндексациюЗаработка,
		...
		|СчитатьКомпенсациюЗаЗадержкуЗарплатыОблагаемымНДФЛДоходом,РассчитыватьВзысканныеСуммыПропорциональноВыплате,
