...
// Очищает количество попыток отправки для выбранных сообщений.
//
// Параметры:
//   СписокВыбранныхСообщений - Массив из РегистрСведенийКлючЗаписи.ОчередьСообщенийВ1СДокументооборот
//
&НаСервере
