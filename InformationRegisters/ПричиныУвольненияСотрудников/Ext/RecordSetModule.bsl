...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Сотрудники = РегистрыБЗК.ЗначенияОтбораЗаписейНабора(ЭтотОбъект, Замещение, "Сотрудник");
	Если Сотрудники.Количество() <> 0 Тогда
		Отбор.ФизическоеЛицо.Значение = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Сотрудники[0], "ФизическоеЛицо");
