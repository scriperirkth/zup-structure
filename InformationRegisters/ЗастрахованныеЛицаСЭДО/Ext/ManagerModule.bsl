...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("АдаптироватьКУчетуСтрахователей");
	Методы.Вставить("ДобавитьПринятыхДо2022ГодаНеТребующихОтправки");
	Методы.Вставить("ДобавитьПринятыхС2022ГодаТребующихОтправки");
КонецПроцедуры
