...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	ДополнительныеСвойства.Вставить("РегистраторыЗаписываемогоНабора", Регистраторы);
	...
	|ГДЕ
	|	ПараметрыПериодовСтажаПФР.Регистратор В (&Регистраторы)";
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	ДополнительныеСвойства.Свойство("РегистраторыЗаписываемогоНабора", Регистраторы);
	...
	|		РегистрСведений.ПараметрыПериодовСтажаПФР КАК ПараметрыПериодовСтажаПФР
	|	ГДЕ
	|		ПараметрыПериодовСтажаПФР.Регистратор В (&Регистраторы)) КАК СравнениеСПредыдущимНабором
	|
	|СГРУППИРОВАТЬ ПО
	|	СравнениеСПредыдущимНабором.ФизическоеЛицо,
	|	СравнениеСПредыдущимНабором.ТипДоговора,
