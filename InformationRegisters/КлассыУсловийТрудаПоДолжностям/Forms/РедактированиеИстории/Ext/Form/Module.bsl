...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтоУсловияТруда = КлассыУсловийТруда.ВладелецНабораЗаписейЭтоУсловияТруда(ОбъектВладелец);
	Если ЭтоУсловияТруда Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы, "НаборЗаписейВыявленыВредныеОпасныеФакторы", "Видимость", Ложь);
	Иначе
		КлассыУсловийТруда.УстановитьУсловноеОформлениеФлагаВредныхФакторов(
			УсловноеОформление, "НаборЗаписей.КлассУсловийТруда", "НаборЗаписейВыявленыВредныеОпасныеФакторы");
	КонецЕсли;
...
&НаКлиенте
Процедура НаборЗаписейКлассУсловийТрудаПриИзменении(Элемент)
