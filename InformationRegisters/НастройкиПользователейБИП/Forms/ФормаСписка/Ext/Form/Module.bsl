...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РольДоступнаПолныеПрава = ОбработкаНовостейПовтИсп.ЕстьРольПолныеПрава();
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если РольДоступнаПолныеПрава = Истина Тогда
...
Процедура СформироватьПредставлениеНастройкиПросмотраНовостей()
	...
	Если Элементы.Список.ТекущиеДанные <> Неопределено Тогда
		...
		КонецЕсли;
		ПредставлениеНастройкиПросмотраНовостей = Результат;
