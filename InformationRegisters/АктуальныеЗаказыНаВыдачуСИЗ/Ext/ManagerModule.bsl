...
Функция РеквизитГоловнаяОрганизация() Экспорт
	Возврат Метаданные.РегистрыСведений.АктуальныеЗаказыНаВыдачуСИЗ.Измерения.ГоловнаяОрганизация.Имя;
КонецФункции

Функция РеквизитФизическоеЛицо() Экспорт
	Возврат Метаданные.РегистрыСведений.АктуальныеЗаказыНаВыдачуСИЗ.Измерения.ФизическоеЛицо.Имя;
КонецФункции
