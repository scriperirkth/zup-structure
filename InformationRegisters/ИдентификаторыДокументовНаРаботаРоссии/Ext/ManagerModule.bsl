...
Функция ИдентификаторДокумента(ПрисоединенныйФайл) Экспорт
	...
	Запрос.Текст =
		...
		|ИЗ
		|	РегистрСведений.ИдентификаторыДокументовНаРаботаРоссии КАК ТаблицаРегистра
		|ГДЕ
...
Функция ДокументПоИдентификатору(Идентификатор) Экспорт
	...
	Запрос.Текст =
		"ВЫБРАТЬ
		|	ИдентификаторыДокументовНаРаботаРоссии.ПрисоединенныйФайл КАК ПрисоединенныйФайл
		|ИЗ
		|	РегистрСведений.ИдентификаторыДокументовНаРаботаРоссии КАК ИдентификаторыДокументовНаРаботаРоссии
		|ГДЕ
		|	ИдентификаторыДокументовНаРаботаРоссии.Идентификатор = &ИдентификаторПРР";
...
Процедура ЗапомнитьИдентификатор(ПрисоединенныйФайл, Идентификатор) Экспорт
	...
	Запись = РегистрыСведений.ИдентификаторыДокументовНаРаботаРоссии.СоздатьМенеджерЗаписи();
