...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	МодульОбщегоНазначния = ОбщегоНазначения.ОбщийМодуль("ОбщегоНазначения");
	Попытка
		ЭтоУдалениеНабораЗаписей = МодульОбщегоНазначния.ЭтоУдалениеНабораЗаписей(Замещение);
	Исключение
		ЭтоУдалениеНабораЗаписей = Ложь;
	КонецПопытки;
	
	Если ЭтоУдалениеНабораЗаписей Тогда
		Возврат;
	КонецЕсли;
