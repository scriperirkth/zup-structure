...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ЗаполнитьВариантПодписания");
	Методы.Вставить("СоздатьНедостающиеВидыДокументов");
	Методы.Вставить("ЗаполнитьНастройки");
	Методы.Вставить("ОбновитьИдентификаторПечатнойФормыСогласияНаПрисоединениеКЭДОБЗК");
КонецПроцедуры
