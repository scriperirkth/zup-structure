...
Процедура ОбновитьДанныеДляПодбораСотрудников(Сотрудники, ОтключитьБизнесЛогику = Ложь, ДополнительныеСвойства = Неопределено) Экспорт
	...
	Запрос.Текст =
		...
		|	НЕОПРЕДЕЛЕНО КАК МестоВСтруктуреПредприятия,
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ОрганизационнаяСтруктура") Тогда
		...
		МодульОрганизационнаяСтруктура.ДополнитьКадровуюИсториюМестамиВСтруктуреПредприятия(Запрос);
	КонецЕсли;
	...
	Запрос.Текст =
		...
		|	РегистрСведений.МестоВСтруктуреПредприятия КАК МестоВСтруктуреПредприятия,
		|	РегистрСведений.КоличествоСтавок КАК КоличествоСтавок,
		...
		|					ТОГДА ИСТИНА
		|				КОГДА РегистрСведений.МестоВСтруктуреПредприятия <> РегистрСведенийПоследующие.МестоВСтруктуреПредприятия
		|					ТОГДА ИСТИНА
		...
		|	РегистрСведений.МестоВСтруктуреПредприятия,
		...
		|	РегистрСведенийСПоследующимиПериодами.МестоВСтруктуреПредприятия КАК МестоВСтруктуреПредприятия,
		...
		|	РегистрСведенийСПоследующимиПериодами.МестоВСтруктуреПредприятия,
	...
	Запрос.Текст =
		...
		|	РегистрСведенийСПериодами.МестоВСтруктуреПредприятия КАК МестоВСтруктуреПредприятия,
		...
		|			И РегистрСведенийСПериодами.МестоВСтруктуреПредприятия = РегистрСведенийПериодПоследнейЗаписи.МестоВСтруктуреПредприятия
		...
		|			И РегистрСведенийСПериодами.МестоВСтруктуреПредприятия = РегистрСведенийНачалоСобытия.МестоВСтруктуреПредприятия
		...
		|			И НаборыЗаписей.МестоВСтруктуреПредприятия = ДанныеДляПодбора.МестоВСтруктуреПредприятия
		|ГДЕ
		|	ВЫБОР
		...
		|	НаборыЗаписей.МестоВСтруктуреПредприятия КАК МестоВСтруктуреПредприятия,
		|	ВЫБОР
