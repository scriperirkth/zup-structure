...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	СоздатьВТВТИзменениямГрафиков(ЭтотОбъект, Замещение);
КонецПроцедуры	
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	Для Каждого ОтборЗаписей Из ОтборыЗаписейНабора Цикл
		Если Не ОтборЗаписей.ГрафикРаботыСотрудников_Использование
			Или ТипЗнч(ОтборЗаписей.ГрафикРаботыСотрудников) <> Тип("СправочникСсылка.ГрафикиРаботыСотрудников") Тогда
			Продолжить;
		КонецЕсли;
		Если ЗначениеЗаполнено(ОтборЗаписей.Год) Тогда
			ГодОбновляемыхДанных = ОтборЗаписей.Год;
		Иначе
			ГодОбновляемыхДанных = Неопределено;
		КонецЕсли;
		РежимРаботы = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ОтборЗаписей.ГрафикРаботыСотрудников, "РежимРаботы");
...
Процедура СоздатьВТВТИзменениямГрафиков(НаборЗаписей, Замещение)
	...
	ГрафикРаботыСотрудников = Неопределено;
	ГрафикРаботыСотрудников_Использование = Неопределено;
	Год = Неопределено;
	Год_Использование = Неопределено;
	Для Каждого ОтборНабора Из ОтборНаборов Цикл
		
		ГрафикРаботыСотрудников_Использование = ОтборНабора["ГрафикРаботыСотрудников_Использование"];
		ГрафикРаботыСотрудников = ОтборНабора["ГрафикРаботыСотрудников"];
		
		Год_Использование = ОтборНабора["Год_Использование"];
		Год = ОтборНабора["Год"];
		
	КонецЦикла;
	
	Если ГрафикРаботыСотрудников_Использование
		И Год_Использование Тогда
