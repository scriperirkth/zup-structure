...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ИзменитьСтатусыНеОтправлявшихсяРеглОтчетов");
	Методы.Вставить("ИзменитьВидИКодКонтролирующегоОрганаПодтвержденийВидаДеятельности");
	...
	Методы.Вставить("ИзменитьВидКонтролирующегоОрганаСоответствийУсловийТруда");
	Методы.Вставить("ИзменитьНаименованияДекларацийПоАлкоголю");
	Методы.Вставить("ЗаполнитьИндексКартинкиРеглОтчетов");
	...
	Методы.Вставить("ИсправитьРеквизитыОтправкиСправокОРублевыхИВалютныхСчетах");
КонецПроцедуры
