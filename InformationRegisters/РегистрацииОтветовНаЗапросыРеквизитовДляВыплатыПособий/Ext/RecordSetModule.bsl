...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	Если ПринятыеОтветыНаЗапросы.Количество() > 0 Тогда
		...
		Запрос.Текст =
		"ВЫБРАТЬ
		|	ЗапросРеквизитовДляВыплатыПособия.Ссылка КАК Ссылка
		|ИЗ
		|	Документ.ЗапросРеквизитовДляВыплатыПособия КАК ЗапросРеквизитовДляВыплатыПособия
		|ГДЕ
		|	ЗапросРеквизитовДляВыплатыПособия.ОтветНаЗапрос В(&ПринятыеОтветыНаЗапросы)
		|	И НЕ ЗапросРеквизитовДляВыплатыПособия.Обработан";
