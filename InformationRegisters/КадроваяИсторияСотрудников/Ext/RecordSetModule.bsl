...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	КадровыйУчет.КадроваяИсторияСотрудниковПриЗаписи(ЭтотОбъект, Отказ, Замещение);
	
	ИзменившиесяДанные = ТаблицаИзменившихсяДанныхНабора();
	КадровыйУчет.ОбработатьИзменениеОрганизацийВНаборе(ИзменившиесяДанные);
	ЭДОБЗК.ОтозватьСогласиеПриУвольнении(ЭтотОбъект, Замещение);
...
Процедура ОбновитьИнтервальныйРегистрСведений(Замещение)
	...
	ЗарплатаКадрыПериодическиеРегистры.СформироватьДвиженияИнтервальногоРегистраПоИзменениям(
		Метаданные.РегистрыСведений.КадроваяИсторияСотрудников.Имя, ЭтотОбъект, Замещение);
