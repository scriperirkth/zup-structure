...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Пользователь = РегистрыБЗК.ЗначенияОтбораЗаписейНабора(ЭтотОбъект, Замещение, "Пользователь")[0];
	...
	Если НеобходимоСкорректироватьНаборЗаписей() Тогда
		СкорректироватьНаборЗаписей(Замещение);
	КонецЕсли;
...
Процедура СкорректироватьНаборЗаписей(Замещение)
	...
	Пока ТребуетсяВнестиКоррективы Цикл
		...
		Записи = РегистрыБЗК.ЗаписиНабораИзБазыДанных(ЭтотОбъект, Замещение);
