...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	ИнтеграцияУправлениеПерсоналомСобытия.ПлановыеУдержанияПередЗаписью(ЭтотОбъект, Замещение);
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	ИнтеграцияУправлениеПерсоналомСобытия.ПлановыеУдержанияПриЗаписи(ЭтотОбъект, Замещение);
