...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	Если ТипЗнч(ЗначенияДоЗаписи) = Тип("ТаблицаЗначений") Тогда
		...
		ЗаполнитьКолонкуНайденаИТаблицуОбновления(ЭтотОбъект, Замещение, ЗначенияДоЗаписи, ТаблицаОбновления);
...
Процедура ЗаполнитьКолонкуНайденаИТаблицуОбновления(НаборЗаписей, Замещение, ЗначенияДоЗаписи, ТаблицаОбновления)
