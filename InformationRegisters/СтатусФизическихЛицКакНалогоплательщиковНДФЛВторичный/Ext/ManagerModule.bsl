...
Функция ВторичныеДанныеФизическогоЛица(ВыборкаПервичногоРегистра)
	...
	ДатаЗаконаЕАЭС = УчетНДФЛ.ДатаЗаконаПроРКиЕАЭС();
	...
	Для Каждого ЗаписьНабора Из ВторичныеДанные Цикл
		...
		Иначе 	
			РезидентРФНаКонецМесяца = Не (ЗаписьНабора.Статус = Справочники.СтатусыНалогоплательщиковПоНДФЛ.Нерезидент Или ЗаписьНабора.Статус = Справочники.СтатусыНалогоплательщиковПоНДФЛ.Иноагент);
		КонецЕсли;
	...
	Для Каждого ЗаписьНабора Из ВторичныеДанные Цикл
		...
		ИначеЕсли ЗаписьНабора.Статус = Справочники.СтатусыНалогоплательщиковПоНДФЛ.Резидент
			Или (ЗаписьНабора.ДатаНачала < ДатаЗаконаЕАЭС И ЗаписьНабора.Статус = Справочники.СтатусыНалогоплательщиковПоНДФЛ.ГражданинСтраныЕАЭС) Тогда
