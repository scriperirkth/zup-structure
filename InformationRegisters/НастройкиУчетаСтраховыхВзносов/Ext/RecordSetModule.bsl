...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	|	УточняемыеДанные.АвтоматическиДополнятьБазуРуководителя КАК АвтоматическиДополнятьБазуРуководителя,
	...
	|	ВЫБОР
	|		КОГДА УточняемыеДанные.Организация = УточняемыеДанные.Организация.ГоловнаяОрганизация
	|			ТОГДА УточняемыеДанные.АвтоматическиДополнятьБазуРуководителя
	|		ИНАЧЕ ЕСТЬNULL(НастройкиУчетаСтраховыхВзносов.АвтоматическиДополнятьБазуРуководителя, ЛОЖЬ)
	|	КОНЕЦ КАК АвтоматическиДополнятьБазуРуководителя,
	|	ВЫБОР
	|		КОГДА УточняемыеДанные.Организация = УточняемыеДанные.Организация.ГоловнаяОрганизация
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	|	НовыеДанные.АвтоматическиДополнятьБазуРуководителя КАК АвтоматическиДополнятьБазуРуководителя,
