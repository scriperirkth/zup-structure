...
Процедура ВключитьВозможностьРедактирования(Команда)
	ТолькоПросмотр = Ложь;
	Элементы.УведомлениеОбИзменении.Вид = ВидПоляФормы.ПолеВвода;
	Элементы.УведомлениеОбИзменении.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Авто;
	Элементы.УведомлениеОбОтсутствииОтвета.Вид = ВидПоляФормы.ПолеВвода;
	Элементы.УведомлениеОбОтсутствииОтвета.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Авто;
	ОбновитьЭлементыФормы();
КонецПроцедуры
...
Процедура ОбновитьЭлементыФормы()
	...
	Элементы.ВыплатаГруппа.Видимость = Не ТолькоПросмотр
		Или ЗначениеЗаполнено(Запись.ВыплатаСсылка)
		Или ЗначениеЗаполнено(Запись.ВыплатаСтатус);
	
	Элементы.ДоставкаТекстОшибки.Видимость = Не ТолькоПросмотр Или ЗначениеЗаполнено(Запись.ДоставкаТекстОшибки);
	Элементы.РегистрацияПротокол.Видимость = Не ТолькоПросмотр Или ЗначениеЗаполнено(Запись.РегистрацияПротокол);
	Элементы.РегистрацияИнформация.Видимость = Не ТолькоПросмотр Или ЗначениеЗаполнено(Запись.РегистрацияИнформация);
	
	Элементы.УведомлениеОбИзмененииВидУведомления.Видимость =
		ЗначениеЗаполнено(Запись.УведомлениеОбИзменении);
	Элементы.УведомлениеОбИзмененииГруппа.Видимость = Не ТолькоПросмотр
		Или ЗначениеЗаполнено(Запись.УведомлениеОбИзменении);
	Элементы.УведомлениеОбОтсутствииОтветаГруппа.Видимость = Не ТолькоПросмотр
		Или ЗначениеЗаполнено(Запись.УведомлениеОбОтсутствииОтвета);
