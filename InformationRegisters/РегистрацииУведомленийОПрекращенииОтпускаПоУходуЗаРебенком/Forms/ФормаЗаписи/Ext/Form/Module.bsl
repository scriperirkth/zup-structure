...
Процедура ОбновитьЭлементыФормы()
	...
	Элементы.ИдентификаторСтроки.Видимость = Не ТолькоПросмотр
		Или ЗначениеЗаполнено(Запись.ИдентификаторСтроки);
	Элементы.ДоставкаТекстОшибки.Видимость = Не ТолькоПросмотр
		Или ЗначениеЗаполнено(Запись.ДоставкаТекстОшибки);
	Элементы.РегистрацияТипСообщения.Видимость = Не ТолькоПросмотр
		Или ЗначениеЗаполнено(Запись.РегистрацияТипСообщения);
