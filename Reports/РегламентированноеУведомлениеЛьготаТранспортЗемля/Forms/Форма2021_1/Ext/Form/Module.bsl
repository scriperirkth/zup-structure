...
Процедура ЗагрузитьПодготовленныеДанные()
	...
	Для Каждого КЗ Из СтруктураДанных.Контейнер.Земля Цикл 
		...
		Если ОтбСтроки.Количество() = 0 Тогда
			ЛьготаДокументЗемля = ОбщегоНазначения.СкопироватьРекурсивно(СтраницаЛьготаДокументЗемля);
	...
	Для Каждого КЗ Из СтруктураДанных.Контейнер.Транспорт Цикл 
		...
		Если ОтбСтроки.Количество() = 0 Тогда
			ЛьготаДокументТранспорт = ОбщегоНазначения.СкопироватьРекурсивно(СтраницаЛьготаДокументТранспорт);
