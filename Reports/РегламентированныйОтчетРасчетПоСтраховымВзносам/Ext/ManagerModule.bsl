...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = "Утверждена приказом ФНС России от 10.10.2016 № ММВ-7-11/551@.";
	...
	НоваяФорма.ОписаниеОтчета
		= "Утверждена приказом ФНС России от 18.09.2019 № ММВ-7-11/470@ (в ред. приказа ФНС России от 15.10.2020 № ЕД-7-11/751@).";
	...
	НоваяФорма.ОписаниеОтчета     = "Утверждена приказом ФНС России от 18.09.2019 № ММВ-7-11/470@.";
	...
	НоваяФорма.ОписаниеОтчета
		= "Утверждена приказом ФНС России от 06.10.2021 № ЕД-7-11/875@ (в редакции приказа ФНС России от 19.05.2022 № ЕД-7-11/413@).";
	...
	НоваяФорма.ОписаниеОтчета
		= "Утверждена приказом ФНС России от 29.09.2022 № ЕД-7-11/878@ (в ред. приказа ФНС России от 04.02.2026 № ЕД-1-11/67@).";
	НоваяФорма.РедакцияФормы      = "от 04.02.2026 № ЕД-1-11/67@.";
	...
	НоваяФорма.ДатаКонецДействия  = '20260630';
...
Функция ДеревоФормИФорматов() Экспорт
	...
	"1151111", '2026-02-04', "ЕД-1-11/67@", "ФормаОтчета2026Кв1");
