...
Процедура ПоказателиОценкиРискаВыезднойНалоговойПроверки(ТаблицаПоказателей, ОписаниеОтчета) Экспорт 
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2022Кв2"
		...
		ЗначениеПоказателя = РегламентированнаяОтчетность.ПоказательОтчета(Таблица1, "П000010000103");
		
	ИначеЕсли ОписаниеОтчета.ВыбраннаяФорма <> "ФормаОтчета2010Кв4" Тогда
		
		ЗначениеПоказателя = РегламентированнаяОтчетность.ПоказательОтчета(Раздел1_3, "П000030001003");
