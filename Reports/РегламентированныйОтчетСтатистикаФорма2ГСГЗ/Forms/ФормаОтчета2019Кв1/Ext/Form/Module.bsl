...
Процедура ПолеТабличногоДокументаФормаОтчетаВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	РегламентированнаяОтчетностьКлиент.ОбработкаВыбораПоляОбособленныхПодразделений(
		ЭтаФорма, Область, СтандартнаяОбработка);
...
Процедура ОчиститьНаСервере() Экспорт
	...
	СписокПоказателей.Добавить(ВыбТабПоле.Области["ГодОтчета1"].Значение,                "ГодОтчета1");
	СписокПоказателей.Добавить(ВыбТабПоле.Области["ГодОтчета2"].Значение,                "ГодОтчета2");
	СписокПоказателей.Добавить(ВыбТабПоле.Области["ГодОтчета3"].Значение,                "ГодОтчета3");
	СписокПоказателей.Добавить(ВыбТабПоле.Области["ОргУровеньГосОргана"].Значение,       "ОргУровеньГосОргана");
