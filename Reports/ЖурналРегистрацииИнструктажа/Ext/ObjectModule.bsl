		...
		Если КлючВарианта = "ЖурналРегистрацииВводногоИнструктажа" Тогда
			...
			Для каждого СтрокаОрганизации Из ДанныеОтчета.Строки Цикл
				...
				Для Каждого СтрокаСотрудника Из СтрокаОрганизации.Строки Цикл
					...
					ОбластьСтрока.Параметры.ФИОИнструктируемого = СтрокаСотрудника.ФИОПолные;
					ОбластьСтрока.Параметры.ДатаРожденияИнструктируемого = СтрокаСотрудника.ДатаРождения;
					...
					ОбластьСтрока.Параметры.ЛокальныйАкт = СтрокаСотрудника.ЛокальныйАкт;
