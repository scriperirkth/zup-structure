...
Функция ПечатьУведомления(МассивОбъектов, ОбъектыПечати)
	...
	ИначеЕсли Реквизиты.ИмяОтчета = "РегламентированноеУведомлениеЕНВД2" Тогда
		Возврат ПечатьУведомленияЕНВД2(Реквизиты, ОбъектыПечати);
	ИначеЕсли Реквизиты.ИмяОтчета = "РегламентированноеУведомлениеЕНВД3" Тогда
		Возврат ПечатьУведомленияЕНВД3(Реквизиты, ОбъектыПечати);
	ИначеЕсли Реквизиты.ИмяОтчета = "РегламентированноеУведомлениеЕНВД4" Тогда
		Возврат ПечатьУведомленияЕНВД4(Реквизиты, ОбъектыПечати);
	ИначеЕсли Реквизиты.ИмяОтчета = "РегламентированноеУведомлениеРеорганизацияЛиквидация" Тогда
		Возврат ПечатьУведомленияРеорганизацияЛиквидация(Реквизиты, ОбъектыПечати);
	ИначеЕсли Реквизиты.ИмяОтчета = "РегламентированноеУведомлениеРанееПредставленныеДокументы" Тогда
		Возврат ПечатьУведомленияРанееПредставленныеДокументы(Реквизиты, ОбъектыПечати);
	ИначеЕсли Реквизиты.ИмяОтчета = "РегламентированноеУведомлениеСообщениеОбУчастии" Тогда
		Возврат ПечатьРегламентированноеУведомлениеСообщениеОбУчастии(Реквизиты, ОбъектыПечати);
	ИначеЕсли Реквизиты.ИмяОтчета = "РегламентированноеУведомлениеИзменениеПараметраУСН" Тогда
		Возврат ПечатьРегламентированноеУведомлениеИзменениеПараметраУСН(Реквизиты, ОбъектыПечати);
	КонецЕсли;
...
Функция ПечатьРегламентированноеУведомлениеИзменениеПараметраУСН(Реквизиты, ОбъектыПечати)
	ДанныеДляЗагрузкиМакетов = Новый Структура("ИмяОтчета", "ВизуализацияУстаревшихУведомлений");
	СписокИспользуемыхМакетов = УведомлениеОСпецрежимахНалогообложения.ЗагрузитьМакетыИзАрхива(ДанныеДляЗагрузкиМакетов, "", "МакетыПечатиБСП");
	...
	МакетУведомления = СписокИспользуемыхМакетов["ИзменениеПараметраУСН"];
	ПараметрыМакета = МакетУведомления.Параметры;
	СтруктураПараметров = Реквизиты.ДанныеУведомления.Получить();
