...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Объект.ВидУведомления = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ПониженныеТарифыСтраховыеВзносыКурилы;
	...
	ПоказатьТекущуюСтраницу("Титульная_2026_1", Неопределено);
...
Процедура СформироватьДеревоСтраниц() Экспорт
	...
	Стр001.ИмяМакета = "Титульная_2026_1";
