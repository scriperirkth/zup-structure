...
Функция СформироватьТаблицуРезультата() Экспорт 
	...
	ТаблицаРезультата.Колонки.Добавить("Критичность", ОписаниеТиповЧ);
...
Функция СформироватьТаблицуОписаний() Экспорт
	...
	ТаблицаОписаний.Колонки.Добавить("Критичность", ОписаниеТиповЧ);
...
Функция НаименованиеКритичногоРаздела() Экспорт
	
	Возврат "Критичные проверки";
