...
Процедура СформироватьДеревоСтраниц() Экспорт
	ЗначениеВРеквизитФормы(Отчеты[Объект.ИмяОтчета].ДеревоСтраниц2026(), "ДеревоСтраниц");
КонецПроцедуры
...
Процедура ПоказатьТекущуюСтраницу(ИмяМакета, МногострочныеЧасти, ПредУИД)
	...
	Если ЭтотОбъект["ТекущееИДНаименования"] = "Титульная" Тогда 
		...
		Иначе
			...
			УведомлениеОСпецрежимахНалогообложения.ЗащитаОбласти(ЭтотОбъект, "ФормРеорг");
			УведомлениеОСпецрежимахНалогообложения.ЗащитаОбласти(ЭтотОбъект, "ИННРеорг");
			УведомлениеОСпецрежимахНалогообложения.ЗащитаОбласти(ЭтотОбъект, "КППРеорг");
		КонецЕсли;
	Иначе
