...
Функция СформироватьСписокЛистов(Объект) Экспорт
	...
	ИначеЕсли Объект.ИмяФормы = "Форма2026_Заключение" Тогда 
		Возврат СформироватьСписокЛистовФорма2026_Заключение(Объект);
	ИначеЕсли Объект.ИмяФормы = "Форма2023_Расторжение" Тогда 
		Возврат СформироватьСписокЛистовФорма2023_Расторжение(Объект);
	ИначеЕсли Объект.ИмяФормы = "Форма2026_Расторжение" Тогда 
		Возврат СформироватьСписокЛистовФорма2026_Расторжение(Объект);
	ИначеЕсли Объект.ИмяФормы = "Форма2023_Обязательства" Тогда 
		Возврат СформироватьСписокЛистовФорма2023_Обязательства(Объект);
	ИначеЕсли Объект.ИмяФормы = "Форма2026_Обязательства" Тогда 
		Возврат СформироватьСписокЛистовФорма2026_Обязательства(Объект);
	ИначеЕсли Объект.ИмяФормы = "Форма2023_Ходатайство" Тогда 
		Возврат СформироватьСписокЛистовФорма2023_Ходатайство(Объект);
	ИначеЕсли Объект.ИмяФормы = "Форма2026_Ходатайство" Тогда 
		Возврат СформироватьСписокЛистовФорма2026_Ходатайство(Объект);
...
Функция ПолучитьТаблицуФорм() Экспорт 
	...
	Стр.ДатаКонца = '20260831';
	
	Стр = Результат.Добавить();
	Стр.ИмяФормы = "Форма2026_Заключение";
	Стр.ВидУведомления = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ЗаключениеТрудовогоДоговора;
	Стр.ОписаниеФормы = "В соответствии с приказом МВД России от 12.05.2026 № 290";
	Стр.ДатаНачала = '20260901';
	...
	Стр = Результат.Добавить();
	Стр.ИмяФормы = "Форма2026_Расторжение";
	Стр.ВидУведомления = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.РасторжениеТрудовогоДоговора;
	Стр.ОписаниеФормы = "В соответствии с приказом МВД России от 12.05.2026 № 290";
	Стр.ДатаНачала = '20260901';
	Стр.ДатаКонца = '20991231';
	...
	Стр = Результат.Добавить();
	Стр.ИмяФормы = "Форма2026_Обязательства";
	Стр.ВидУведомления = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ОбязательстваВыплатаЗП;
	Стр.ОписаниеФормы = "В соответствии с приказом МВД России от 12.05.2026 № 290";
	Стр.ДатаНачала = '20260901';
	Стр.ДатаКонца = '20991231';
	...
	Стр = Результат.Добавить();
	Стр.ИмяФормы = "Форма2026_Ходатайство";
	Стр.ВидУведомления = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ХодатайствоОПривлечении;
	Стр.ОписаниеФормы = "В соответствии с приказом МВД России от 12.05.2026 № 290";
	Стр.ДатаНачала = '20260901';
	Стр.ДатаКонца = '20991231';
	...
	Для Каждого Элт Из СтруктураДлинныхПолей Цикл
		...
		Пока Истина Цикл
			...
			Если Инд = 4 Тогда 
				...
				ЗаполнениеОбластей(ПечатнаяФорма, СтруктураПечати);
...
Функция СформироватьСписокЛистовФорма2023_Заключение(Объект) Экспорт
	...
	ИННКПП = ОбщегоНазначенияКлиентСервер.СкопироватьРекурсивно(Титульная);
	...
	Для Инд = 1 По 4 Цикл 
		УведомлениеОСпецрежимахНалогообложения.НапечататьСтруктуру(Объект.ИмяОтчета, Титульная, ИННКПП.НомСтр, 
			...
			ПечатнаяФорма, ИННКПП, Истина, Ложь);
		ЗаполнениеОбластей(ПечатнаяФорма, Титульная);
		УведомлениеОСпецрежимахНалогообложения.ПоложитьПФВСписокЛистов(Объект, Листы, ПечатнаяФорма, ИННКПП.НомСтр, Ложь);
	КонецЦикла;
	...
	ПечатьПриложения(ОбщегоНазначенияКлиентСервер.СкопироватьРекурсивно(Титульная), СтруктураДлинныхПолей,
		Объект, ИННКПП, СписокИспользуемыхМакетов, ПечатнаяФорма, Листы, "Печать_Форма2023_Приложение_стр");
	
	Возврат Листы;
КонецФункции

Функция СформироватьСписокЛистовФорма2026_Заключение(Объект) Экспорт
	СписокИспользуемыхМакетов = УведомлениеОСпецрежимахНалогообложения.ЗагрузитьМакетыИзАрхива(Объект, , "БланкиПечати");
	Листы = Новый СписокЗначений;
	...
	Для Инд = 1 По 5 Цикл 
		УведомлениеОСпецрежимахНалогообложения.НапечататьСтруктуру(Объект.ИмяОтчета, Титульная, ИННКПП.НомСтр, 
			УведомлениеОСпецрежимахНалогообложения.ПустойМакетИзСписка(Объект, СписокИспользуемыхМакетов, "Печать_Форма2026_Заключение_стр" + Инд),
			ПечатнаяФорма, ИННКПП, Истина, Ложь);
		ЗаполнениеОбластей(ПечатнаяФорма, Титульная);
		УведомлениеОСпецрежимахНалогообложения.ПоложитьПФВСписокЛистов(Объект, Листы, ПечатнаяФорма, ИННКПП.НомСтр, Ложь);
	КонецЦикла;
	...
	СтруктураДлинныхПолей.Добавить(ЭлементСтруктурыДлинныхПолей("2.3", "Отчество", 28, "Отчество"));
	СтруктураДлинныхПолей.Добавить(ЭлементСтруктурыДлинныхПолей("2.4", "Гражданство", 27, "Гражданство"));
	СтруктураДлинныхПолей.Добавить(ЭлементСтруктурыДлинныхПолей("2.6", "Наименование документа", 20, "Документ"));
	СтруктураДлинныхПолей.Добавить(ЭлементСтруктурыДлинныхПолей("2.6", "Кем выдан", 74, "КемВыдан"));
	СтруктураДлинныхПолей.Добавить(ЭлементСтруктурыДлинныхПолей("3", "Наименование документа", 20, "ДокументРазр"));
	СтруктураДлинныхПолей.Добавить(ЭлементСтруктурыДлинныхПолей("3", "Кем выдан", 61, "КемВыданРазр"));
	СтруктураДлинныхПолей.Добавить(ЭлементСтруктурыДлинныхПолей("3.1", "Разъяснения по пункту 3.1", 102, "Описание31п"));
	СтруктураДлинныхПолей.Добавить(ЭлементСтруктурыДлинныхПолей("3.2", "Профессия", 102, "Описание32п"));
	...
	ПечатьПриложения(ОбщегоНазначенияКлиентСервер.СкопироватьРекурсивно(Титульная), СтруктураДлинныхПолей,
		Объект, ИННКПП, СписокИспользуемыхМакетов, ПечатнаяФорма, Листы, "Печать_Форма2026_Приложение_стр");
...
Функция СформироватьСписокЛистовФорма2026_Расторжение(Объект) Экспорт
	СписокИспользуемыхМакетов = УведомлениеОСпецрежимахНалогообложения.ЗагрузитьМакетыИзАрхива(Объект, , "БланкиПечати");
	Листы = Новый СписокЗначений;
	...
	Для Инд = 1 По 5 Цикл 
		УведомлениеОСпецрежимахНалогообложения.НапечататьСтруктуру(Объект.ИмяОтчета, Титульная, ИННКПП.НомСтр, 
			УведомлениеОСпецрежимахНалогообложения.ПустойМакетИзСписка(Объект, СписокИспользуемыхМакетов, "Печать_Форма2026_Расторжение_стр" + Инд),
			ПечатнаяФорма, ИННКПП, Истина, Ложь);
		ЗаполнениеОбластей(ПечатнаяФорма, Титульная);
		УведомлениеОСпецрежимахНалогообложения.ПоложитьПФВСписокЛистов(Объект, Листы, ПечатнаяФорма, ИННКПП.НомСтр, Ложь);
	КонецЦикла;
...
Функция СформироватьСписокЛистовФорма2026_Обязательства(Объект) Экспорт
	СписокИспользуемыхМакетов = УведомлениеОСпецрежимахНалогообложения.ЗагрузитьМакетыИзАрхива(Объект, , "БланкиПечати");
	Листы = Новый СписокЗначений;
	...
	Для Инд = 1 По 4 Цикл 
		УведомлениеОСпецрежимахНалогообложения.НапечататьСтруктуру(Объект.ИмяОтчета, Титульная, ИННКПП.НомСтр, 
			УведомлениеОСпецрежимахНалогообложения.ПустойМакетИзСписка(Объект, СписокИспользуемыхМакетов, "Печать_Форма2026_Обязательства_стр" + Инд),
			ПечатнаяФорма, ИННКПП, Истина, Ложь);
		ЗаполнениеОбластей(ПечатнаяФорма, Титульная);
		УведомлениеОСпецрежимахНалогообложения.ПоложитьПФВСписокЛистов(Объект, Листы, ПечатнаяФорма, ИННКПП.НомСтр, Ложь);
	КонецЦикла;
...
Процедура ОтрезатьПоСловам(ИмяПоля, Исходник, Приемник, Индекс, Макс)
	...
	Пока Истина Цикл
		...
		Если Макс - СтрДлина(Приемник[ИмяПоляПриемника]) < НепереносимыйОстаток() 
...
Процедура ЗаполнениеОбластей(Макет, Данные)
	Для Каждого Обл Из Макет.Области Цикл 
		Если Обл.ТипОбласти = ТипОбластиЯчеекТабличногоДокумента.Прямоугольник
			И Обл.СодержитЗначение = Ложь И Данные.Свойство(Обл.Имя) Тогда 
			Обл.Текст = Данные[Обл.Имя];
		КонецЕсли;
	КонецЦикла;
КонецПроцедуры
...
Функция СформироватьСписокЛистовФорма2026_Ходатайство(Объект) Экспорт
	СписокИспользуемыхМакетов = УведомлениеОСпецрежимахНалогообложения.ЗагрузитьМакетыИзАрхива(Объект, , "БланкиПечати");
	Листы = Новый СписокЗначений;
	ПечатнаяФорма = УведомлениеОСпецрежимахНалогообложения.НовыйПустойЛист();
	СтруктураПараметров = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.Ссылка, "ДанныеУведомления").Получить();
	...
	Пока Истина Цикл 
		...
		ОтрезатьСтроку("МестоПроживанияГосударство", Титульная, СтруктураПечати, 1, 50);
		ОтрезатьСтроку("МестоПроживанияНаселенныйПункт", Титульная, СтруктураПечати, 1, 60);
		ОтрезатьСтроку("КемВыдан", Титульная, СтруктураПечати, 2, 85);
		ОтрезатьСтроку("НаимОбрОрг", Титульная, СтруктураПечати, 2, 65);
		ОтрезатьСтроку("НомерДок", Титульная, СтруктураПечати, 1, 55);
		ОтрезатьСтроку("ДатаВыдачиДок", Титульная, СтруктураПечати, 1, 65);
		ОтрезатьСтроку("Специальность", Титульная, СтруктураПечати, 1, 95);
		ОтрезатьСтроку("Квалификация", Титульная, СтруктураПечати, 1, 95);
		...
		УведомлениеОСпецрежимахНалогообложения.НапечататьСтруктуру(Объект.ИмяОтчета, СтруктураПечати, ИННКПП.НомСтр, 
			УведомлениеОСпецрежимахНалогообложения.ПустойМакетИзСписка(Объект, СписокИспользуемыхМакетов, "Печать_Форма2026_Ходатайство_стр1"),
			ПечатнаяФорма, ИННКПП, Истина, Ложь);
		УведомлениеОСпецрежимахНалогообложения.ПоложитьПФВСписокЛистов(Объект, Листы, ПечатнаяФорма, ИННКПП.НомСтр, Ложь);
		...
		ОтрезатьСтроку("СведенияОНавыках", Титульная, СтруктураПечати, 5);
		ОтрезатьСтроку("РекомендациюДал", Титульная, СтруктураПечати, 2, 70);
		ОтрезатьСтроку("РодДеятельности", Титульная, СтруктураПечати, 2, 70);
		ОтрезатьСтроку("ОценкаКачеств", Титульная, СтруктураПечати, 2, 70);
		ОтрезатьСтроку("ЛичнаяХарактеристика", Титульная, СтруктураПечати, 10, 70);
		
		УведомлениеОСпецрежимахНалогообложения.НапечататьСтруктуру(Объект.ИмяОтчета, СтруктураПечати, ИННКПП.НомСтр, 
			УведомлениеОСпецрежимахНалогообложения.ПустойМакетИзСписка(Объект, СписокИспользуемыхМакетов, "Печать_Форма2026_Ходатайство_стр2"),
			ПечатнаяФорма, ИННКПП, Истина, Ложь);
		УведомлениеОСпецрежимахНалогообложения.ПоложитьПФВСписокЛистов(Объект, Листы, ПечатнаяФорма, ИННКПП.НомСтр, Ложь);
	КонецЦикла;
	Возврат Листы;
...
Функция СформироватьСписокЛистовФорма2023_ХодатайствоПатент(Объект) Экспорт
	...
	ЗаполнениеОбластей(ОбластьЧасть, Титульная);
	ЗаполнениеОбластей(ОбластьЧасть, СтруктураПечати);
	...
	Для Каждого МнгСтр Из ОпытРаботы Цикл 
		...
		ЗаполнениеОбластей(ОбластьЧасть, ОбщегоНазначения.СтрокаТаблицыЗначенийВСтруктуру(МнгСтр));
