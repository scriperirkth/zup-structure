...
Функция СведенияИзФормРегистрации(ИмяФормы, ДанныеУведомления) Экспорт
	...
	Если ИмяФормы = "Форма2020_4" Тогда 
		Для Каждого ЛистН Из Данные.ДанныеМногостраничныхРазделов.ЛистН Цикл
			Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(ЛистН.Значение) Тогда
				Продолжить;
			КонецЕсли;
	...
	ИначеЕсли ИмяФормы = "Форма2021_4" Тогда
		Для Каждого ЛистП Из Данные.ДанныеМногостраничныхРазделов.ЛистП Цикл
			Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(ЛистП.Значение) Тогда
				Продолжить;
			КонецЕсли;
...
Процедура ДополнитьПараметры_Форма2021_4(Параметры, ВсеДанные)
	...
	Для Каждого Страница Из ЛистыВ Цикл
		...
		Если УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(ДанныеСтраницы) Тогда
...
Процедура ПроверитьДокументСВыводомВТаблицу_Форма2021_4_ЛистВ(Данные, ТаблицаОшибок, СхемаВыгрузки)
	Для Каждого Элт Из Данные.ДанныеМногостраничныхРазделов.ЛистВ Цикл 
		ЛистВ = Элт.Значение;
		Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(ЛистВ) Тогда 
			Продолжить;
		КонецЕсли;
		...
		Если УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_ЗалЧастДол) Тогда 
			...
			Если УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_СвЗалДер) Тогда 
				...
				Заполнено_ЗалДерЮЛРос = УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_ЗалДерЮЛРос);
				...
				Заполнено_ЗалДерЮЛИн = УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_ЗалДерЮЛИн);
				...
				Заполнено_ЗалДерФЛ = УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_ЗалДерФЛ);
			...
			Если УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_СвУправЗал) Тогда 
				РегистрационныеФормы.Проверка_ДоговорНотариус(
				...
				Если УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_СвУпрЗал) Тогда
					...
					Заполнено_УпрЗалЮЛРос = УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_УпрЗалЮЛРос);
					...
					Заполнено_УпрЗалЮЛИн = УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_УпрЗалЮЛИн);
					...
					Заполнено_УпрЗалФЛ = УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_УпрЗалФЛ);
		...
		Если УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_СвДовУправ) Тогда 
			...
			Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_СвДовУпр) Тогда 
				Продолжить;
			КонецЕсли;
			...
			Заполнено_ДовУпрЮЛРос = УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_ДовУпрЮЛРос);
			...
			Заполнено_ДовУпрЮЛИн = УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_ДовУпрЮЛИн);
			...
			Заполнено_ДовУпрИп = УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_ДовУпрИп);
			...
			Заполнено_ДовУпрФЛ = УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_ДовУпрФЛ);
...
Процедура ПроверитьДокументСВыводомВТаблицу_Форма2021_4_ЛистГ(Данные, ТаблицаОшибок, СхемаВыгрузки)
	Для Каждого Элт Из Данные.ДанныеМногостраничныхРазделов.ЛистГ Цикл 
		ЛистГ = Элт.Значение;
		Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(ЛистГ) Тогда 
			Продолжить;
		КонецЕсли;
...
Процедура ПроверитьДокументСВыводомВТаблицу_Форма2021_4_ЛистД(Данные, ТаблицаОшибок, СхемаВыгрузки)
	Для Каждого Элт Из Данные.ДанныеМногостраничныхРазделов.ЛистД Цикл 
		ЛистД = Элт.Значение;
		Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(ЛистД) Тогда 
			Продолжить;
		КонецЕсли;
		...
		Если УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_СвФЛОсущПр) Тогда 
		...
		Если УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_СвДовУправ) Тогда
			...
			Если УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_СвДовУпр) Тогда
...
Процедура ПроверитьДокументСВыводомВТаблицу_Форма2021_4_ЛистЕ(Данные, ТаблицаОшибок, СхемаВыгрузки)
	Для Каждого Элт Из Данные.ДанныеМногостраничныхРазделов.ЛистЕ Цикл 
		ЛистЕ = Элт.Значение;
		Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(ЛистЕ) Тогда 
			Продолжить;
		КонецЕсли;
		...
		Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_ЗалЧастДол) Тогда 
			Продолжить;
		КонецЕсли;
		РегистрационныеФормы.Проверка_ДоговорНотариус(
...
Процедура ПроверитьДокументСВыводомВТаблицу_Форма2021_4_ЛистЖ(Данные, ТаблицаОшибок, СхемаВыгрузки)
	Для Каждого Элт Из Данные.ДанныеМногостраничныхРазделов.ЛистЖ Цикл 
		ЛистЖ = Элт.Значение;
		Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(ЛистЖ) Тогда 
			Продолжить;
		КонецЕсли;
		...
		Если УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_СвИнПрДогВн) Тогда 
			...
			Заполнено_СвУпТовЮЛ = УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_СвУпТовЮЛ);
			...
			Заполнено_СвУпТовЮЛИн = УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_СвУпТовЮЛИн);
...
Процедура ПроверитьДокументСВыводомВТаблицу_Форма2021_4_ЛистЗ(Данные, ТаблицаОшибок, СхемаВыгрузки)
	...
	Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(ЛистЗ) Тогда 
		Возврат;
	КонецЕсли;
	...
	Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_СвУправЗал) Тогда 
		Возврат;
	КонецЕсли;
	...
	Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_СвУпрЗал) Тогда 
		Возврат;
	КонецЕсли;
...
Процедура ПроверитьДокументСВыводомВТаблицу_Форма2021_4_ЛистИ(Данные, ТаблицаОшибок, СхемаВыгрузки)
	Для Каждого Элт Из Данные.ДанныеМногостраничныхРазделов.ЛистИ Цикл 
		ЛистИ = Элт.Значение;
		Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(ЛистИ) Тогда 
			Продолжить;
		КонецЕсли;
...
Процедура ПроверитьДокументСВыводомВТаблицу_Форма2021_4_ЛистЛ(Данные, ТаблицаОшибок, СхемаВыгрузки)
	Для Каждого Элт Из Данные.ДанныеМногостраничныхРазделов.ЛистЛ Цикл 
		ЛистЛ = Элт.Значение;
		Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(ЛистЛ) Тогда 
			Продолжить;
		КонецЕсли;
...
Процедура ПроверитьДокументСВыводомВТаблицу_Форма2021_4_ЛистН(Данные, ТаблицаОшибок, СхемаВыгрузки)
	Для Каждого Элт Из Данные.ДанныеМногостраничныхРазделов.ЛистН Цикл 
		ЛистН = Элт.Значение;
		Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(ЛистН) Тогда 
			Продолжить;
		КонецЕсли;
		...
		Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(СтруктураДанных_СвЗаймДав) Тогда 
			Продолжить;
		КонецЕсли;
