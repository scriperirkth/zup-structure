...
Процедура ПодготовитьДанныеПоРазделуКадровыйУчет(ТаблицаПоказателей)
	...
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиКадровогоУчета", "УчитыватьМатериальнуюОтветственностьСотрудников", 
		"Учитывать материальную ответственность сотрудников", "Кадровый учет", "", "Ложь", 3, 1, 2);
...
Процедура ПодготовитьДанныеПоРазделуРасчетЗарплаты(ТаблицаПоказателей)
	...
	ДобавитьПоказатель(ТаблицаПоказателей, "РегистрСведений.НастройкиРасчетаЗарплатыРасширенный", "РассчитыватьВзысканныеСуммыПропорциональноВыплате", 
		"Рассчитывать взысканные суммы пропорционально выплате", "Расчет зарплаты", "", "Ложь", 4, 1, 24);
