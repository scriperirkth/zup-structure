...
Процедура ЗагрузитьЛистыД(ДеревоЗагрузки, СхемаВыгрузки, ДополнительныеПараметры)
	...
	ЛистДЭталон = ОбщегоНазначения.СкопироватьРекурсивно(ЭтотОбъект["ДанныеМногостраничныхРазделов"].ЛистД[0].Значение);
	...
	Для Каждого ЛистД0 Из ЛистыД0 Цикл
		...
		ЛистДЗнач = ОбщегоНазначения.СкопироватьРекурсивно(ЛистДЭталон);
