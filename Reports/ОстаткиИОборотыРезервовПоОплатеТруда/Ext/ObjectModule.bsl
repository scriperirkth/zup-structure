...
Процедура ПередКомпоновкойМакета(Отказ)
	...
	Если ОстаткиОбороты Тогда
		...
		МассивПоказателейРасчета.Добавить("Перенос" + Показатель);
	...
	ИначеЕсли ПоСотрудникам Тогда
		...
		// Перенесено
		МассивПоказателейРасчета.Добавить("СуммаРезерваПеренос" + Показатель);
		МассивПоказателейРасчета.Добавить("СуммаРезерваСтраховыхВзносовПеренос" + Показатель);
		МассивПоказателейРасчета.Добавить("СуммаРезерваФССНесчастныеСлучаиПеренос" + Показатель);
		МассивПоказателейРасчета.Добавить("СуммаРезерваПереносВсего" + Показатель);
