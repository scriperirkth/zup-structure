...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	Отчеты.СостояниеШтатногоРасписания.ФормаОтчетаПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка);
...
Процедура ПриЗагрузкеВариантаНаСервере(Форма, НовыеНастройкиКД) Экспорт
	...
	Отчеты.СостояниеШтатногоРасписания.ОбновитьВидимостьДоступностьЭлементовФормы(Форма);
...
Процедура ПередФормированиемОтчета(Форма, ДополнительныеПараметры) Экспорт
	...
	Если Не Форма.КлючТекущегоВарианта = "АнализШтатногоРасписания" Тогда
		Возврат;
	КонецЕсли;
