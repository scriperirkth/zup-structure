...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "НаправлениеДляПостановкиНаВоинскийУчет");
	НастройкиВарианта.Описание =
		НСтр("ru = 'Форма направления для постановки на воинский учет, утвержденная Приказом Министра 
		|обороны РФ N 366, МВД РФ N 789, ФМС РФ N 197 от 10.09.2007.
		|Обратите внимание - с 2020 года для постановки на воинский учет организации должны 
		|выдавать форму Извещение о приеме (Постановление Правительства РФ от 06.02.2020 N 103). 
		|Используйте данную форму, только если военкомат явно затребовал именно ее.'");
	НастройкиВарианта.ФункциональныеОпции.Добавить("ИспользоватьНаправлениеДляПостановкиНаВоинскийУчет2019");
