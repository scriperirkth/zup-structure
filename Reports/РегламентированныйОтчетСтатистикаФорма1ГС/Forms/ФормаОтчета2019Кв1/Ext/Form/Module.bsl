...
Процедура ЗагрузитьПодготовленныеДанные()
	...
	ТекТабличноеПоле.Вывести(ОбъектОтчета(ИмяФормы).ПолучитьМакет("ФормаОтчета2019Кв1_ФормаОтчета"));
	РегламентированнаяОтчетность.ОбновитьОбластьРегистрацииРеспондента(ЭтотОбъект);
...
Функция ПроверитьКонтрольныеСоотношенияИзШаблонаВФоне()
	...
	ИмяМакета = ?(ТабДокумент.ОргУровеньГосОргана = "Федеральный", "АтрибВыгрузкиXML2019Кв1_фед", "АтрибВыгрузкиXML2019Кв1_рег");
	ИмяШаблона = ?(ТабДокумент.ОргУровеньГосОргана = "Федеральный", "ШаблонРосстата2019Кв1_фед", "ШаблонРосстата2019Кв1_рег");
