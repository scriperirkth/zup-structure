...
Функция ПроверитьДокументСВыводомВТаблицу_Форма2024_1(Данные, УникальныйИдентификатор)
	...
	Если Титульная.ПризИзмен = "2" Или Титульная.ПризИзмен = "3"
		...
		ИначеЕсли Не СтрПодобнаПоРегулярномуВыражению(СвСчетДо.НаимБанкИно, РегулярноеВыражениеСимволыЦифрыЛатиница(1, 1000), Истина) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам(
				"Неправильно указано наименование", "СвСчетДо", "НаимБанкИно"));
		КонецЕсли;
		Если (СвСчетДо.ПрФинОрг = "1" Или ЗначениеЗаполнено(СвСчетДо.CODE)) 
			И (Не СтрПодобнаПоРегулярномуВыражению(СвСчетДо.CODE, РегулярноеВыражениеЦифрыЛатиница(3, 25), Истина))Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам(
		...
		ИначеЕсли Не СтрПодобнаПоРегулярномуВыражению(СвСчетДо.АдрТекст, РегулярноеВыражениеСимволыЦифрыЛатиница(1, 255), Истина) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам(
	...
	Если Титульная.ПризИзмен = "1" Или Титульная.ПризИзмен = "3"
		...
		ИначеЕсли Не СтрПодобнаПоРегулярномуВыражению(СвСчетДо.НомСчет, РегулярноеВыражениеЦифрыЛатиница(1, 34), Истина) Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам(
