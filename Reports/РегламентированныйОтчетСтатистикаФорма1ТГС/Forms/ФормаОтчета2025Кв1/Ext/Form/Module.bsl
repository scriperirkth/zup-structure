...
Процедура Расчет(Форма, ИмяТекущейСтраницыПанели = "", ОбластьИмя = "")
	...
	Для Гр = 3 По 19 Цикл
		...
		Области["П0030010303" + Графа].Значение
			= Области["П0030010304" + Графа].Значение
			+ Области["П0030010305" + Графа].Значение
			+ Области["П0030010306" + Графа].Значение;
		
		//стр. 307 = сумме стр. 308–310;
		Области["П0030010307" + Графа].Значение
			= Области["П0030010308" + Графа].Значение
		...
		Области["П0030010311" + Графа].Значение
			...
			+ Области["П0030010313" + Графа].Значение
			+ Области["П0030010314" + Графа].Значение
			+ Области["П0030010315" + Графа].Значение;
		
		//стр. 316 = сумме стр. 317–320;
		Области["П0030010316" + Графа].Значение
			= Области["П0030010317" + Графа].Значение
			+ Области["П0030010318" + Графа].Значение
			+ Области["П0030010319" + Графа].Значение
	...
	//по всем соответствующим строкам (с 301 по 321):
	//гр. 12 = сумме гр. 13-19.
	Для Стр = 301 По 321 Цикл
		...
		КонецЦикла;
		Области["П0030010" + Стр + "12"].Значение = СуммаПоГр;
	КонецЦикла;
	
	//Раздел 4
	//по всем графам (с 3 по 9):
	Для Гр = 3 По 9 Цикл
		Графа = Формат(Гр, "ЧЦ=2; ЧВН=");
		
		//стр. 403 = сумме стр. 404–406;
		...
		//стр. 402 = сумме стр. 403, 407, 411, 416;
		...
		//стр. 421 = сумме стр. 401, 402;
		Области["П0040010421" + Графа].Значение
			= Области["П0040010401" + Графа].Значение
			+ Области["П0040010402" + Графа].Значение;
	КонецЦикла;
	
	//Раздел 5
	//по всем графам (с 3 по 18):
	Для Гр = 4 По 18 Цикл
		Графа = Формат(Гр, "ЧЦ=2; ЧВН=");
		
		//стр. 503 = сумме стр. 504–506;
		...
		//стр. 502 = сумме стр. 503, 507, 511, 516;
	...
	Для Стр = 501 По 523 Цикл
		...
		Для Гр = 4 По 16 Цикл
			...
			КонецЕсли;
			Графа = Формат(Гр, "ЧЦ=2; ЧВН=");
			СуммаПоГр = СуммаПоГр + Области["П0050010" + Стр + Графа].Значение;
		КонецЦикла;
		Области["П0050010" + Стр + "03"].Значение = СуммаПоГр;
	КонецЦикла;
	
	//Раздел 6
	//по всем графам (с 3 по 6):
	Для Гр = 3 По 6 Цикл
		Графа = Формат(Гр, "ЧЦ=2; ЧВН=");
		
		//стр. 603 = сумме стр. 604–606;
		...
		//стр. 602 = сумме стр. 603, 607, 611, 616;
