...
Процедура ДополнитьДанныеУведомленияДляВыгрузки(ДанныеУведомления, ОсновныеСведения)
	...
	Для Каждого Элт Из ДанныеУведомления.ДанныеМногостраничныхРазделов.Лист1 Цикл 
		Лист1 = Элт.Значение;
		Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(Лист1) Тогда 
			Продолжить;
		КонецЕсли;
	...
	Для Каждого Элт Из ДанныеУведомления.ДанныеМногостраничныхРазделов.Лист2 Цикл 
		Лист2 = Элт.Значение;
		Если Не УведомлениеОСпецрежимахНалогообложенияКлиентСервер.СтраницаЗаполнена(Лист2) Тогда 
			Продолжить;
		КонецЕсли;
