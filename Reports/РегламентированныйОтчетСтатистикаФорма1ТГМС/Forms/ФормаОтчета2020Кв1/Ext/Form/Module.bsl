...
Процедура ОчиститьНаСервере() Экспорт
	...
	Если ВыбТабличноеПоле.Области.Найти("РегистрацияРеспондента") <> Неопределено Тогда
		СписокПоказателейНеПодлежащихОчистке.Добавить(ВыбТабличноеПоле.Области["РегистрацияРеспондента"].Значение,"РегистрацияРеспондента");
	КонецЕсли;
