...
Функция ВерсияФорматаВыгрузки(Знач НаДату = Неопределено, ВыбраннаяФорма = Неопределено) Экспорт
	...
	Возврат Перечисления.ВерсииФорматовВыгрузки.ВерсияМинтруда;
...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = "Пункт 118 постановления Правительства РФ от 24.12.2021 № 2464 (с выгрузкой в формате 1.0.3).";
	НоваяФорма.РедакцияФормы      = "выгрузка в формате 1.0.3.";
...
Функция ДеревоФормИФорматов() Экспорт
	...
	"РОЛМТРФ", '2021-12-24', "2464", "ФормаОтчета2023Кв1");
	ОпределитьФорматВДеревеФормИФорматов(Форма2023Кв1, "1.0.3");
