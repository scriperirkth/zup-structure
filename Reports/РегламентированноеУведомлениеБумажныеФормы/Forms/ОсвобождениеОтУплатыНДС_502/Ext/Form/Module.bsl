...
#КонецОбласти    
	...
	Контейнер.Вставить("Титульная", ОбщегоНазначения.СкопироватьРекурсивно(ЭтотОбъект["ДанныеУведомления"].Титульная));
	Контейнер.Вставить("СовВыр3Месяца", ОбщегоНазначения.СкопироватьРекурсивно(ЭтотОбъект["ДанныеУведомления"].СовВыр3Месяца));
	Контейнер.Вставить("Выр12Месяцев", ОбщегоНазначения.СкопироватьРекурсивно(ЭтотОбъект["ДанныеУведомления"].Выр12Месяцев));
