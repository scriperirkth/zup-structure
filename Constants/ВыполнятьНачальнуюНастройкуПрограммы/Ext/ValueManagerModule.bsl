...
Процедура ПриЗаписи(Отказ)
	...
	Если ЗарплатаКадры.ОтключитьБизнесЛогикуПриЗаписи(ЭтотОбъект) Тогда
		Возврат;
	КонецЕсли;
	ИнтеграцияКабинетСотрудникаРасширенный.ОбработатьИзменениеВыполняетсяНачальнаяНастройка(Значение);
	Интеграция1СПерсоналРасширенный.ОбработатьИзменениеВыполняетсяНачальнаяНастройка(Значение);
