...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	ИспользуемыеТранспортыСообщенийОбмена.Добавить(Обработки.ТранспортСообщенийОбменаFILE);
	ИспользуемыеТранспортыСообщенийОбмена.Добавить(Обработки.ТранспортСообщенийОбменаFTP);
	ИспользуемыеТранспортыСообщенийОбмена.Добавить(Обработки.ТранспортСообщенийОбменаEMAIL);
