...
Процедура ПриПолученииНастроек(Настройки) Экспорт
	...
	Настройки.ИмяМенеджераРегистрации = "МенеджерРегистрацииОбменаЗУП";
...
Процедура ПриПолученииВариантовНастроекОбмена(ВариантыНастроекОбмена, ПараметрыКонтекста) Экспорт
	...
	ВариантНастройки.ИдентификаторНастройки        = ОбменДаннымиУниверсальныйФормат.ВариантНастройкиОбменаERP();
	ВариантНастройки.КорреспондентВМоделиСервиса   = Истина;
	ВариантНастройки.КорреспондентВЛокальномРежиме = Истина;
	
	ВариантНастройки = ВариантыНастроекОбмена.Добавить();
	ВариантНастройки.ИдентификаторНастройки        = ОбменДаннымиУниверсальныйФормат.ВариантНастройкиОбменаБП();
	ВариантНастройки.КорреспондентВМоделиСервиса   = Истина;
	ВариантНастройки.КорреспондентВЛокальномРежиме = Истина;
	
	ВариантНастройки = ВариантыНастроекОбмена.Добавить();
	ВариантНастройки.ИдентификаторНастройки        = ОбменДаннымиУниверсальныйФормат.ВариантНастройкиОбменаУНФ();
	ВариантНастройки.КорреспондентВМоделиСервиса   = Истина;
	ВариантНастройки.КорреспондентВЛокальномРежиме = Истина;
	
	ВариантНастройки = ВариантыНастроекОбмена.Добавить();
	ВариантНастройки.ИдентификаторНастройки        = ОбменДаннымиУниверсальныйФормат.ВариантНастройкиОбменаДО();
	ВариантНастройки.КорреспондентВМоделиСервиса   = Истина;
	ВариантНастройки.КорреспондентВЛокальномРежиме = Истина;
	
	ВариантНастройки = ВариантыНастроекОбмена.Добавить();
	ВариантНастройки.ИдентификаторНастройки        = ОбменДаннымиУниверсальныйФормат.ВариантНастройкиОбменУниверсальный();
	ВариантНастройки.КорреспондентВМоделиСервиса   = Истина;
	ВариантНастройки.КорреспондентВЛокальномРежиме = Истина;
...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	Если ИдентификаторНастройки = ОбменДаннымиУниверсальныйФормат.ВариантНастройкиОбменаERP() Тогда
	...
	ИначеЕсли ИдентификаторНастройки = ОбменДаннымиУниверсальныйФормат.ВариантНастройкиОбменаБП() Тогда
		...
		ЗаголовокКоманды   = НСтр("ru='Бухгалтерия предприятия, редакция 3. Обмен с использованием универсального формата обмена ""Enterprise Data""'");
	...
	ИначеЕсли ИдентификаторНастройки = ОбменДаннымиУниверсальныйФормат.ВариантНастройкиОбменаУНФ() Тогда
		
		ИмяКонфигурацииКорреспондента          = НСтр("ru = 'УправлениеНебольшойФирмой'");
		НаименованиеКонфигурацииКорреспондента = НСтр("ru = '1С:Управление нашей фирмой 3.0'");
		
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами ""Зарплата и управление персоналом, редакция 3.1""
		|и ""1С:Управление нашей фирмой 3.0"". В синхронизации участвуют документы и нормативно-справочная информация.'");
		
		ЗаголовокКоманды   = НСтр("ru='1С:Управление нашей фирмой 3.0'");
		ЗаголовокПомощника = НСтр("ru='Настройка синхронизации с программой ""1С:Управление нашей фирмой 3.0""'");
		ЗаголовокУзла      = НСтр("ru='Синхронизация с программой ""1С:Управление нашей фирмой 3.0""'");
		
	ИначеЕсли ИдентификаторНастройки = ОбменДаннымиУниверсальныйФормат.ВариантНастройкиОбменаДО() Тогда
		
		ИмяКонфигурацииКорреспондента          = НСтр("ru = 'ДокументооборотКОРП'");
		НаименованиеКонфигурацииКорреспондента = НСтр("ru = '1С:Документооборот'");
		
		КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами ""Зарплата и управление персоналом, редакция 3.1""
		|и ""1С:Документооборот"". В синхронизации участвует нормативно-справочная информация.'");
		
		ЗаголовокКоманды   = НСтр("ru='1С:Документооборот'");
		ЗаголовокПомощника = НСтр("ru='Настройка синхронизации с программой ""1С:Документооборот""'");
		ЗаголовокУзла      = НСтр("ru='Синхронизация с программой ""1С:Документооборот""'");
