...
Функция ИмяОбъектаМетаданных(Имя) Экспорт
	...
	ИначеЕсли Имя = "СведенияОДоходахСотрудникаДляСоцВыплат" Тогда
		Возврат "СведенияОДоходахСотрудникаДляСоцВыплат";
...
Процедура ПроверятьУникальностьРегистрацииВНалоговомОргане(Проверять = Истина) Экспорт
	КонфигурацииЗарплатаКадрыКлиентСервер.ПроверятьУникальностьРегистрацииВНалоговомОргане(Проверять);
КонецПроцедуры
