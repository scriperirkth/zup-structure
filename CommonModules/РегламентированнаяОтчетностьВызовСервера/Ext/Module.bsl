...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("УстановитьПараметрыВнешнихРегламентированныхОтчетов");
КонецПроцедуры
...
Процедура ЗаполнитьСтруктуруДанныхФайлаРаздела(ТабличныйДокумент, ДанныеФайловРазделов, АдресФайла, ПолноеИмяФайла, Каталог) Экспорт 
	...
	Для Каждого ФайлДляУдаления Из МассивДляУдаления Цикл 
		ОперацииСФайламиЭДКО.УдалитьВременныйФайл(ФайлДляУдаления);
	КонецЦикла;
...
Функция НеотправляемыйРеглОтчетИмеетВозможностьИзмененияСтатусаОтправкиИзФормыОтчетаВручную(ИмяОбъекта)
	...
	МассивИмен.Добавить("РегламентированныйОтчетГОЗФорма2");
	МассивИмен.Добавить("РегламентированныйОтчетГОЗФорма2д");
	МассивИмен.Добавить("РегламентированныйОтчетГОЗФорма3д");
	МассивИмен.Добавить("РегламентированныйОтчетГОЗФорма4");
	МассивИмен.Добавить("РегламентированныйОтчетГОЗФорма5");
	МассивИмен.Добавить("РегламентированныйОтчетГОЗФорма6");
	МассивИмен.Добавить("РегламентированныйОтчетГОЗФорма7");
	МассивИмен.Добавить("РегламентированныйОтчетГОЗФорма9");
	МассивИмен.Добавить("РегламентированныйОтчетГОЗФорма11");
	МассивИмен.Добавить("РегламентированныйОтчетГОЗФорма13");
	МассивИмен.Добавить("РегламентированныйОтчетГОЗФорма14");
	МассивИмен.Добавить("РегламентированныйОтчетГОЗФорма16");
	МассивИмен.Добавить("РегламентированныйОтчетГОЗФорма19д");
	МассивИмен.Добавить("РегламентированныйОтчетГОЗФорма20д");
	МассивИмен.Добавить("РегламентированныйОтчетГОЗФорма21");
	МассивИмен.Добавить("РегламентированныйОтчетГОЗФорма23");
