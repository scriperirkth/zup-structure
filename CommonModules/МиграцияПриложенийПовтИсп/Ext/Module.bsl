...
Функция МодельДанныхОбласти() Экспорт
	...
	Для Каждого Состав Из Метаданные.ОбщиеРеквизиты.ОбластьДанныхОсновныеДанные.Состав Цикл
		...
		// Если объект добавлен расширением, тогда независимо от настроек он входит в модель данных области
		// данный код нужен для корректной выгрузки данных из неразделенной базы.
		//
		// Схема вхождения добавленных расширением объектов в состав разделителей следующая:
		// Если база не разделенная:
		//	тогда для объектов расширения будет установлено НеИспользовать
		//	исключение, когда у общего реквизита свойство Автоиспользование стоит в положении НеИспользовать
		//	тогда для объектов расширения будет установлено Авто
		// Если база разделенная и расширение установлено в область:
		//	тогда для объектов расширения настройка будет установлена в такое же положение как и свойство
		//	Разделение расширений конфигурации общего реквизита.
	...
	Для Каждого Состав Из Метаданные.ОбщиеРеквизиты.ОбластьДанныхВспомогательныеДанные.Состав Цикл
		...
		Если Состав.Использование = Использовать 
			...
			И Не Метаданные.СервисыИнтеграции.Содержит(ОбъектМетаданных)
