...
Функция ПодставитьНулевыеДокументыОснования(МенеджерВременныхТаблиц, Параметры) Экспорт
	ВзаиморасчетыССотрудникамиРасширенный.ПодставитьНулевыеДокументыОснования(МенеджерВременныхТаблиц, Параметры);
КонецФункции
