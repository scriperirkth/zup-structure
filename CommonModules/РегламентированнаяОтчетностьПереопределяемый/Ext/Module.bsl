...
// Процедура определяет дату перехода на общую систему налогообложения за указанный период.
//
// Параметры:
//   ДатаПереходаНаОСНО - Дата - дата перехода на общую систему налогообложения.
//   СтруктураПараметров - Структура:
//        * Организация   - СправочникСсылка.Организации - организации, для которой определяется дата перехода.
//        * ДатаНачала    - Дата - дата начала периода, для которого нужно определить дату перехода.
//        * ДатаОкончания - Дата - дата окончания периода, для которого нужно определить дату перехода.
Процедура ОпределитьДатуПереходаНаОСНО(ДатаПереходаНаОСНО, СтруктураПараметров) Экспорт
...
Процедура ИзменитьРучнойСтатус(Ссылка, Статус) Экспорт
	...
	ЗарплатаКадры.ИзменитьРучнойСтатус(Ссылка, Статус);
...
Процедура ФормаРегламентированнойОтчетности_ПриСозданииНаСервере(Форма) Экспорт
	ЗарплатаКадры.ФормаРегламентированнойОтчетности_ПриСозданииНаСервере(Форма);
КонецПроцедуры
...
Процедура ОтчетыПриАктивизацииСтрокиНаСервере(СсылкаНаОбъект) Экспорт
	ЗарплатаКадры.ОтчетыПриАктивизацииСтрокиНаСервере(СсылкаНаОбъект);
КонецПроцедуры
