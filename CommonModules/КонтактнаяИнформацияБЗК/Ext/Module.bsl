		...
		Для Каждого КонтактнаяИнформация Из КоллекцияПолейКонтактнойИнформации Цикл
			...
			Если Элемент <> Неопределено Тогда
				...
				ИначеЕсли КонтактнаяИнформация.Тип = Перечисления.ТипыКонтактнойИнформации.Адрес Тогда
					...
					Если КонтактнаяИнформация.Вид = Справочники.ВидыКонтактнойИнформации.АдресМестаПроживанияФизическиеЛица Тогда
						...
						ИмяГруппыАдресаМестаПроживания = "ГруппаАдресМестаПроживания" + Элемент.Имя;
						ГруппаАдресаМестаПроживания = Форма.Элементы.Найти(ИмяГруппыАдресаМестаПроживания);
						Если ГруппаАдресаМестаПроживания = Неопределено Тогда
							
							ГруппаАдресаМестаПроживания = Форма.Элементы.Добавить(ИмяГруппыАдресаМестаПроживания, Тип("ГруппаФормы"));
							
							ГруппаАдресаМестаПроживания.Вид = ВидГруппыФормы.ОбычнаяГруппа;
							ГруппаАдресаМестаПроживания.ОтображатьЗаголовок = Ложь;
							ГруппаАдресаМестаПроживания.Отображение = ОтображениеОбычнойГруппы.Нет;
							ГруппаАдресаМестаПроживания.Группировка = ГруппировкаПодчиненныхЭлементовФормы.Горизонтальная;
							
							Форма.Элементы.Переместить(ГруппаАдресаМестаПроживания, Элемент.Родитель, Элемент);
							Форма.Элементы.Переместить(Элемент, ГруппаАдресаМестаПроживания);
							
							ЭлементДатаВременнойРегистрации = Форма.Элементы.Найти("ДатаВременнойРегистрации" + Элемент.Имя);
							Если ЭлементДатаВременнойРегистрации = Неопределено Тогда
								
								ЭлементДатаВременнойРегистрации = Форма.Элементы.Добавить("ДатаВременнойРегистрации" + Элемент.Имя, Тип("ПолеФормы"), ГруппаАдресаМестаПроживания);
								
								ЭлементДатаВременнойРегистрации.Вид = ВидПоляФормы.ПолеВвода;
								ЭлементДатаВременнойРегистрации.ПутьКДанным = "ФизическоеЛицо.ДатаВременнойРегистрации";
								ЭлементДатаВременнойРегистрации.РастягиватьПоГоризонтали = Ложь;
								ЭлементДатаВременнойРегистрации.Ширина = 8;
								ЭлементДатаВременнойРегистрации.Заголовок = НСтр("ru = 'Начало проживания'");
								
								Если ПоложениеЗаголовкаВерх Тогда
									ЭлементДатаВременнойРегистрации.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Верх;
									ЭлементДатаВременнойРегистрации.ВысотаЗаголовка = 1;
								Иначе
									ЭлементДатаВременнойРегистрации.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Лево;
								КонецЕсли;
								
								ЭлементДатаВременнойРегистрации.УстановитьДействие("ПриИзменении", "Подключаемый_ФизлицоДатаВременнойРегистрацииПриИзменении");
					...
					Если КонтактнаяИнформация.Вид = Справочники.ВидыКонтактнойИнформации.АдресДляИнформированияФизическиеЛица Тогда
						...
						ИмяГруппыАдресаДляИнформирования = "ГруппаАдресДляИнформирования" + Элемент.Имя;
						ГруппаАдресДляИнформирования = Форма.Элементы.Найти(ИмяГруппыАдресаДляИнформирования);
						Если ГруппаАдресДляИнформирования = Неопределено Тогда
							
							ГруппаАдресДляИнформирования = Форма.Элементы.Добавить(ИмяГруппыАдресаДляИнформирования, Тип("ГруппаФормы"));
							
							ГруппаАдресДляИнформирования.Вид = ВидГруппыФормы.ОбычнаяГруппа;
							ГруппаАдресДляИнформирования.ОтображатьЗаголовок = Ложь;
							ГруппаАдресДляИнформирования.Отображение = ОтображениеОбычнойГруппы.Нет;
							ГруппаАдресДляИнформирования.Группировка = ГруппировкаПодчиненныхЭлементовФормы.Горизонтальная;
							
							Форма.Элементы.Переместить(ГруппаАдресДляИнформирования, Элемент.Родитель, Элемент);
							Форма.Элементы.Переместить(Элемент, ГруппаАдресДляИнформирования);
							
							ЭлементДатаФактическогоПроживания = Форма.Элементы.Найти("ДатаФактическогоПроживания" + Элемент.Имя);
							Если ЭлементДатаФактическогоПроживания = Неопределено Тогда
								
								ЭлементДатаФактическогоПроживания = Форма.Элементы.Добавить("ДатаФактическогоПроживания" + Элемент.Имя, Тип("ПолеФормы"), ГруппаАдресДляИнформирования);
								
								ЭлементДатаФактическогоПроживания.Вид = ВидПоляФормы.ПолеВвода;
								ЭлементДатаФактическогоПроживания.ПутьКДанным = "ФизическоеЛицо.ДатаФактическогоПроживания";
								ЭлементДатаФактическогоПроживания.РастягиватьПоГоризонтали = Ложь;
								ЭлементДатаФактическогоПроживания.Ширина = 8;
								ЭлементДатаФактическогоПроживания.Заголовок = НСтр("ru = 'Используется с'");
								
								Если ПоложениеЗаголовкаВерх Тогда
									ЭлементДатаФактическогоПроживания.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Верх;
									ЭлементДатаФактическогоПроживания.ВысотаЗаголовка = 1;
								Иначе
									ЭлементДатаФактическогоПроживания.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Лево;
								КонецЕсли;
								
								ЭлементДатаФактическогоПроживания.УстановитьДействие("ПриИзменении", "Подключаемый_ФизлицоДатаФактическогоПроживанияПриИзменении");
