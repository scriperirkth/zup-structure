...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ВыполнитьОбменФоновоеЗадание", Истина);
	Методы.Вставить("ЗарегистрироватьОбъектыВыгружаемыеПоСсылкам");
	Методы.Вставить("УстановитьИспользоватьИнтеграциюСПриложением1СПерсонал");
	Методы.Вставить("УстановитьЗначениеПоказыватьПриглашение");
	Методы.Вставить("НастроитьРегламентноеЗаданиеПроверкаСостоянияПриложения1СПерсонал");
КонецПроцедуры
...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 			= "3.1.38.67";
	Обработчик.Процедура 		= "Интеграция1СПерсонал.УстановитьИспользоватьИнтеграциюСПриложением1СПерсонал";
	Обработчик.РежимВыполнения 	= "Монопольно";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 			= "3.1.38.67";
	Обработчик.Процедура 		= "Интеграция1СПерсонал.УстановитьЗначениеПоказыватьПриглашение";
	Обработчик.РежимВыполнения 	= "Монопольно";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия 			= "3.1.38.67";
	Обработчик.РежимВыполнения 	= ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ОсновнойРежимВыполненияОбновления();
	Обработчик.Идентификатор 	= Новый УникальныйИдентификатор("1e9d0b29-08ab-4c24-9bfd-e354aed6e42f");
	Обработчик.Процедура 		= "Интеграция1СПерсонал.НастроитьРегламентноеЗаданиеПроверкаСостоянияПриложения1СПерсонал";
	Обработчик.Комментарий 		= НСтр("ru = 'Настройка регламентного задания Проверка состояния приложения 1С:Персонал.'");
...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
	...
	Настройка = Настройки.Добавить();
	Настройка.РегламентноеЗадание = Метаданные.РегламентныеЗадания.ПроверкаСостоянияПриложения1СПерсонал;
	Настройка.ФункциональнаяОпция = Метаданные.ФункциональныеОпции.ИспользуетсяПриложение1СПерсонал;
	Настройка.ДоступноВАвтономномРабочемМесте 	= Ложь;
	Настройка.РаботаетСВнешнимиРесурсами 		= Истина;
	
	Настройка = Настройки.Добавить();
	Настройка.РегламентноеЗадание = Метаданные.РегламентныеЗадания.ПроверкаДоступностиИспользованияПриложения1СПерсонал;
	Настройка.ДоступноВАвтономномРабочемМесте 	= Ложь;
	Настройка.РаботаетСВнешнимиРесурсами 		= Истина;
...
Процедура ПриПолученииСпискаШаблоновОчередиЗаданий(Шаблоны) Экспорт
	...
	Шаблоны.Добавить(Метаданные.РегламентныеЗадания.ПроверкаСостоянияПриложения1СПерсонал.Имя);
	Шаблоны.Добавить(Метаданные.РегламентныеЗадания.ПроверкаДоступностиИспользованияПриложения1СПерсонал.Имя);
...
Процедура ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам) Экспорт
	...
	СоответствиеИменПсевдонимам.Вставить(Метаданные.РегламентныеЗадания.ПроверкаСостоянияПриложения1СПерсонал.ИмяМетода);
	СоответствиеИменПсевдонимам.Вставить(Метаданные.РегламентныеЗадания.ПроверкаДоступностиИспользованияПриложения1СПерсонал.ИмяМетода);
...
Процедура СохранитьНовыеНастройкиПодключения(АдресПриложения, АдресСервисаАвторизации, АдресРесурсовAPI) Экспорт
	...
	Настройки.АдресРесурсовAPI			= АдресРесурсовAPI;
...
Процедура СохранитьНовыйАдресРесурсовAPI(АдресРесурсовAPI) Экспорт
	
	РегистрыСведений.НастройкиПодключения1СПерсонал.УстановитьАдресРесурсовAPI(АдресРесурсовAPI);
...
Процедура ЗаписатьАдресПриложения(АдресПриложения, АдресСервисаАвторизации, АдресРесурсовAPI) Экспорт
...
Процедура УстановитьИспользоватьИнтеграциюСПриложением1СПерсонал() Экспорт
	
	ИспользоватьИнтеграцию = ПолучитьФункциональнуюОпцию("ИспользуетсяПриложение1СПерсонал");
	Если ИспользоватьИнтеграцию <> Константы.ИспользоватьИнтеграциюСПриложением1СПерсонал.Получить() Тогда
		Константы.ИспользоватьИнтеграциюСПриложением1СПерсонал.Установить(ИспользоватьИнтеграцию);
	КонецЕсли;
	...
	ПоказыватьПриглашение = ИспользоватьИнтеграцию
		И Не ВыполняетсяНачальнаяНастройка И Не ПолучитьФункциональнуюОпцию("ИспользуетсяПриложение1СПерсонал");
	
	Если ПоказыватьПриглашение <> Константы.ПоказыватьПриглашение1СПерсонал.Получить() Тогда
		Константы.ПоказыватьПриглашение1СПерсонал.Установить(ПоказыватьПриглашение);
	КонецЕсли;
	
КонецПроцедуры

Процедура УстановитьЗначениеПоказыватьПриглашение() Экспорт
	...
	ПоказыватьПриглашение = Константы.ИспользоватьИнтеграциюСПриложением1СПерсонал.Получить()
		И Не(ВыполняетсяНачальнаяНастройка Или ПолучитьФункциональнуюОпцию("ИспользуетсяПриложение1СПерсонал"));
...
Процедура НастроитьРегламентноеЗаданиеПроверкаСостоянияПриложения1СПерсонал(ПараметрыОбновления = Неопределено) Экспорт
	...
	Отбор.Вставить("Ключ", "ПроверкаСостоянияПриложения1СПерсонал");
	...
	УстановитьПривилегированныйРежим(Истина);
	ИдентификаторЗадания = РегламентныеЗаданияСервер.УникальныйИдентификатор(Метаданные.РегламентныеЗадания.ПроверкаСостоянияПриложения1СПерсонал);
...
Процедура ЗаполнитьНастройкиПодключения(НастройкиПодключения) Экспорт
	...
	НастройкиПодключения.АдресРесурсовAPI 			= Настройки.АдресРесурсовAPI;
...
// Процедура регламентного задания ПроверкаСостоянияПриложения1СПерсонал
Процедура ПроверкаСостоянияПриложения() Экспорт

	ОбщегоНазначения.ПриНачалеВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.ПроверкаСостоянияПриложения1СПерсонал);
	
	Приложение = Перечисления.ПриложенияДляИнтеграции.УправлениеПерсоналом;
	
	Если ИнтеграцияУправлениеПерсоналомОбмен.РегламентныеЗаданияЗаблокированы(Приложение) Тогда
		Возврат;
	КонецЕсли;
	
	ИСДоступна = ИнтеграцияУправлениеПерсоналомОбмен.ИнформационнаяСистемаДоступна(Приложение);
	...
	ПриложениеЗаблокировано = Не ИСДоступна;
	РегистрыСведений.НастройкиПодключения1СПерсонал.УстановитьСостояниеБлокировки(ПриложениеЗаблокировано);

КонецПроцедуры

Процедура ПроверкаДоступностиИспользованияПриложения1СПерсонал() Экспорт
	
	ОбщегоНазначения.ПриНачалеВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.ПроверкаДоступностиИспользованияПриложения1СПерсонал);
	
	Если ПолучитьФункциональнуюОпцию("ИспользоватьИнтеграциюСПриложением1СПерсонал") Тогда
		Возврат;
	КонецЕсли;
	
	Если ИнтеграцияУправлениеПерсоналомМенеджер.ДоступноПодключениеПриложения1СПерсонал() Тогда
		Константы.ИспользоватьИнтеграциюСПриложением1СПерсонал.Установить(Истина);
	КонецЕсли;
...
Функция ПриложениеЗаблокировано() Экспорт
	...
	Настройки = РегистрыСведений.НастройкиПодключения1СПерсонал.Настройки();
	Возврат Настройки.ПриложениеЗаблокировано;
