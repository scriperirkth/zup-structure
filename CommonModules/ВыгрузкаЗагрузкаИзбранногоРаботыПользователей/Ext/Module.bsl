...
Функция ЭтоНавигационнаяСсылкаНаОбъектИнформационнойБазы(Знач СтруктураНавигационнойСсылки)
	...
	Если СтруктураНавигационнойСсылки.Протокол = "e1cib"
		И СтруктураНавигационнойСсылки.Тип = "data"
		И Не ПустаяСтрока(СтруктураНавигационнойСсылки.Параметры) Тогда // Не локализуется
		Возврат Истина;
	Иначе
		Возврат Ложь;
	КонецЕсли;
