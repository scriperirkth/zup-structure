...
Процедура УстановитьИспользованиеИндексацииШтатногоРасписания(Источник, Отказ, Замещение) Экспорт
	...
	Если ЗарплатаКадры.ОтключитьБизнесЛогикуПриЗаписи(Источник)
...
Процедура ЗапомнитьДанныеПоУмолчаниюНовогоПодразделенияПриЗаписи(Источник, Отказ) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ОрганизационнаяСтруктура") Тогда
		...
		Если МодульОрганизационнаяСтруктура.ЭтоОбъектСтруктурыПредприятия(Источник)
			И Не МодульОрганизационнаяСтруктура.ПодсистемаСостоянияСтруктурыПредприятияСуществует() Тогда
			Возврат;
		КонецЕсли;
	КонецЕсли;
