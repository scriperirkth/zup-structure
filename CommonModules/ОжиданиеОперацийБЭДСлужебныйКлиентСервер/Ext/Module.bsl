...
// 	Структура - Описание:
// * ПроцентПрогресса - Неопределено, Число - число процентов выполнения операции. Если не задано, индикатор прогресса 
// выводиться не будет. 
...
Функция НовыеПараметры() Экспорт
	...
	Параметры.Вставить("ПроцентПрогресса", Неопределено);
	Параметры.Вставить("ОперацияЗавершена", Ложь);
	Параметры.Вставить("ОтображатьПроценты", Ложь);
...
// Возвращаемое значение:
//  Структура:
//  * ИдентификаторОперации - Неопределено,УникальныйИдентификатор
Функция НовыеПараметрыОповещенияСобытияЗакрытияФормы() Экспорт
