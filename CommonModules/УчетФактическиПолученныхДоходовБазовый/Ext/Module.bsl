...
Процедура ЗарегистрироватьНовуюДатуПолученияДохода(Регистратор, Движения, МенеджерВременныхТаблиц, ДатаВыплаты, ДатаОперации, Отказ, Записывать = Ложь) Экспорт
	...
	ПеренесенныхДоходы.Колонки.Добавить("РегистрацияВНалоговомОргане", Новый ОписаниеТипов("СправочникСсылка.РегистрацииВНалоговомОргане"));
	ПеренесенныхДоходы.Колонки.Добавить("Подразделение", Метаданные.ОпределяемыеТипы.ТерриторияВыполненияРаботВОрганизации.Тип);
	...
	СтрокаИзмерений = "ФизическоеЛицо,КатегорияДохода,ДокументОснование,РегистрацияВНалоговомОргане,Подразделение";
	...
	|			И СведенияОДоходахНДФЛ.РегистрацияВНалоговомОргане = ВаловыеСуммы.РегистрацияВНалоговомОргане
	|			И СведенияОДоходахНДФЛ.Подразделение = ВаловыеСуммы.Подразделение
	|ГДЕ
	...
	Если Не Результат.Пустой() Тогда
		...
		Пока Выборка.Следующий() Цикл
			...
			ЗаполнитьЗначенияСвойств(ПеренесенныйДоход, Выборка, СтрокаИзмерений);
	...
	ПеренесенныхДоходы.Свернуть(СтрокаИзмерений + ", ОбщаяСуммаДохода, РанееПеренесеннаяСуммаДохода", "СуммаДохода");
	...
	|	ПеренесенныеДоходы.РегистрацияВНалоговомОргане КАК РегистрацияВНалоговомОргане,
	|	ПеренесенныеДоходы.Подразделение КАК Подразделение,
	...
	|	ПеренесенныеДоходы.РегистрацияВНалоговомОргане,
	|	ПеренесенныеДоходы.Подразделение,
	|	НЕОПРЕДЕЛЕНО,
	...
	|			И РасчетыНалогоплательщиковСБюджетомПоНДФЛ.РегистрацияВНалоговомОргане = Выплаты.РегистрацияВНалоговомОргане
	|			И РасчетыНалогоплательщиковСБюджетомПоНДФЛ.Подразделение = Выплаты.Подразделение
