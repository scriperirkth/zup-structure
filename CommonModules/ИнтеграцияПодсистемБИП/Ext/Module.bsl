...
// См. ОнлайнЗаказыПереопределяемый.ПриНастройкеОнлайнЗаказов.
//
Процедура ПриНастройкеОнлайнЗаказов(НастройкиОнлайнЗаказов) Экспорт
	
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриНастройкеОнлайнЗаказов Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриНастройкеОнлайнЗаказов(НастройкиОнлайнЗаказов);
	КонецЕсли;
...
// См. ОнлайнОплатыПереопределяемый.ПриНастройкеОнлайнОплат.
//
Процедура ПриНастройкеОнлайнОплат(НастройкиОнлайнОплат) Экспорт
	
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриНастройкеОнлайнОплат Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриНастройкеОнлайнОплат(НастройкиОнлайнОплат);
	КонецЕсли;
...
Функция СобытияБИП() Экспорт
	...
	// ОнлайнЗаказы
	События.Вставить("ПриНастройкеОнлайнЗаказов", Ложь);
	...
	// Онлайн оплаты
	События.Вставить("ПриНастройкеОнлайнОплат", Ложь);
