...
//
Функция ПолучитьИнформациюОНовости(Знач УИННовости, Знач ПрочиеПараметры) Экспорт
...
Функция РазрешенаРаботаСНовостямиТекущемуПользователю() Экспорт
	...
	Возврат ОбработкаНовостей.РазрешенаРаботаСНовостямиТекущемуПользователю();
