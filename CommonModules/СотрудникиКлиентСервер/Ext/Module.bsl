...
// Возвращает структуру параметров проверки уникальности физического лица.
// 
// Возвращаемое значение:
//  Структура:
...
Функция НовыеПараметрыПроверкиУникальностиФизическогоЛица() Экспорт
	
	ПараметрыПроверки = Новый Структура;
	
	ПараметрыПроверки.Вставить("ФизическоеЛицо", ПредопределенноеЗначение("Справочник.ФизическиеЛица.ПустаяСсылка"));
	ПараметрыПроверки.Вставить("ИНН", "");
	ПараметрыПроверки.Вставить("СтраховойНомерПФР", "");
	ПараметрыПроверки.Вставить("ДокументВид", "");
	ПараметрыПроверки.Вставить("ДокументСерия", "");
	ПараметрыПроверки.Вставить("ДокументНомер", "");
