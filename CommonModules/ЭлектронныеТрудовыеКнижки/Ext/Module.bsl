...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ЗаполнитьПредставленияОбъектовМероприятияТрудовойДеятельности");
	Методы.Вставить("ЗаполнитьСотрудниковЗаявленийОПредоставленииСведенийОТрудовойДеятельности");
	Методы.Вставить("ЗаполнитьКодыКатегорияТрудовыхФункций");
	Методы.Вставить("ЗаполнитьКодыТрудовыхФункцийПоДолжностям");
	Методы.Вставить("ЗаполнитьКодыКлассификатора2026годаВТрудовыхФункциях");
КонецПроцедуры
	...
	Если ИсточникиДанных.Получить("СведенияОПоследнихМероприятияхТрудовойДеятельности") <> Неопределено Тогда
		...
		Если ПолучитьФункциональнуюОпцию("ИспользоватьКадровыйУчет") Тогда
			...
			ТекстЗапросаПоследнихМероприятий =
				...
				|			ПО КадроваяИсторияСотрудников.ФизическоеЛицо = Мероприятия.ФизическоеЛицо
				...
				|				И КадроваяИсторияСотрудников.Сотрудник = Мероприятия.Сотрудник
		...
		Иначе
			...
			ТекстЗапросаПоследнихМероприятий =
				...
				|					И Мероприятия.ИдМероприятия = МероприятияОтмененные.ИдМероприятия
				|					И (МероприятияОтмененные.Отменено)
				|			ПО ТекущиеКадровыеДанныеСотрудников.ФизическоеЛицо = Мероприятия.ФизическоеЛицо
				|				И ТекущиеКадровыеДанныеСотрудников.ТекущаяОрганизация = Мероприятия.Организация
				|				И ТекущиеКадровыеДанныеСотрудников.Сотрудник = Мероприятия.Сотрудник
				|				И (НЕ Мероприятия.Регистратор В (&СведенияОПоследнихМероприятияхТрудовойДеятельности_ИсключаемыеРегистраторы))
		...
		ТекстЗапросаПоследнихМероприятий =
			...
			+	"ВЫБРАТЬ РАЗРЕШЕННЫЕ
			 	...
			 	|				И Мероприятия.ИдМероприятия = МероприятияОтмененные.ИдМероприятия
			 	|				И (МероприятияОтмененные.Отменено)
			 	|		ПО ДатыПоследнихМероприятийТрудовойДеятельности.ФизическоеЛицо = Мероприятия.ФизическоеЛицо
			 	...
			 	|			И ДатыПоследнихМероприятийТрудовойДеятельности.Сотрудник = Мероприятия.Сотрудник
			 	|ГДЕ
			 	|	НЕ Мероприятия.Отменено
			 	|	И НЕ ЕСТЬNULL(МероприятияОтмененные.Отменено, ЛОЖЬ)
			 	|
...
Функция ВидМероприятияПоНомеру(НомерВидаМероприятия) Экспорт
	...
	ВидПоНомеруМероприятия.Вставить("7", Перечисления.ВидыМероприятийТрудовойДеятельности.Приостановление);
	ВидПоНомеруМероприятия.Вставить("8", Перечисления.ВидыМероприятийТрудовойДеятельности.Возобновление);
	ВидПоНомеруМероприятия.Вставить("9", Перечисления.ВидыМероприятийТрудовойДеятельности.НачалоДоговораГПХ);
	ВидПоНомеруМероприятия.Вставить("10", Перечисления.ВидыМероприятийТрудовойДеятельности.ОкончаниеДоговораГПХ);
