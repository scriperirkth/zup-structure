...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ЗаполнитьДистанционнуюРаботуСотрудников");
	Методы.Вставить("ВключитьИспользованиеДистанционнойРаботы");
	Методы.Вставить("ЗаполнитьДанныеПриказовДистанционнойРаботы");
КонецПроцедуры
...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.1.36.41";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("d53a1bb1-b33f-11f0-8926-f4d4730d1494");
	Обработчик.Процедура = "ДистанционнаяРабота.ЗаполнитьДанныеПриказовДистанционнойРаботы";
	Обработчик.Комментарий = НСтр("ru = 'Заполнение данных приказов дистанционной работы сотрудников.'");
...
Процедура ЗаполнитьДанныеПриказовДистанционнойРаботы(ПараметрыОбновления = Неопределено) Экспорт
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	ДистанционнаяРаботаСотрудников.Регистратор КАК Регистратор,
	|	ДистанционнаяРаботаСотрудников.Сотрудник КАК Сотрудник
	|ПОМЕСТИТЬ ВТЗаписиКОбновлению
	|ИЗ
	|	РегистрСведений.ДистанционнаяРаботаСотрудников КАК ДистанционнаяРаботаСотрудников
	|ГДЕ
	|	НЕ ДистанционнаяРаботаСотрудников.Регистратор ССЫЛКА Документ.ПереносДанных
	|	И ДистанционнаяРаботаСотрудников.НомерПриказа = """"
	|	И ДистанционнаяРаботаСотрудников.ДатаПриказа = ДАТАВРЕМЯ(1, 1, 1)";

	РезультатЗапроса = ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ВыполнитьЗапросПолученияОбновляемыхДанных(
		Запрос, ПараметрыОбновления, "ВТЗаписиКОбновлению");
	...
	|	ВЫБОР
	|		КОГДА ЗаписиКОбновлению.Регистратор ССЫЛКА Документ.КадровыйПеревод
	|			ТОГДА ВЫРАЗИТЬ(ЗаписиКОбновлению.Регистратор КАК Документ.КадровыйПеревод).Номер
	|		КОГДА ЗаписиКОбновлению.Регистратор ССЫЛКА Документ.КадровыйПереводСписком
	|			ТОГДА ВЫРАЗИТЬ(ЗаписиКОбновлению.Регистратор КАК Документ.КадровыйПереводСписком).Номер
	|		КОГДА ЗаписиКОбновлению.Регистратор ССЫЛКА Документ.НачальнаяШтатнаяРасстановка
	|			ТОГДА ВЫРАЗИТЬ(ЗаписиКОбновлению.Регистратор КАК Документ.НачальнаяШтатнаяРасстановка).Номер
	|		КОГДА ЗаписиКОбновлению.Регистратор ССЫЛКА Документ.ПеремещениеВДругоеПодразделение
	|			ТОГДА ВЫРАЗИТЬ(ЗаписиКОбновлению.Регистратор КАК Документ.ПеремещениеВДругоеПодразделение).Номер
	|		КОГДА ЗаписиКОбновлению.Регистратор ССЫЛКА Документ.ПриемНаРаботу
	|			ТОГДА ВЫРАЗИТЬ(ЗаписиКОбновлению.Регистратор КАК Документ.ПриемНаРаботу).Номер
	|		КОГДА ЗаписиКОбновлению.Регистратор ССЫЛКА Документ.ПриемНаРаботуСписком
	|			ТОГДА ВЫРАЗИТЬ(ЗаписиКОбновлению.Регистратор КАК Документ.ПриемНаРаботуСписком).Номер
	|		ИНАЧЕ """"
	|	КОНЕЦ КАК Номер,
	|	ВЫБОР
	|		КОГДА ЗаписиКОбновлению.Регистратор ССЫЛКА Документ.КадровыйПеревод
	|			ТОГДА ВЫРАЗИТЬ(ЗаписиКОбновлению.Регистратор КАК Документ.КадровыйПеревод).НомерПриказа
	|		КОГДА ЗаписиКОбновлению.Регистратор ССЫЛКА Документ.КадровыйПереводСписком
	|			ТОГДА ВЫРАЗИТЬ(ЗаписиКОбновлению.Регистратор КАК Документ.КадровыйПереводСписком).НомерПриказа
	|		КОГДА ЗаписиКОбновлению.Регистратор ССЫЛКА Документ.ПеремещениеВДругоеПодразделение
	|			ТОГДА ВЫРАЗИТЬ(ЗаписиКОбновлению.Регистратор КАК Документ.ПеремещениеВДругоеПодразделение).НомерПриказа
	|		КОГДА ЗаписиКОбновлению.Регистратор ССЫЛКА Документ.ПриемНаРаботу
	|			ТОГДА ВЫРАЗИТЬ(ЗаписиКОбновлению.Регистратор КАК Документ.ПриемНаРаботу).НомерПриказа
	|		КОГДА ЗаписиКОбновлению.Регистратор ССЫЛКА Документ.ПриемНаРаботуСписком
	|			ТОГДА ВЫРАЗИТЬ(ЗаписиКОбновлению.Регистратор КАК Документ.ПриемНаРаботуСписком).НомерПриказа
	|		ИНАЧЕ """"
	|	КОНЕЦ КАК НомерПриказа,
	|	ВЫБОР
	|		КОГДА ЗаписиКОбновлению.Регистратор ССЫЛКА Документ.КадровыйПеревод
	|			ТОГДА ВЫРАЗИТЬ(ЗаписиКОбновлению.Регистратор КАК Документ.КадровыйПеревод).Дата
	|		КОГДА ЗаписиКОбновлению.Регистратор ССЫЛКА Документ.КадровыйПереводСписком
	|			ТОГДА ВЫРАЗИТЬ(ЗаписиКОбновлению.Регистратор КАК Документ.КадровыйПереводСписком).Дата
	|		КОГДА ЗаписиКОбновлению.Регистратор ССЫЛКА Документ.НачальнаяШтатнаяРасстановка
	|			ТОГДА ВЫРАЗИТЬ(ЗаписиКОбновлению.Регистратор КАК Документ.НачальнаяШтатнаяРасстановка).Дата
	|		КОГДА ЗаписиКОбновлению.Регистратор ССЫЛКА Документ.ПеремещениеВДругоеПодразделение
	|			ТОГДА ВЫРАЗИТЬ(ЗаписиКОбновлению.Регистратор КАК Документ.ПеремещениеВДругоеПодразделение).Дата
	|		КОГДА ЗаписиКОбновлению.Регистратор ССЫЛКА Документ.ПриемНаРаботу
	|			ТОГДА ВЫРАЗИТЬ(ЗаписиКОбновлению.Регистратор КАК Документ.ПриемНаРаботу).Дата
	|		КОГДА ЗаписиКОбновлению.Регистратор ССЫЛКА Документ.ПриемНаРаботуСписком
	|			ТОГДА ВЫРАЗИТЬ(ЗаписиКОбновлению.Регистратор КАК Документ.ПриемНаРаботуСписком).Дата
	|		ИНАЧЕ """"
	...
	ОписаниеБлокировки = ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ОписаниеБлокируемыхДанных(
	...
	Пока Выборка.СледующийПоЗначениюПоля("Регистратор") Цикл
		...
		Если ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.НачатьОбновлениеДанных(ОписаниеБлокировки,
			ПараметрыОбновления) Тогда

			НаборЗаписей = РегистрыСведений.ДистанционнаяРаботаСотрудников.СоздатьНаборЗаписей();
			...
			Для Каждого Запись Из НаборЗаписей Цикл
				Запись.НомерПриказа = ЗарплатаКадрыОтчеты.НомерНаПечать(Выборка.Номер, Выборка.НомерПриказа);
				Запись.ДатаПриказа = Выборка.ДатаПриказа;
			КонецЦикла;
	...
	Если СписокРегистраторовДляОбновленияИнтервальногоРегистра.Количество() > 0 Тогда
		...
		Запрос.УстановитьПараметр("СписокОбновленныхРегистраторов",
			СписокРегистраторовДляОбновленияИнтервальногоРегистра);

		Запрос.Текст =
		"ВЫБРАТЬ РАЗЛИЧНЫЕ
		|	ЗаписиКОбновлению.Сотрудник КАК Сотрудник
		|ПОМЕСТИТЬ ВТОтборДляПереформирования
		|ИЗ
		|	ВТЗаписиКОбновлению КАК ЗаписиКОбновлению
		|ГДЕ
		|	ЗаписиКОбновлению.Регистратор В (&СписокОбновленныхРегистраторов)";

		Запрос.Выполнить();

		РегистрыСведений.ДистанционнаяРаботаСотрудников.ОбновитьДвиженияИнтервальногоРегистра(
			Запрос.МенеджерВременныхТаблиц);
...
Функция ДобавитьПолеСведенийОДистанционнойРаботеСотрудников(Знач ИмяПоля, ТекстыОписанияПолей, ИсточникиДанных) Экспорт
...
Функция ДобавитьКритерийПоискаПоСведениямОДистанционнойРаботеСотрудников(КритерииПоиска, УсловиеПоиска) Экспорт
	...
	Если НеобходимыСведенияОДистанционнойРаботеСотрудников(УсловиеПоиска.ЛевоеЗначение) Тогда
		...
		ИначеЕсли ИмяПоля = ВРег("РаботаетДистанционноНомерПриказа") Тогда
			УсловиеПоиска.ЛевоеЗначение = "НомерПриказа";
		ИначеЕсли ИмяПоля = ВРег("РаботаетДистанционноДатаПриказа") Тогда
...
Процедура ЗаполнитьПоляПредставленийКадровыхДанныхСотрудников(ДополнительныеПоляПредставлений, ПутьКПолямСотрудника, ИсключаемыеПоля) Экспорт
	...
	ОписаниеПоля.ПутьПоляСКД = ПутьКПолямСотрудника + ".ДистанционнаяРабота.РаботаетДистанционно";
	...
	ОписаниеПоля.ПутьПоляСКД = ПутьКПолямСотрудника + ".ДистанционнаяРабота.РаботаетДистанционноДатаРегистрации";
	ЗарплатаКадрыОбщиеНаборыДанных.ДобавитьПолеПредставления(ДополнительныеПоляПредставлений, ОписаниеПоля, ИсключаемыеПоля);
	
	ОписаниеПоля = ЗарплатаКадрыОбщиеНаборыДанных.ОписаниеДополнительногоПоляПредставлений();
	ОписаниеПоля.ИмяПоля = "РаботаетДистанционноРегистратор";
	ОписаниеПоля.ПустоеЗначениеНаЯзыкеЗапросов = "НЕОПРЕДЕЛЕНО";
	ОписаниеПоля.ПутьПоляСКД = ПутьКПолямСотрудника + ".ДистанционнаяРабота.РаботаетДистанционноРегистратор";
	ЗарплатаКадрыОбщиеНаборыДанных.ДобавитьПолеПредставления(ДополнительныеПоляПредставлений, ОписаниеПоля, ИсключаемыеПоля);
	
	ОписаниеПоля = ЗарплатаКадрыОбщиеНаборыДанных.ОписаниеДополнительногоПоляПредставлений();
	ОписаниеПоля.ИмяПоля = "РаботаетДистанционноНомерПриказа";
	ОписаниеПоля.ПустоеЗначениеНаЯзыкеЗапросов = """""";
	ОписаниеПоля.ПутьПоляСКД = ПутьКПолямСотрудника + ".ДистанционнаяРабота.РаботаетДистанционноНомерПриказа";
	ЗарплатаКадрыОбщиеНаборыДанных.ДобавитьПолеПредставления(ДополнительныеПоляПредставлений, ОписаниеПоля, ИсключаемыеПоля);
	
	ОписаниеПоля = ЗарплатаКадрыОбщиеНаборыДанных.ОписаниеДополнительногоПоляПредставлений();
	ОписаниеПоля.ИмяПоля = "РаботаетДистанционноДатаПриказа";
	ОписаниеПоля.ПустоеЗначениеНаЯзыкеЗапросов = "ДАТАВРЕМЯ(1, 1, 1)";
	ОписаниеПоля.ПутьПоляСКД = ПутьКПолямСотрудника + ".ДистанционнаяРабота.РаботаетДистанционноДатаПриказа";
	ЗарплатаКадрыОбщиеНаборыДанных.ДобавитьПолеПредставления(ДополнительныеПоляПредставлений, ОписаниеПоля, ИсключаемыеПоля);
...
Процедура ПриемНаРаботуСведенияОДистанционнойРаботе(ДанныеДляПроведения, ДокументСсылка) Экспорт
	...
	Запрос.Текст =
		...
		|	ПриемНаРаботу.Ссылка.НомерПриказа КАК НомерПриказа,
	...
	ЗаполнитьДанныеПриказовСведенийОДистанционнойРаботеСотрудников(СведенияОДистанционнойРаботеСотрудников);
...
Процедура КадровыйПереводСведенияОДистанционнойРаботе(ДанныеДляПроведения, ДокументСсылка) Экспорт
	...
	Запрос.Текст =
		...
		|	Сотрудники.Ссылка.НомерПриказа КАК НомерПриказа,
		|	Сотрудники.Ссылка.Дата КАК ДатаПриказа
		|ИЗ
...
Процедура НачальнаяШтатнаяРасстановкаСведенияОДистанционнойРаботе(ДанныеДляПроведения, ДокументСсылка) Экспорт
	...
	Запрос.Текст =
		...
		|	НачальнаяШтатнаяРасстановка.Ссылка.Номер КАК Номер,
		|	"""" КАК НомерПриказа,
		|	НачальнаяШтатнаяРасстановка.Ссылка.Дата КАК ДатаПриказа
		|ИЗ
...
Процедура ПеремещениеВДругоеПодразделениеСведенияОДистанционнойРаботе(ДанныеДляПроведения, Запрос) Экспорт
	...
	Запрос.Текст =
		...
		|	ПеремещениеВДругоеПодразделениеСотрудники.Ссылка.Номер КАК Номер,
		|	ПеремещениеВДругоеПодразделениеСотрудники.Ссылка.НомерПриказа КАК НомерПриказа,
...
Функция НеобходимыСведенияОДистанционнойРаботеСотрудников(Знач ИмяПоля)
	...
	Возврат ИмяПоля = ВРег("РаботаетДистанционноПериодРегистрации")
		...
		Или ИмяПоля = ВРег("РаботаетДистанционноНомерПриказа")
		Или ИмяПоля = ВРег("РаботаетДистанционноДатаПриказа");
...
Функция ПутьКДаннымСведенийОДистанционнойРаботеСотрудников(Знач ИмяПоля)
	...
	ИначеЕсли ИмяПоляВВерхнемРегистре = ВРег("РаботаетДистанционноНомерПриказа") Тогда
		ПутьКДанным =
		"	ВЫБОР
		|		КОГДА СведенияОДистанционнойРаботеСотрудников.РаботаетДистанционно ТОГДА
		|			СведенияОДистанционнойРаботеСотрудников.НомерПриказа
		|		ИНАЧЕ """"
		|	КОНЕЦ";
	ИначеЕсли ИмяПоляВВерхнемРегистре = ВРег("РаботаетДистанционноДатаПриказа") Тогда
		ПутьКДанным =
		"	ВЫБОР
		|		КОГДА СведенияОДистанционнойРаботеСотрудников.РаботаетДистанционно ТОГДА
		|			СведенияОДистанционнойРаботеСотрудников.ДатаПриказа
...
Процедура ЗаполнитьДанныеПриказовСведенийОДистанционнойРаботеСотрудников(СведенияОДистанционнойРаботеСотрудников)
	
	Для Каждого СтрокаДанныхДляПроведения Из СведенияОДистанционнойРаботеСотрудников Цикл
		СтрокаДанныхДляПроведения.НомерПриказа = ЗарплатаКадрыОтчеты.НомерНаПечать(СтрокаДанныхДляПроведения.Номер,
			СтрокаДанныхДляПроведения.НомерПриказа);
	КонецЦикла;
