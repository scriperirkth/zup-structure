...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	// Для проверки внедрения новостей идентификатор в момент обновления должен быть заполнен.
	Если Описание.ИдентификаторИнтернетПоддержки = ""
		И ОбновлениеИнформационнойБазы.ВыполняетсяОбновлениеИнформационнойБазы() Тогда
		Описание.ИдентификаторИнтернетПоддержки = СтроковыеФункции.СтрокаЛатиницей(Метаданные.Имя);
	КонецЕсли;
