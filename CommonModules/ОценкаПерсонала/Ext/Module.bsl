...
Процедура ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание) Экспорт
	...
	Описание = Описание + "
		|Справочник.МероприятияОценкиПерсонала.Чтение.ГруппыФизическихЛиц
		|Справочник.МероприятияОценкиПерсонала.Изменение.ГруппыФизическихЛиц";
...
Функция ВнешняяСсылкаНаСписокДоступныхАнкет(ПользовательИБ, Пароль = Неопределено)
	...
	Если Не ЗначениеЗаполнено(АдресПубликацииИБ) Тогда
		ТекстСообщения =
			НСтр("ru = 'Не удалось сформировать веб-ссылку на форму анкеты в тексте приглашения, т.к. в настройках не указан адрес публикации информационной базы в интернете.
...
Процедура ПолучитьНастройкиПрограммы(НастройкиПриложения) Экспорт
	...
	Настройки.Прочитать();
	НастройкиСтруктура = ОбщегоНазначения.СтруктураПоМенеджеруЗаписи(Настройки, Метаданные.РегистрыСведений.НастройкиОценкиПерсонала);
	НастройкиПриложения.Вставить("НастройкиОценкиПерсонала", НастройкиСтруктура);
