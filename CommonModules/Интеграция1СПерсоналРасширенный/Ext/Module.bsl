...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("СоздатьРешенияОПриемеНаРаботу");
КонецПроцедуры
...
// Устанавливает значение для ФО ПоказыватьПриглашение1СПерсонал
//
//	Параметры:
...
Процедура ОбработатьИзменениеВыполняетсяНачальнаяНастройка(ВыполняетсяНачальнаяНастройка) Экспорт
	...
	ПоказыватьПриглашение = ПолучитьФункциональнуюОпцию("ИспользоватьИнтеграциюСПриложением1СПерсонал")
		И Не (ВыполняетсяНачальнаяНастройка Или ПолучитьФункциональнуюОпцию("ПоказыватьПриглашение1СПерсонал"));
