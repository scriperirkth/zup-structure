...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ОчиститьПоляРезервовПоОплатеТруда");
	Методы.Вставить("ЗаполнитьДвиженияОтражениеВБухучете");
КонецПроцедуры
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ДанныеДляОтраженияУдержанногоНДФЛВБухучете);
	...
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ДанныеДляОтраженияУдержанногоНДФЛВБухучете, "ОтражениеУдержанногоНДФЛВБухучетеПоСтатьям");
	Вариант.ФункциональныеОпции = ФункциональныеОпции;
	...
	Вариант.ФункциональныеОпции = ФункциональныеОпции;
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ДанныеДляОтраженияУдержанногоНДФЛВБухучете, "ОтражениеУдержанногоНДФЛВБухучете");
	Вариант.ФункциональныеОпции = ФункциональныеОпции;
