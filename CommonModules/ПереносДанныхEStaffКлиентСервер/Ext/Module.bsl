...
Функция КлючЛичныхДанныхКандидата() Экспорт
	Возврат "person";
КонецФункции
...
// * Считывается - Булево
// * ВОдномФайле - Булево
// * ХранениеФайлов - Массив из Строка
// * СопоставляетсяПользователем - Булево 
// * Иерархический - Булево
// * ФильтруетсяПо - Строка
// * Ключ - Строка
// * ИменаСвойств - Строка
// * ИмяСвойстваИдентификатор - Строка
// * ИмяСвойстваНаименование - Строка
// * ИмяТаблицы - Строка
...
Функция НовоеОписаниеОбъекта(ИмяТаблицыОбъектов)
	...
	ОписаниеОбъекта.Вставить("ХранениеФайлов", Новый Массив);
	...
	ОписаниеОбъекта.Вставить("Ошибки", Новый Массив);
...
Функция ОписаниеФизическогоЛица()
	...
	ОписаниеОбъекта.Ключ = КлючЛичныхДанныхКандидата();
...
// Возвращаемое значение:
//  Массив из Структура: см. НовоеОписаниеОбъекта
