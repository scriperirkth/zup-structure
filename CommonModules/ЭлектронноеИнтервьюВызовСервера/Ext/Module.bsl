...
Функция ИзменяемыеХарактеристики(СписокДействий, СписокХарактеристик) Экспорт
	...
	Запрос.Текст =
		...
		|ГДЕ
		|	ДействияСотрудниковХарактеристикиПерсонала.Ссылка В(&СписокДействий)
		|	И ДействияСотрудниковХарактеристикиПерсонала.Характеристика.ПометкаУдаления = ЛОЖЬ
		|	И ДействияСотрудниковХарактеристикиПерсонала.Характеристика.ВАрхиве = ЛОЖЬ
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
