...
//
// Параметры:
//  Префикс - Строка - длиной 2 символа. Префикс кодов и номеров объектов информационной базы по умолчанию.
//
...
Процедура ПриПоискеИмениПланаОбменаЧерезУниверсальныйФормат(
	...
	КонфигурацииЗарплатаКадрыРасширенный.ПриПоискеИмениПланаОбменаЧерезУниверсальныйФормат(
		ИмяПланаОбмена,
