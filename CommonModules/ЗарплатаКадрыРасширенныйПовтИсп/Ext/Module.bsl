...
Функция НачислениеРайонныйКоэффициент(ПрименяетсяАУСН) Экспорт
	...
	Возврат ПланыВидовРасчета.Начисления.НачислениеРайонныйКоэффициент(ПрименяетсяАУСН);
	
КонецФункции

Функция НачислениеСевернаяНадбавка(ПрименяетсяАУСН) Экспорт
	
	Возврат ПланыВидовРасчета.Начисления.НачислениеСевернаяНадбавка(ПрименяетсяАУСН);
	
КонецФункции

Функция НачислениеНадбавкаЗаВредность(ПрименяетсяАУСН) Экспорт
	
	Возврат ПланыВидовРасчета.Начисления.НачислениеНадбавкаЗаВредность(ПрименяетсяАУСН);
	
КонецФункции

Функция ОрганизацияПрименяетАУСН(Организация, Период) Экспорт
	
	ПрименяемыйТариф = РегистрыСведений.ПрименяемыеТарифыСтраховыхВзносов.ПолучитьПоследнее(
		Период, Новый Структура("ГоловнаяОрганизация", ЗарплатаКадры.ГоловнаяОрганизация(Организация)));
...
Функция СписочныеДокументыДляОтбора() Экспорт
	СписочныеДокументы = Новый Соответствие;
	СписочныеДокументы.Вставить(Тип("ДокументСсылка.ДоходВНатуральнойФорме"), Истина);
	СписочныеДокументы.Вставить(Тип("ДокументСсылка.МатериальнаяПомощь"), Истина);
	СписочныеДокументы.Вставить(Тип("ДокументСсылка.НачислениеЗаПервуюПоловинуМесяца"), Истина);
	СписочныеДокументы.Вставить(Тип("ДокументСсылка.НачислениеЗарплаты"), Истина);
	СписочныеДокументы.Вставить(Тип("ДокументСсылка.НачислениеПоДоговорам"), Истина);
	СписочныеДокументы.Вставить(Тип("ДокументСсылка.ОтгулСписком"), Истина);
	СписочныеДокументы.Вставить(Тип("ДокументСсылка.ОтпускБезСохраненияОплатыСписком"), Истина);
	СписочныеДокументы.Вставить(Тип("ДокументСсылка.Премия"), Истина);
	СписочныеДокументы.Вставить(Тип("ДокументСсылка.ПрогулНеявкаСписком"), Истина);
	СписочныеДокументы.Вставить(Тип("ДокументСсылка.ПростойСотрудников"), Истина);
	СписочныеДокументы.Вставить(Тип("ДокументСсылка.РазовоеНачисление"), Истина);
	СписочныеДокументы.Вставить(Тип("ДокументСсылка.УвольнениеСписком"), Истина);
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ГосударственнаяСлужба") Тогда
		МодульГосударственнаяСлужба = ОбщегоНазначения.ОбщийМодуль("ГосударственнаяСлужба");
		МодульГосударственнаяСлужба.СписочныеДокументыДляОтбора(СписочныеДокументы);
	КонецЕсли;
	Возврат СписочныеДокументы;
КонецФункции
