...
//  ДобавлятьЗначенияХарактеристик 	- Структура - Структура параметров подбора
...
//
Процедура ОткрытьФормуПодбораХарактеристик(Форма, ПараметрыПодбора, ОповещениеОЗакрытии = Неопределено, СтрокаСкрываемыхРеквизитов = "") Экспорт
	
	Если ПараметрыПодбора.Свойство("ДобавлятьЗначенияХарактеристик") Тогда
		ДобавлятьЗначенияХарактеристик = ПараметрыПодбора.ДобавлятьЗначенияХарактеристик;
	Иначе
		ДобавлятьЗначенияХарактеристик = Истина;
	КонецЕсли;
	...
	Если Не ПустаяСтрока(СтрокаСкрываемыхРеквизитов) Тогда
		...
		КонецЦикла; 
		ПараметрыПодбора.Вставить("СкрытьРеквизиты", СкрытьРеквизиты);
	КонецЕсли;
	
	ОткрытьФорму("ОбщаяФорма.ПодборХарактеристикПерсонала", ПараметрыПодбора, Форма, Форма.УникальныйИдентификатор,,, Оповещение);
...
Процедура ШтатноеРасписаниеОткрытьФормуДобавленияДействий(Форма, Отказ) Экспорт 
	...
	ОткрытьФорму("Справочник.ДействияСотрудников.Форма.ФормаСписка", ПараметрыФормы, Форма.Элементы.ДействияСотрудников);
	
КонецПроцедуры

Процедура ШтатноеРасписаниеДействияСотрудниковОбработкаВыбора(Форма, ВыбранноеЗначение) Экспорт
	...
	ДополнительныеПараметры.Вставить("Подключаемый_");
	ДополнительныеПараметры.Вставить("ИмяРеквизитаТаблицыДействий", "ДействияСотрудников");
	
	ЗавершениеДобавленияДействий(ВыбранноеЗначение, ДополнительныеПараметры);
...
Процедура ПодобратьХарактеристики(Форма) Экспорт
	...
	ОткрытьФормуПодбораХарактеристик(
		Форма,
		ПараметрыПодбора,
		Новый ОписаниеОповещения("Подключаемый_ДобавитьХарактеристикиПерсоналаНаКлиенте", Форма));
...
Функция ЗначенияЗаполненияХарактеристик() Экспорт
	
	ЗначенияЗаполнения = Новый Структура;
	ЗначенияЗаполнения.Вставить("СтруктураЗначенийПоУмолчанию", Новый Структура);
