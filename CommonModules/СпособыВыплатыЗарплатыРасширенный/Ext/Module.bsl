...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("УточнитьСпособВыплатыАванса");
	Методы.Вставить("УстановитьМежрасчетныйПорядокВыплатыПриОкончательномРасчетеПоОснованиям");
	Методы.Вставить("ДобавитьВыплатуНачисленияЗарплаты");
КонецПроцедуры
...
Процедура УточнитьСпособВыплатыАванса(ПараметрыОбновления = Неопределено) Экспорт
	...
	|	Справочник.СпособыВыплатыЗарплаты КАК СпособыВыплатыЗарплаты
	|ГДЕ
	|	СпособыВыплатыЗарплаты.ХарактерВыплаты = ЗНАЧЕНИЕ(Перечисление.ХарактерВыплатыЗарплаты.Аванс)
	|	И СпособыВыплатыЗарплаты.Поставляемый";
	...
	Если РезультатЗапроса.Пустой() Тогда
		...
		ПараметрыОтбора.Вставить(
			"ВидДокументаОснования", 
			Перечисления.ВидыДокументовОснованийВедомостейНаВыплатуЗарплаты.НачислениеЗаПервуюПоловинуМесяца);
		ПараметрыОтбора.Вставить(
			"ХарактерВыплаты", 
	...
	Иначе
		...
		Выборка.Следующий();
		СпособВыплатыОбъект = Выборка.Ссылка.ПолучитьОбъект();
		СпособВыплатыОбъект.ВидДокументаОснования = Перечисления.ВидыДокументовОснованийВедомостейНаВыплатуЗарплаты.НачислениеЗаПервуюПоловинуМесяца;
...
Функция ОписанияПоставляемых()
	...
	Описание.ВидДокументаОснования   = Перечисления.ВидыДокументовОснованийВедомостейНаВыплатуЗарплаты.НачислениеЗаПервуюПоловинуМесяца;
