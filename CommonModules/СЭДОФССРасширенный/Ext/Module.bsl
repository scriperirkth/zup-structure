...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("СоздатьСведенияОЗастрахованномЛицеФСС", Истина);
	Методы.Вставить("ДобавитьРолиСреднегоВПользовательскиеПрофили");
	Методы.Вставить("АдаптацияКУчетуВРазрезеСтрахователей");
	Методы.Вставить("ПровестиВсеДокументыСреднийЗаработокСЭДО");
	Методы.Вставить("ОбновитьСведенияОСогласииВФоне", Истина);
КонецПроцедуры
