...
Функция ПериодОтсутствия(Знач Объект) Экспорт
...
//  ПроверятьНеобходимостьУстановки - Булево - если Истина, то проверяется необходимость установки форм перед непосредственной установкой
//
// Возвращаемое значение:
// Булево - признак изменения состава форм рабочего стола
//
Функция УстановленРабочийСтолПользователя(ИмяПользователя = "", ПроверятьНеобходимостьУстановки = Ложь) Экспорт
	
	Возврат КадровыйУчетРасширенный.УстановленРабочийСтолПользователя(ИмяПользователя, ПроверятьНеобходимостьУстановки);
