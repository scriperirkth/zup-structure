...
//
Процедура СформироватьВТНачисленияСДаннымиУчета(Организация, ПериодРегистрации, МенеджерВременныхТаблиц, ИсключаемыйРегистратор, ИмяТаблицыНачислений) Экспорт
	УчетСтраховыхВзносовРасширенный.СформироватьВТНачисленияСДаннымиУчета(Организация, ПериодРегистрации, МенеджерВременныхТаблиц, ИсключаемыйРегистратор, ИмяТаблицыНачислений)
КонецПроцедуры
...
//
Процедура СоздатьВТКлассыУсловийТруда(МенеджерВременныхТаблиц, Организация = Неопределено) Экспорт
	УчетСтраховыхВзносовРасширенный.СоздатьВТКлассыУсловийТруда(МенеджерВременныхТаблиц, Организация);
КонецПроцедуры
...
Процедура ДополнитьПоляЗапросаРабочимМестом(Организация, Запрос, ИмяТаблицы, ДобавитьПредставление, ВключатьИспользованиеРесурса, ЗамещатьДолжность) Экспорт
	УчетСтраховыхВзносовРасширенный.ДополнитьПоляЗапросаРабочимМестом(Организация, Запрос, ИмяТаблицы, ДобавитьПредставление, ВключатьИспользованиеРесурса, ЗамещатьДолжность);
КонецПроцедуры
