...
Процедура ПриНастройкеПроверкиМетодовВызываемыхКакПроизвольныйКод(Настройки) Экспорт
	...
	ЗарплатаКадрыВнутренний.ПриНастройкеПроверкиМетодовВызываемыхКакПроизвольныйКод(Настройки);
...
Процедура ЭтоФормаОбъекта(Форма, ЭтоФормаОбъекта) Экспорт
	...
	ЗарплатаКадрыВнутренний.ЭтоФормаОбъекта(Форма, ЭтоФормаОбъекта);
...
Процедура ИмяРеквизитаФормыСодержащегоИнтегрируемыйОбъект(Форма, ИмяРеквизита) Экспорт
	...
	ЗарплатаКадрыВнутренний.ИмяРеквизитаФормыСодержащегоИнтегрируемыйОбъект(Форма, ИмяРеквизита);
...
Процедура ТаблицаДанныхНСИДляВыгрузки(СсылкиНаОбъектыНСИ, СвойстваОбъектаXDTO, ТаблицаНСИ) Экспорт
	...
	ЗарплатаКадрыВнутренний.ТаблицаДанныхНСИДляВыгрузки(СсылкиНаОбъектыНСИ, СвойстваОбъектаXDTO, ТаблицаНСИ);
...
Процедура СоздатьДокументыБИА(СсылкаНаОбъектИсточник, ДокументыБИА) Экспорт
	...
	ЗарплатаКадрыВнутренний.СоздатьДокументыБИА(СсылкаНаОбъектИсточник, ДокументыБИА);
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("СтатьиРасходовЗарплатаНачальноеЗаполнениеПоСпособамРасчетов");
КонецПроцедуры
