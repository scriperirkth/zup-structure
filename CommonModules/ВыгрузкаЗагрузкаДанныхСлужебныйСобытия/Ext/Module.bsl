...
Функция ОписанияТиповИсключаемыхИзВыгрузкиЗагрузки() Экспорт 
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ТехнологияСервиса.ВидыПриложений") Тогда
		МодульВидыПриложенийСлужебный = ОбщегоНазначения.ОбщийМодуль("ВидыПриложенийСлужебный");
		МодульВидыПриложенийСлужебный.ПриЗаполненииТиповИсключаемыхИзВыгрузкиЗагрузки(Типы);
	КонецЕсли;
	
	Если ОбщегоНазначения.ПодсистемаСуществует("ТехнологияСервиса.ЛичныйКабинет") Тогда
		МодульЛичныйКабинетСервиса = ОбщегоНазначения.ОбщийМодуль("ЛичныйКабинетСервиса");
		МодульЛичныйКабинетСервиса.ПриЗаполненииТиповИсключаемыхИзВыгрузкиЗагрузки(Типы);
	КонецЕсли;
