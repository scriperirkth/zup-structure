	...
	Если Не Настройки.ОбновлятьАвтоматически Тогда
		...
		РаботаСКлассификаторами.ЗаписатьИнформациюВЖурналРегистрации(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Обработка классификатора %1 не требуется, т.к. настройка %2 имеет значение Ложь
					|подробнее см. реализацию метода %3
					|и %4.'"),
				ОписаниеФайла.Идентификатор,
				"ОбновлятьАвтоматически",
				"РаботаСКлассификаторамиПереопределяемый.ПриДобавленииКлассификаторов",
				"ИнтеграцияПодсистемБИП.ПриДобавленииКлассификаторов"),
			Ложь);
		Возврат;
	КонецЕсли;
