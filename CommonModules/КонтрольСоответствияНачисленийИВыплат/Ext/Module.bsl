...
Процедура ПередЗаписьюЗарплатыКВыплате(Источник, Отказ, Замещение) Экспорт
	...
	|ГДЕ
	|	ЗарплатаКВыплате.Регистратор В (&Регистраторы)
	|
	|СГРУППИРОВАТЬ ПО
...
Процедура СоздатьВТУвеличениеЗадолженности(МенеджерВременныхТаблиц, Регистраторы, Источник)
	...
	|		#ЗарплатаКВыплате КАК ЗарплатаКВыплате
	|	ГДЕ
	|		ЗарплатаКВыплате.Регистратор = &Регистраторы) КАК ЗарплатаКВыплате
	|
	|СГРУППИРОВАТЬ ПО
	|	ЗарплатаКВыплате.ВидДвижения,
	|	ЗарплатаКВыплате.ДокументОснование,
