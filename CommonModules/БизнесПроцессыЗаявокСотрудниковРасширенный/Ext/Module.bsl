...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ПеренестиЗаявкиКабинетаСотрудниковВЗаявкиСотрудников");
	Методы.Вставить("ОбновитьИспользованиеБизнесПроцессов");
	Методы.Вставить("ОбновитьРолиИсполнителейЗаявокСотрудников");
	Методы.Вставить("ОбновитьТочкиМаршрутовБизнесПроцессов");
	Методы.Вставить("ОбновитьИсполнителейЗаявокСотрудников");
...
#Область ОбновлениеДляИспользованияЭДОБЗК
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия			= "3.1.19.33";
	Обработчик.Процедура		= "БизнесПроцессы.ЗаявкаСотрудникаОтсутствие.ОбновлениеДляИспользованияЭДОБЗК";
	Обработчик.РежимВыполнения	= ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ОсновнойРежимВыполненияОбновления();
	Обработчик.Идентификатор    = Новый УникальныйИдентификатор("3d0bc515-1d39-44a6-a885-b677c2478255");
	Обработчик.Комментарий      = НСтр("ru = 'Подготовка заявок сотрудников с предупреждением об отсутствии для работы с использованием ЭДО.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия			= "3.1.19.33";
	Обработчик.Процедура		= "БизнесПроцессы.ЗаявкаСотрудникаСправкаОстаткиОтпусков.ОбновлениеДляИспользованияЭДОБЗК";
	Обработчик.РежимВыполнения	= ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ОсновнойРежимВыполненияОбновления();
	Обработчик.Идентификатор    = Новый УникальныйИдентификатор("a9905a76-12ca-40bc-93d3-35aa4e493a59");
	Обработчик.Комментарий      = НСтр("ru = 'Подготовка заявок сотрудников на получение справки об остатках отпусков для работы с использованием ЭДО.'");

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия			= "3.1.19.33";
	Обработчик.Процедура		= "БизнесПроцессы.ЗаявкаСотрудникаСправкаСМестаРаботы.ОбновлениеДляИспользованияЭДОБЗК";
	Обработчик.РежимВыполнения	= ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ОсновнойРежимВыполненияОбновления();
	Обработчик.Идентификатор    = Новый УникальныйИдентификатор("0a897e6d-2f47-448b-a351-c90d67ae5b5e");
	Обработчик.Комментарий      = НСтр("ru = 'Подготовка заявок сотрудников на получение справки с места работы для работы с использованием ЭДО.'");
...
#Область ЗаполнитьСодержимоеДокументаЭДОБЗКЗаявокСотрудников
	...
	Обработчик.Процедура       	= "БизнесПроцессы.ЗаявкаСотрудникаДобровольныеСтраховыеВзносы.ЗаполнитьСодержимоеДокументаЭДОБЗКЗаявокСотрудников";
	Обработчик.РежимВыполнения 	= ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ОсновнойРежимВыполненияОбновления();
	Обработчик.Идентификатор   	= Новый УникальныйИдентификатор("d6d6a7b1-4ab5-453e-bfc8-9656d8f16a8f");
	Обработчик.Комментарий     	= НСтр("ru = 'Заполнение реквизита содержимое документа у документов эдо по заявкам сотрудника на добровольные страховые взносы.'");

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия          	= "3.1.21.3";
	Обработчик.Процедура       	= "БизнесПроцессы.ЗаявкаСотрудникаОтсутствие.ЗаполнитьСодержимоеДокументаЭДОБЗКЗаявокСотрудников";
	Обработчик.РежимВыполнения 	= ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ОсновнойРежимВыполненияОбновления();
	Обработчик.Идентификатор   	= Новый УникальныйИдентификатор("98ef2adc-e5df-4293-8cf5-fe7bdec67404");
	Обработчик.Комментарий     	= НСтр("ru = 'Заполнение реквизита содержимое документа у документов эдо по заявкам сотрудника с предупреждением об отсутствии.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия          	= "3.1.21.3";
	Обработчик.Процедура       	= "БизнесПроцессы.ЗаявкаСотрудникаСправкаОстаткиОтпусков.ЗаполнитьСодержимоеДокументаЭДОБЗКЗаявокСотрудников";
	Обработчик.РежимВыполнения 	= ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ОсновнойРежимВыполненияОбновления();
	Обработчик.Идентификатор   	= Новый УникальныйИдентификатор("d442ff9e-fb68-40d4-a4ab-32db998e179f");
	Обработчик.Комментарий     	= НСтр("ru = 'Заполнение реквизита содержимое документа у документов эдо по заявкам сотрудника на получение справки об остатках отпусков.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия          	= "3.1.21.3";
	Обработчик.Процедура       	= "БизнесПроцессы.ЗаявкаСотрудникаСправкаСМестаРаботы.ЗаполнитьСодержимоеДокументаЭДОБЗКЗаявокСотрудников";
	Обработчик.РежимВыполнения 	= ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ОсновнойРежимВыполненияОбновления();
	Обработчик.Идентификатор   	= Новый УникальныйИдентификатор("677479bd-9319-4aad-aa7a-ab81461aabba");
	Обработчик.Комментарий     	= НСтр("ru = 'Заполнение реквизита содержимое документа у документов эдо по заявкам сотрудника на получение справки с места работы.'");
...
Функция ТекстЗапросаЗаявкиСотрудникаСПодписаннымФайломОтвета() Экспорт
	Возврат "ВЫБРАТЬ
	        ...
	        |	КОЛИЧЕСТВО(ЗапланированныеДействияСФайламиДокументовЭДОБЗК.ПрисоединенныйФайл) КАК КоличествоЗапланированныхДействий,
	        ...
	        |		ПО ВТПодписанныеСправкиНДФЛ.СправкаНДФЛ = ЗапланированныеДействияСФайламиДокументовЭДОБЗК.ПрисоединенныйФайл
	        ...
	        |	КОЛИЧЕСТВО(ЗапланированныеДействияСФайламиДокументовЭДОБЗК.ПрисоединенныйФайл),
	        |	ВТПодписанныеСправкиСМестаРаботы.Ссылка,
	        |	ЗадачаИсполнителя.Ссылка
	        |ИЗ
	        |	ВТПодписанныеСправкиСМестаРаботы КАК ВТПодписанныеСправкиСМестаРаботы
	        |		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ЗапланированныеДействияСФайламиДокументовЭДОБЗК КАК ЗапланированныеДействияСФайламиДокументовЭДОБЗК
	        |		ПО ВТПодписанныеСправкиСМестаРаботы.СправкаСМестаРаботы = ЗапланированныеДействияСФайламиДокументовЭДОБЗК.ПрисоединенныйФайл
	        |			И (ЗапланированныеДействияСФайламиДокументовЭДОБЗК.Действие = ЗНАЧЕНИЕ(Перечисление.ДействияСФайламиДокументовЭДОБЗК.Подписать))
	        |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Задача.ЗадачаИсполнителя КАК ЗадачаИсполнителя
