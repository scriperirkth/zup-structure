...
Функция ДополнительныеИсточникиДляВыгрузкиФайлов(Источники) Экспорт
	Возврат ОбменСБанкамиПоЗарплатнымПроектамРасширенный.ДополнительныеИсточникиДляВыгрузкиФайлов(Источники);
КонецФункции

Процедура ПредупредитьЗарплатныйПроектИспользуется(ЗарплатныйПроект) Экспорт
	
	ОбменСБанкамиПоЗарплатнымПроектамРасширенный.ПредупредитьЗарплатныйПроектИспользуется(ЗарплатныйПроект);
