...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Если ЭтоНачальноеЗаполнениеИлиОбновление Тогда
		...
		Обработчик = Обработчики.Добавить();
		Обработчик.Процедура = "ОбновлениеИнформационнойБазыЗарплатаКадрыРасширенный.ЗаполнитьПоставляемыеГруппыДоступа";
		Обработчик.НачальноеЗаполнение = Истина; 
	КонецЕсли;
	...
	УчетОтгулов.ЗарегистрироватьОбработчикиОбновления(Обработчики);
	
	Интеграция1СПерсоналРасширенный.ЗарегистрироватьОбработчикиОбновления(Обработчики);
	...
	// ЗарплатаКадрыПриложения.СостояниеСтруктурыПредприятия
	...
	КонецЕсли;
	// Конец ЗарплатаКадрыПриложения.СостояниеСтруктурыПредприятия
	...
	// ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.ОбучениеПоОхранеТруда
	...
	КонецЕсли;
	// Конец ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.ОбучениеПоОхранеТруда
	...
	// ЗарплатаКадрыКорпоративнаяПодсистемы.Конкурсы
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.Конкурсы") Тогда
		...
		МодульКонкурсы.ЗарегистрироватьОбработчикиОбновления(Обработчики);
	КонецЕсли;
	// Конец ЗарплатаКадрыКорпоративнаяПодсистемы.Конкурсы
	
	// ЗарплатаКадрыПриложения.ОбменДаннымиУниверсальныйФорматБО
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ОбменДаннымиУниверсальныйФорматБО") Тогда
		МодульОбменДаннымиУниверсальныйФормат = ОбщегоНазначения.ОбщийМодуль("ОбменДаннымиУниверсальныйФорматБО");
		МодульОбменДаннымиУниверсальныйФормат.ЗарегистрироватьОбработчикиОбновления(Обработчики);
	КонецЕсли;
	// Конец ЗарплатаКадрыПриложения.ОбменДаннымиУниверсальныйФорматБО
	
	// ЗарплатаКадрыКорпоративнаяПодсистемы.Наставничество
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.Наставничество") Тогда
		...
		МодульНаставничество.ЗарегистрироватьОбработчикиОбновления(Обработчики);
	КонецЕсли;
	// Конец ЗарплатаКадрыКорпоративнаяПодсистемы.Наставничество
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ЗаполнитьПоставляемыеГруппыДоступа");
	Методы.Вставить("УстановитьЗначениеКонстантыИспользоватьНачислениеЗарплатыНесколькихОрганизаций");
	Методы.Вставить("УстановитьЗначениеКонстантыРаботаВНесколькихХозрасчетныхОрганизациях");
	Методы.Вставить("УстановитьФункциональныеОпцииПоМетаданным");
	Методы.Вставить("УстановитьИспользованиеНесколькихОрганизаций");
	Методы.Вставить("УстановитьИспользованиеЗарплатаКадрыКорпоративнаяПодсистемы");
	Методы.Вставить("ЗаполнитьЦелевоеВремяКлючевыхОпераций");
	Методы.Вставить("УстановитьФункциональныеОпцииИспользованияЗарплатыИКадров");
	Методы.Вставить("УстановитьВидОрганизации");
КонецПроцедуры
...
Процедура ЗаполнитьПоставляемыеГруппыДоступа() Экспорт
	ЗарплатаКадрыРасширенный.ПроверитьПоставляемыеПрофилиГруппДоступа();
КонецПроцедуры
