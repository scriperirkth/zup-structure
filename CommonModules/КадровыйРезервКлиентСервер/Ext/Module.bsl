...
// Заполняет текстовое поле "ОписаниеДействия" строки табличной части по полю "Действие".
// 
// Параметры:
//  ТекущаяСтрока - СтрокаТабличнойЧасти
//  СоСтороныИсключения - Булево
...
// Заполняет текстовое поле "ОписаниеСтатуса" строки табличной части по полю "Действие".
// 
// Параметры:
//  ТекущаяСтрока - СтрокаТабличнойЧасти
