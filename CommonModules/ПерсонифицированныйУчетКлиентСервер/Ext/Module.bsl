...
Функция ТерриториальныеУсловияПФРВКоторыхПрименяетсяСевренаяНадбавка() Экспорт
	СписокУсловий = Новый Массив;
	СписокУсловий.Добавить(ПредопределенноеЗначение("Справочник.ТерриториальныеУсловияПФР.РКС"));
...
Функция ДатаПостановленияАДВ2025() Экспорт
