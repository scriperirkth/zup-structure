...
// Возвращает массив сертификатов сервиса мобильного подписания, зарегистрированных в учетной записи ЭДО
// Параметры:
...
//  ВидМобильнойПодписи - ПеречислениеСсылка.ВидыМобильныхПодписей, Неопределено - Вид мобильной подписи
// Возвращаемое значение:
//  Массив из СправочникСсылка.СертификатыКлючейЭлектроннойПодписиИШифрования
//
Функция ЗарегистрированныеВЭДОСертификаты(ПараметрыПодписанта = Неопределено, ВидМобильнойПодписи = Неопределено) Экспорт
	...
	ТекстОтбораВидаМобильнойПодписи = "СертификатыПодписантовМобильнойПодписи.ВидМобильнойПодписи = &ВидМобильнойПодписи";

	Запрос.Текст = СтрЗаменить(Запрос.Текст,
		"&ОтборВидМобильнойПодписи",
		?(ВидМобильнойПодписи <> Неопределено, ТекстОтбораВидаМобильнойПодписи,"Истина"));

	Запрос.УстановитьПараметр("ДействителенДо", ТекущаяДатаСеанса());

	Если ПараметрыПодписанта <> Неопределено Тогда
	...
	Если ВидМобильнойПодписи <> Неопределено Тогда
