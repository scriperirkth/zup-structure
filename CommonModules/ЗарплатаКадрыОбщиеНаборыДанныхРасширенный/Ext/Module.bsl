...
Функция ПолучитьТекстОбщегоЗапроса(ИсточникДанных, ТолькоРазрешенные) Экспорт
	...
	ИначеЕсли ВРег(ИсточникДанных) = ВРег("НачисленияУдержанияАвансом") Тогда
		...
		ТекстЗапроса = 
			...
			|	ДанныеСотрудников.ИдентификаторСтроки КАК ИдентификаторСтроки
			...
			|	NULL,
			|	0,
			|	ДанныеСотрудников.ИдентификаторСтроки
			|ИЗ
			|	ВТНачисленияИУдержанияСКадровымиДанными КАК ДанныеСотрудников
			|		{ЛЕВОЕ СОЕДИНЕНИЕ ВТОтработанноеВремя КАК ОтработанноеВремя
			|		ПО ДанныеСотрудников.Регистратор = ОтработанноеВремя.Регистратор
...
Функция ПолучитьЗапросПоПредставлению(ТекстЗапроса, СоответствиеПараметров) Экспорт
	...
	Если ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("ШтатноеРасписание") Тогда
		
		ПредставлениеВключатьНачисления = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("ВключатьНачисления", СвойстваТаблицы.ПараметрыЗапроса);
		НеВключатьНачисления = ВРег(ПредставлениеВключатьНачисления) = "ЛОЖЬ";
		ВключаяЗакрытые = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("ВключаяЗакрытые", СвойстваТаблицы.ПараметрыЗапроса);
		...
		КонецЕсли;
		ДатаАктуальности = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("ДатаАктуальности", СвойстваТаблицы.ПараметрыЗапроса);
		...
		Запрос = УправлениеШтатнымРасписанием.ЗапросПредставленияШтатноеРасписание(
			СвойстваТаблицы.ТолькоРазрешенные, ДатаАктуальности, СвойстваТаблицы.КоллекцияПолей, СвойстваТаблицы.ИмяИсточникаДанных,
			ВключаяЗакрытые, НЕ НеВключатьНачисления, ИмяВТИсточникДанных);
		
	ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("ТекущаяКадроваяРасстановка") Тогда
		
		Организация = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("Организация", СвойстваТаблицы.ПараметрыЗапроса);
		Дата = ЗарплатаКадрыОбщиеНаборыДанных.ПараметрЗапроса("Дата", СвойстваТаблицы.ПараметрыЗапроса);
	...
	ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("ФункциональныеОпцииОрганизаций") Тогда
	...
	ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("ФактическиеОтпускаСотрудников") Тогда
		...
		Запрос = ОстаткиОтпусков.ЗапросВТФактическиеОтпускаСотрудников(ОписательВременныхТаблиц, СвойстваТаблицы.ТолькоРазрешенные);
		
	ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("ПлановыеНачисленияСотрудников") Тогда
		...
		ИмяВТИсточникДанных = СвойстваТаблицы.ИменаВТИсточниковПараметров[0];
		Запрос = КадровыйУчетРасширенный.ЗапросВТПлановыеНачисленияСотрудников(СвойстваТаблицы.ТолькоРазрешенные, СвойстваТаблицы.ИмяИсточникаДанных, ИмяВТИсточникДанных, , , ФормироватьСПериодичностьДень);
		
	ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("ПлановыеУдержанияСотрудников") Тогда
		
		ИмяВТИсточникДанных = СвойстваТаблицы.ИменаВТИсточниковПараметров[0];
		Запрос = КадровыйУчетРасширенный.ЗапросВТПлановыеУдержанияСотрудников(СвойстваТаблицы.ТолькоРазрешенные, СвойстваТаблицы.ИмяИсточникаДанных, ИмяВТИсточникДанных);
		
	ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("СтажиСотрудников") Тогда
		...
		Запрос = КадровыйУчетРасширенный.ЗапросВТСтажиФизическихЛиц(СвойстваТаблицы.ТолькоРазрешенные, ОписаниеВременнойТаблицыОтборов, СвойстваТаблицы.ИмяИсточникаДанных);
		
	ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("СвойстваСтатейФинансирования") Тогда
	...
	ИначеЕсли ВРег(СвойстваТаблицы.ИмяПредставления) = ВРег("БухучетЗарплатыСотрудников") Тогда
		
		ИмяВТИсточникДанных = СвойстваТаблицы.ИменаВТИсточниковПараметров[0];
		Запрос = ОтражениеЗарплатыВБухучетеРасширенный.ЗапросПредставленияБухучетЗарплатыСотрудников(СвойстваТаблицы.ТолькоРазрешенные, ИмяВТИсточникДанных);
		
	КонецЕсли;
	
	Если Запрос = Неопределено Тогда
		Запрос = УчетРабочегоВремениРасширенный.ЗапросПоПредставлению(СвойстваТаблицы.ТолькоРазрешенные, СвойстваТаблицы.ИмяПредставления, СвойстваТаблицы.ИменаВТИсточниковПараметров, СвойстваТаблицы.ПараметрыЗапроса, СвойстваТаблицы.ИмяИсточникаДанных);
	КонецЕсли;	
	...
	Если Запрос = Неопределено Тогда
		Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.АттестацииСотрудников") Тогда
			...
			Запрос = Модуль.ЗапросПоПредставлению(СвойстваТаблицы.ИмяПредставления, СвойстваТаблицы.ПараметрыЗапроса);
		КонецЕсли;
	КонецЕсли;
	...
	Если Запрос = Неопределено Тогда
		Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.УчетБюджетныхУчреждений") Тогда
			...
			Запрос = МодульУчетБюджетныхУчреждений.ЗапросПоПредставлению(СвойстваТаблицы.ИмяПредставления, СвойстваТаблицы.ПараметрыЗапроса);
		КонецЕсли;
	КонецЕсли;
	...
	Если Запрос = Неопределено Тогда
		Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.РабочиеМестаОхраныТруда") Тогда
			...
			Запрос = МодульРабочиеМестаОхраныТруда.ЗапросПоПредставлению(СвойстваТаблицы.ИмяПредставления, СвойстваТаблицы.ПараметрыЗапроса, СвойстваТаблицы.ТолькоРазрешенные);
		КонецЕсли;
	КонецЕсли;
	...
	Если Запрос = Неопределено Тогда
		Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.КадровоеПланирование") Тогда
			...
			Запрос = МодульКадровоеПланирование.ЗапросПоПредставлению(СвойстваТаблицы.ИмяПредставления, СвойстваТаблицы.ПараметрыЗапроса, СвойстваТаблицы.ТолькоРазрешенные);
		КонецЕсли;
	КонецЕсли;
	...
	Если Запрос = Неопределено Тогда
		Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.ПодборПерсонала") Тогда
			...
			Запрос = МодульПодборПерсонала.ЗапросПоПредставлению(СвойстваТаблицы.ИмяПредставления, СвойстваТаблицы.ПараметрыЗапроса, СвойстваТаблицы.ТолькоРазрешенные);
		КонецЕсли;
	КонецЕсли;
	...
	Если Запрос = Неопределено Тогда
		Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.КадровыйРезерв.КадровыйРезервГосслужащих") Тогда
			...
			Запрос = МодульКадровыйРезервГосслужащих.ЗапросПоПредставлению(СвойстваТаблицы.ИмяПредставления, СвойстваТаблицы.ПараметрыЗапроса);
		КонецЕсли;
	КонецЕсли;
	
	Если Запрос = Неопределено Тогда
		Если ОбщегоНазначения.ПодсистемаСуществует(
			"ЗарплатаКадрыКорпоративнаяПодсистемы.ОхранаТруда.МедицинскиеОсмотры") Тогда
			МодульМедицинскиеОсмотры = ОбщегоНазначения.ОбщийМодуль("МедицинскиеОсмотры");
			Запрос = МодульМедицинскиеОсмотры.ЗапросПоПредставлению(СвойстваТаблицы.ИмяПредставления,
				СвойстваТаблицы.ТолькоРазрешенные, СвойстваТаблицы.ПараметрыЗапроса,
				СвойстваТаблицы.ИмяИсточникаДанных, СвойстваТаблицы.ИменаВТИсточниковПараметров);
		КонецЕсли;
	КонецЕсли;
	...
	Если Запрос = Неопределено Тогда
		Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ОрганизационнаяСтруктура") Тогда
			...
			Запрос = МодульОрганизационнаяСтруктура.ЗапросПоПредставлению(СвойстваТаблицы.ИмяПредставления,
				СвойстваТаблицы.ТолькоРазрешенные, СвойстваТаблицы.ПараметрыЗапроса,
				СвойстваТаблицы.ИмяИсточникаДанных, СвойстваТаблицы.ИменаВТИсточниковПараметров);
		КонецЕсли;
	КонецЕсли;
