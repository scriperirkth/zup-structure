...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ВключитьОбсужденияФоновоеЗадание", Истина);
	Методы.Вставить("ОбъединениеПриложенийФоновоеЗадание", Истина);
	Методы.Вставить("ОтключениеОбсужденийФоновоеЗадание", Истина);
	Методы.Вставить("ОбработатьНовыеОбсужденияФоновоеЗадание", Истина);
