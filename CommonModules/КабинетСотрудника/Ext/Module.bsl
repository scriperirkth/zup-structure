...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("НастроитьРегламентноеЗаданиеПроверкаСостоянияСервисаКабинетСотрудника");
	Методы.Вставить("УстановитьЗначениеПоказыватьПриглашениеКабинетСотрудникаБазовойВерсии");
	Методы.Вставить("ОбновитьПубликациюПравНаВычеты");
	Методы.Вставить("ИнициализироватьРолиИсполнителейЗадач");
	Методы.Вставить("ЗарегистрироватьОбновлениеУровеньДоступаКИ");
	Методы.Вставить("ЗарегистрироватьОбновлениеНастроекСервиса");
	Методы.Вставить("ЗаполнитьОбъектыСОшибкамиЗаполнения");
	Методы.Вставить("ПроверитьВерсиюФормата");
	Методы.Вставить("ЗарегистрироватьОбновлениеУволенныхСотрудников");
	Методы.Вставить("ЗарегистрироватьОбработчикОбновленияФизическихЛиц");
	Методы.Вставить("ЗарегистрироватьОбновлениеФункциональностиСервиса");
	Методы.Вставить("ОбновитьФункциональностьСервисаПриИспользованииЭДОБЗК");
	Методы.Вставить("ЗаполнитьСодержимоеДокументаЭДОБЗКРасчетныхЛистков");
	Методы.Вставить("ОбновитьИсключенияИзПравил");
	Методы.Вставить("ЗарегистрироватьОбработчикОбновленияРуководителей");
	Методы.Вставить("ЗарегистрироватьПроверкуОзнакомленияСРасчетнымиЛистками");
	Методы.Вставить("УстановитьТребуетсяОбновитьНастройкиФункциональности");
	Методы.Вставить("ЗаполнитьСобытиеСотрудникиДляОбновленияПубликуемыхОбъектов");
	Методы.Вставить("УстановитьВерсияИзмененийКабинетСотрудника");
	Методы.Вставить("ЗарегистрироватьОбновлениеНастроекСервисаВерсии303");
	Методы.Вставить("УстановитьЗначениеПоказыватьПриглашениеКабинетСотрудника");
КонецПроцедуры
