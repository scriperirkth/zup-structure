...
Процедура ПриОпределенииЭтоДокументСЭДО(Признак, Правило) Экспорт
	...
	ЗарплатаКадрыКлиентСерверВнутренний.ПриОпределенииЭтоДокументСЭДО(Признак, Правило);
...
Процедура УстановитьРасширеннуюПодсказкуЭлементуФормы(Форма, ИмяЭлемента, ТекстПодсказки, ЦветТекста = Неопределено) Экспорт
	...
	Если ЭлементФормы <> Неопределено Тогда
		...
		Если ЦветТекста <> Неопределено Тогда
			ЭлементФормы.РасширеннаяПодсказка.ЦветТекста = ЦветТекста;
		КонецЕсли;
	КонецЕсли;
