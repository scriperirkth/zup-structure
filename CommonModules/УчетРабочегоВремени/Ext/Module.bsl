...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ОтключитьНеИспользуемыеВидыИспользованияРабочегоВремени");
	Методы.Вставить("СоздатьВидыИспользованияРабочегоВремениОтпускБезОплаты");
	Методы.Вставить("СоздатьВидыИспользованияРабочегоВремениПоНастройкам");
КонецПроцедуры
...
Процедура ПриОпределенииДоступныхДляПереводаМакетов(Макеты) Экспорт
	...
	УчетРабочегоВремениВнутренний.ПриОпределенииДоступныхДляПереводаМакетов(Макеты);
