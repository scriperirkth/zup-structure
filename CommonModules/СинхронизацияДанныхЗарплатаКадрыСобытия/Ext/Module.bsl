...
Процедура ПриЗагрузкеПервичныхДанныхНабораПередЗаписью(Источник, Отказ, Замещение) Экспорт
	...
	ОбменДаннымиСОтборомПриЗагрузкеПередЗаписью(Источник, Отказ, Замещение); // АПК:БЗК.75 Требуется для формирования вторичных данных
...
Процедура ПриЗагрузкеПервичныхДанныхНабораПриЗаписи(Источник, Отказ, Замещение) Экспорт
	ОбменДаннымиСОтборомПриЗагрузкеПриЗаписи(Источник, Отказ, Замещение);
КонецПроцедуры

Процедура ПриЗагрузкеПервичныхДанныхОбъектаПередЗаписью(Источник, Отказ) Экспорт
	
	ОбменДаннымиСОтборомПриЗагрузкеПередЗаписью(Источник, Отказ, Неопределено); // АПК:БЗК.75 Требуется для регистрации изменений на другие узлы
...
Процедура ПриЗагрузкеПервичныхДанныхОбъектаПриЗаписи(Источник, Отказ) Экспорт
	ОбменДаннымиСОтборомПриЗагрузкеПриЗаписи(Источник, Отказ, Неопределено);
КонецПроцедуры
...
Процедура ИзменитьСвязиФизическогоЛицаНаборЗаписейПередЗаписью(Источник, Отказ, Замещение) Экспорт
	...
	МенеджерОбъекта.ПринадлежностьНабораПередЗаписью(Источник, Замещение);
	// АПК:БЗК.75-вкл
...
Процедура ИзменитьСвязиФизическогоЛицаНаборЗаписейПриЗаписи(Источник, Отказ, Замещение) Экспорт
	...
	МенеджерОбъекта = ОбщегоНазначения.МенеджерОбъектаПоПолномуИмени(Источник.Метаданные().ПолноеИмя());
	МенеджерОбъекта.ПодразделенияФизическихЛицПриЗаписиРегистра(Источник, Замещение);
...
Процедура ИзменитьСвязиСотрудникаНаборЗаписейПриЗаписи(Источник, Отказ, Замещение) Экспорт
	...
	МенеджерОбъекта = ОбщегоНазначения.МенеджерОбъектаПоПолномуИмени(Источник.Метаданные().ПолноеИмя());
	МенеджерОбъекта.ПодразделенияСотрудниковПриЗаписиРегистра(Источник, Замещение);
...
Процедура ОбменДаннымиСОтборомПриЗагрузкеПередЗаписью(Источник, Отказ, Замещение)
	...
	Если Источник.ДополнительныеСвойства.ПодготовитьОбновлениеЗависимыхДанныхПриОбмене = Истина Тогда
		МенеджерОбъекта = ОбщегоНазначения.МенеджерОбъектаПоПолномуИмени(Источник.Метаданные().ПолноеИмя());
		МенеджерОбъекта.ПодготовитьОбновлениеЗависимыхДанныхПриОбменеПередЗаписью(Источник, Замещение);
	КонецЕсли;
	
КонецПроцедуры

Процедура ОбменДаннымиСОтборомПриЗагрузкеПриЗаписи(Источник, Отказ, Замещение)
	...
	Если Источник.ДополнительныеСвойства.ПодготовитьОбновлениеЗависимыхДанныхПриОбмене = Истина Тогда
		МенеджерОбъекта = ОбщегоНазначения.МенеджерОбъектаПоПолномуИмени(Источник.Метаданные().ПолноеИмя());
		МенеджерОбъекта.ПодготовитьОбновлениеЗависимыхДанныхПриОбменеПриЗаписи(Источник, Замещение);
	КонецЕсли;
