...
// * ВсеКонстанты - ФиксированноеСоответствие из КлючИЗначение:
//    ** Ключ - ОбъектМетаданныхКонстанта
//    ** Значение - Булево
// * ВсеСсылочныеДанные - ФиксированноеСоответствие из КлючИЗначение:
...
//    ** Ключ - ОбъектМетаданных
//    ** Значение - Булево
// * ВсеЖурналыДокументов - ФиксированноеСоответствие из КлючИЗначение:
//    ** Ключ - ОбъектМетаданныхЖурналДокументов
//    ** Значение - Булево
// * ВсеРегламентныеЗадания - ФиксированноеСоответствие из КлючИЗначение:
//    ** Ключ - ОбъектМетаданныхРегламентноеЗадание
//    ** Значение - Булево
// * ВсеВнешниеИсточникиДанных - ФиксированноеСоответствие из КлючИЗначение:
//    ** Ключ - ОбъектМетаданныхВнешнийИсточникДанных
//    ** Значение - Булево
// * ВсеСервисыИнтеграции - ФиксированноеСоответствие из КлючИЗначение:
//    ** Ключ - ОбъектМетаданныхСервисИнтеграции
//    ** Значение - Булево
// * ВсеПодсистемы - ФиксированноеСоответствие из КлючИЗначение:
//    ** Ключ - ОбъектМетаданныхПодсистема
//    ** Значение - Булево
// * ВсеПараметрыСеанса - ФиксированноеСоответствие из КлючИЗначение:
//    ** Ключ - ОбъектМетаданныхПараметрСеанса
//    ** Значение - Булево
// * ВсеОбщиеРеквизиты - ФиксированноеСоответствие из КлючИЗначение:
//    ** Ключ - ОбъектМетаданныхОбщийРеквизит
//    ** Значение - Булево
// * ВсеЗадачи - ФиксированноеСоответствие из КлючИЗначение:
//    ** Ключ - ОбъектМетаданныхЗадача
//    ** Значение - Булево
Функция МодельКонфигурации() Экспорт
	...
	Для Каждого ОбъектМетаданных Из Метаданные.Задачи Цикл
		ВсеСсылочныеДанные.Вставить(ОбъектМетаданных, Истина);
		ВсеЗадачи.Вставить(ОбъектМетаданных, Истина);
	КонецЦикла;
	...
	Для Каждого ОбъектМетаданных Из Метаданные.СервисыИнтеграции Цикл
		ВсеСервисыИнтеграции.Вставить(ОбъектМетаданных, Истина);
	КонецЦикла;
	...
	Модель.Вставить("ВсеСервисыИнтеграции", Новый ФиксированноеСоответствие(ВсеСервисыИнтеграции));
	...
	Модель.Вставить("ВсеЗадачи", Новый ФиксированноеСоответствие(ВсеЗадачи));
