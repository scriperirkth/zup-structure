...
Функция ВыгрузитьНаДиск(Знач ЭлектронныеКурсы, Знач ФорматВыгрузки, Знач ПутьККаталогуВыгрузокНаКлиенте = Неопределено, Знач УникальныйИдентификаторФормы = Неопределено) Экспорт
	...
	Иначе
		...
		ЭлектронноеОбучениеСлужебный.УдалитьВременныйФайл(ИмяАрхива);
...
Функция ЗначениеРеквизитаЭлементаКурсаВСтруктуру(Знач ЗначениеРеквизита, Знач ОписаниеТипаВсеСсылки) Экспорт
...
//
Процедура ИмпортироватьЭлементыОрганизацииКонтентаSCORM(ЭлектронныйКурс, ЭлектронныйРесурс, МанифестSCORM, ЭлементыОрганизацииXDTO, Родитель = Неопределено) Экспорт
