...
Процедура ОценочныеОбязательстваВДанныеФормы(ТаблицаПриемник, ТаблицаИсточник, Очищать, РаспределятьВыявленныеИзлишки = Ложь) Экспорт
	
	Если Очищать Тогда
		ТаблицаПриемник.Очистить();
		РезервыПоОплатеТруда.РаспределитьВыявленныеИзлишки(ТаблицаИсточник, РаспределятьВыявленныеИзлишки);
	...
	Иначе
		...
		РезервыПоОплатеТруда.РаспределитьВыявленныеИзлишки(ТаблицаРезервов, РаспределятьВыявленныеИзлишки);
