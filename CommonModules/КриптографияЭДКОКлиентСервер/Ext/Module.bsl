...
Функция АлгоритмШифрованияВМоделиСервиса(АлгоритмШифрования) Экспорт
	
	Результат = "";
	
	Если ВРег(АлгоритмШифрования) = "GR 34.12-15 M" Тогда // Магла
		Результат = "1.2.643.7.1.1.5.1.1";
	ИначеЕсли ВРег(АлгоритмШифрования) = "GR 34.12-15 K" Тогда // Кузнечик
		Результат = "1.2.643.7.1.1.5.2.1";
	ИначеЕсли ВРег(АлгоритмШифрования) = "GOST 28147-89" Тогда // Обычный
