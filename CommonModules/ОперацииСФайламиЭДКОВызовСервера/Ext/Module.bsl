...
Функция УпаковатьФайлы(Файлы, АдресПакета = Неопределено) Экспорт
	...
	Для Каждого Файл Из Файлы Цикл
		...
		ИмяФайла = ОбщегоНазначенияЭДКОКлиентСервер.ЗаменитьЗапрещенныеСимволыВИмениФайла(Файл.Имя, "");
		ИмяФайла = СтрЗаменить(ИмяФайла, "%", "");
		
		ИмяВложенногоФайла = ВременныйКаталог + ИмяФайла;
		МассивУдаляемыхФайлов.Добавить(ИмяВложенногоФайла);
	...
	// защита от обхода путей (..\)
	Для каждого ИмяФайла Из МассивУдаляемыхФайлов Цикл
