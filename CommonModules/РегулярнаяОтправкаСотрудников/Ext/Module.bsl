...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ДанныеСтатусаОтправкиСотрудникаПоУсловиюДлительнаяОперация", Истина);
	Методы.Вставить("ОтправитьСотрудниковВСистемуБронированияДлительнаяОперация", Истина);
...
Функция ДанныеСтатусаОтправкиСотрудникаПоУсловию(СистемаБронирования, ФизическоеЛицо)
	...
	Если ТаблицаВсехПодразделений <> Неопределено И ТаблицаВсехПодразделений.Количество() > 0 Тогда
