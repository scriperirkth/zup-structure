...
Процедура ПодразделенияОтбораОбработкаВыбора(Форма, Элемент, ВыбранноеЗначение, СтандартнаяОбработка, ПоСтруктуреПредприятия) Экспорт
	...
	Если Не ПоСтруктуреПредприятия Тогда
		РегулярнаяОтправкаСотрудниковФормыКлиентБазовый.ПодразделенияОтбораОбработкаВыбора(Форма, Элемент, ВыбранноеЗначение, СтандартнаяОбработка);
		Возврат;
	КонецЕсли;
