...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ЗарегистрироватьОтработанныеЧасы");
	Методы.Вставить("ДобавитьТаблицуДанныеОбИспользованииОтгуловВПереносДанных");
	Методы.Вставить("ЗарегистрироватьОтработанныеДни");
КонецПроцедуры
