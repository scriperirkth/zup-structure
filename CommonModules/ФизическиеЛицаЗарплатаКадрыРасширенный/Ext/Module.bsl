...
Процедура ЗаписатьСвязанныеОбъекты(ФизическоеЛицо) Экспорт
	...
	Если СвязанныеОбъекты.Свойство("УченыеЗвания") Тогда
		РегистрыСведений.УченыеЗванияФизическихЛиц.ЗаполнитьУченыеЗванияФизическогоЛица(ФизическоеЛицо.Ссылка,
			СвязанныеОбъекты.УченыеЗвания);
	КонецЕсли;
