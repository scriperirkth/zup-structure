...
Процедура УстановитьОтображениеПоляОбращенияСотрудника(УправляемаяФорма, БизнесПроцесс) Экспорт
	...
	Если УправляемаяФорма.ЭлектронныйДокумент <> Неопределено И ЭДОБЗК.ЭтоФайлПечатнойФормы(УправляемаяФорма.ЭлектронныйДокумент) Тогда
...
Процедура ВыполнитьБизнесПроцессЗаявки(Заявка, СостояниеЗапроса, Исполнитель) Экспорт
	...
	Документы.ДокументЭДОБЗК.ОбновитьОтветственногоПоОснованиюДокумента(Заявка, Исполнитель);
...
Процедура ЗаполнитьЭлементыФайлаОтвета(Форма, ФайлОтветаЭлемент, ФайлОтвета, ИмяРеквизита, ЗначенияРеквизитов) Экспорт
	...
	Элементы[ИмяРеквизита + "Подписан"].Видимость = Не ФайлПустой 
													И (ПолучитьФункциональнуюОпцию("ИспользуетсяЭДОБЗККабинетСотрудника")
	                                                   Или ФайлСЭП); 
...
Процедура ОтразитьРезультатыСогласований(Форма) Экспорт
	...
	РолиСогласующих.Добавить(Перечисления.РолиПодписантовЭДОБЗК.Сотрудник);
	РолиСогласующих.Добавить(Перечисления.РолиПодписантовЭДОБЗК.НепосредственныйРуководитель);
	РолиСогласующих.Добавить(Перечисления.РолиПодписантовЭДОБЗК.ВышестоящийРуководитель);
	РолиСогласующих.Добавить(Перечисления.РолиПодписантовЭДОБЗК.НеформальныйРуководитель);
	РолиСогласующих.Добавить(Перечисления.РолиПодписантовЭДОБЗК.РуководителиПоВсемМестамРаботы);
	РолиСогласующих.Добавить(Перечисления.РолиПодписантовЭДОБЗК.РуководительПоДополнительнымМестамРаботы);
