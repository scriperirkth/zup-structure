...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ОбновитьФлагИспользованияМногофункциональности");
	Методы.Вставить("ДобавитьРолиНаДокументы");
	Методы.Вставить("ЗаполнитьРегистрыПравПриОбновлении");
КонецПроцедуры
