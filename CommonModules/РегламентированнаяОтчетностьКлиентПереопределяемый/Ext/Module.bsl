...
// Проверяется возможность заполнения отчетности из удаленной ИБ
// Параметры:
//  ИмяФормы - Строка - Имя формы отчета
//  ЕстьВозможностьЗаполнения - Булево - Признак возможности удаленного заполнения
//
Процедура ПроверитьВозможностьЗаполненияИзУчетныхБаз(ИмяФормы, ЕстьВозможностьЗаполнения) Экспорт
