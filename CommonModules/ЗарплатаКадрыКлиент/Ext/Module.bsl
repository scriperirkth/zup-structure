...
Процедура ИзменитьОтборПоОсновнойОрганизации(Список, ИмяРеквизита, ЗначениеОтбора) Экспорт
	...
	ЗарплатаКадрыКлиентВнутренний.ИзменитьОтборПоОсновнойОрганизации(Список, ИмяРеквизита, ЗначениеОтбора);
...
Процедура ОткрытьНастройкуНалоговОтчетов(Организация, ИсточникПерехода, ТекущаяЗакладка = Неопределено) Экспорт
	...
	ЗарплатаКадрыКлиентВнутренний.ОткрытьНастройкуНалоговОтчетов(Организация, ИсточникПерехода, ТекущаяЗакладка);
...
Процедура ОткрытьСписокНалогиИОтчеты(ПараметрыОткрытия = Неопределено) Экспорт
	...
	ЗарплатаКадрыКлиентВнутренний.ОткрытьСписокНалогиИОтчеты(ПараметрыОткрытия);
...
Процедура ОткрытьСписокЗадач() Экспорт
	...
	ЗарплатаКадрыКлиентВнутренний.ОткрытьСписокЗадач();
...
Процедура ЗаполнитьПояснениеДляДокументаСЭДОНаБоковойПанели(Форма, ПараметрыОтчета) Экспорт
	...
	ЗарплатаКадрыКлиентВнутренний.ЗаполнитьПояснениеДляДокументаСЭДОНаБоковойПанели(Форма, ПараметрыОтчета);
...
Процедура ОбработкаДополнительнойРасшифровки(ФормаОтчета, Элемент, Расшифровка, СтандартнаяОбработка) Экспорт
	ЗарплатаКадрыКлиентВнутренний.ОбработкаДополнительнойРасшифровки(ФормаОтчета, Элемент, Расшифровка, СтандартнаяОбработка);
КонецПроцедуры
