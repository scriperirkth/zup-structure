...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ЗаполнитьКонтактнуюИнформациюJSON");
КонецПроцедуры
...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	ОбновлениеБЗК.ОписаниеПредопределенного(КодыЯзыков, Элементы, "СправочникФизическиеЛица",
		"ru = 'Контактная информация справочника ""Физические лица""'", РеквизитыГруппы);
	
	Реквизиты = Новый Структура;
	Реквизиты.Вставить("Используется", Истина);
	Реквизиты.Вставить("Родитель", Справочники.ВидыКонтактнойИнформации.СправочникФизическиеЛица);
	Реквизиты.Вставить("ОтображатьВсегда", Истина);
	
	Элемент = ОбновлениеБЗК.ОписаниеПредопределенного(КодыЯзыков, Элементы, "ТелефонМобильныйФизическиеЛица",
		"ru = 'Мобильный телефон'", Реквизиты);
	...
	Элемент = ОбновлениеБЗК.ОписаниеПредопределенного(КодыЯзыков, Элементы, "EMailФизическиеЛица",
	...
	Элемент = ОбновлениеБЗК.ОписаниеПредопределенного(КодыЯзыков, Элементы, "ТелефонДомашнийФизическиеЛица",
		"ru = 'Домашний телефон'", Реквизиты);
	Элемент.Тип = Перечисления.ТипыКонтактнойИнформации.Телефон;
	Элемент.МожноИзменятьСпособРедактирования = Истина;
	Элемент.ОбязательноеЗаполнение = Ложь;
	
	Элемент = ОбновлениеБЗК.ОписаниеПредопределенного(КодыЯзыков, Элементы, "ТелефонРабочийФизическиеЛица",
		"ru = 'Рабочий телефон'", Реквизиты);
	Элемент.Тип = Перечисления.ТипыКонтактнойИнформации.Телефон;
	Элемент.МожноИзменятьСпособРедактирования = Истина;
	Элемент.ОбязательноеЗаполнение = Ложь;
	Элемент.РазрешитьВводНесколькихЗначений = Ложь;
	
	Элемент = ОбновлениеБЗК.ОписаниеПредопределенного(КодыЯзыков, Элементы, "АдресПоПропискеФизическиеЛица",
		"ru = 'Адрес по прописке'", Реквизиты);
	...
	Элемент = ОбновлениеБЗК.ОписаниеПредопределенного(КодыЯзыков, Элементы, "АдресМестаПроживанияФизическиеЛица",
	...
	Элемент = ОбновлениеБЗК.ОписаниеПредопределенного(КодыЯзыков, Элементы, "АдресЗаПределамиРФФизическиеЛица",
		"ru = 'Адрес за пределами РФ'", Реквизиты); // "ru = 'Иностранный адрес'"
	Элемент.Тип = Перечисления.ТипыКонтактнойИнформации.Адрес;
	Элемент.МожноИзменятьСпособРедактирования = Истина;
	Элемент.ВидРедактирования = "Диалог";
	Элемент.ОбязательноеЗаполнение = Ложь;
	...
	Элемент = ОбновлениеБЗК.ОписаниеПредопределенного(КодыЯзыков, Элементы, "АдресДляИнформированияФизическиеЛица",
		"ru = 'Адрес для информирования'", Реквизиты);
	Элемент.Тип = Перечисления.ТипыКонтактнойИнформации.Адрес;
	Элемент.МожноИзменятьСпособРедактирования = Ложь;
	Элемент.ВидРедактирования = "Диалог";
	Элемент.ОбязательноеЗаполнение = Ложь;
...
Функция ЗапросПоСтрокеПоиска(Параметры) Экспорт
...
Процедура ЗаполнитьДанныеВыбораПоЗапросу(Запрос, ДанныеВыбора, СтрокаПоиска, СтандартнаяОбработка) Экспорт
