...
Процедура ВыгрузитьВФайлПлатежныеДокументыПеречисленияЗарплаты(ПлатежныеДокументы, Форма) Экспорт
	...
	СтруктураПараметровДляФормированияФайла.Вставить("ФормироватьJSON", Ложь);
...
Процедура ВыгрузитьФайлОбменаСБанком(ПараметрКоманды, ПараметрыВыполненияКоманды) Экспорт
	...
	ПараметрыВыгрузки = Новый Структура("МассивДокументов, УникальныйИдентификаторФормы, ФормироватьJSON");
	...
	ПараметрыВыгрузки.ФормироватьJSON = Ложь;
