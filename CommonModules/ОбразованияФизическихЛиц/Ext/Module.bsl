...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	Списки.Вставить(Метаданные.Справочники.ОбразованиеФизическихЛицПрисоединенныеФайлы, Истина);
...
Процедура ЗаписатьДанныеОбОбразовании(ОбъектФизическоеЛицо, Образование) Экспорт
	...
	Для Каждого СтрокаОбразование Из Образование Цикл
		...
		ЗаполнитьЗначенияСвойств(ПараметрыЗаполненияОбразования, СтрокаОбразование,
			"ВидОбразования, НаименованиеКурса, Квалификация, Начало, Окончание, ВидПослевузовскогоОбразования, ВидДополнительногоОбучения, 
			|СкрыватьВТ2, ВидДокумента, Серия, Номер, ДатаВыдачи, СОтличием, ОсновноеОбразование, Квалификация");
...
Процедура ЗаписатьДанныеОЗнанииЯзыков(ОбъектФизическоеЛицо, ЗнаниеЯзыков) Экспорт
	...
	Для Каждого СтрокаЗнаниеЯзыков Из ЗнаниеЯзыков Цикл
		...
		НаборЗаписей.Отбор.Язык.Установить(СтрокаЗнаниеЯзыков.Язык);
...
Функция ЗапросВТОбразованияФизическихЛиц(ТолькоРазрешенные, ОписательВременнойТаблицыОтборов, ИмяВТОбразованияФизическихЛиц = "ВТОбразованияФизическихЛиц") Экспорт
	...
	Запрос.Текст =
		...
		|	ФизическиеЛицаОбразование.СОтличием,
		|	ФизическиеЛицаОбразование.Основание,
		|	ФизическиеЛицаОбразование.Основание,
		|	ФизическиеЛицаОбразование.СкрыватьВТ2
...
Функция НовоеУчебноеЗаведение(НаименованиеУчебногоЗаведения)
	...
	УчебноеЗаведение.ПолноеНаименование = НаименованиеУчебногоЗаведения;
...
Функция ДобавитьПолеСведенийОЗнанияхЯзыковФизическихЛиц(Знач ИмяПоля, ТекстыОписанияПолей, ИсточникиДанных) Экспорт
...
Функция ДобавитьПолеСведенийОбОбразованииФизическихЛиц(Знач ИмяПоля, ТекстыОписанияПолей, ИсточникиДанных) Экспорт
...
Функция ДобавитьПолеСведенийОСпециальностяхФизическихЛиц(Знач ИмяПоля, ТекстыОписанияПолей, ИсточникиДанных) Экспорт
...
Функция ДобавитьПолеСведенийОПрофессияхФизическихЛиц(Знач ИмяПоля, ТекстыОписанияПолей, ИсточникиДанных) Экспорт
...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики)Экспорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.1.36.35";
	Обработчик.РежимВыполнения = ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ОсновнойРежимВыполненияОбновления();
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("a9790920-c216-4a01-bd13-bbb111c2aec3");
	Обработчик.Процедура = "Справочники.КлассификаторСпециальностейПоОбразованию.ЗаполнитьПолноеНаименование";
	Обработчик.Комментарий = НСтр("ru = 'Заполняет реквизит ""Полное наименование"" справочника ""Специальности (ОКСО)"".'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.1.36.35";
	Обработчик.РежимВыполнения = ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ОсновнойРежимВыполненияОбновления();
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("8c02fb2e-4368-422d-9ae0-3e0be56e3b36");
	Обработчик.Процедура = "Справочники.УчебныеЗаведения.ЗаполнитьПолноеНаименование";
	Обработчик.Комментарий = НСтр("ru = 'Заполняет реквизит ""Полное наименование"" справочника ""Учебные заведения"".'");
	...
	Для Каждого НаборДанных Из ОтчетОбъект.СхемаКомпоновкиДанных.НаборыДанных Цикл
		Если ТипЗнч(НаборДанных) = Тип("НаборДанныхЗапросСхемыКомпоновкиДанных") Тогда
			...
			НаборДанных.Запрос = СтрЗаменить(НаборДанных.Запрос,
				...
				"КадровыеДанныеСотрудников.ПослеВузовскоеОбразованиеУчебноеЗаведение.ПолноеНаименование КАК ПослеВузовскоеОбразованиеУчебноеЗаведение,");
			НаборДанных.Запрос = СтрЗаменить(НаборДанных.Запрос,
			...
			НаборДанных.Запрос = СтрЗаменить(НаборДанных.Запрос,
				...
				"КадровыеДанныеСотрудников.ПослеВузовскоеОбразованиеСпециальность.ПолноеНаименование КАК ПослеВузовскоеОбразованиеСпециальность,");
			НаборДанных.Запрос = СтрЗаменить(НаборДанных.Запрос,
			...
			НаборДанных.Запрос = СтрЗаменить(НаборДанных.Запрос,
				...
				"КадровыеДанныеСотрудников.Образование1УчебноеЗаведение.ПолноеНаименование КАК Образование1УчебноеЗаведение,");
			НаборДанных.Запрос = СтрЗаменить(НаборДанных.Запрос,
			...
			НаборДанных.Запрос = СтрЗаменить(НаборДанных.Запрос,
				...
				"КадровыеДанныеСотрудников.Образование1Специальность.ПолноеНаименование КАК Образование1Специальность,");
			НаборДанных.Запрос = СтрЗаменить(НаборДанных.Запрос,
			...
			НаборДанных.Запрос = СтрЗаменить(НаборДанных.Запрос,
				...
				"КадровыеДанныеСотрудников.Образование2УчебноеЗаведение.ПолноеНаименование КАК Образование2УчебноеЗаведение,");
			НаборДанных.Запрос = СтрЗаменить(НаборДанных.Запрос,
			...
			НаборДанных.Запрос = СтрЗаменить(НаборДанных.Запрос,
				...
				"КадровыеДанныеСотрудников.Образование2Специальность.ПолноеНаименование КАК Образование2Специальность,");
			НаборДанных.Запрос = СтрЗаменить(НаборДанных.Запрос,
...
Процедура ДополнитьСведенияУнифицированнойФормыТ2(ДополнительныеСведения, СтрокиДанных, ДатаОтчета, КлючВарианта) Экспорт
	...
	Запрос.Текст =
		...
		|	ОбразованиеФизическихЛиц.Окончание КАК Окончание,
		|	ОбразованиеФизическихЛиц.УчебноеЗаведение КАК УчебноеЗаведение,
		|	ОбразованиеФизическихЛиц.УчебноеЗаведение.ПолноеНаименование КАК УчебноеЗаведениеПолноеНаименование,
		|	ОбразованиеФизическихЛиц.ВидДокумента КАК ВидДокумента,
		|	ОбразованиеФизическихЛиц.Серия КАК Серия,
		|	ОбразованиеФизическихЛиц.Номер КАК Номер,
		|	ОбразованиеФизическихЛиц.ДатаВыдачи КАК ДатаВыдачи,
		|	ОбразованиеФизическихЛиц.Основание КАК Основание
		|ИЗ
		...
		|	И НЕ ОбразованиеФизическихЛиц.СкрыватьВТ2
		|
		|УПОРЯДОЧИТЬ ПО
		|	ФизическоеЛицо,
		|	Начало";
	...
	Пока Выборка.СледующийПоЗначениюПоля("ФизическоеЛицо") Цикл
		...
		Пока Выборка.Следующий() Цикл
			...
			СтруктураСтроки.Вставить("УчебноеЗаведениеАдрес", Выборка.УчебноеЗаведениеПолноеНаименование);
	...
	Запрос.Текст =
		...
		|	ОбразованиеФизическихЛиц.Окончание КАК Окончание,
		|	ОбразованиеФизическихЛиц.Специальность КАК Специальность,
		|	ОбразованиеФизическихЛиц.Специальность.ПолноеНаименование КАК СпециальностьПолноеНаименование,
		|	ОбразованиеФизическихЛиц.ВидДокумента КАК ВидДокумента,
		|	ОбразованиеФизическихЛиц.Серия КАК Серия,
		|	ОбразованиеФизическихЛиц.Номер КАК Номер,
		|	ОбразованиеФизическихЛиц.ДатаВыдачи КАК ДатаВыдачи,
	...
	Пока Выборка.СледующийПоЗначениюПоля("ФизическоеЛицо") Цикл
		...
		Пока Выборка.Следующий() Цикл
			...
			СтруктураСтроки.Вставить("Начало", Формат(Выборка.Начало, "ДЛФ=D"));
			СтруктураСтроки.Вставить("Окончание", Формат(Выборка.Окончание, "ДЛФ=D"));
			СтруктураСтроки.Вставить("Специальность", Выборка.СпециальностьПолноеНаименование);
			СтруктураСтроки.Вставить("ВидДокумента", Выборка.ВидДокумента);
			СтруктураСтроки.Вставить("СерияНомер", ?(ЗначениеЗаполнено(Выборка.Серия), Выборка.Серия + ", ", "") + Выборка.Номер);
			СтруктураСтроки.Вставить("ДатаВыдачи", Формат(Выборка.ДатаВыдачи, "ДФ=дд.ММ.гг"));
			СтруктураСтроки.Вставить("Основание", Выборка.Основание);
