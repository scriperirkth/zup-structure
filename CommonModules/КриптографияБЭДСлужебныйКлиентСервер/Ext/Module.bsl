...
Функция ВидОшибкиДляСертификатаНетПодписываемогоВидаДокумента() Экспорт
	...
	ВидОшибки.Идентификатор = КриптографияБЭДКлиентСервер.ИдентификаторОшибкиДляСертификатаНетПодписываемогоВидаДокумента();
	...
	ОписаниеРешения = НСтр("ru = '<a href = ""%1"">Проверьте</a> подписываемые виды документов в сертификате'");
