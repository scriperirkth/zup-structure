...
Функция РекомендацииПомещений(Бронь) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		ПредставлениеПомещения = ТерриторииИПомещения.ФорматированноеПредставлениеПомещения(
...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	Списки.Вставить(Метаданные.Справочники.БроньПрисоединенныеФайлы, Истина);
...
Функция ИспользоватьБронированиеПомещений() Экспорт
	...
	Возврат ПолучитьФункциональнуюОпцию("ИспользоватьБронированиеПомещений");
