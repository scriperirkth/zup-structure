...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ЗаполнитьАналитикуВРегистрахУчетаРезервов");
	Методы.Вставить("УстановитьПериодВыплаты");
	Методы.Вставить("ВключитьРезервыПоОплатеТрудаПоОплатуТруда");
КонецПроцедуры
