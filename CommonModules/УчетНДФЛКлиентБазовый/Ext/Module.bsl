	...
	Если ГруппаФормыПанельВычеты <> Неопределено Тогда
		...
		Если НДФЛТекущиеДанные = Неопределено Тогда
			...
			Если ЕстьПанельВычетыЛичные Тогда
				...
				ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
					Форма.Элементы,
					ГруппаФормыПанельВычеты.Имя + "ПримененныйВычетЛичныйНалоговаяБаза",
					"ТолькоПросмотр",
					Истина);
		...
		Иначе
			...
			Если ЕстьПанельВычетыЛичные Тогда
				...
				Форма[ГруппаФормыПанельВычеты.Имя + "ПримененныйВычетЛичныйНалоговаяБаза"] 				= НДФЛТекущиеДанные["ПримененныйВычетЛичныйНалоговаяБаза"];
