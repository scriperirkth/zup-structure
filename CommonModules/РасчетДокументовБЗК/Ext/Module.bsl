...
Функция ДобавитьСтрокуТаблицыСИдентефикатором(ТаблицаОбъекта, ОписаниеТаблицы, ПозицияВставки = Неопределено) Экспорт
	...
	ИначеЕсли ОписаниеТаблицы.Свойство("МаксимальныйИдентификаторСтроки") Тогда
		ИдентификаторСтроки = ОписаниеТаблицы.МаксимальныйИдентификаторСтроки + 1;
		ОписаниеТаблицы.МаксимальныйИдентификаторСтроки = ИдентификаторСтроки;
	Иначе
