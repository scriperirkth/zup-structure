...
Функция НайтиСоздатьСертификатПодписантаИзСвойствПодписи(Знач СвойстваПодписи,
	...
	МодульИнтеграцияБСПБЭДВызовСервера = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияБСПБЭДВызовСервера");
	ПараметрыПодписанта = МодульИнтеграцияБСПБЭДВызовСервера.ПараметрыПодписантаМобильнойПодписи(Подписант);
	
	МодульКриптографияБЭД = ОбщегоНазначения.ОбщийМодуль("КриптографияБЭД");
	СсылкаНаСертификат = МодульКриптографияБЭД.НайтиСоздатьСертификатЭП(СвойстваПодписи.Сертификат,
		ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(ПараметрыПодписанта, "Организация"));
	
	МодульМобильныйЭДОСлужебныйВызовСервера = ОбщегоНазначения.ОбщийМодуль("МобильныйЭДОСлужебныйВызовСервера");
	МодульМобильныйЭДОСлужебныйВызовСервера.ДобавитьСертификатПодписанта(Подписант,
		СсылкаНаСертификат,
		ВидМобильнойПодписи);
