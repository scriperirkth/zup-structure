...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ПолучитьСписокКалендарейВФоне", Истина);
	Методы.Вставить("СинхронизироватьВФоне", Истина); 
	Методы.Вставить("ДоступностьПомещений", Истина);
	Методы.Вставить("ДоступностьПользователей", Истина);
	Методы.Вставить("ТаблицаЗанятостиИзВнешнихСистем", Истина);
КонецПроцедуры
...
Функция СоздатьНапоминание(ПараметрыНапоминания)
	...
	Если Напоминание.Расписание <> Неопределено Тогда
		Напоминание.ВремяСобытия = НапоминанияПользователяСлужебный.БлижайшаяДатаСобытияПоРасписанию(Напоминание.Расписание);
		Напоминание.СрокНапоминания = Напоминание.ВремяСобытия - Напоминание.ИнтервалВремениНапоминания;
	КонецЕсли;
