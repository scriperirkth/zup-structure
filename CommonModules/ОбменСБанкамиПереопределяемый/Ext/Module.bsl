...
Процедура ПолучитьНомераБанковскихСчетов(Организация, Банк, МассивНомеровБанковскихСчетов) Экспорт
	ОбменСБанкамиБЗК.ПолучитьНомераБанковскихСчетов(Организация, Банк, МассивНомеровБанковскихСчетов)
КонецПроцедуры
...
//
// Параметры:
//  ДоступнаяФункциональность - Структура - см. ОбменСБанкамиСлужебныйКлиентСервер.НовыйДоступнаяФункциональность
//
Процедура ПриОпределенииДоступнойФункциональности(ДоступнаяФункциональность) Экспорт
