...
Процедура ОтметитьКакПрочтенное(Ссылка) Экспорт
	...
	Если ТипЗнч(Ссылка) = Тип("ДокументСсылка.ВходящийДокументСЭДОФСС")
		...
		ИЛИ (ЭтоРежимОблачной1СО
			И ОбщегоНазначения.ОбщийМодуль("КалендарьОтчетности").ЭтоДокументРазделаВыплатыИПособия(Ссылка)) Тогда
...
Функция КатегорияТранспортногоСообщения(
	...
	Если ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.РассылкаНО
		...
		Возврат ?(ВернутьУпрощенныеКатегории = "ВернутьСтраницыЖурналаОтчетность",
			Перечисления.СтраницыЖурналаОтчетность.Входящие, "Рассылка");
	...
	ИначеЕсли ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.ПисьмоНО
		...
		Возврат ?(ВернутьУпрощенныеКатегории = "ВернутьСтраницыЖурналаОтчетность",
			Перечисления.СтраницыЖурналаОтчетность.Входящие, "ВходящееПисьмо");
		
	ИначеЕсли ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.ДокументНО Тогда
		Возврат ?(ВернутьУпрощенныеКатегории = "ВернутьСтраницыЖурналаОтчетность",
			Перечисления.ВидыДокументовВЖурнале.ТребованиеИлиУведомление, "ДокументРеализацииПолномочий");
	...
	ИначеЕсли ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеФНС
		...
		Если ВернутьУпрощенныеКатегории = "ВернутьСтраницыЖурналаОтчетность" Тогда
			Если (ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеФНС
						ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.КритическаяОшибка)
					И (ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.НалоговаяИлиБухгалтерскаяОтчетность
						ИЛИ ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.Заявление
						ИЛИ ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.Форма2НДФЛ)
				ИЛИ (ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеПФР
						ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.КритическаяОшибка)
					И ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.ОтчетностьПФР
				ИЛИ (ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеФСГС
						ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.КритическаяОшибка)
					И ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.ОтчетностьФСГС Тогда
				
				Возврат Перечисления.СтраницыЖурналаОтчетность.Отчеты;
				
			ИначеЕсли (ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеФНС
						ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.КритическаяОшибка)
					И ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.Представление Тогда
				
				Возврат Перечисления.СтраницыЖурналаОтчетность.Уведомления;
				
			ИначеЕсли (ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеФНС
						ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.КритическаяОшибка)
					И ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.ОбращениеНП
				ИЛИ (ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеПФР
						ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.КритическаяОшибка)
					И ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.НеформализованнаяПерепискаПФРИсходящие
				ИЛИ (ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеФСГС
						ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.КритическаяОшибка)
					И ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.ПисьменноеОбращениеВФСГС Тогда
				
				Возврат Перечисления.СтраницыЖурналаОтчетность.Письма;
				
			ИначеЕсли (ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеФНС
						ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.КритическаяОшибка)
					И ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.ИОН
				ИЛИ (ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеПФР
						ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.КритическаяОшибка)
					И ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.ИОС Тогда
				
				Возврат Перечисления.СтраницыЖурналаОтчетность.Сверки;
				
			ИначеЕсли (ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеФНС
						ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.КритическаяОшибка)
					И (ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.ПисьмоНО
						ИЛИ ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.Рассылка
						ИЛИ ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.РассылкаГрупповая)
				ИЛИ (ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеПФР
						ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.КритическаяОшибка)
					И (ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.НеформализованнаяПерепискаПФРВходящие
						ИЛИ ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.РассылкаПФР)
				ИЛИ (ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеФСГС
						ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.КритическаяОшибка)
					И (ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.ИндивидуальноеИнформированиеФСГС
						ИЛИ ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.РассылкаФСГС
						ИЛИ ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.РассылкаШаблоновФСГС) Тогда
				
				Возврат Перечисления.СтраницыЖурналаОтчетность.Входящие;
				
			ИначеЕсли (ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.УведомлениеОбОшибкеФНС
						ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.КритическаяОшибка)
					И ТипЦиклаОбмена = Перечисления.ТипыЦикловОбмена.Документ Тогда
				
				Возврат Перечисления.ВидыДокументовВЖурнале.ТребованиеИлиУведомление;
		...
		Иначе
			Возврат ?(ВернутьУпрощенныеКатегории = Истина, "Протокол", "УведомлениеОбОшибке");
		КонецЕсли;
		
	ИначеЕсли ВернутьУпрощенныеКатегории = "ВернутьСтраницыЖурналаОтчетность" Тогда
		Если ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.ПодтверждениеДекларацияНО
			ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.ИзвещениеДекларацияНО
			ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.ПодтверждениеДекларацияНО
			ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.ИзвещениеДекларацияНО
			ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.РезультатПриемаДекларацияНО
		...
		ИначеЕсли ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.ПодтверждениеПредставлениеНО
			ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.РезультатПриемаПредставлениеНО Тогда
			
			Возврат Перечисления.СтраницыЖурналаОтчетность.Уведомления;
			
		ИначеЕсли ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.ПодтверждениеОбращениеНО
			ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.РезультатПриемаОбращениеНО
			
			ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.ПисьмоИсходящееКвитанцияПФР
			
			ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.ИзвещениеПисьмоИсходящееФСГС Тогда
			
			Возврат Перечисления.СтраницыЖурналаОтчетность.Письма;
			
		ИначеЕсли ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.ПодтверждениеЗапросНО
			ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.ИзвещениеЗапросНО
			ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.РезультатПриемаЗапросНО
			ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.РезультатОбработкиЗапросНО
			
			ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.ПодтверждениеПолученияЗапросаПФР
			ИЛИ ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.ОтветНаЗапросПФР Тогда
	...
	ИначеЕсли ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.РезультатПриемаДекларацияНО
		...
		Если ПротоколСОшибкой
			...
			Возврат ?(ВернутьУпрощенныеКатегории = Истина, "Протокол", "ПротоколСОшибкой");
		...
		ИначеЕсли ТипТранспортногоСообщения = Перечисления.ТипыТранспортныхСообщений.РезультатПриемаДекларацияНО
			...
			Возврат ?(ВернутьУпрощенныеКатегории = Истина, "Другое", "Квитанция");
		...
		Иначе
			Возврат ?(ВернутьУпрощенныеКатегории = Истина, "Другое", "УспешныйПротокол");
		КонецЕсли;
		
	ИначеЕсли ВернутьУпрощенныеКатегории = Истина Тогда
		Возврат "Другое";
...
// Возвращает значение настройки обмена по организациям.
// 
...
Функция ЗагрузитьФайлXML(Знач ИмяФайла) Экспорт
	
	РегламентированнаяОтчетностьКлиентСервер.ПроверитьПолноеИмяВременногоФайла(
		ИмяФайла, "ИмяФайла", "ЗагрузитьФайлXML");	
...
Процедура ЗаписатьСобытиеДокументооборотаСКО(Запись) Экспорт
	...
	Если МенеджерЗаписи.Выбран() 
		...
		МенеджерЗаписи.СтраницаЖурнала = Запись.Страница;
		МенеджерЗаписи.ВидКонтролирующегоОргана = Запись.ВидКонтролирующегоОргана;
...
Функция ЕстьОтвет(Запись)
	...
	Если ТипЗнч(Запись.Объект) = Тип("ДокументСсылка.ЗапросНаИнформационноеОбслуживаниеНалогоплательщика")
		...
		ИЛИ ТипЗнч(Запись.Объект) = Тип("ДокументСсылка.ЗапросНаВыпискуИзЕГРЮЛ_ЕГРИП")
		ИЛИ ТипЗнч(Запись.Объект) = Тип("СправочникСсылка.ДокументыРеализацииПолномочийНалоговыхОрганов") Тогда
...
Функция ПолучитьОтправленоПолученоНовогоСобытияДокументооборотаСКО(Запись)
	...
	Если Запись.Страница = Перечисления.СтраницыЖурналаОтчетность.Входящие
		ИЛИ Запись.Страница = Перечисления.СтраницыЖурналаОтчетность.ВыплатыИПособия Тогда
		...
		ИначеЕсли ДокументооборотСКОПовтИсп.ЭтоРежимОблачной1СО()
			И ОбщегоНазначения.ОбщийМодуль("КалендарьОтчетности").ЭтоДокументРазделаВыплатыИПособия(Запись.Объект) Тогда
			Возврат ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Запись.Объект, "ДатаСообщения");
...
Функция ПолучитьНадписьВремяОбновления(ДатаПоследнегоОбновления) Экспорт
	...
	ИначеЕсли ВременнаяРазница < 15 * 60 Тогда
		НадписьВремяОбновления = ?(ДокументооборотСКОПовтИсп.ЭтоРежимОблачной1СО(),
			НСтр("ru = 'Сообщения получены только что'"), НСтр("ru = 'Обновлено только что'"));
	ИначеЕсли ВременнаяРазница < 30 * 60 Тогда
		НадписьВремяОбновления = ?(ДокументооборотСКОПовтИсп.ЭтоРежимОблачной1СО(),
			НСтр("ru = 'Сообщения получены 15 минут назад'"), НСтр("ru = 'Обновлено 15 минут назад'"));
	ИначеЕсли ВременнаяРазница < 60 * 60 Тогда
		НадписьВремяОбновления = ?(ДокументооборотСКОПовтИсп.ЭтоРежимОблачной1СО(),
			НСтр("ru = 'Сообщения получены полчаса назад'"), НСтр("ru = 'Обновлено полчаса назад'"));
	ИначеЕсли ВременнаяРазница < 2 * 60 * 60 Тогда
		НадписьВремяОбновления = ?(ДокументооборотСКОПовтИсп.ЭтоРежимОблачной1СО(),
			НСтр("ru = 'Сообщения получены час назад'"), НСтр("ru = 'Обновлено час назад'"));
	ИначеЕсли ВременнаяРазница < 24 * 60 * 60 Тогда
		НадписьВремяОбновления = ?(ДокументооборотСКОПовтИсп.ЭтоРежимОблачной1СО(),
			НСтр("ru = 'Сообщения получены несколько часов назад'"), НСтр("ru = 'Обновлено несколько часов назад'"));
	ИначеЕсли ВременнаяРазница < 48 * 60 * 60 Тогда
		НадписьВремяОбновления = ?(ДокументооборотСКОПовтИсп.ЭтоРежимОблачной1СО(),
			НСтр("ru = 'Сообщения получены вчера'"), НСтр("ru = 'Обновлено вчера'"));
	Иначе
		НадписьВремяОбновления = ?(ДокументооборотСКОПовтИсп.ЭтоРежимОблачной1СО(),
			НСтр("ru = 'Сообщения получены несколько дней назад'"), НСтр("ru = 'Обновлено несколько дней назад'"));
	КонецЕсли;
...
Функция НовоеДеревоНовыхСобытий() Экспорт
	...
	МассивТиповГруппы = Новый Массив();
	МассивТиповГруппы.Добавить(
		Новый ОписаниеТипов("ПеречислениеСсылка.ВидыДокументовВЖурнале"));
	МассивТиповГруппы.Добавить(
		Новый ОписаниеТипов("ПеречислениеСсылка.СтраницыЖурналаОтчетность"));
	МассивТиповГруппы.Добавить(
		Новый ОписаниеТипов("ПеречислениеСсылка.ГруппыНовыхСобытийДокументооборотаСКонтролирующимиОрганами"));
	ТипСтрока100 = Новый КвалификаторыСтроки(100);
	ТипыГруппы = Новый ОписаниеТипов(МассивТиповГруппы,, ТипСтрока100);
	...
	Результат.Колонки.Добавить("СостояниеСдачиОтчетности",
	...
	Результат.Колонки.Добавить("Группа", ТипыГруппы);
	Результат.Колонки.Добавить("ЕстьКритическиеОшибкиОтправки", ТипБулево);
	Результат.Колонки.Добавить("ИсходнаяГруппа",
		Новый ОписаниеТипов("ПеречислениеСсылка.ГруппыНовыхСобытийДокументооборотаСКонтролирующимиОрганами"));
...
Процедура ЗаполнитьДеревоНовое(
		ДеревоНовое,
		ИнициаторСеанса = Неопределено,
		ТолькоНепоказанные = Ложь,
		Отборы = Неопределено,
		ДеревоНовоеНепоказанные = Неопределено) Экспорт
	
	ОтборыВызова = Новый Структура;
	ОтборыВызова.Вставить("Организация", Справочники.Организации.ПустаяСсылка());
	ОтборыВызова.Вставить("ВидКонтролирующегоОргана", Перечисления.ТипыКонтролирующихОрганов.ПустаяСсылка());
	ОтборыВызова.Вставить("ДатаНачала", '00010101');
	ОтборыВызова.Вставить("ДатаОкончания", '00010101');
	ОтборыВызова.Вставить("ТолькоУказанныйПериод", Ложь);
	ОтборыВызова.Вставить("ВключатьПросмотренные", Ложь);
	ОтборыВызова.Вставить("Группа", Неопределено);
	ОтборыВызова.Вставить("УпрощенныйРезультат", Ложь);
	Если Отборы <> Неопределено Тогда
		ЗаполнитьЗначенияСвойств(ОтборыВызова, Отборы);
	КонецЕсли;
	
	ДеревоНовое.Строки.Очистить();
	Если ДеревоНовоеНепоказанные <> Неопределено Тогда
		ДеревоНовоеНепоказанные.Строки.Очистить();
	КонецЕсли;
	
	Запрос = Новый Запрос;
	
	Если ЭлектронныйДокументооборотСКонтролирующимиОрганамиВызовСервера.НовыеСобытияПоСтраницамЖурнала()
		И НЕ ОтборыВызова.УпрощенныйРезультат Тогда
		...
		Запрос.Текст =
			...
			|	ЖурналНовыхСобытий.КонтролирующийОрган КАК КонтролирующийОрган,
			|	ВЫБОР
			|		КОГДА ЖурналНовыхСобытий.СтраницаЖурнала = ЗНАЧЕНИЕ(Перечисление.СтраницыЖурналаОтчетность.ВыплатыИПособия)
			|			ТОГДА ЕСТЬNULL(ЖурналСЭДО.Просмотрено, ИСТИНА)
			|		ИНАЧЕ ЖурналНовыхСобытий.Просмотрено
			|	КОНЕЦ КАК Просмотрено,
			|	ЖурналНовыхСобытий.Состояние КАК Состояние,
			|	ВЫБОР
			|		КОГДА ЖурналНовыхСобытий.ВидДокумента = ЗНАЧЕНИЕ(Перечисление.ВидыДокументовВЖурнале.Рассылка)
			|				И (НЕ ЖурналНовыхСобытий.Просмотрено ИЛИ &ВключатьПросмотренные)
			|			ТОГДА 7
			|		КОГДА ЖурналНовыхСобытий.ВидДокумента = ЗНАЧЕНИЕ(Перечисление.ВидыДокументовВЖурнале.ТребованиеИлиУведомление)
			|				И (НЕ ЖурналНовыхСобытий.Просмотрено ИЛИ &ВключатьПросмотренные)
			|			ТОГДА 0
			|		КОГДА ЖурналНовыхСобытий.СтраницаЖурнала = ЗНАЧЕНИЕ(Перечисление.СтраницыЖурналаОтчетность.Отчеты)
			|				И (НЕ ЖурналНовыхСобытий.Просмотрено ИЛИ &ВключатьПросмотренные)
			|			ТОГДА 1
			|		КОГДА ЖурналНовыхСобытий.СтраницаЖурнала = ЗНАЧЕНИЕ(Перечисление.СтраницыЖурналаОтчетность.Уведомления)
			|				И (НЕ ЖурналНовыхСобытий.Просмотрено ИЛИ &ВключатьПросмотренные)
			|			ТОГДА 2
			|		КОГДА ЖурналНовыхСобытий.СтраницаЖурнала = ЗНАЧЕНИЕ(Перечисление.СтраницыЖурналаОтчетность.Сверки)
			|				И (НЕ ЖурналНовыхСобытий.Просмотрено ИЛИ &ВключатьПросмотренные)
			|			ТОГДА 3
			|		КОГДА ЖурналНовыхСобытий.СтраницаЖурнала = ЗНАЧЕНИЕ(Перечисление.СтраницыЖурналаОтчетность.Письма)
			|				И (НЕ ЖурналНовыхСобытий.Просмотрено ИЛИ &ВключатьПросмотренные)
			|			ТОГДА 4
			|		КОГДА ЖурналНовыхСобытий.СтраницаЖурнала = ЗНАЧЕНИЕ(Перечисление.СтраницыЖурналаОтчетность.Входящие)
			|				И (НЕ ЖурналНовыхСобытий.Просмотрено ИЛИ &ВключатьПросмотренные)
			|			ТОГДА 5
			|		КОГДА ЖурналНовыхСобытий.СтраницаЖурнала = ЗНАЧЕНИЕ(Перечисление.СтраницыЖурналаОтчетность.ВыплатыИПособия)
			|				И (НЕ ЕСТЬNULL(ЖурналСЭДО.Просмотрено, ИСТИНА) ИЛИ &ВключатьПросмотренные)
			|			ТОГДА 6
			|		КОГДА ЖурналНовыхСобытий.Просмотрено
			|				ИЛИ ЖурналНовыхСобытий.СтраницаЖурнала = ЗНАЧЕНИЕ(Перечисление.СтраницыЖурналаОтчетность.ВыплатыИПособия)
			|					И ЕСТЬNULL(ЖурналСЭДО.Просмотрено, ИСТИНА)
			|			ТОГДА 8
			|	КОНЕЦ КАК ГруппаПорядок,
			|	ЖурналНовыхСобытий.СеансСвязи КАК СеансСвязи,
			|	ЖурналНовыхСобытий.ДатаСобытия КАК ДатаСобытия,
			|	ЖурналНовыхСобытий.Порядок КАК Порядок,
			|	ЖурналНовыхСобытий.ЕстьОтвет КАК ЕстьОтвет,
			|	ЖурналНовыхСобытий.НеОтправляетсяВКонтролирующийОрган КАК НеОтправляетсяВКонтролирующийОрган,
			|	ВЫБОР
			|		КОГДА ЖурналНовыхСобытий.ВидДокумента = ЗНАЧЕНИЕ(Перечисление.ВидыДокументовВЖурнале.Рассылка)
			|					И (НЕ ЖурналНовыхСобытий.Просмотрено ИЛИ &ВключатьПросмотренные)
			|				ИЛИ ЖурналНовыхСобытий.ВидДокумента = ЗНАЧЕНИЕ(Перечисление.ВидыДокументовВЖурнале.ТребованиеИлиУведомление)
			|					И (НЕ ЖурналНовыхСобытий.Просмотрено ИЛИ &ВключатьПросмотренные)
			|			ТОГДА ЖурналНовыхСобытий.ВидДокумента
			|		КОГДА НЕ ЖурналНовыхСобытий.Просмотрено
			|				И (ЖурналНовыхСобытий.СтраницаЖурнала <> ЗНАЧЕНИЕ(Перечисление.СтраницыЖурналаОтчетность.ВыплатыИПособия)
			|					ИЛИ НЕ ЕСТЬNULL(ЖурналСЭДО.Просмотрено, ИСТИНА))
			|				ИЛИ &ВключатьПросмотренные
			|			ТОГДА ЖурналНовыхСобытий.СтраницаЖурнала
			|		ИНАЧЕ ""Прочтенные""
			|	КОНЕЦ КАК Группа,
			|	ЖурналНовыхСобытий.ОтправленоПолучено КАК ОтправленоПолучено,
			|	ЖурналНовыхСобытий.ЕстьКритическиеОшибкиОтправки КАК ЕстьКритическиеОшибкиОтправки,
			|	ЖурналНовыхСобытий.Группа КАК ИсходнаяГруппа
			|ИЗ
			|	РегистрСведений.ЖурналНовыхСобытий КАК ЖурналНовыхСобытий
			|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ЖурналНовыхСобытий КАК ЖурналСЭДО
			|		ПО ЖурналНовыхСобытий.Ссылка = ЖурналСЭДО.Ссылка
			|ГДЕ
			...
			|			ИЛИ ЖурналНовыхСобытий.Организация = &Организация)
			|	И (&ВидКонтролирующегоОргана = ЗНАЧЕНИЕ(Перечисление.ТипыКонтролирующихОрганов.ПустаяСсылка)
			|			ИЛИ ЖурналНовыхСобытий.ВидКонтролирующегоОргана = &ВидКонтролирующегоОргана)
			|	И (&ДатаНачала = ДАТАВРЕМЯ(1, 1, 1, 0, 0, 0)
			|				И &ДатаОкончания = ДАТАВРЕМЯ(1, 1, 1, 0, 0, 0)
			|			ИЛИ &ТолькоУказанныйПериод = ИСТИНА
			|				И ЖурналНовыхСобытий.ДатаНачала = &ДатаНачала
			|				И ЖурналНовыхСобытий.ДатаОкончания = &ДатаОкончания
			|			ИЛИ &ТолькоУказанныйПериод <> ИСТИНА
			|				И ЖурналНовыхСобытий.ДатаНачала >= &ДатаНачала
			|				И ЖурналНовыхСобытий.ДатаОкончания <= &ДатаОкончания
			|				И ЖурналНовыхСобытий.ДатаОкончания >= &ДатаНачала)
			...
			|	ЗНАЧЕНИЕ(Перечисление.СтраницыЖурналаОтчетность.Отчеты),
			...
			|	NULL,
			|	NULL,
			|	ЗНАЧЕНИЕ(Перечисление.СтраницыЖурналаОтчетность.Входящие),
			|	NULL,
			|	NULL,
			|	NULL
			|
			...
			|	NULL,
			|	NULL,
			|	ЗНАЧЕНИЕ(Перечисление.СтраницыЖурналаОтчетность.ВыплатыИПособия),
			|	NULL,
			|	NULL,
			|	NULL
			|
			...
			|	NULL,
			|	NULL,
			|	ЗНАЧЕНИЕ(Перечисление.ВидыДокументовВЖурнале.Рассылка),
			|	NULL,
			|	NULL,
			|	NULL
			|
			...
			ИмяРегистраЖурналаНовогоСЭДО = 
				РегламентированнаяОтчетностьКлиентСервер.ПараметрыФункциональности().ИмяРегистраЖурналаНовыхСобытийСЭДО;
			ПодстрокаДляЗамены = "ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ЖурналНовыхСобытий КАК ЖурналСЭДО";
			ПодстрокаДляПодстановки = СтрЗаменить(ПодстрокаДляЗамены, "ЖурналНовыхСобытий", ИмяРегистраЖурналаНовогоСЭДО);
			Запрос.Текст = СтрЗаменить(Запрос.Текст, ПодстрокаДляЗамены, ПодстрокаДляПодстановки);
			
		Если ИнициаторСеанса <> Перечисления.ИнициаторыСеансовСвязиСКонтролирующимиОрганами.Автообмен Тогда
			Запрос.Текст = СтрЗаменить(Запрос.Текст, "УПОРЯДОЧИТЬ ПО",
				...
				|	NULL,
				|	NULL,
				|	ЗНАЧЕНИЕ(Перечисление.СтраницыЖурналаОтчетность.Уведомления),
				|	NULL,
				|	NULL,
				|	NULL
				|
				...
				|	NULL,
				|	NULL,
				|	ЗНАЧЕНИЕ(Перечисление.СтраницыЖурналаОтчетность.Сверки),
				|	NULL,
				|	NULL,
				|	NULL
				|
				...
				|	NULL,
				|	NULL,
				|	ЗНАЧЕНИЕ(Перечисление.СтраницыЖурналаОтчетность.Письма),
				|	NULL,
				|	NULL,
				|	NULL
				|
	...
	Если ЭлектронныйДокументооборотСКонтролирующимиОрганамиВызовСервера.НовыеСобытияПоСтраницамЖурнала()
		...
		Запрос.УстановитьПараметр("Организация", ОтборыВызова.Организация);
		Запрос.УстановитьПараметр("ВидКонтролирующегоОргана", ОтборыВызова.ВидКонтролирующегоОргана);
		Запрос.УстановитьПараметр("ДатаНачала", ОтборыВызова.ДатаНачала);
		Запрос.УстановитьПараметр("ДатаОкончания", ОтборыВызова.ДатаОкончания);
		Запрос.УстановитьПараметр("ТолькоУказанныйПериод", ОтборыВызова.ТолькоУказанныйПериод);
		Запрос.УстановитьПараметр("ВключатьПросмотренные", ОтборыВызова.ВключатьПросмотренные);
	КонецЕсли;
...
Процедура ЗаполнитьСтрокиДерева(
		ДеревоНовое,
		ВыборкаДетали,
		Группа,
		ИсходнаяГруппа,
	...
	Если ИнициаторСеанса = Перечисления.ИнициаторыСеансовСвязиСКонтролирующимиОрганами.Автообмен
		И ИсходнаяГруппа =
			Перечисления.ГруппыНовыхСобытийДокументооборотаСКонтролирующимиОрганами.НезавершенныеОтправки Тогда
		Возврат;
	КонецЕсли;
	...
	Пока ВыборкаДетали.Следующий() Цикл
		Если ЗначениеЗаполнено(ВыборкаДетали.Объект) Тогда
			...
			Если ВыборкаДетали.Просмотрено И (НЕ НовыеСобытияПоСтраницамЖурнала
					ИЛИ ИнициаторСеанса = Перечисления.ИнициаторыСеансовСвязиСКонтролирующимиОрганами.Автообмен) Тогда
	...
	СтрокаБлок = Неопределено;
	Если НЕ НовыеСобытияПоСтраницамЖурнала ИЛИ (МассивНовые.Количество() <> 0 И ОтборыВызова.Группа = Неопределено) Тогда
		СтрокаБлок = ДеревоНовое.Строки.Добавить();
		СтрокаБлок.ЭтоЗаголовокБлока = Истина;
		СтрокаБлок.ЗаголовокБлока = ИмяГруппыНовых(Группа);
		СтрокаБлок.Группа = Группа;
	КонецЕсли;
	
	Если МассивНовые.Количество() = 0 Тогда
		Если НЕ НовыеСобытияПоСтраницамЖурнала Тогда
			СтрокаСобытие = ДеревоНовое.Строки.Добавить();
			СтрокаСобытие.Наименование = Отступ(, "ПринудительныйОтступ") + НадписьНовыхНет(Группа);
		КонецЕсли;
		
	Иначе
		Для каждого НовоеСобытие Из МассивНовые Цикл
			Если НовыеСобытияПоСтраницамЖурнала И ОтборыВызова.Группа <> Неопределено И ОтборыВызова.Группа <> Группа Тогда
				Если ДеревоНовоеНепоказанные <> Неопределено Тогда
					СтрокаСобытие = ДеревоНовоеНепоказанные.Строки.Добавить();
				КонецЕсли;
			ИначеЕсли НовыеСобытияПоСтраницамЖурнала И СтрокаБлок <> Неопределено Тогда
	...
	Если НЕ НовыеСобытияПоСтраницамЖурнала
		И ИнициаторСеанса <> Перечисления.ИнициаторыСеансовСвязиСКонтролирующимиОрганами.Автообмен
		И ИсходнаяГруппа <>
			Перечисления.ГруппыНовыхСобытийДокументооборотаСКонтролирующимиОрганами.НезавершенныеОтправки Тогда
...
Функция Отступ(Просмотрено = Ложь, Группа = Неопределено)
	...
	Если (Группа = Перечисления.ГруппыНовыхСобытийДокументооборотаСКонтролирующимиОрганами.НезавершенныеОтправки
			ИЛИ НЕ Просмотрено)
		И НЕ ЭлектронныйДокументооборотСКонтролирующимиОрганамиВызовСервера.НовыеСобытияПоСтраницамЖурнала()
			ИЛИ Группа = "ПринудительныйОтступ"
				И ЭлектронныйДокументооборотСКонтролирующимиОрганамиВызовСервера.НовыеСобытияПоСтраницамЖурнала() Тогда
...
Функция НадписьНовыхНет(Группа)
	...
	Если Группа = Перечисления.ГруппыНовыхСобытийДокументооборотаСКонтролирующимиОрганами.НезавершенныеОтправки Тогда
...
Функция ИмяГруппыНовых(Группа)
	
	Если Группа = Перечисления.ВидыДокументовВЖурнале.ТребованиеИлиУведомление Тогда
		Возврат НСтр("ru = 'Требования'");
	ИначеЕсли Группа = Перечисления.ВидыДокументовВЖурнале.Рассылка Тогда
		Возврат НСтр("ru = 'Рассылки'");
	ИначеЕсли Группа = "Прочтенные" Тогда
		Возврат НСтр("ru = 'Прочтенные'");
	Иначе
		Возврат Строка(Группа);
	КонецЕсли;
	
КонецФункции

Процедура ОформитьРежимОблачнойОтчетностиЖурналаОтчетности(ОбъектФормы) Экспорт
	
	Элементы = ОбъектФормы.Элементы;
	Элементы.ГруппаСсылокРазделы.Видимость = Ложь;
	Элементы.ГиперссылкаНовое.Видимость = Ложь;
	Элементы.Декорация2.РастягиватьПоГоризонтали = Истина;
	Элементы.Декорация2.Ширина = 0;
	Элементы.Декорация2.АвтоМаксимальнаяШирина = Ложь;
	
	Элементы.Переместить(Элементы.ИнформационныеПанели,
		Элементы.НоваяГруппаИнформационныеПанели);
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ЗаполнитьНеобходимоРасшифроватьВФоне", Истина);
КонецПроцедуры

Процедура СохранитьВариантОбменаПриОтбореПоОрганизации(ВыборВидаОбменаПриОтборе, ВариантОтображенияВыбора = Неопределено) Экспорт
	
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить(
		"НастройкиОбменаПоОрганизациям",
		"ВариантОбменаПриОтбореПоОрганизации",
		ВыборВидаОбменаПриОтборе);
		
	Если ВариантОтображенияВыбора <> Неопределено Тогда
		ОбщегоНазначения.ХранилищеОбщихНастроекСохранить(
			"НастройкиОбменаПоОрганизациям",
			"ВариантОтображенияВыбораОкнаИлиМеню",
			ВариантОтображенияВыбора);
	КонецЕсли;
		
КонецПроцедуры

// Возвращает режим вывода окна выбора при получений сообщений с установленным отбором
// 
// Возвращаемое значение:
//  Булево - Отображать выбор получения сообщений в окне
Функция ОтображатьВыборПолученияСообщенийВОкне() Экспорт
...
// Возвращает вариант обмена при отборе по организации.
// 
// Возвращаемое значение:
//  Число
Функция ПолучитьВариантОбменаПриОтбореПоОрганизации() Экспорт
...
Функция ЗаполнитьНеобходимоРасшифроватьВФоне() Экспорт
	
	Результат = Неопределено;
	КонтекстЭДОСервер = ДокументооборотСКО.ПолучитьОбработкуЭДО();
	Если КонтекстЭДОСервер <> Неопределено Тогда
		Результат = КонтекстЭДОСервер.ПолучитьСообщенияДляРасшифровки().НеобходимоРасшифровать;
	КонецЕсли;
...
// Сохраняем настройки обмена по организациям.
// 
// Параметры:
//  ВыборВидаНастройки  - Число
