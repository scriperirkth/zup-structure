...
Процедура ПриЗаполненииТиповИсключаемыхИзВыгрузкиЗагрузки(Типы) Экспорт
	...
	Типы.Добавить(Метаданные.РегистрыСведений.РасширенияИзменяющиеСтруктуруДанныхОжидаемыеПользователем);
	Типы.Добавить(Метаданные.РегистрыСведений.НастройкиКаталогаРасширенийВОбластяхДанных);
...
Процедура ЗапланироватьОбновленияРасширенийВОбластях(ЗавершатьСеансы = Ложь, 
	ЗапланированныйМоментЗапуска = Неопределено, Пользователь = Неопределено) Экспорт
