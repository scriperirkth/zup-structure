...
Процедура Подписать(ОписаниеДанных, КонтекстДиагностики, Форма = Неопределено, Оповещение = Неопределено,
	...
	МодульСервисЭДОКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("СервисЭДОКлиент");
	ОперацияПодписаниеРегистрационныхДанных = МодульСервисЭДОКлиент.ОперацияПодписаниеРегистрационныхДанных();
	
	Если Не (ОписаниеДанных.Свойство("Операция") И ОписаниеДанных.Операция = ОперацияПодписаниеРегистрационныхДанных) Тогда
...
// Проверяет сертификат средствами БСП, а также дополнительно проверяет на условия признания квалифицированным.
// 
// Параметры:
...
Функция ЭтоВидСертификатаФизическогоЛица(СвойстваСубъекта, СвойстваИздателя) Экспорт
	...
	Возврат КриптографияБЭДКлиентСервер.ЭтоВидСертификатаФизическогоЛица(СвойстваСубъекта);
...
// Возвращаемое значение:
//  Булево
Функция ЭтоСертификатВыданныйЦентральнымБанком(СвойстваСубъектаСертификата, СвойстваИздателяСертификата)
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЭлектронноеВзаимодействие.ОбменСКонтрагентами") Тогда
		МодульМашиночитаемыеДоверенностиКлиентСервер =
			ОбщегоНазначенияКлиент.ОбщийМодуль("МашиночитаемыеДоверенностиКлиентСервер");
		ИздательЦБ = 
			МодульМашиночитаемыеДоверенностиКлиентСервер.ЭтоИННЦентральногоБанка(СвойстваИздателяСертификата.ИНН);
