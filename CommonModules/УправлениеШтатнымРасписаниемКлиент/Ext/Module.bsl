...
Процедура ОбработчикКоманды(ФормаОтчета, Команда, Результат) Экспорт
	...
	Если ФормаОтчета.ИмяФормы = "Отчет.СостояниеШтатногоРасписания.Форма" Тогда
		
		Если Команда.Имя = "ИзменитьПозицииШР" Тогда
...
Процедура ОбработкаДополнительнойРасшифровки(ФормаОтчета, Элемент, Расшифровка, СтандартнаяОбработка) Экспорт
	...
	Если ФормаОтчета.НастройкиОтчета.ПолноеИмя = "Отчет.СостояниеШтатногоРасписания" Тогда
		...
		ИменаПолейРасшифровки.Добавить("ПозицияШтатногоРасписания");
		ИменаПолейРасшифровки.Добавить("Подразделение");
		ИменаПолейРасшифровки.Добавить("Организация");
		
		РегистраторРасшифровки = УправлениеШтатнымРасписаниемВызовСервера.ПолучитьРегистраторРасшифровки(ФормаОтчета.ОтчетДанныеРасшифровки, КомпоновщикНастроек, Расшифровка);
		...
		ПараметрыРасшифровки.ИменаДокументов = ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве("ИзменениеШтатногоРасписания");
		ПараметрыРасшифровки.ВариантОтчетаДляЗаполнения = (ФормаОтчета.КлючТекущегоВарианта = "АнализШтатногоРасписания");
		ПараметрыРасшифровки.РегистраторРасшифровки = РегистраторРасшифровки;
...
Процедура ЗаполнитьДокументИзОтчета(ФормаОтчета, КомандаЗаполнения = Неопределено) Экспорт
	...
	МассивПолей.Добавить("ПозицияШтатногоРасписания");
	...
	МассивКолонок.Добавить("ПозицияШтатногоРасписания");
	...
	Для Каждого СтруктураЗаполнения Из МассивДанных Цикл
		ОткрытьФорму("Документ.ИзменениеШтатногоРасписания.Форма.ФормаДокумента", Новый Структура("Основание", СтруктураЗаполнения),,Истина);
	КонецЦикла;
