...
Функция ДанныеРасшифровкиИзОтчета(Знач ОтчетДанныеРасшифровки, ХранилищеРезультатаОтчета, МассивРасшифровок, МассивПолейОтбора, МассивГруппировок, МассивКолонок) Экспорт
	
	Возврат ЗарплатаКадрыРасширенный.ДанныеРасшифровкиИзОтчета(ОтчетДанныеРасшифровки, ХранилищеРезультатаОтчета, МассивРасшифровок, МассивПолейОтбора, МассивГруппировок, МассивКолонок);

КонецФункции

Функция ХранилищеТаблицыРезультатаОтчета(Знач ИсходныйКомпоновщикНастроек, ИмяОтчета, ИмяМакета, МассивПолей, МенеджерВременныхТаблиц = Неопределено) Экспорт
...
Функция ДанныеЭлементаРасшифровки(ОтчетДанныеРасшифровки, Расшифровка) Экспорт
	...
	Возврат ЗарплатаКадрыРасширенный.ДанныеЭлементаРасшифровки(ОтчетДанныеРасшифровки, Расшифровка);

КонецФункции

Функция ДействияДополнительнойРасшифровкиОтчета(ОтчетДанныеРасшифровки, Расшифровка, ПараметрыРасшифровки) Экспорт
	
	Возврат ЗарплатаКадрыРасширенный.ДействияДополнительнойРасшифровкиОтчета(ОтчетДанныеРасшифровки, Расшифровка, ПараметрыРасшифровки);
