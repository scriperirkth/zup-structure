...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ПроставитьОснованияПоУдержанномуНДФЛ");
КонецПроцедуры
...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "Документы.ДивидендыФизическимЛицам.ПроставитьВидОрганизацииВыплачивающейДивиденды";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("345c207c-dfc8-498b-a617-56f1008083f7");
	Обработчик.Комментарий = НСтр("ru = 'Уточнение вида организации, выплатившей дивиденды.'");
