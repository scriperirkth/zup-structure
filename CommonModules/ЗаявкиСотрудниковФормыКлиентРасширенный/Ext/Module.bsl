...
Процедура ОткрытьФормуБанковскогоСчета(ПараметрыФормы, Владелец, Уникальность, ОписаниеОповещения, Режим) Экспорт
	...
	ОткрытьФорму("Справочник.БанковскиеСчетаКонтрагентов.ФормаОбъекта", ПараметрыФормы, Владелец, Уникальность,,, ОписаниеОповещения, Режим);
	
КонецПроцедуры

Процедура ОткрытьФормуВыбораБанковскогоСчета(ПараметрыФормы, Владелец, ОписаниеОповещения, Режим) Экспорт
	
	ОткрытьФорму("Справочник.БанковскиеСчетаКонтрагентов.ФормаВыбора", ПараметрыФормы, Владелец,,,, ОписаниеОповещения, Режим);
