...
Функция ОбъектФормыЗафиксирован(Форма) Экспорт
	Возврат Форма["ФиксацияОбъектЗафиксирован"];
КонецФункции
...
Процедура УстановитьФиксациюРеквизита(Форма, ОписаниеФиксацииРеквизита, ИдентификаторСтроки = 0, Значение)
	Если ОписаниеФиксацииРеквизита.Значение.РеквизитСтроки Тогда
		Если ПолучитьПризнакФиксацииРеквизитаТЧ(Форма, ОписаниеФиксацииРеквизита, ИдентификаторСтроки) <> Значение Тогда
		...
		КонецЕсли;
	Иначе
		Если ПолучитьПризнакФиксацииРеквизита(Форма, ОписаниеФиксацииРеквизита) <> Значение Тогда
...
Функция НайтиЭлементСоответствияПоКлючу(Соответствие, Ключ)
	Если ТипЗнч(Ключ) = Тип("КлючИЗначение") Тогда
		Возврат Ключ;
	КонецЕсли;
