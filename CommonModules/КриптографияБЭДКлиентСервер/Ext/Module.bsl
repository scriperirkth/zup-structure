...
// Служебный. Необходимо использовать См. КриптографияБЭДКлиент.ЭтоВидСертификатаФизическогоЛица
// или См. КриптографияБЭД.ЭтоВидСертификатаФизическогоЛица.
// Возвращает признак является ли субъект сертификата физическим лицом по данным свойств субъекта.
// 
// Параметры:
...
// Возвращаемое значение:
//  Булево
Функция ЭтоВидСертификатаФизическогоЛица(СвойстваСубъекта) Экспорт
