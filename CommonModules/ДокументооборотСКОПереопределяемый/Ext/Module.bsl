...
Процедура ОбновитьИЗаполнитьТребованияФНС(Организация, Дата) Экспорт
	...
	ЗарплатаКадры.ОбновитьИЗаполнитьТребованияФНС(Организация, Дата);
...
Процедура ЗарегистрироватьИзменениеСтатусаЗадачТребованиеФНС(Ссылка) Экспорт
	...
	ЗарплатаКадры.ЗарегистрироватьИзменениеСтатусаЗадачТребованиеФНС(Ссылка);
...
//
Процедура ИзменениеСтатусаПродленияСертификатаЭлектроннойПодписи(Ссылка) Экспорт
