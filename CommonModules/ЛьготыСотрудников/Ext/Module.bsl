...
Процедура ДополнитьФормуДокументовИзмененияШтатногоРасписания(Форма, ОписаниеТаблицыЛьгот, ПутьКТаблицеПозиций = "Объект.Позиции") Экспорт
	
	Если Не ПолучитьФункциональнуюОпцию("ИспользоватьЗарплатаКадрыКорпоративнаяПодсистемы")
		ИЛИ Не ПолучитьФункциональнуюОпцию("ИспользоватьЛьготыСотрудников") Тогда
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(Форма, "Льготы") Тогда
		МассивИменРеквизитовФормы = Новый Массив;
		ЗарплатаКадры.ЗаполнитьМассивИменРеквизитовФормы(Форма, МассивИменРеквизитовФормы);
		
		ДобавляемыеРеквизиты = Новый Массив;
		
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("Льготы", Новый ОписаниеТипов("ТаблицаЗначений"), , Истина));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("Льгота", Новый ОписаниеТипов("ПланВидовРасчетаСсылка.Начисления"), "Льготы"));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("Размер", ОбщегоНазначения.ОписаниеТипаЧисло(15, 2), "Льготы"));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ИдентификаторСтрокиВидаРасчета", ОбщегоНазначения.ОписаниеТипаЧисло(7), "Льготы"));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ИдентификаторСтрокиПозиции", ОбщегоНазначения.ОписаниеТипаЧисло(5), "Льготы"));
		
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("Показатели", Новый ОписаниеТипов("ТаблицаЗначений"), , Истина));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("Показатель", Новый ОписаниеТипов("СправочникСсылка.ПоказателиРасчетаЗарплаты"), "Показатели"));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("Значение", ОбщегоНазначения.ОписаниеТипаЧисло(15, 3), "Показатели"));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ИдентификаторСтрокиВидаРасчета", ОбщегоНазначения.ОписаниеТипаЧисло(7), "Показатели"));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ИдентификаторСтрокиПозиции", ОбщегоНазначения.ОписаниеТипаЧисло(5), "Показатели"));
		
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ИндивидуальныеЛьготы", Новый ОписаниеТипов("ТаблицаЗначений"), , Истина));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("Льгота", Новый ОписаниеТипов("ПланВидовРасчетаСсылка.Начисления"), "ИндивидуальныеЛьготы"));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("Размер", ОбщегоНазначения.ОписаниеТипаЧисло(15, 2), "ИндивидуальныеЛьготы"));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ИдентификаторСтрокиВидаРасчета", ОбщегоНазначения.ОписаниеТипаЧисло(7), "ИндивидуальныеЛьготы"));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ИдентификаторСтрокиПозиции", ОбщегоНазначения.ОписаниеТипаЧисло(5), "ИндивидуальныеЛьготы"));
		
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ИспользоватьЛимит", Новый ОписаниеТипов("Булево"), ПутьКТаблицеПозиций));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("КоличествоБаллов", ОбщегоНазначения.ОписаниеТипаЧисло(3), ПутьКТаблицеПозиций));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ДоступныВсеЛьготы", ОбщегоНазначения.ОписаниеТипаЧисло(1), ПутьКТаблицеПозиций));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ЛьготыИзменены", Новый ОписаниеТипов("Булево"), ПутьКТаблицеПозиций));

		ЗарплатаКадры.ИзменитьРеквизитыФормы(Форма, ДобавляемыеРеквизиты, МассивИменРеквизитовФормы);
		
		ЗарплатаКадрыРасширенный.РедактированиеСоставаНачисленийДополнитьФорму(Форма, ОписаниеТаблицыЛьгот, "Начисления", 3, Ложь);
	КонецЕсли;
	
	ТаблицаПозиций = ОбщегоНазначенияКлиентСервер.ПолучитьРеквизитФормыПоПути(Форма, ПутьКТаблицеПозиций);
	Если ТаблицаПозиций.Количество() = 0 Тогда
		Возврат;
	КонецЕсли;
	
	Позиции = ТаблицаПозиций.Выгрузить();
	ПрочитатьЛьготыПозиции(Форма, Позиции, ОписаниеТаблицыЛьгот, , "ИндивидуальныеЛьготы");
	ПрочитатьЛимитыЛьготПозиции(Форма, Позиции, ПутьКТаблицеПозиций);
		
КонецПроцедуры

Процедура ПоместитьЛьготыВОписаниеПозиции(Форма, ОписаниеПозиции, ДанныеПозиции = Неопределено) Экспорт
	
	Если Не ОписаниеПозиции.Свойство("Льготы") Тогда
		Возврат;
	КонецЕсли;
	
	Если ДанныеПозиции = Неопределено Тогда
		ОписаниеПозиции.ЛьготыИзменены = Истина;
		ОписаниеПозиции.Льготы = ОбщегоНазначения.ТаблицаЗначенийВМассив(Форма.Льготы.Выгрузить());
		ОписаниеПозиции.ИндивидуальныеЛьготы = ОбщегоНазначения.ТаблицаЗначенийВМассив(Форма.ИндивидуальныеЛьготы.Выгрузить());
		ОписаниеПозиции.ПоказателиЛьгот = ОбщегоНазначения.ТаблицаЗначенийВМассив(Форма.Показатели.Выгрузить());
		ОписаниеПозиции.ИспользоватьЛимит = Форма.ИспользоватьЛимит;
		ОписаниеПозиции.КоличествоБаллов = Форма.КоличествоБаллов;
		ОписаниеПозиции.ДоступныВсеЛьготы = Форма.ДоступныВсеЛьготы;
	Иначе
		СтруктураОтбора = Новый Структура("ИдентификаторСтрокиПозиции", ДанныеПозиции.ИдентификаторСтрокиПозиции);
		ОписаниеПозиции.Льготы = ОбщегоНазначения.ТаблицаЗначенийВМассив(Форма.Льготы.Выгрузить(СтруктураОтбора));
		ОписаниеПозиции.ИндивидуальныеЛьготы =
			ОбщегоНазначения.ТаблицаЗначенийВМассив(Форма.ИндивидуальныеЛьготы.Выгрузить(СтруктураОтбора));
		ОписаниеПозиции.ПоказателиЛьгот = ОбщегоНазначения.ТаблицаЗначенийВМассив(Форма.Показатели.Выгрузить(СтруктураОтбора));
	КонецЕсли;
...
Процедура ДополнитьОписаниеПозицииШтатногоРасписания(ДанныеПозиции) Экспорт
	...
	Если Не ПолучитьФункциональнуюОпцию("ИспользоватьЗарплатаКадрыКорпоративнаяПодсистемы")
		ИЛИ Не ПолучитьФункциональнуюОпцию("ИспользоватьЛьготыСотрудников")
		ИЛИ Не ПравоДоступа("Чтение", Метаданные.РегистрыСведений.ПакетыЛьготСотрудникамПоШтатномуРасписанию) Тогда
		
		Возврат;
	КонецЕсли;
	
	ДанныеПозиции.Вставить("Льготы", Новый Массив);
	ДанныеПозиции.Вставить("ПоказателиЛьгот", Новый Массив);
	ДанныеПозиции.Вставить("ИндивидуальныеЛьготы", Новый Массив);
	ДанныеПозиции.Вставить("ИспользоватьЛимит", Ложь);
	ДанныеПозиции.Вставить("КоличествоБаллов", 0);
	ДанныеПозиции.Вставить("ДоступныВсеЛьготы", Истина);
	ДанныеПозиции.Вставить("ЛьготыИзменены", Ложь);
	
КонецПроцедуры

Процедура ПриПолученииДанныхПозицииШтатногоРасписания(Форма, ДанныеПозиции) Экспорт
	
	Если Не ДанныеПозиции.Свойство("Льготы") Тогда
		Возврат;
	КонецЕсли;
	...
	Форма.ИспользоватьЛимит = ДанныеПозиции.ИспользоватьЛимит;
	Форма.КоличествоБаллов = ДанныеПозиции.КоличествоБаллов;
	Форма.ДоступныВсеЛьготы = ДанныеПозиции.ДоступныВсеЛьготы;
	
	Форма.Льготы.Очистить();
	Для Каждого ОписаниеЛьготы Из ДанныеПозиции.Льготы Цикл
		ЗаполнитьЗначенияСвойств(Форма.Льготы.Добавить(), ОписаниеЛьготы);
	КонецЦикла;
	
	Форма.ИндивидуальныеЛьготы.Очистить();
	Для Каждого ОписаниеЛьготы Из ДанныеПозиции.ИндивидуальныеЛьготы Цикл
		ЗаполнитьЗначенияСвойств(Форма.ИндивидуальныеЛьготы.Добавить(), ОписаниеЛьготы);
	КонецЦикла;
	
	Форма.Показатели.Очистить();
	Для Каждого ОписаниеПоказателя Из ДанныеПозиции.ПоказателиЛьгот Цикл
		ЗаполнитьЗначенияСвойств(Форма.Показатели.Добавить(), ОписаниеПоказателя);
	КонецЦикла;
...
Процедура ПрочитатьДанныеПозицииВФорму(Форма, Объект, НовыеДанныеПозиции) Экспорт
	...
	Если Не НовыеДанныеПозиции.Свойство("Льготы") Тогда
		Возврат;
	КонецЕсли;
	...
	Для Каждого ИдентификаторВыделеннойСтроки Из Форма.Элементы.Позиции.ВыделенныеСтроки Цикл
		...
		УдаляемыеСтроки = Форма.Льготы.НайтиСтроки(СтруктураОтбора);
		Для Каждого УдаляемаяСтрока Из УдаляемыеСтроки Цикл
			Форма.Льготы.Удалить(Форма.Льготы.Индекс(УдаляемаяСтрока));
		КонецЦикла;
		
		УдаляемыеСтроки = Форма.ИндивидуальныеЛьготы.НайтиСтроки(СтруктураОтбора);
		Для Каждого УдаляемаяСтрока Из УдаляемыеСтроки Цикл
			Форма.ИндивидуальныеЛьготы.Удалить(Форма.ИндивидуальныеЛьготы.Индекс(УдаляемаяСтрока));
		КонецЦикла;
		
		УдаляемыеСтроки = Форма.Показатели.НайтиСтроки(СтруктураОтбора);
		Для Каждого УдаляемаяСтрока Из УдаляемыеСтроки Цикл
			Форма.Показатели.Удалить(Форма.Показатели.Индекс(УдаляемаяСтрока));
		КонецЦикла;
	КонецЦикла;
	
	ДанныеТекущейПозиции = Объект.Позиции.НайтиПоИдентификатору(Форма.ИдентификаторРедактируемойСтроки);
	
	Для Каждого ОписаниеЛьготы Из НовыеДанныеПозиции.Льготы Цикл
		НоваяСтрокаЛьгот = Форма.Льготы.Добавить();
		ЗаполнитьЗначенияСвойств(НоваяСтрокаЛьгот, ОписаниеЛьготы);
		НоваяСтрокаЛьгот.ИдентификаторСтрокиПозиции = ДанныеТекущейПозиции.ИдентификаторСтрокиПозиции;
	КонецЦикла;
	
	Для Каждого ОписаниеЛьготы Из НовыеДанныеПозиции.ИндивидуальныеЛьготы Цикл
		НоваяСтрокаЛьгот = Форма.ИндивидуальныеЛьготы.Добавить();
		ЗаполнитьЗначенияСвойств(НоваяСтрокаЛьгот, ОписаниеЛьготы);
		НоваяСтрокаЛьгот.ИдентификаторСтрокиПозиции = ДанныеТекущейПозиции.ИдентификаторСтрокиПозиции;
	КонецЦикла;
	
	Для Каждого ОписаниеПоказателя Из НовыеДанныеПозиции.ПоказателиЛьгот Цикл
		НоваяСтрокаПоказателя = Форма.Показатели.Добавить();
...
Процедура ДобавитьДополнительныеСведенияОЛьготахПозиций(Форма, ТекущийОбъект, ПутьКТаблицеПозиций = "Объект.Позиции") Экспорт
	...
	СтруктураОтбора = Новый Структура("ЛьготыИзменены", Истина);
	ИменаКолонок = "ИдентификаторСтрокиПозиции,Позиция,Подразделение,Должность,ИспользоватьЛимит,КоличествоБаллов,ДоступныВсеЛьготы";
	СведенияОПозициях = Позиции.Выгрузить(СтруктураОтбора).Скопировать(, ИменаКолонок);
	
	Если СведенияОПозициях.Количество() > 0 Тогда
		СведенияОЛьготах = Новый Структура;
		СведенияОЛьготах.Вставить("СведенияОПозициях", СведенияОПозициях);
		СведенияОЛьготах.Вставить("Льготы", Форма.Льготы.Выгрузить());
		СведенияОЛьготах.Вставить("ИндивидуальныеЛьготы", Форма.ИндивидуальныеЛьготы.Выгрузить());
		СведенияОЛьготах.Вставить("Показатели", Форма.Показатели.Выгрузить());
		ТекущийОбъект.ДополнительныеСвойства.Вставить("СведенияОЛьготах", СведенияОЛьготах);
	КонецЕсли;
	
КонецПроцедуры

Процедура ПередЗаписьюДокументовИзмененияШтатногоРасписания(Объект) Экспорт
	ЗаписатьСведенияОЛьготах(Объект.Позиции, Объект.ДополнительныеСвойства);
КонецПроцедуры

#КонецОбласти

Процедура ПередЗаписьюТарифныхСтавокШтатногоРасписания(Форма) Экспорт
	...
	ДобавитьДополнительныеСведенияОЛьготахПозиций(Форма, ДанныеОбъекта, "Позиции");
	
	Позиции = ОбщегоНазначенияКлиентСервер.ПолучитьРеквизитФормыПоПути(Форма, "Позиции");
	ЗаписатьСведенияОЛьготах(Позиции.Выгрузить(), ДанныеОбъекта.ДополнительныеСвойства);
...
Процедура ДополнитьФормуКадровогоДокумента(Форма, ОписаниеТаблицыЛьгот, ДобавлятьЭлементыФормы = Истина, ДобавлятьРеквизитыФормы = Истина, ОтложенноеИзменение = Ложь) Экспорт
	...
	Если ДобавлятьРеквизитыФормы Тогда
		...
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ИдентификаторСтрокиПозиции", ОбщегоНазначения.ОписаниеТипаЧисло(5),
			ОписаниеТаблицыЛьгот.ПутьКДанным));
		ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ИдентификаторСтрокиПозиции", ОбщегоНазначения.ОписаниеТипаЧисло(5),
			ОписаниеТаблицыЛьгот.ПутьКДаннымПоказателей));
...
Процедура ПрочитатьЛьготыПозиции(Форма, Позиция, ОписаниеТаблицыЛьгот, ЗаполнениеИзПеремещения = Ложь, ИмяТаблицыИндивидуальныеЛьготы = Неопределено, ДатаСобытия = Неопределено) Экспорт 
	...
	Если Не ПравоДоступа("Чтение", Метаданные.РегистрыСведений.ПакетыЛьготСотрудникамПоШтатномуРасписанию, Пользователи.ТекущийПользователь()) Тогда
		Возврат;
	КонецЕсли;
	...
	Если ТипЗнч(Позиция) = Тип("ТаблицаЗначений") Тогда
		Для Каждого СтрокаПозиция Из Позиция Цикл
			ЗаполнитьТаблицуОписанийПозиций(Форма, СтрокаПозиция, ТаблицаОписанийПозиций, Истина);
		КонецЦикла;
	Иначе
		ЗаполнитьТаблицуОписанийПозиций(Форма, Позиция, ТаблицаОписанийПозиций);
	КонецЕсли;
	...
	Пока Выборка.СледующийПоЗначениюПоля("ИдентификаторСтрокиПозиции") Цикл 
		...
		КонецЦикла;
		ДанныеПоказателейПозиций.Вставить(Выборка.ИдентификаторСтрокиПозиции, ДанныеПоказателейЛьгот);
	КонецЦикла;
	...
	Пока Выборка.СледующийПоЗначениюПоля("ИдентификаторСтрокиПозиции") Цикл 
		...
		ДанныеПоказателейЛьгот = ДанныеПоказателейПозиций.Получить(Выборка.ИдентификаторСтрокиПозиции);
		
		Пока Выборка.Следующий() Цикл
			ОтборСтрок = Новый Структура(ИмяПоляЛьгота, Выборка.Льгота);
			ОтборСтрок.Вставить("ИдентификаторСтрокиПозиции", Выборка.ИдентификаторСтрокиПозиции);
			НайденныеСтроки = ДанныеЛьгот.НайтиСтроки(ОтборСтрок);
			...
			СтрокаЛьготы.ИдентификаторСтрокиПозиции = Выборка.ИдентификаторСтрокиПозиции;
			...
			Если ДанныеПоказателейЛьгот <> Неопределено Тогда 
				...
				Если ЗначенияПоказателей <> Неопределено Тогда 
					Для Каждого КлючИЗначение Из ЗначенияПоказателей Цикл 
						...
						НоваяСтрока.ИдентификаторСтрокиПозиции = Выборка.ИдентификаторСтрокиПозиции;
					КонецЦикла;
				КонецЕсли;
			КонецЕсли;
	...
	Для Каждого СтрокаЛьготы Из ТаблицаЛьгот Цикл
		...
		Если ЗаполнениеИзПеремещения Тогда
			...
			Если ЛьготыПозиции = Неопределено Или ЛьготыПозиции[Льгота] = Неопределено Тогда
...
Функция ТаблицаОписанийПозиций() Экспорт 
	...
	ТаблицаОписанийПозиций.Колонки.Добавить("ИдентификаторСтрокиПозиции", Новый ОписаниеТипов("Число"));
	
	Возврат ТаблицаОписанийПозиций;
	
КонецФункции

Процедура ЗаполнитьТаблицуОписанийПозиций(Форма, Позиция, ТаблицаОписанийПозиций, ЭтоСтрокаТаблицы = Ложь)
	
	Если Позиция = Неопределено Тогда 
		НоваяСтрока = ТаблицаОписанийПозиций.Добавить();
		НоваяСтрока.Организация = Форма.Объект.Владелец;
		НоваяСтрока.Подразделение = Форма.Объект.Подразделение;
	Иначе
		Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(Форма, "ВнешниеДанные") И Форма["ВнешниеДанные"] Тогда
			НоваяСтрока = ТаблицаОписанийПозиций.Добавить();
			НоваяСтрока.Позиция = Форма.РедактируемаяПозиция;
			НоваяСтрока.Организация = Форма.Объект.Владелец;
			НоваяСтрока.Подразделение = Форма.Объект.Подразделение;
			НоваяСтрока.Должность = Форма.Объект.Должность;
		ИначеЕсли ЭтоСтрокаТаблицы Тогда
			НоваяСтрока = ТаблицаОписанийПозиций.Добавить();
			ЗаполнитьЗначенияСвойств(НоваяСтрока, Позиция);
			НоваяСтрока.Организация = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Позиция.Позиция, "Владелец");
		Иначе
...
Процедура СохранитьДанныеПозиции(Форма) Экспорт 
	...
	ДанныеДляЗаписи = НовыйДанныеДляЗаписи();
	ДанныеДляЗаписи.Позиция = Форма.СсылкаНаОбъект;
	ДанныеДляЗаписи.Организация = Форма.Объект.Владелец;
	ДанныеДляЗаписи.Подразделение = Форма.Объект.Подразделение;
	ДанныеДляЗаписи.Должность = Форма.Объект.Должность;
	ДанныеДляЗаписи.Льготы = Форма.Льготы; 
	ДанныеДляЗаписи.ИндивидуальныеЛьготы = Форма.ИндивидуальныеЛьготы; 
	ДанныеДляЗаписи.Показатели = Форма.Показатели; 
	ДанныеДляЗаписи.ИспользоватьЛимит = Форма.ИспользоватьЛимит; 
	ДанныеДляЗаписи.КоличествоБаллов = Форма.КоличествоБаллов; 
	ДанныеДляЗаписи.ДоступныВсеЛьготы = Форма.ДоступныВсеЛьготы;
	
	ЗаписатьПакетыЛьгот(ДанныеДляЗаписи);
	ЗаписатьЗначенияПоказателей(ДанныеДляЗаписи);
	ЗаписатьЛимитыЛьгот(ДанныеДляЗаписи);
	
КонецПроцедуры
	
Процедура ЗаписатьЛимитыЛьгот(ДанныеДляЗаписи)
	
	НаборЗаписей = РегистрыСведений.ЛимитыЛьготСотрудникамПоШтатномуРасписанию.СоздатьНаборЗаписей();
	НаборЗаписей.Отбор.Организация.Установить(ДанныеДляЗаписи.Организация);
	НаборЗаписей.Отбор.Подразделение.Установить(ДанныеДляЗаписи.Подразделение);
	НаборЗаписей.Отбор.Должность.Установить(ДанныеДляЗаписи.Должность);
	НаборЗаписей.Отбор.Позиция.Установить(ДанныеДляЗаписи.Позиция);
	
	НоваяЗапись = НаборЗаписей.Добавить();
	НоваяЗапись.Организация = ДанныеДляЗаписи.Организация;
	НоваяЗапись.Подразделение = ДанныеДляЗаписи.Подразделение;
	НоваяЗапись.Должность = ДанныеДляЗаписи.Должность;
	НоваяЗапись.Позиция = ДанныеДляЗаписи.Позиция;
	НоваяЗапись.ИспользоватьЛимит = ДанныеДляЗаписи.ИспользоватьЛимит;
	НоваяЗапись.КоличествоБаллов = ?(ДанныеДляЗаписи.ИспользоватьЛимит, ДанныеДляЗаписи.КоличествоБаллов, 0);
	НоваяЗапись.ДоступныВсеЛьготы = ДанныеДляЗаписи.ДоступныВсеЛьготы = 0;
	
	НаборЗаписей.Записать();
	
КонецПроцедуры

Процедура ЗаписатьПакетыЛьгот(ДанныеДляЗаписи)
	...
	Для Каждого ДанныеЛьготы Из ДанныеДляЗаписи.Льготы Цикл 
		НоваяЗапись = НаборЗаписей.Добавить();
		НоваяЗапись.Организация = ДанныеДляЗаписи.Организация;
		НоваяЗапись.Подразделение = ДанныеДляЗаписи.Подразделение;
		НоваяЗапись.Должность = ДанныеДляЗаписи.Должность;
	...
	Для Каждого ДанныеЛьготы Из ДанныеДляЗаписи.ИндивидуальныеЛьготы Цикл 
		НоваяЗапись = НаборЗаписей.Добавить();
		НоваяЗапись.Организация = ДанныеДляЗаписи.Организация;
		НоваяЗапись.Подразделение = ДанныеДляЗаписи.Подразделение;
		НоваяЗапись.Должность = ДанныеДляЗаписи.Должность;
...
Процедура ЗаписатьЗначенияПоказателей(ДанныеДляЗаписи)
	...
	Для Каждого ДанныеПоказателя Из ДанныеДляЗаписи.Показатели Цикл 
...
Функция ЗапросДанныеЛьгот(ТаблицаОписанийПозиций) Экспорт 
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	ОписанияПозиций.ИдентификаторСтрокиПозиции КАК ИдентификаторСтрокиПозиции,
	               ...
	               |	ИсходныеДанные.ИдентификаторСтрокиПозиции КАК ИдентификаторСтрокиПозиции,
	               ...
	               |	ЛьготыПозиций.ИдентификаторСтрокиПозиции КАК ИдентификаторСтрокиПозиции,
	               ...
	               |	ПоказателиЛьгот.ИдентификаторСтрокиПозиции КАК ИдентификаторСтрокиПозиции,
...
Процедура УстановитьВидимостьГруппыЛьготы(Элементы, ИмяГруппыЛьготы = "ЛьготыСтраница") Экспорт
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "БухучетЛьготГруппа", "Видимость", ИспользоватьЛьготы);
...
Процедура ЗаписатьСведенияОЛьготах(Позиции, ДополнительныеСвойстваОбъекта)
	
	СведенияОЛьготах = Неопределено;
	Если Не ДополнительныеСвойстваОбъекта.Свойство("СведенияОЛьготах", СведенияОЛьготах) Тогда
		Возврат;
	КонецЕсли;
	
	ОрганизацииПозиций = ОбщегоНазначения.ЗначениеРеквизитаОбъектов(Позиции.ВыгрузитьКолонку("Позиция"), "Владелец");
	Для Каждого СтрокаПозиции Из СведенияОЛьготах.СведенияОПозициях Цикл
		СтруктураОтбора = Новый Структура("ИдентификаторСтрокиПозиции", СтрокаПозиции.ИдентификаторСтрокиПозиции);
		
		ДанныеДляЗаписи = НовыйДанныеДляЗаписи();
		ЗаполнитьЗначенияСвойств(ДанныеДляЗаписи, СтрокаПозиции);
		ДанныеДляЗаписи.Льготы = СведенияОЛьготах.Льготы.НайтиСтроки(СтруктураОтбора); 
		ДанныеДляЗаписи.ИндивидуальныеЛьготы = СведенияОЛьготах.ИндивидуальныеЛьготы.НайтиСтроки(СтруктураОтбора); 
		ДанныеДляЗаписи.Показатели = СведенияОЛьготах.Показатели.НайтиСтроки(СтруктураОтбора); 
		ДанныеДляЗаписи.ИспользоватьЛимит = СтрокаПозиции.ИспользоватьЛимит; 
		ДанныеДляЗаписи.КоличествоБаллов = СтрокаПозиции.КоличествоБаллов; 
		ДанныеДляЗаписи.ДоступныВсеЛьготы = СтрокаПозиции.ДоступныВсеЛьготы;
		
		ПозицияШтатногоРасписания = СтрокаПозиции.Позиция;
		...
		ДанныеДляЗаписи.Позиция = ПозицияШтатногоРасписания;
		ДанныеДляЗаписи.Организация = ОрганизацииПозиций.Получить(ПозицияШтатногоРасписания);
...
Функция НовыйДанныеДляЗаписи()
	
	ДанныеДляЗаписи = Новый Структура;
	ДанныеДляЗаписи.Вставить("Организация"); 
	ДанныеДляЗаписи.Вставить("Подразделение"); 
	ДанныеДляЗаписи.Вставить("Позиция"); 
	ДанныеДляЗаписи.Вставить("Должность"); 
	ДанныеДляЗаписи.Вставить("Льготы"); 
	ДанныеДляЗаписи.Вставить("ИндивидуальныеЛьготы"); 
	ДанныеДляЗаписи.Вставить("Показатели"); 
	ДанныеДляЗаписи.Вставить("ИспользоватьЛимит"); 
	ДанныеДляЗаписи.Вставить("КоличествоБаллов"); 
	ДанныеДляЗаписи.Вставить("ДоступныВсеЛьготы");
...
Процедура ЗарегистрироватьПерерасчетыЛьгот(МенеджерВременныхТаблиц, ИсключаемыйРегистратор = Неопределено) Экспорт 
	...
	УдаляемыеВТ.Добавить("ВТСотрудникиПериоды");
...
Функция ЛимитПакетаЛьготПозиции(Форма, Позиция)
	...
	ДанныеЛимита = Новый Соответствие;
	
	Выборка = РезультатЗапроса.Выбрать();
	Пока Выборка.Следующий() Цикл
		НовыеДанныеЛимита = СтруктураДанныхЛимита();
		ЗаполнитьЗначенияСвойств(НовыеДанныеЛимита, Выборка);
		ДанныеЛимита.Вставить(Выборка.ИдентификаторСтрокиПозиции, НовыеДанныеЛимита);
	КонецЦикла;
...
Функция СтруктураДанныхЛимита() Экспорт 
	...
	Возврат Новый Структура("ИспользоватьЛимит, КоличествоБаллов, ДоступныВсеЛьготы", Ложь, 0, Ложь);
	
КонецФункции

Процедура ПрочитатьЛимитыЛьготПозиции(Форма, Позиция, ПутьКТаблицеПозиций = "") Экспорт 
	
	Если Не ПравоДоступа("Чтение", Метаданные.РегистрыСведений.ЛимитыЛьготСотрудникамПоШтатномуРасписанию) Тогда
		Возврат;
	КонецЕсли;
	
	ДанныеЛимита = ЛимитПакетаЛьготПозиции(Форма, Позиция);
	Если ДанныеЛимита.Количество() = 0 Тогда
		Возврат;
	КонецЕсли;
	
	Если ПустаяСтрока(ПутьКТаблицеПозиций) Тогда
		Если ДанныеЛимита[0] <> Неопределено Тогда 
			Форма.ИспользоватьЛимит = ДанныеЛимита[0].ИспользоватьЛимит;
			Форма.КоличествоБаллов = ДанныеЛимита[0].КоличествоБаллов;
			Форма.ДоступныВсеЛьготы = ?(ДанныеЛимита[0].ДоступныВсеЛьготы, 0, 1);
		КонецЕсли;
	Иначе
		ДанныеПозиций = ОбщегоНазначенияКлиентСервер.ПолучитьРеквизитФормыПоПути(Форма, ПутьКТаблицеПозиций);
		Для Каждого СтрокаПозиция Из ДанныеПозиций Цикл
			ДанныеЛимитаПозиции = ДанныеЛимита.Получить(СтрокаПозиция.ИдентификаторСтрокиПозиции);
			Если ДанныеЛимитаПозиции <> Неопределено Тогда 
				СтрокаПозиция.ИспользоватьЛимит = ДанныеЛимитаПозиции.ИспользоватьЛимит;
				СтрокаПозиция.КоличествоБаллов = ДанныеЛимитаПозиции.КоличествоБаллов;
				СтрокаПозиция.ДоступныВсеЛьготы = ?(ДанныеЛимитаПозиции.ДоступныВсеЛьготы, 0, 1);
			КонецЕсли;
		КонецЦикла;
	КонецЕсли;
...
Процедура ПриЗаполненииВыявленнымиНачислениями(СотрудникиПериоды, МесяцНачисления, МенеджерРасчета) Экспорт
	...
	Если СотрудникиПериоды.Колонки.Найти("ФизическоеЛицо") = Неопределено Тогда
		Сотрудники = СотрудникиПериоды.ВыгрузитьКолонку("Сотрудник");
		СотрудникиФизическиеЛица = ОбщегоНазначения.ЗначениеРеквизитаОбъектов(Сотрудники, "ФизическоеЛицо");
		ФизическиеЛица = ОбщегоНазначения.ВыгрузитьКолонку(СотрудникиФизическиеЛица, "Значение", Истина);
	Иначе
		ЕстьКолонкаФизическоеЛицо = Истина;
		ФизическиеЛица = СотрудникиПериоды.ВыгрузитьКолонку("ФизическоеЛицо");
	КонецЕсли;	
	
	ИндивидуальныеЛьготыФизическихЛиц = ЛьготыФизическихЛиц(МесяцНачисления, ФизическиеЛица);
	ДобавляемыеЛьготы = НовыйТаблицаДобавляемыхЛьгот();
	
	Для Каждого СтрокаПериода Из СотрудникиПериоды Цикл
		Если ЕстьКолонкаФизическоеЛицо Тогда
			ФизическоеЛицо = СтрокаПериода.ФизическоеЛицо;
		Иначе
			ФизическоеЛицо = СотрудникиФизическиеЛица[СтрокаПериода.Сотрудник];
		КонецЕсли;
		
		НайденныеЛьготы = ИндивидуальныеЛьготыФизическихЛиц[ФизическоеЛицо];
		
		Если Не ЗначениеЗаполнено(НайденныеЛьготы) Тогда
			Продолжить;
		КонецЕсли;
		
		Для Каждого ТекущаяЛьгота Из НайденныеЛьготы Цикл
			СтрокаДобавляемыхНачислений = ДобавляемыеЛьготы.Добавить();
			ЗаполнитьЗначенияСвойств(СтрокаДобавляемыхНачислений, СтрокаПериода);
			СтрокаДобавляемыхНачислений.Начисление = ТекущаяЛьгота;
			СтрокаДобавляемыхНачислений.Используется = Истина;
		КонецЦикла;			
	КонецЦикла;		
	
	Колонки = ОбщегоНазначения.ВыгрузитьКолонку(ДобавляемыеЛьготы.Колонки, "Имя");
	ДобавляемыеЛьготы.Свернуть(СтрСоединить(Колонки, ","));
	ДобавляемыеЛьготы.Сортировать("Сотрудник, Начисление, ДатаНачала", Новый СравнениеЗначений);
	
	МенеджерРасчета.ДобавитьНачисленияСотрудников(СотрудникиПериоды, ДобавляемыеЛьготы, "ПлановыеНачисления");
	
КонецПроцедуры	

Функция НовыйТаблицаДобавляемыхЛьгот()
...
Процедура ПолучитьНастройкиПрограммы(НастройкиПриложения) Экспорт
	...
	Настройки.Прочитать();
	НастройкиСтруктура = ОбщегоНазначения.СтруктураПоМенеджеруЗаписи(Настройки, Метаданные.РегистрыСведений.НастройкиЛьготСотрудников);
	НастройкиПриложения.Вставить("НастройкиЛьготСотрудников", НастройкиСтруктура);
