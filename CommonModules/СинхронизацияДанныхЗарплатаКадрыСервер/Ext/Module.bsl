...
Процедура ПолучитьПланыОбмена(ПланыОбменаПодсистемы) Экспорт
	...
	ДобавитьПланОбмена(ПланыОбменаПодсистемы, "СинхронизацияДанныхЧерезУниверсальныйФорматБО");
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("УстановитьОрганизацииСотрудников");
	Методы.Вставить("ЗарегистрироватьПодразделенияПоСотрудникам", Истина);
	Методы.Вставить("ЗарегистрироватьОрганизацииСотрудниковУтраченные", Истина);
	Методы.Вставить("ЗарегистрироватьПодразделенияСотрудниковУтраченные", Истина);
	Методы.Вставить("УстановитьПринадлежностиФизическихЛицОрганизаций");
	Методы.Вставить("ЗаполнитьТабличнуюЧастьРазделыДанных");
	Методы.Вставить("ОбновитьУзлыПлановОбменов");
	Методы.Вставить("ЗарегистрироватьПринадлежностьФизическихЛицОрганизаций", Истина);
	Методы.Вставить("ЗарегистрироватьПринадлежностьФизическихЛицПодразделений", Истина);
	Методы.Вставить("ЗарегистрироватьОрганизацииФизическихЛицУтраченные", Истина);
	Методы.Вставить("ЗарегистрироватьПодразделенияФизическихЛицУтраченные", Истина);
	Методы.Вставить("УстановитьИспользованиеСинхронизацииСОтборами");
	Методы.Вставить("УстановитьПодразделенияСотрудников");
	Методы.Вставить("УстановитьПринадлежностиФизическихЛицПодразделений");
	Методы.Вставить("ЗарегистрироватьОрганизацииПоСотрудникам", Истина);
КонецПроцедуры
...
Процедура ЗарегистрироватьСвязанныеПрисоединенныеФайлы(Объект, Отказ, Параметры) Экспорт
	...
	Если Отказ Или Параметры.Получатели.Количество() = 0 Или Параметры.Выгрузка
...
Функция ОбъектыПринадлежностиФизическихЛицОрганизациям()
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыКорпоративнаяПодсистемы.КадровыеРешения") Тогда
		...
		МодульКадровыеРешенияРасширенный.ДополнитьОбъектыИзмененияОрганизацийФизическихЛиц(МассивОбъектов);
	КонецЕсли;
