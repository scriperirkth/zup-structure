...
// Возвращает свойства субъекта и свойства издателя сертификата по ссылке на элемент справочника сертификаты.
//
// Параметры:
...
// Возвращаемое значение:
//  Структура:
//  * СвойстваСубъекта - См. ЭлектроннаяПодпись.СвойстваСубъектаСертификата
//  * СвойстваИздателя - См. ЭлектроннаяПодпись.СвойстваИздателяСертификата
Функция СвойстваСубъектаИСвойстваИздателяСертификатаПоСсылке(Сертификат) Экспорт
	
	Результат = Новый Структура("СвойстваСубъекта, СвойстваИздателя");
	Результат.СвойстваСубъекта = КриптографияБЭД.СвойстваСубъектаСертификатаПоСсылке(Сертификат);
	Результат.СвойстваИздателя = КриптографияБЭД.СвойстваИздателяСертификатаПоСсылке(Сертификат);
	Возврат Результат;
