...
Функция ОписанияСоставаНачисленийПоВременнойТаблице(МенеджерВременныхТаблиц, ИмяВТСотрудникиПериоды, ИмяПоляПериод, ИмяПоляСотрудник, ИмяПоляДатаОкончания, ИспользоватьКраткиеПредставления, ВыводитьДенежныеПоказателиСВалютой, ФормироватьСПериодичностьДень, ИменаДополнительныхПолей) Экспорт
	
	Возврат КадровыйУчетРасширенный.ОписанияСоставаНачисленийПоВременнойТаблице(МенеджерВременныхТаблиц, ИмяВТСотрудникиПериоды, ИмяПоляПериод, ИмяПоляСотрудник, ИмяПоляДатаОкончания, ИспользоватьКраткиеПредставления, ВыводитьДенежныеПоказателиСВалютой, ФормироватьСПериодичностьДень, ИменаДополнительныхПолей);
...
//			- ПриказОПриемеДата
//			- ПриказОПриемеНомер
//			- ПриказоПриемеДлительностьИспытательногоСрока
//			- ПриказОбУвольнении
...
//			- ИнвалидностьГруппаИнвалидности 	- Перечисления.ГруппыИнвалидности
//			- ИнвалидностьСерияСправки 			- Строка
//			- ИнвалидностьНомерСправки 			- Строка
//			- ИнвалидностьПроцентПотериТрудоспособности - Число
//
...
Процедура КадроваяИсторияСотрудниковПередЗаписью(НаборЗаписей, Отказ, Замещение) Экспорт
	...
	КадровыйУчетРасширенный.КадроваяИсторияСотрудниковПередЗаписью(НаборЗаписей, Отказ, Замещение);
	
КонецПроцедуры

Процедура КадроваяИсторияСотрудниковПриЗаписи(НаборЗаписей, Отказ, Замещение) Экспорт
	
	КадровыйУчетРасширенный.КадроваяИсторияСотрудниковПриЗаписи(НаборЗаписей, Отказ, Замещение);
	
КонецПроцедуры

Процедура ПлановыеНачисленияПередЗаписью(НаборЗаписей, Отказ, Замещение) Экспорт
	
	КадровыйУчетРасширенный.ПлановыеНачисленияПередЗаписью(НаборЗаписей, Отказ, Замещение);
	
КонецПроцедуры

Процедура ПлановыеНачисленияПриЗаписи(НаборЗаписей, Отказ, Замещение) Экспорт
	
	КадровыйУчетРасширенный.ПлановыеНачисленияПриЗаписи(НаборЗаписей, Отказ, Замещение);
	
КонецПроцедуры

Процедура ОбновитьВторичныеКадровыеДанныеСотрудников(НаборЗаписей, Замещение) Экспорт
	
	КадровыйУчетРасширенный.ОбновитьВторичныеКадровыеДанныеСотрудников(НаборЗаписей, Замещение);
...
Процедура ПриЗаписиНастроекКадровогоУчета(НаборЗаписей, Отказ, Замещение) Экспорт
	...
	КадровыйУчетРасширенный.ПриЗаписиНастроекКадровогоУчета(НаборЗаписей, Отказ, Замещение);
...
Процедура ПриОпределенииДоступныхДляПереводаМакетов(Макеты) Экспорт
	...
	КадровыйУчетРасширенный.ПриОпределенииДоступныхДляПереводаМакетов(Макеты);
...
Функция ДоступноОбъединениеДублейПерсональныхДанных() Экспорт
	...
	Возврат КадровыйУчетРасширенный.ДоступноОбъединениеДублейПерсональныхДанных();
