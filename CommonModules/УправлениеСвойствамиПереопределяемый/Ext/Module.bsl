...
Процедура ПриПолученииНаименованийНаборовСвойств(Наименования, КодЯзыка) Экспорт
	...
	// ЗарплатаКадрыПодсистемы
	ЗарплатаКадры.ПриПолученииНаименованийНаборовСвойств(Наименования, КодЯзыка);
	// Конец ЗарплатаКадрыПодсистемы
...
Процедура ЗаполнитьНаборыСвойствОбъекта(Знач Объект, ТипСсылки, НаборыСвойств, СтандартнаяОбработка, КлючНазначения) Экспорт
	...
	// ЗарплатаКадрыПодсистемы
	ЗарплатаКадры.ЗаполнитьНаборыСвойствОбъекта(Объект, ТипСсылки, НаборыСвойств, СтандартнаяОбработка, КлючНазначения);
	// Конец ЗарплатаКадрыПодсистемы
