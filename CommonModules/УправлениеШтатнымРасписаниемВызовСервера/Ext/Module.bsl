...
Процедура ПодразделенияУстановитьОтборПоУмолчаниюПараметровДанныхВыбора(Параметры) Экспорт
...
Функция ПолучитьРегистраторРасшифровки(Знач ОтчетДанныеРасшифровки, КомпоновщикНастроек, Расшифровка) Экспорт
	
	Возврат УправлениеШтатнымРасписанием.ПолучитьРегистраторРасшифровки(ОтчетДанныеРасшифровки, КомпоновщикНастроек, Расшифровка);
