...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("УстановитьДоступностьВсехНаборовДополнительныхРеквизитов");
КонецПроцедуры
...
Процедура УстановитьДоступностьНаборовДополнительныхРеквизитовПоРегиструСведений(Источник, Отказ, Замещение) Экспорт
	...
	УстановитьДоступностьДополнительныхРеквизитов(Источник.Метаданные(), Источник, , Замещение);
...
//
Процедура УстановитьДоступностьДополнительныхРеквизитов(МетаданныеИсточника, ЗначенияИсточника = Неопределено, ПараметрыОбновления = Неопределено, Замещение = Неопределено) Экспорт
	...
	Иначе
		...
		Иначе
			...
			Если ЗначенияИсточника.Количество() = 0 Или РегистрыБЗК.ЭтоУдалениеНабораЗаписей(Замещение) Тогда
