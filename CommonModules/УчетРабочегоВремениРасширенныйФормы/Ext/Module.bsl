...
Функция ТабельМожноЗаполнитьАвтоматически(Объект) Экспорт
...
Функция ТабельПустаяТаблицаСотрудников() Экспорт
...
Функция ТабельСтрокаСотрудникаДублируется(ДанныеОВремени, Сотрудник) Экспорт
