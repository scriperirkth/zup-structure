...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
    Методы.Вставить("ОбновитьСтатусОтправкиРегистрацииЮЛ", Истина);
    Методы.Вставить("СоздатьОтправкуРегистрацииЮЛ", Истина);
    Методы.Вставить("НайтиОтправкуРегистрацииЮЛ", Истина);
    Методы.Вставить("ВыполнитьОперациюСервераРегистрацииЮЛ", Истина);
    Методы.Вставить("ПодготовитьВыгрузкуФайлов", Истина);
    Методы.Вставить("СервисРегистрацииФНСАвторизация", Истина);
КонецПроцедуры
