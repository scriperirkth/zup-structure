		...
		Для каждого ТекущаяНовость Из ОченьВажныеНовостиСВключеннымиНапоминаниями Цикл
			...
			Если (НЕ ТекущаяНовость.Новость.Пустая())
				...
				ПараметрыОткрытияФормы = Новый Структура;
					ПараметрыОткрытияФормы.Вставить("ИнициаторОткрытияНовости", "ОченьВажнаяНовость"); // АПК:1297 Это идентификатор.
...
// Вызывается через "ПодключитьОбработчикОжидания".
//
Процедура ПодключитьРаботуСНовостямиНаКлиентеСЗадержкой() Экспорт
