...
Процедура ПриНастройкеПроверкиМетодовВызываемыхКакПроизвольныйКод(Настройки) Экспорт
	...
	ИсключениеПроверки.ПолноеИмяОбъекта   = "Обработка.Интеграция1СПерсонал";
	ИсключениеПроверки.ИмяПроцедуры       = "ЗапуститьФоновоеЗадание";
	ИсключениеПроверки.ФрагментСодержания = "Результат = ДлительныеОперации.ВыполнитьВФоне(ПараметрыЗадания.ИмяМетода, ПараметрыЗадания.ПараметрыМетода, ПараметрыВыполнения)";
	
	ИсключениеПроверки = Настройки.ИсключенияПроверки.Добавить();
	ИсключениеПроверки.ПолноеИмяОбъекта   = "Обработка.ИнтеграцияКабинетСотрудника";
	ИсключениеПроверки.ИмяПроцедуры       = "ЗапуститьФоновоеЗадание";
	ИсключениеПроверки.ФрагментСодержания = "Результат = ДлительныеОперации.ВыполнитьВФоне(ПараметрыЗадания.ИмяМетода, ПараметрыЗадания.ПараметрыМетода, ПараметрыВыполнения)";
	...
	ИсключениеПроверки.ПолноеИмяОбъекта   = "Обработка.ИнтеграцияКабинетСотрудника";
	ИсключениеПроверки.ИмяПроцедуры       = "ЗапуститьФоновоеЗадание";
	ИсключениеПроверки.ФрагментСодержания = "РезультатВыполнения = ДлительныеОперации.ВыполнитьВФоне(ИмяМетода, ПараметрыМетода, ПараметрыВыполненияВФоне)";
	
	ИсключениеПроверки = Настройки.ИсключенияПроверки.Добавить();
	ИсключениеПроверки.ПолноеИмяОбъекта   = "Обработка.ИнтеграцияУправлениеПерсоналом";
	ИсключениеПроверки.ИмяПроцедуры       = "НачатьПроверкуИдентификатора";
	ИсключениеПроверки.ФрагментСодержания = "ДлительнаяОперация = ДлительныеОперации.ВыполнитьВФоне(ИмяМетода, ПараметрыМетода, ПараметрыВыполненияВФоне)";
	
	ИсключениеПроверки = Настройки.ИсключенияПроверки.Добавить();
	ИсключениеПроверки.ПолноеИмяОбъекта   = "Обработка.ИнтеграцияУправлениеПерсоналом";
	ИсключениеПроверки.ИмяПроцедуры       = "НачатьПолучениеДанных";
	ИсключениеПроверки.ФрагментСодержания = "РезультатВыполнения = ДлительныеОперации.ВыполнитьВФоне(ИмяМетода, ПараметрыМетода, ПараметрыВыполненияВФоне)";
	...
	ИсключениеПроверки.ПолноеИмяОбъекта   = "Обработка.ИнтеграцияУправлениеПерсоналом";
	ИсключениеПроверки.ИмяПроцедуры       = "ЗапуститьФоновоеЗадание";
	ИсключениеПроверки.ФрагментСодержания = "ДлительнаяОперация = ДлительныеОперации.ВыполнитьВФоне(ИмяМетода, ПараметрыПроцедуры, ПараметрыВыполненияВФоне)";

	ИсключениеПроверки = Настройки.ИсключенияПроверки.Добавить();
	ИсключениеПроверки.ПолноеИмяОбъекта   = "ОбщийМодуль.ЗарплатаКадрыВызовСервера";
	ИсключениеПроверки.ИмяПроцедуры       = "ВосстановитьНачальныеЗначения";
	ИсключениеПроверки.ФрагментСодержания = "Возврат ДлительныеОперации.ВыполнитьВФоне(ИмяПроцедуры, ПараметрыПроцедуры, ПараметрыЗапуска)";
	
	ИсключениеПроверки = Настройки.ИсключенияПроверки.Добавить();
	ИсключениеПроверки.ПолноеИмяОбъекта   = "ОбщийМодуль.УчетПособийСоциальногоСтрахования";
	ИсключениеПроверки.ИмяПроцедуры       = "ЗапуститьФоновыйПроцессПриЗаписиДокумента";
	ИсключениеПроверки.ФрагментСодержания = "ДлительныеОперации.ВыполнитьВФоне(ИмяМетода, ПараметрыПроцедуры, ПараметрыЗапуска)";

	ИсключениеПроверки = Настройки.ИсключенияПроверки.Добавить();
	ИсключениеПроверки.ПолноеИмяОбъекта   = "РегистрСведений.ЗастрахованныеЛицаСЭДО";
	ИсключениеПроверки.ИмяПроцедуры       = "ОбновитьДанныеРегистраНаСервере";
	ИсключениеПроверки.ФрагментСодержания = "ДлительнаяОперация = ДлительныеОперации.ВыполнитьВФоне(ИмяМетода, ПараметрыПроцедуры, ПараметрыЗапуска)";
	
	ИсключениеПроверки = Настройки.ИсключенияПроверки.Добавить();
	ИсключениеПроверки.ПолноеИмяОбъекта   = "РегистрСведений.НастройкиПрямыхВыплатФСССотрудников";
	ИсключениеПроверки.ИмяПроцедуры       = "НачатьРасчетПодробностей";
	ИсключениеПроверки.ФрагментСодержания = "ДлительнаяОперация = ДлительныеОперации.ВыполнитьПроцедуру(НастройкиЗапуска, ИмяМетода, Организация)";
	
	Методы = Новый Соответствие;
	Методы.Вставить("УстановитьИспользованиеОтбораПоПодразделениямПоУмолчанию");
	Настройки.ИсключенияКогдаУказанныйМетодНеВызывается.Вставить("ОбщийМодуль.РегулярнаяОтправкаСотрудников", Методы);
	
	Методы = Новый Соответствие;
	Методы.Вставить("ОчиститьВидыДоходовИсполнительногоПроизводства");
	Настройки.ИсключенияКогдаУказанныйМетодНеВызывается.Вставить("РегистрНакопления.НачисленияУдержанияПоСотрудникамАвансом", Методы);
	
	Методы = Новый Соответствие;
	Методы.Вставить("ОбновитьДанныеРегистраДокументыУчтенныеПриРасчетеНДФЛ");
	Настройки.ИсключенияКогдаУказанныйМетодНеВызывается.Вставить("РегистрСведений.ДокументыУчтенныеПриРасчетеНДФЛ", Методы);
...
Процедура ЭтоФормаОбъекта(Форма, ЭтоФормаОбъекта) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульИнтеграцияС1САрхивом.ЭтоФормаОбъекта(Форма, ЭтоФормаОбъекта);
	КонецЕсли;
...
Процедура ИмяРеквизитаФормыСодержащегоИнтегрируемыйОбъект(Форма, ИмяРеквизита) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульИнтеграцияС1САрхивом.ИмяРеквизитаФормыСодержащегоИнтегрируемыйОбъект(Форма, ИмяРеквизита);
	КонецЕсли;
...
Процедура ТаблицаДанныхНСИДляВыгрузки(СсылкиНаОбъектыНСИ, СвойстваОбъектаXDTO, ТаблицаНСИ) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульИнтеграцияС1САрхивом.ТаблицаДанныхНСИДляВыгрузки(СсылкиНаОбъектыНСИ, СвойстваОбъектаXDTO, ТаблицаНСИ);
	КонецЕсли;
...
Процедура СоздатьДокументыБИА(СсылкаНаОбъектИсточник, ДокументыБИА) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ИнтеграцияС1САрхивомЗарплатаКадры") Тогда
		МодульИнтеграцияС1САрхивом = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1САрхивом");
		МодульИнтеграцияС1САрхивом.СоздатьДокументыБИА(СсылкаНаОбъектИсточник, ДокументыБИА);
	КонецЕсли;
