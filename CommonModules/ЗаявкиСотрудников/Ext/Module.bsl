...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ЗаписатьНастройкиПравилОбработки", Истина);
	Методы.Вставить("ЗаписатьЗаявкуПриВыполненииФоновоеЗадание", Истина);
	Методы.Вставить("СоздатьЗаявкиБолезньПрежнейВерсии");
	Методы.Вставить("ОбновитьТипАдресацииРолиОтветственныйЗаОбращенияСотрудников");
	Методы.Вставить("ОбновитьРольОбработкаЗаявленийОСпособеВыплатыЗарплаты");
	Методы.Вставить("ОбновитьРольОбработкаЗаявленийВПроизвольнойФорме");
	Методы.Вставить("ОбновитьШаблонЗаявлениеВПроизвольнойФорме");
	Методы.Вставить("ОбновитьРольОтветственныйЗаСоциальныеПособия");
	Методы.Вставить("ЗаполнитьДокументыПоЗаявкамБолезньПрежнейВерсии");
	Методы.Вставить("ОбновитьНазначениеРолей");
	Методы.Вставить("ЗаполнитьДокументыПоЗаявкамСправкиНДФЛПрежнейВерсии");
	Методы.Вставить("СоздатьЗаявкиНалоговыйВычетПрежнейВерсии");
	Методы.Вставить("ЗаполнитьДокументыПоЗаявкамНалоговыйВычетПрежнейВерсии");
	Методы.Вставить("ЗаполнитьДокументыПоЗаявкамОтпускПрежнейВерсии");
	Методы.Вставить("ОчиститьПустыеДокументыПоЗаявкам");
	Методы.Вставить("СоздатьЗаявкиОтпускПрежнейВерсии");
	Методы.Вставить("ЗаполнитьОбъектДополнительнойАдресации");
	Методы.Вставить("ЗаполнитьПравилаОбработкиЗаявок");
	Методы.Вставить("СоздатьЗаявкиОбращенияПрежнейВерсии");
	Методы.Вставить("СоздатьЗаявкиСправкиНДФЛПрежнейВерсии");
	Методы.Вставить("СоздатьЗаявкиЛичныеДанныеПрежнейВерсии");
КонецПроцедуры
