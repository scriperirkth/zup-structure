...
Функция КонтролируемыеРесурсыПоРегистрамИсточникамВторичныхДанных()
	 ...
	 МетаданныеЗначенияПоказателейСреднегоЗаработка = Метаданные.РегистрыСведений.ЗначенияПоказателейСреднегоЗаработкаСотрудников;
	 
	 КонтролируемыеРесурсыЗначенийПоказателейСреднегоЗаработка = Новый Массив;
	 КонтролируемыеРесурсы.Вставить(МетаданныеЗначенияПоказателейСреднегоЗаработка.Имя, КонтролируемыеРесурсыЗначенийПоказателейСреднегоЗаработка);
	 КонтролируемыеРесурсыЗначенийПоказателейСреднегоЗаработка.Добавить(МетаданныеЗначенияПоказателейСреднегоЗаработка.Ресурсы.ЧасовоеЗначение.Имя);
	 КонтролируемыеРесурсыЗначенийПоказателейСреднегоЗаработка.Добавить(МетаданныеЗначенияПоказателейСреднегоЗаработка.Ресурсы.ДневноеЗначение.Имя);
