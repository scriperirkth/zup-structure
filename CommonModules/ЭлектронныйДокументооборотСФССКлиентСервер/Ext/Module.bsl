...
// Возвращает новую структуру для хранения результата обработки содержимого сообщения СЭДО.
//
// Возвращаемое значение:
//   Структура:
//     * Обработано - Булево - признак успешной обработки сообщения
//     * ОшибкаОбработки - Булево - признак наличия ошибки при обработке
//     * ОписаниеОшибки - Строка - текстовое описание ошибки
//     * СсылкаНаДокумент - ЛюбаяСсылка, Неопределено - ссылка на документ для списка новых сообщений
//     * СтатусДокумента - Строка - статус документа для списка новых сообщений
//     * ЭтоЗавершенныйДокументооборот - Булево - признак завершенности обмена
Функция НовыйРезультатПриПолученииСодержимогоСообщенияСЭДО() Экспорт
	...
	// Данные для добавления данных в список Новое
	// Ссылка на документ, который будет отображаться в списке формы с новыми сообщениями.
	РезультатОбработки.Вставить("СсылкаНаДокумент", Неопределено);
	// Статус документа, который будет отображаться у документа в списке формы с новыми сообщениями.
	РезультатОбработки.Вставить("СтатусДокумента", "");
	// Признак завершенности обмена для списка формы с новыми сообщениями.
	РезультатОбработки.Вставить("ЭтоЗавершенныйДокументооборот", Ложь);
