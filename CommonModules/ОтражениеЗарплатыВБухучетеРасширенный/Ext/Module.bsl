...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ПереместитьБухучетДоговоровГПХИспр");
	Методы.Вставить("ПеренестиБухучетЗарплатыСотрудников");
	Методы.Вставить("ПеренестиНастройкиБухучетаВыплатПоДоговорамГПХ");
	Методы.Вставить("ЗаполнитьСтатьюРасходовВБухучетНачисленияУдержанияПоСотрудникам");
	Методы.Вставить("ЗаполнитьПравилаЗаменыСтатейФинансирования");
	Методы.Вставить("ОбновитьДокументыРаспределениеОсновногоЗаработка");
	Методы.Вставить("СтатьиФинансированияЗаполнитьИспользованиеВБазеСреднегоЗаработка");
	Методы.Вставить("ОбновитьБухучетСотрудниковПоСписочнымКадровымДокументам");
	Методы.Вставить("ПеренестиБухучетНачисленийСотрудников");
	Методы.Вставить("ЗаполнитьСтатьюРасходовОплатаДнейУходаЗаДетьмиИнвалидами");
	Методы.Вставить("ПеренестиНастройкиБухучетаДоговоровОпеки");
	Методы.Вставить("ЗаполнитьСтатьюРасходовВБухучетНачисленияУдержанияПоКонтрагентамАкционерам");
	Методы.Вставить("ОбновитьСтратегиюБухучетаСдельногоЗаработка");
	Методы.Вставить("ЗаполнитьПравилаЗаменыСпособовОтражения");
	Методы.Вставить("ОбновитьСтратегиюБухучетаУдержаний");
	Методы.Вставить("ПеренестиНастройкиБухучетаДоговоровГПХ");
	Методы.Вставить("ЗаполнитьСтатьюРасходовВСтраховыеВзносыПоФизическимЛицам");
	Методы.Вставить("ПроверитьОбновитьСтратегиюБухучетаУдержаний");
КонецПроцедуры
...
Процедура УточнитьСтратегиюОтраженияВУчетеНачисления(ВидРасчетаОбъект) Экспорт
	...
	Если ОтражениеЗарплатыВБухучетеКлиентСерверРасширенный.ЭтоКатегорияНачисленияОплатаДолиРКСН(КатегорияНачисления) Тогда
		КатегорияНачисления = ОтражениеЗарплатыВБухучетеКлиентСерверРасширенный.КатегорияОсновногоВидаРасчета(ВидРасчетаОбъект);
	КонецЕсли;
...
Процедура ДанныеДляПроведенияСоздатьВТНачисленияСтраховыеВзносы(МенеджерВременныхТаблиц, РеквизитыДляПроведения, ИмяВТНачисленияСтраховыеВзносы) Экспорт
	...
	|	НачисленийПоДоговорам.Договор КАК Договор,
	|	ВЫБОР
	|		КОГДА НЕ ЕСТЬNULL(ПлановыеНачисленияПоДоговорам.КодДоходаСтраховыеВзносы, ПлановыеНачисленияПоДоговорамИспр.КодДоходаСтраховыеВзносы) ЕСТЬ NULL
	|			ТОГДА ЕСТЬNULL(ПлановыеНачисленияПоДоговорам.КодДоходаСтраховыеВзносы, ПлановыеНачисленияПоДоговорамИспр.КодДоходаСтраховыеВзносы)
	|		КОГДА НЕ ЕСТЬNULL(УсловияДоговораГПХ.КодДоходаСтраховыеВзносы, УсловияДоговораГПХИспр.КодДоходаСтраховыеВзносы) ЕСТЬ NULL
	|			ТОГДА ЕСТЬNULL(УсловияДоговораГПХ.КодДоходаСтраховыеВзносы, УсловияДоговораГПХИспр.КодДоходаСтраховыеВзносы)
	|		ИНАЧЕ УсловияДоговораОпеки.КодДоходаСтраховыеВзносы
	|	КОНЕЦ КАК КодДоходаСтраховыеВзносы,
	|	ВЫБОР
	|		КОГДА НЕ ЕСТЬNULL(ПлановыеНачисленияПоДоговорам.ЗаключенСоСтудентомРаботающимВСтудотряде, ПлановыеНачисленияПоДоговорамИспр.ЗаключенСоСтудентомРаботающимВСтудотряде) ЕСТЬ NULL
	|			ТОГДА ЕСТЬNULL(ПлановыеНачисленияПоДоговорам.ЗаключенСоСтудентомРаботающимВСтудотряде, ПлановыеНачисленияПоДоговорамИспр.ЗаключенСоСтудентомРаботающимВСтудотряде)
	|		ИНАЧЕ ЕСТЬNULL(УсловияДоговораГПХ.ЗаключенСоСтудентомРаботающимВСтудотряде, УсловияДоговораГПХИспр.ЗаключенСоСтудентомРаботающимВСтудотряде)
	|	КОНЕЦ КАК ЗаключенСоСтудентомРаботающимВСтудотряде
	...
	|			И (ПлановыеНачисленияПоДоговорам.МесяцНачисления = НачисленийПоДоговорам.ПериодДействия)
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ПлановыеНачисленияПоДоговорамИспр КАК ПлановыеНачисленияПоДоговорамИспр
	|		ПО НачисленийПоДоговорам.Договор = ПлановыеНачисленияПоДоговорамИспр.ДоговорАкт
	|			И (ПлановыеНачисленияПоДоговорамИспр.МесяцНачисления = НачисленийПоДоговорам.ПериодДействия)
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.УсловияДоговораГПХИспр КАК УсловияДоговораГПХИспр
	|		ПО НачисленийПоДоговорам.Договор = УсловияДоговораГПХИспр.Договор
...
Процедура ДополнитьСведенияОВзносахДаннымиБухучета(Движения, Организация, ПериодРегистрации, Ссылка, МенеджерВременныхТаблиц, ИмяВременнойТаблицы) Экспорт
	...
	Если ИспользоватьБюджетныйТарифНСиПЗ(ПериодРегистрации) Тогда
		СтатьиБюджетныйТарифНСиПЗ = СтатьиБюджетныйТарифНСиПЗ();
		...
		Для каждого СтрокаТЗ Из БухучетНачислений Цикл
			СтрокаТЗ.БюджетныйТарифНСиПЗ = (СтатьиБюджетныйТарифНСиПЗ[СтрокаТЗ.СтатьяФинансирования] = Истина);
		КонецЦикла;
	КонецЕсли;
...
Функция ИспользоватьБюджетныйТарифНСиПЗ(Период) Экспорт

	Возврат ПолучитьФункциональнуюОпцию("РаботаВБюджетномУчреждении")
		И Период >= '20250101'
		И ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.УчетБюджетныхУчреждений");
		
КонецФункции
	
Функция СтатьиБюджетныйТарифНСиПЗ() Экспорт

	СтатьиБюджетныйТарифНСиПЗ = Новый Соответствие;
	...
	Иначе
		Возврат СтатьиБюджетныйТарифНСиПЗ;
	КонецЕсли;
	...
	|	СтатьиБюджетныйТарифНСиПЗ.БюджетныйТарифНСиПЗ КАК БюджетныйТарифНСиПЗ
	|ИЗ
	|	ВТСтатьиБюджетныйТарифНСиПЗ КАК СтатьиБюджетныйТарифНСиПЗ";
	РезультатЗапроса = Запрос.Выполнить();
	Выборка = РезультатЗапроса.Выбрать();
	Пока Выборка.Следующий() Цикл
		СтатьиБюджетныйТарифНСиПЗ.Вставить(Выборка.СтатьяФинансирования, Выборка.БюджетныйТарифНСиПЗ);
	КонецЦикла;
...
// Дополняет таблицу ВТНачисления колонкой СуммаПоБюджетномуТарифуНСиПЗ при условии
// РаботаВБюджетномУчреждении = Истина и ПериодРегистрации больше или равен 01.01.2025
//
// Параметры:
//		МенеджерВТ, содержит временные таблицы
//			ВТНачисления - начисления
//			ВТНачисленияСРаспределением - таблица с результатами распределения начислений
//		Организация
//		Период
//		ИмяПоляИдентификаторСтроки
//
Процедура ДополнитьВТНачисленияБюджетныйТарифНСиПЗ(МенеджерВТ, Организация, Период, ИмяПоляИдентификаторСтроки = "ИдентификаторСтроки") Экспорт
	
	Если Не ИспользоватьБюджетныйТарифНСиПЗ(Период) Тогда
		Возврат;
	КонецЕсли;
	
	УдалитьВТ = Новый Массив;
	
	Если Не ЗарплатаКадры.ВТСуществует(МенеджерВТ, "ВТСтатьиБюджетныйТарифНСиПЗ") Тогда
	...
	Если Не ЗарплатаКадрыРасширенный.ИспользоватьРаспределениеПоТерриториямУсловиямТруда(Организация) Тогда
		...
		|ИЗ
		|	ВТНачисленияСРаспределением КАК БухучетНачислений
		...
		|ВЫБРАТЬ
		|	&ИменаПолей,
		|	ЕСТЬNULL(НачисленияБюджетныйТарифНСиПЗ.Сумма, 0) КАК СуммаПоБюджетномуТарифуНСиПЗ
		|ПОМЕСТИТЬ ВТНачисленияВременная
		|ИЗ
		|	ВТНачисления КАК Начисления
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТНачисленияБюджетныйТарифНСиПЗ КАК НачисленияБюджетныйТарифНСиПЗ
		|		ПО Начисления.ИдентификаторСтроки = НачисленияБюджетныйТарифНСиПЗ.ИдентификаторСтроки";
		
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "БухучетНачислений.ИдентификаторСтроки", СтрШаблон("%1.%2","БухучетНачислений", ИмяПоляИдентификаторСтроки));
		ЗарплатаКадры.ЗаполнитьИменаПолейВТ(Запрос.Текст, МенеджерВТ, "ВТНачисления", "Начисления", Новый Массив);
		Запрос.Выполнить();
		
		ЗарплатаКадры.УничтожитьВТ(МенеджерВТ, "ВТНачисления");
		...
		|ИЗ
		|	ВТНачисленияВременная КАК Начисления";
		ЗарплатаКадры.ЗаполнитьИменаПолейВТ(Запрос.Текст, МенеджерВТ, "ВТНачисленияВременная", "Начисления", Новый Массив);
		Запрос.Выполнить();
	...
	Иначе
		...
		"ВЫБРАТЬ
		|	БухучетНачислений.ИдентификаторСтроки КАК ИдентификаторСтроки,
		|	БухучетНачислений.ТерриторияВыполненияРаботВОрганизации КАК Подразделение,
		|	СУММА(БухучетНачислений.Сумма) КАК Сумма
		|ИЗ
		|	ВТНачисленияСРаспределением КАК БухучетНачислений
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТСтатьиБюджетныйТарифНСиПЗ КАК СтатьиБюджетныйТарифНСиПЗ
		...
		РезультатЗапроса = Запрос.Выполнить();
		Выборка = РезультатЗапроса.Выбрать();
		СтрокиБюджетныйТариф = Новый Соответствие;
		Пока Выборка.СледующийПоЗначениюПоля("ИдентификаторСтроки") Цикл
			ДанныеПоПодразделению = Новый Соответствие;
			Пока Выборка.Следующий() Цикл
				ДанныеПоПодразделению.Вставить(Выборка.Подразделение, Выборка.Сумма);
			КонецЦикла;
			СтрокиБюджетныйТариф.Вставить(Выборка.ИдентификаторСтроки, ДанныеПоПодразделению);
		КонецЦикла;
		
		Запрос.Текст = "ВЫБРАТЬ * ИЗ ВТНачисления КАК Начисления";
		ИсходныеНачисления = Запрос.Выполнить().Выгрузить();
		
		Начисления = ИсходныеНачисления.СкопироватьКолонки();
		Начисления.Колонки.Добавить("СуммаПоБюджетномуТарифуНСиПЗ", Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(13, 2)));
		
		ИдентификаторыСтрок = ИсходныеНачисления.Скопировать(,"ИдентификаторСтроки,Подразделение");
		ИдентификаторыСтрок.Свернуть("ИдентификаторСтроки,Подразделение");
		
		Отбор = Новый Структура("ИдентификаторСтроки,Подразделение");
		ИсходныеНачисления.Индексы.Добавить("ИдентификаторСтроки,Подразделение");
		
		Для каждого СтрокаТЗ Из ИдентификаторыСтрок Цикл
			
			СуммаПоБюджетномуТарифуНСиПЗ = 0;
			ДанныеСтроки = СтрокиБюджетныйТариф[СтрокаТЗ.ИдентификаторСтроки];
			Если ДанныеСтроки <> Неопределено Тогда
				СуммаПоБюджетномуТарифуНСиПЗ = ?(ДанныеСтроки[СтрокаТЗ.Подразделение] = Неопределено, 0, ДанныеСтроки[СтрокаТЗ.Подразделение]);
			КонецЕсли;
			
			ЗаполнитьЗначенияСвойств(Отбор, СтрокаТЗ);
			НайденныеСтроки = ИсходныеНачисления.НайтиСтроки(Отбор);
			
			Если СуммаПоБюджетномуТарифуНСиПЗ = 0 Тогда
			...
			Иначе
				Если НайденныеСтроки.Количество() = 1 Тогда
					...
					НоваяСтрока.СуммаПоБюджетномуТарифуНСиПЗ = СуммаПоБюджетномуТарифуНСиПЗ;
				Иначе
					Коэффициенты = Новый Массив;
					Для каждого СтрокаТаблицы Из НайденныеСтроки Цикл
						Коэффициенты.Добавить(СтрокаТаблицы.СуммаДохода);
					КонецЦикла;
					Результаты = ЗарплатаКадрыКлиентСервер.РаспределитьПропорциональноКоэффициентам(СуммаПоБюджетномуТарифуНСиПЗ, Коэффициенты);
					...
					Иначе
						...
						Для Каждого СтрокаТаблицы Из НайденныеСтроки Цикл
							...
							НоваяСтрока.СуммаПоБюджетномуТарифуНСиПЗ = Результаты[Индекс];
							Индекс = Индекс + 1;
						КонецЦикла;
					КонецЕсли;
				КонецЕсли;
		...
		ЗарплатаКадры.УничтожитьВТ(МенеджерВТ, "ВТНачисления");
		ЗарплатаКадры.СоздатьВТПоТаблицеЗначений(МенеджерВТ, Начисления, "ВТНачисления");
...
//		ЗаписыватьДвижения - тип Булево, признак того, что движения необходимо записать
//
Процедура ЗарегистрироватьНачисленияУдержанияАвансом(ДанныеДляПроведения, Отказ, Начисления, Удержания, РезультатыРасчетаНДФЛ, ЗаписыватьДвижения = Ложь) Экспорт
	...
	Если Начисления <> НеОпределено Тогда
		...
		Для Каждого Строка Из Начисления Цикл
			...
			НоваяСтрока = Движения.БухучетНачисленияУдержанияПоСотрудникамАвансом.Добавить();
			ЗаполнитьЗначенияСвойств(НоваяСтрока, Строка);
		...
		Движения.БухучетНачисленияУдержанияПоСотрудникамАвансом.Записывать = Истина;
	...
	Если ЗаписыватьДвижения Тогда
		Движения.БухучетНачисленияУдержанияПоСотрудникамАвансом.Записать();
		Движения.БухучетНачисленияУдержанияПоСотрудникамАвансом.Записывать = Ложь;
	КонецЕсли;
...
Функция ВыполнитьОтражениеНачисленийВБухучете(ИсходныеДанные) Экспорт
	...
	Запрос.УстановитьПараметр("ПериодРегистрации", ИсходныеДанные.МесяцНачисления);
	Запрос.УстановитьПараметр("ОкончаниеПериода", НачалоДня(КонецМесяца(ИсходныеДанные.МесяцНачисления)));
	...
	|	ВЫБОР
	|		КОГДА ЕСТЬNULL(Начисления.КатегорияНачисленияИлиНеоплаченногоВремени, ЗНАЧЕНИЕ(Перечисление.КатегорииНачисленийИНеоплаченногоВремени.ПустаяСсылка)) = ЗНАЧЕНИЕ(Перечисление.КатегорииНачисленийИНеоплаченногоВремени.КомпенсацияНеИспользованныхДнейЧасовОтдыха)
	|				И НачисленияДляРаспределения.ДатаНачала < &ПериодРегистрации
	|			ТОГДА &ОкончаниеПериода
	|		ИНАЧЕ НачисленияДляРаспределения.ДатаНачала
	|	КОНЕЦ КАК Период,
	...
	|	НачисленияДляРаспределения.БольничныйСотрудникДоговорник КАК БольничныйСотрудникДоговорник,
	|	НачисленияДляРаспределения.КоэффициентИндексации КАК КоэффициентИндексации,
	...
	|ПОМЕСТИТЬ ВТРанееНачисленоДляКорректировки
	|ИЗ
	...
	УдалитьВТ.Добавить("ВТРанееНачисленоДляКорректировки");
...
Функция ВыполнитьОтражениеНачисленийПоДоговорамВБухучете(ИсходныеДанные) Экспорт
	...
	СоздатьВТБухучетНачисленийСторно(МенеджерВременныхТаблиц, ИмяВТНачисления, ИсходныеДанные.СтрокиБухучетСторноНачислений);
	УдалитьВТ.Добавить("ВТБухучетНачисленийСторно");
	...
	|		БухучетНачислений.ОблагаетсяЕНВД
	|	ИЗ
	|		ВТБухучетНачисленийСторно КАК БухучетНачислений) КАК БухучетНачислений
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.СтатьиФинансированияЗарплата КАК СтатьиФинансированияЗарплата
	|		ПО БухучетНачислений.СтатьяФинансирования = СтатьиФинансированияЗарплата.Ссылка
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТНачисленияДляОтраженияВБухучете КАК Начисления
	|		ПО БухучетНачислений.ИдентификаторСтроки = Начисления.ИдентификаторСтроки
...
Процедура СоздатьВТБухучетНачисленийПоТаблицеБухучетНачислений(МенеджерВременныхТаблиц, БухучетНачислений, ИмяВТ, ПланируемаяДатаВыплаты) Экспорт
	...
	Если БухучетНачислений.Количество() = 0 Тогда
		...
		|	ЗНАЧЕНИЕ(Справочник.ПодразделенияОрганизаций.ПустаяСсылка) КАК ТерриторияВыполненияРаботВОрганизации
		|ПОМЕСТИТЬ ВТБухучетНачисленийВыходнаяТаблица";
...
Функция НоваяТаблицаНачисленияДляБухучета() Экспорт
	...
	Таблица.Колонки.Добавить("БольничныйСотрудникДоговорник", Новый ОписаниеТипов("Булево"));
	Таблица.Колонки.Добавить("КоэффициентИндексации", Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15,2)));
...
Функция ВыполнитьОтражениеНДФЛВБухучете(ИсходныеДанные) Экспорт
	...
	Если РегистраторыНДФЛОбновленияБухучета <> Неопределено И ПериодРегистрации >= УчетНДФЛ.ДатаЗакона263ФЗ()
		И Не ЗарплатаКадры.ВТСуществует(МенеджерВременныхТаблиц, "ВТОтборЗачетАванса") Тогда
		Запрос = Новый Запрос;
		Запрос.МенеджерВременныхТаблиц = МенеджерВременныхТаблиц;
		Запрос.УстановитьПараметр("ТаблицаНДФЛ", ТаблицаНДФЛ);
		Запрос.УстановитьПараметр("Организация", Организация);
	...
	НатуральныеДоходы = ОбщегоНазначенияБЗККлиентСервер.МассивВСоответствие(Перечисления.КатегорииДоходовНДФЛ.Натуральные());
	СтрокиНатуральныйДоход = Новый Массив;
	...
	Для каждого СтрокаТЗ Из ТаблицаНДФЛ Цикл
		...
		НатуральныйДоход = (НатуральныеДоходы[СтрокаТЗ.КатегорияДохода] = Истина);
		...
		Если СтрокиНДФЛ.Количество() = 1 Тогда
			Для каждого СтрокаРаспределения Из РаспределениеСтрокиНДФЛ Цикл
				...
				Если НатуральныйДоход Тогда
					СтрокиНатуральныйДоход.Добавить(НоваяСтрока);
				КонецЕсли;
			КонецЦикла;
		Иначе
	...
	Если СтрокиНатуральныйДоход.Количество() > 0 Тогда
		СтатьяОплатаТруда = СтатьяОплатаТруда();
		ЗаполнятьСтатьюФинансирования = Ложь;
		СтатьяФинансирования 	= Неопределено;
		СтатьяРасходов 			= Неопределено;
		Если ИсходныеДанные.НастройкиБухучетаНДФЛДокумента <> Неопределено Тогда
			СтатьяФинансирования = ИсходныеДанные.НастройкиБухучетаНДФЛДокумента.СтатьяФинансирования;
			СтатьяРасходов = ИсходныеДанные.НастройкиБухучетаНДФЛДокумента.СтатьяРасходов;
		КонецЕсли;
		ЗаполнятьСтатьюФинансирования = ЗначениеЗаполнено(СтатьяФинансирования);
		СтатьяРасходов = ?(ЗначениеЗаполнено(СтатьяРасходов), СтатьяРасходов, СтатьяОплатаТруда);
		Для каждого СтрокаТЗ Из СтрокиНатуральныйДоход Цикл
			Если ЗаполнятьСтатьюФинансирования Тогда
				СтрокаТЗ.СтатьяФинансирования = СтатьяФинансирования;
			КонецЕсли;
...
Функция ОписаниеИсходныхДанныхДляОтраженияУдержанийВБухучете() Экспорт
	...
	|ПерваяПоловинаМесяца,
	|НастройкиБухучетаНДФЛДокумента");
...
Функция ПараметрыДляЗаполненияТаблицДокумента() Экспорт
	...
	|Подразделение,
	|МежрасчетныйДокумент");
	
	Параметры.МежрасчетныйДокумент = Ложь;
...
// Возвращает ссылку на элемент справочника СтатьиРасходовЗарплата с кодом 262.
Функция СтатьяРасходов262() Экспорт
	
	Статья = Справочники.СтатьиРасходовЗарплата.ПустаяСсылка();
	Если ПолучитьФункциональнуюОпцию("РаботаВБюджетномУчреждении") Тогда
		Статья = Справочники.СтатьиРасходовЗарплата.НайтиПоКоду("262");
	КонецЕсли;
...
//   Статья расходов - тип СправочникСсылка.СтатьиРасходовЗарплата.
//
Функция СтатьяРасходовДляЕдиновременныхПособий(ПериодРегистрации) Экспорт

	Если Не ЗначениеЗаполнено(ПериодРегистрации) Или ПериодРегистрации >= ДатаПриказа222н() Тогда
		Возврат СтатьяРасходов266();
	Иначе
		Возврат СтатьяРасходов213();
	КонецЕсли;
...
Функция ДанныеДляБухучетаЗарплатыПервичныхДокументов(ДокументОбъект, Начисления, ОбработатьСпособРасчетов = Ложь) Экспорт
	...
	ЕстьПодразделениеУчетаЗатрат = ОбщегоНазначения.ЕстьРеквизитОбъекта("ПодразделениеУчетаЗатрат", ДокументОбъект.Ссылка.Метаданные());
	...
	Для каждого Начисление Из Начисления Цикл
		...
		Иначе
			...
			НоваяСтрока.СтатьяРасходов 						= СтатьяРасходов;
			Если ЕстьПодразделениеУчетаЗатрат Тогда
				НоваяСтрока.ПодразделениеУчетаЗатрат = ДокументОбъект.ПодразделениеУчетаЗатрат;
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
...
Функция ДанныеДляБухучетаЗарплатыПервичныхДокументовМножественный(ДокументСсылка, НастройкиБухучета) Экспорт

	ТаблицаБухучетЗарплаты = НоваяТаблицаБухучетЗарплатыПервичныхДокументов();
	Если ТипЗнч(НастройкиБухучета) = Тип("ТаблицаЗначений") Тогда
		Начисления = НастройкиБухучета.ВыгрузитьКолонку("Начисление");
	Иначе
		Начисления = НастройкиБухучета.Выгрузить().ВыгрузитьКолонку("Начисление");
	КонецЕсли;
	...
	Выборка = РезультатЗапроса.Выбрать();
	Пока Выборка.СледующийПоЗначениюПоля("ОсновнойВидРасчета") Цикл
		Начисления =ДополнительныеНачисления[Выборка.ОсновнойВидРасчета];
		Если Начисления = Неопределено Тогда
			Начисления = Новый Массив;
		КонецЕсли;
		Начисления.Добавить(Выборка.Ссылка);
		ДополнительныеНачисления.Вставить(Выборка.ОсновнойВидРасчета, Начисления);
	КонецЦикла;
	...
	Для каждого СтрокаТЗ Из НастройкиБухучета Цикл
		...
		НоваяСтрока.НачислениеУдержание = СтрокаТЗ.Начисление;
		
		Начисления = ДополнительныеНачисления[СтрокаТЗ.Начисление];
		Если Начисления <> Неопределено Тогда
			Для каждого Начисление Из Начисления Цикл
				НоваяСтрока = ТаблицаБухучетЗарплаты.Добавить();
				ЗаполнитьЗначенияСвойств(НоваяСтрока, СтрокаТЗ);
...
Функция ДанныеДляЗаполненияТаблицДокумента(ПараметрыДляЗаполнения) Экспорт
	...
	МежрасчетныйДокумент 	= ПараметрыДляЗаполнения.МежрасчетныйДокумент;
	...
	УчитыватьРасчетЗаПервуюПоловинуМесяца = ПолучитьФункциональнуюОпцию("РаботаВБюджетномУчреждении")
		И МежрасчетныйДокумент И РегистрыСведений.НастройкиБухучета.Настройки().РегистрироватьВБухучетеРасчетЗаПервуюПоловинуМесяца;
	Если УчитыватьРасчетЗаПервуюПоловинуМесяца Тогда
		ДанныеПервойПоловиныМесяца = ДанныеДляЗаполненияТаблицДокументаАвансом(ПараметрыДляЗаполнения);
		Для каждого ЭлементКоллекции Из ДанныеПервойПоловиныМесяца Цикл
			ОбщегоНазначенияКлиентСервер.ДополнитьТаблицу(ЭлементКоллекции.Значение, РезультатЗаполнения[ЭлементКоллекции.Ключ]);
		КонецЦикла;
	КонецЕсли;
...
Функция БухучетНачислений(Организация, Период, ТаблицаНачислений)
	...
	ПустыеЗначенияИсходныйДокумент = Новый Массив;
	ПустыеЗначенияИсходныйДокумент.Добавить(Неопределено);
	ПустыеЗначенияИсходныйДокумент.Добавить(Null);
	Для Каждого ТипДокументОснование Из Метаданные.ОпределяемыеТипы.СторнируемыйДокумент.Тип.Типы() Цикл
		ПустыеЗначенияИсходныйДокумент.Добавить(ОбщегоНазначенияБЗК.МенеджерОбъектаПоТипу(ТипДокументОснование).ПустаяСсылка());
	КонецЦикла;
	...
	Запрос.УстановитьПараметр("ПустыеЗначенияИсходныйДокумент", ПустыеЗначенияИсходныйДокумент);
	...
	|	НачисленияДляРаспределения.ФиксСторно КАК ФиксСторно,
	|	НачисленияДляРаспределения.ИдентификаторСтрокиНачисления КАК ИдентификаторСтрокиНачисления,
	|	НачисленияДляРаспределения.ИсходныйДокумент КАК ИсходныйДокумент
	|ПОМЕСТИТЬ ВТНачисления
	|ИЗ
	...
	|ПОМЕСТИТЬ ВТНачисленияПоДоговорамГПХ
	|ИЗ
	|	ВТНачисления КАК НачисленияДляРаспределения
	|ГДЕ
	...
	|	НачисленияДляРаспределения.ИдентификаторСтрокиНачисления КАК ИдентификаторСтрокиНачисления,
	|	ЛОЖЬ КАК БольничныйСотрудникДоговорник,
	|	1 КАК КоэффициентИндексации,
	|	ВЫБОР
	|		КОГДА НачисленияДляРаспределения.Сторно
	|				И НачисленияДляРаспределения.ИсходныйДокумент В (&ПустыеЗначенияИсходныйДокумент)
	|			ТОГДА НачисленияДляРаспределения.ДокументОснование
	|		ИНАЧЕ НачисленияДляРаспределения.ИсходныйДокумент
...
Функция БухучетВзносовПоСтатьям(Организация, Период, Сотрудники = Неопределено)
	...
	|	ЕСТЬNULL(НачислениеУдержаниеВидОперации.ВидОперации, ЗНАЧЕНИЕ(Перечисление.ВидыОперацийПоЗарплате.НачисленоДоход)) КАК ВидОперации,
	...
	|		ИНАЧЕ СтраховыеВзносы.ПодразделениеУчетаЗатрат
	|	КОНЕЦ,
	|	ЕСТЬNULL(НачислениеУдержаниеВидОперации.ВидОперации, ЗНАЧЕНИЕ(Перечисление.ВидыОперацийПоЗарплате.НачисленоДоход)),
...
Процедура СтатьиРасходовНачисленийБюджет(МенеджерВТ, Организация, ПериодРегистрации, СтатьиРасходовПоВидамНачислений)
	...
	Иначе
		...
		|	Начисления.Ссылка,
		|	ВЫБОР
		|		КОГДА Начисления.КатегорияНачисления В (ЗНАЧЕНИЕ(Перечисление.КатегорииНачисленийИНеоплаченногоВремени.ПособиеПоУходуЗаРебенкомДоТрехЛет), ЗНАЧЕНИЕ(Перечисление.КатегорииНачисленийИНеоплаченногоВремени.ОплатаБольничногоЛистаЗаСчетРаботодателя), ЗНАЧЕНИЕ(Перечисление.КатегорииНачисленийИНеоплаченногоВремени.КомпенсацияЗаНеотработанныеДниЧасыПриУвольнении), ЗНАЧЕНИЕ(Перечисление.КатегорииНачисленийИНеоплаченногоВремени.КомпенсацияЗаНеотработанныеДниПриУвольненииГосслужащего), ЗНАЧЕНИЕ(Перечисление.КатегорииНачисленийИНеоплаченногоВремени.ВыходноеПособиеМесячноеДенежноеСодержание), ЗНАЧЕНИЕ(Перечисление.КатегорииНачисленийИНеоплаченногоВремени.ВыходноеПособие))
		|				И Начисления.СтатьяРасходов = ЗНАЧЕНИЕ(Справочник.СтатьиРасходовЗарплата.ПустаяСсылка)
		|			ТОГДА &Статья266
		|		КОГДА Начисления.КатегорияНачисления В (ЗНАЧЕНИЕ(Перечисление.КатегорииНачисленийИНеоплаченногоВремени.ОплатаДнейУходаЗаДетьмиИнвалидами), ЗНАЧЕНИЕ(Перечисление.КатегорииНачисленийИНеоплаченногоВремени.ДенежноеСодержаниеОплатаДнейУходаЗаДетьмиИнвалидами))
		|			ТОГДА ВЫБОР
		...
		|		Начисления.СтатьяРасходов КАК СтатьяРасходов,
		|		ВЫБОР
		|			КОГДА ОсновныеНачисления.ВидОперацииПоЗарплате ЕСТЬ NULL
		|				ТОГДА Начисления.ВидОперацииПоЗарплате
		|			ИНАЧЕ ОсновныеНачисления.ВидОперацииПоЗарплате
		|		КОНЕЦ КАК ВидОперацииПоЗарплате,
		|		ВЫБОР
		|			КОГДА ОсновныеНачисления.КатегорияНачисленияИлиНеоплаченногоВремени ЕСТЬ NULL
		|				ТОГДА Начисления.КатегорияНачисленияИлиНеоплаченногоВремени
		|			ИНАЧЕ ОсновныеНачисления.КатегорияНачисленияИлиНеоплаченногоВремени
		|		КОНЕЦ КАК КатегорияНачисления
		|	ИЗ
		|		ПланВидовРасчета.Начисления КАК Начисления
		|			ЛЕВОЕ СОЕДИНЕНИЕ ПланВидовРасчета.Начисления КАК ОсновныеНачисления
		|			ПО Начисления.ОсновнойВидРасчета = ОсновныеНачисления.Ссылка) КАК Начисления";
		Запрос.Выполнить();
...
Функция НачисленияРКиСН()

	Запрос = Новый Запрос;
	Запрос.УстановитьПараметр("КатегорияРК", Перечисления.КатегорииНачисленийИНеоплаченногоВремени.РайонныйКоэффициент);
	Запрос.УстановитьПараметр("КатегорияСН", Перечисления.КатегорииНачисленийИНеоплаченногоВремени.СевернаяНадбавка);
	Запрос.Текст =
	"ВЫБРАТЬ
	|	Начисления.Ссылка КАК Ссылка
	|ИЗ
	|	ПланВидовРасчета.Начисления КАК Начисления
	|ГДЕ
	|	Начисления.КатегорияНачисленияИлиНеоплаченногоВремени = &КатегорияРК
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|	ПланВидовРасчета.Начисления КАК Начисления
	|ГДЕ
	|	Начисления.КатегорияНачисленияИлиНеоплаченногоВремени = &КатегорияСН";
	РезультатЗапроса = Запрос.ВыполнитьПакет();
	
	НачисленияРК = ОбщегоНазначенияБЗККлиентСервер.МассивВСоответствие(РезультатЗапроса[0].Выгрузить().ВыгрузитьКолонку("Ссылка"));
	НачисленияСН = ОбщегоНазначенияБЗККлиентСервер.МассивВСоответствие(РезультатЗапроса[1].Выгрузить().ВыгрузитьКолонку("Ссылка"));
	
	НачисленияРКиСН = Новый Структура;
	НачисленияРКиСН.Вставить("НачисленияРК", НачисленияРК);
	НачисленияРКиСН.Вставить("НачисленияСН", НачисленияСН);
	
	Возврат НачисленияРКиСН;
...
Функция СоздатьВТНачисленияПоДокументамДляБухучета(Запрос, ИмяВТНачисленияИсходная)
	...
	Если Не ИспользоватьСтатьиФинансирования Тогда
		...
		|					И Начисления.ИсходныйДокумент = НастройкиБухучета.ДокументОснование)
		|			И (НастройкиБухучета.Сотрудник = ЗНАЧЕНИЕ(Справочник.Сотрудники.ПустаяСсылка)
		|				ИЛИ Начисления.Сотрудник = НастройкиБухучета.Сотрудник)
		|			И (НастройкиБухучета.СпособОтраженияЗарплатыВБухучете <> ЗНАЧЕНИЕ(Справочник.СпособыОтраженияЗарплатыВБухучете.ПустаяСсылка)
		|				ИЛИ НастройкиБухучета.ПодразделениеУчетаЗатрат <> ЗНАЧЕНИЕ(Справочник.ПодразделенияОрганизаций.ПустаяСсылка)
	...
	Иначе
		...
		|	БухучетПервичныхДокументов.ПодразделениеУчетаЗатрат КАК ПодразделениеУчетаЗатрат,
		|	БухучетПервичныхДокументов.ДоляРаспределения КАК ДоляРаспределения,
		|	БухучетПервичныхДокументов.Сотрудник КАК Сотрудник
...
Функция СоздатьВТБухучетНачисленийПоБазеСреднегоЗаработка(Запрос, ИмяВТНачисленияИсходная, ПараметрыРаспределенияПоСтатьям, ПараметрыРаспределенияБюджет)
	...
	НачисленияРКиСН.Вставить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаДолиРайонногоКоэффициентаВСреднемЗаработке,
		ПараметрыРаспределенияПоСтатьям.НачисленияРКиСН.НачисленияРК);
	НачисленияРКиСН.Вставить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаДолиСевернойНадбавкиВСреднемЗаработке,
		ПараметрыРаспределенияПоСтатьям.НачисленияРКиСН.НачисленияСН);
	...
	|	Начисления.КоэффициентИндексации КАК КоэффициентИндексации,
	|	Начисления.Сумма КАК Сумма
	...
	Для каждого СтрокаНачисления Из НачисленияПоБазе Цикл
		...
		Иначе
					...
					Если ЗначениеЗаполнено(СтрокаБазы.СтатьяФинансирования) Тогда
						...
						Иначе
							Используется = НастройкиСтатьи.ИспользуетсяВБазеСреднего Или НастройкиСтатьи.КатегорииНачислений[СтрокаНачисления.КатегорияНачисления] = Истина
								 Или НастройкиСтатьи.КатегорииНачислений[СтрокаНачисления.КатегорияНачисленияОсновнойВидРасчета] = Истина;
			...
			Если База.Количество() = 0 Тогда
				Результаты = Неопределено;
			Иначе
				Если СтрокаНачисления.КоэффициентИндексации > 1 Тогда
					Для каждого СтрокаБазы Из База Цикл
						Если СтрокаБазы.Индексируется Тогда
							СтрокаБазы.Коэффициент = СтрокаБазы.Коэффициент * СтрокаНачисления.КоэффициентИндексации;
						КонецЕсли;
					КонецЦикла;
				КонецЕсли;
		...
		Для Каждого СтрокаБазы Из База Цикл
			...
			Если ЗначениеЗаполнено(СтрокаБазы.СтатьяФинансирования) Тогда
				...
				Иначе
					Если НастройкиСтатьи.КатегорииНачислений[СтрокаНачисления.КатегорияНачисления] = Истина
						Или НастройкиСтатьи.КатегорииНачислений[СтрокаНачисления.КатегорияНачисленияОсновнойВидРасчета] = Истина Тогда
						НоваяСтрока.СтатьяФинансирования = АктуальныеСтатьиФинансирования[СтрокаБазы.СтатьяФинансирования];
					Иначе
...
Функция СоздатьВТБухучетНачисленийПоБазеСохраняемогоДС(Запрос, ИмяВТНачисленияИсходная, ПараметрыСохраняемогоДенежногоСодержания, ПараметрыРаспределенияБюджет)
	...
	НачисленияРКиСН = Новый Соответствие;
	НачисленияРКиСН.Вставить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаДолиРайонногоКоэффициентаВСДС,
		ПараметрыСохраняемогоДенежногоСодержания.НачисленияРКиСН.НачисленияРК);
	НачисленияРКиСН.Вставить(Перечисления.КатегорииНачисленийИНеоплаченногоВремени.ОплатаДолиСевернойНадбавкиВСДС,
		ПараметрыСохраняемогоДенежногоСодержания.НачисленияРКиСН.НачисленияСН);
	...
	Для каждого СтрокаНачисления Из НачисленияПоБазе Цикл
		...
		Иначе
			...
			Если ИспользуемыеСтрокиОтражения.Количество() > 0 Тогда
				Если СтрокаНачисления.КоэффициентИндексации > 1 Тогда
					Для каждого СтрокаБазы Из ИспользуемыеСтрокиОтражения Цикл
						Если СтрокаБазы.Индексируется Тогда
							СтрокаБазы.Коэффициент = СтрокаБазы.Коэффициент * СтрокаНачисления.КоэффициентИндексации;
						КонецЕсли;
					КонецЦикла;
...
Процедура СоздатьВТБухучетНачисленийПоБазовымРасчетам(Запрос, ИмяВТНачисленияИсходная, ИсходныеДанные, ПараметрыРаспределенияБюджет)
	
	МенеджерКадровогоУчета = ИсходныеДанные.МенеджерКадровогоУчета;
	МенеджерДанныхУчетаВремени = ИсходныеДанные.МенеджерДанныхУчетаВремени;
	...
	Если ИсходныеДанные.МенеджерРасчетаЗарплаты <> Неопределено
		И ИсходныеДанные.МенеджерРасчетаЗарплаты.ЭтоИсправлениеТекущимПериодом
		И ЗначениеЗаполнено(ИсходныеДанные.МенеджерРасчетаЗарплаты.ИсправленныйДокумент) Тогда
		Запрос.УстановитьПараметр("ИсправленныйДокумент", ИсходныеДанные.МенеджерРасчетаЗарплаты.ИсправленныйДокумент);
		ДополнительноеУсловие = "РасчетнаяБаза.ИдентификаторСтрокиРазрез > 0
			|	И РасчетнаяБаза.РегистраторРазрез <> &ИсправленныйДокумент";
	КонецЕсли;
	Запрос.Текст = 
	"ВЫБРАТЬ
	...
	Пока Выборка.Следующий() Цикл
		...
		|	НачисленияПоБазе.ДатаОкончания КАК ДатаОкончания,
		|	НачисленияПоБазе.Сторно КАК Сторно,
		|	НачисленияПоБазе.Сумма + НачисленияДляРаспределения.РанееНачислено КАК Сумма
		|ИЗ
		|	ВТНачисленияПоБазовымРасчетам КАК НачисленияПоБазе
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТНачисленияДляРаспределения КАК НачисленияДляРаспределения
		|		ПО НачисленияПоБазе.ИдентификаторСтроки = НачисленияДляРаспределения.ИдентификаторСтроки
		...
		ОтражениеЗарплатыВУчете.СвернутьТаблицу(ТаблицаБухучетОчередности, Ложь);
		Если ИспользоватьСтатьиФинансирования Тогда
			ВыполнитьКорректировкуРанееНачисленныхСумм(ТаблицаБухучетОчередности, ИсходныеДанные);
		КонецЕсли;
...
Процедура ВыполнитьКорректировкуРанееНачисленныхСумм(БухучетТекущегоРасчета, ИсходныеДанные)
	
	МенеджерВТ = ИсходныеДанные.МенеджерВременныхТаблиц;
	Если Не ЗарплатаКадры.ВТСуществует(МенеджерВТ, "ВТРанееНачисленоДляКорректировки")
		Или Не ЗарплатаКадры.ВТСодержитСтроки(МенеджерВТ, "ВТРанееНачисленоДляКорректировки") Тогда
		Возврат;
	КонецЕсли;
	
	УдалитьВТ = Новый Массив;
	ЗарплатаКадры.СоздатьВТПоТаблицеЗначений(МенеджерВТ, БухучетТекущегоРасчета, "ВТБухучетДляКорректировки");
	УдалитьВТ.Добавить("ВТБухучетДляКорректировки");
	
	Запрос = Новый Запрос;
	Запрос.МенеджерВременныхТаблиц = МенеджерВТ;
	Запрос.Текст =
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	БухучетДляКорректировки.ИдентификаторСтроки КАК ИдентификаторСтроки
	|ПОМЕСТИТЬ ВТИдентификаторыСтрокКорректировки
	|ИЗ
	|	ВТБухучетДляКорректировки КАК БухучетДляКорректировки
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ТаблицаРанееНачислено.ИдентификаторСтроки КАК ИдентификаторСтроки,
	|	ТаблицаРанееНачислено.ИдентификаторСтрокиНачисления КАК ИдентификаторСтрокиНачисления,
	|	ТаблицаРанееНачислено.Сотрудник КАК Сотрудник,
	|	ТаблицаРанееНачислено.ФизическоеЛицо КАК ФизическоеЛицо,
	|	ТаблицаРанееНачислено.Подразделение КАК Подразделение,
	|	ТаблицаРанееНачислено.Начисление КАК Начисление,
	|	ТаблицаРанееНачислено.ДатаНачала КАК ДатаНачала,
	|	ТаблицаРанееНачислено.ДатаОкончания КАК ДатаОкончания,
	|	ТаблицаРанееНачислено.РанееНачислено КАК РанееНачислено,
	|	ТаблицаРанееНачислено.Территория КАК Территория
	|ИЗ
	|	ВТРанееНачисленоДляКорректировки КАК ТаблицаРанееНачислено
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТИдентификаторыСтрокКорректировки КАК ИдентификаторыСтрок
	|		ПО ТаблицаРанееНачислено.ИдентификаторСтроки = ИдентификаторыСтрок.ИдентификаторСтроки";
	ТаблицаРанееНачислено = Запрос.Выполнить().Выгрузить();
	УдалитьВТ.Добавить("ВТИдентификаторыСтрокКорректировки");
	...
	|ИЗ
	|	ВТФильтрБухУчета КАК ФильтрБухУчета
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТБухучетДляКорректировки КАК БухучетНачислений
	...
	БухучетБазовыхНачислений = Запрос.Выполнить().Выгрузить();
	...
	Для Каждого СтрокаНачисления Из ТаблицаРанееНачислено Цикл
		...
		Для Каждого СтрокаКоэффициентов Из СтрокиКоэффициентов Цикл
			...
			Для Каждого СтрокаРаспределения Из СтрокиРаспределения Цикл
				Если СтрокаРаспределения.Сумма <> 0 Тогда
					...
					Коэффициенты.Добавить(СтрокаРаспределения.Сумма * СтрокаКоэффициентов.Коэффициент);
				КонецЕсли;	
			КонецЦикла;
		...
		Если Распределение <> Неопределено Тогда
			Для Индекс = 0 По Распределение.Количество() - 1 Цикл
				...
				СтрокаБухучет.Сумма = - Распределение[Индекс]
			КонецЦикла;
		КонецЕсли;
	...
	Если БухучетНачислений.Количество() > 0 Тогда
		ОбщегоНазначенияКлиентСервер.ДополнитьТаблицу(БухучетНачислений, БухучетТекущегоРасчета);
	КонецЕсли;
...
Процедура ПолучитьБухучетНачисленийБезДоговоровСоздатьВТ(ИсходныеДанные, ИмяВТБухучетНачислений)
	...
	НачисленияРКиСН = НачисленияРКиСН();
	...
	|НачисленияРКиСН");
	ПараметрыРаспределенияПоСтатьям.НачисленияРКиСН = НачисленияРКиСН;
	Если ИспользоватьСтатьиФинансирования Тогда
	...
	|СтрокиКоэффициентыСохраняемогоДС,
	|НачисленияРКиСН");
	ПараметрыСохраняемогоДенежногоСодержания.НачисленияРКиСН = НачисленияРКиСН;
	...
	ПараметрыПолученияНастроек.ИмяПоляПериод = "Период";
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТНастройкиБухучета КАК НастройкиБухучета
	|		ПО Начисления.Сотрудник = НастройкиБухучета.Сотрудник
	|			И Начисления.Период = НастройкиБухучета.Период
	|			И Начисления.Подразделение = НастройкиБухучета.Подразделение
	|			И Начисления.ТерриторияВыполненияРаботВОрганизации = НастройкиБухучета.ТерриторияВыполненияРаботВОрганизации
	|;
	|
		...
		ИначеЕсли РаботаВБюджетномУчреждении Тогда
			...
			Если СтатьиРасходовПоПриказу209нПрименяются(ПериодРегистрации) Тогда
				...
				Если Не РезультатЗапроса.Пустой() Тогда
					...
					СтатьяРасходов262 = СтатьяРасходов262();
					СтатьяРасходов264 = СтатьяРасходов264();
					
					ТаблицаСотрудников = РезультатЗапроса.Выгрузить();
					СтрокиДляКорректировки = ТаблицаСотрудников.СкопироватьКолонки();
					
					Отбор = Новый Структура("БольничныйСотрудникДоговорник", Истина);
					ТаблицаДоговорников = ТаблицаСотрудников.Скопировать(Отбор);
					Для каждого СтрокаПоСотруднику Из ТаблицаДоговорников Цикл
						НоваяСтрока = СтрокиДляКорректировки.Добавить();
						ЗаполнитьЗначенияСвойств(НоваяСтрока, СтрокаПоСотруднику);
						НоваяСтрока.СтатьяРасходов = СтатьяРасходов262;
					КонецЦикла;
					
					Отбор = Новый Структура("БольничныйСотрудникДоговорник", Ложь);
					ТаблицаНеДоговорники = ТаблицаСотрудников.Скопировать(Отбор);
					Если ТаблицаНеДоговорники.Количество() > 0 Тогда
						
						ДокументыОснования = Новый Соответствие;
						Для каждого СтрокаТЗ Из ТаблицаНеДоговорники Цикл
							Если ТипЗнч(СтрокаТЗ.ДокументОснование) = Тип("ДокументСсылка.БольничныйЛист") Тогда
								ДокументыОснования.Вставить(СтрокаТЗ.ДокументОснование, Истина);
							КонецЕсли;
						КонецЦикла;
						ДокументыОснования = ОбщегоНазначенияБЗККлиентСервер.КлючиСоответствия(ДокументыОснования);
						ДатыНачалаСобытия = Новый Соответствие;
						Если ЗначениеЗаполнено(ДокументыОснования) Тогда
							УстановитьПривилегированныйРежим(Истина);
							ДатыНачалаСобытия = ОбщегоНазначения.ЗначениеРеквизитаОбъектов(ДокументыОснования, "ДатаНачалаСобытия");
							УстановитьПривилегированныйРежим(Ложь);
						КонецЕсли;
						
						Сотрудники = ОбщегоНазначения.ВыгрузитьКолонку(ТаблицаНеДоговорники, "Сотрудник", Истина);
						...
						УволенныеСотрудники = Новый Соответствие;
						Для каждого СтрокаТЗ Из КадровыеДанные Цикл
							Если ЗначениеЗаполнено(СтрокаТЗ.ДатаЗавершенияРаботы) Тогда
								УволенныеСотрудники.Вставить(СтрокаТЗ.Сотрудник, СтрокаТЗ.ДатаЗавершенияРаботы);
							КонецЕсли;
						КонецЦикла;
						
						Отбор = Новый Структура("Сотрудник");
						КонецМесяцаРегистрации = КонецМесяца(ПериодРегистрации);
						Для каждого КлючИЗначение Из УволенныеСотрудники Цикл
							Отбор.Сотрудник = КлючИЗначение.Ключ;
							ДатаУвольнения 	= КлючИЗначение.Значение;
							НайденныеСтроки = ТаблицаНеДоговорники.НайтиСтроки(Отбор);
							Для каждого СтрокаПоСотруднику Из НайденныеСтроки Цикл
								ДатаСобытия = ДатыНачалаСобытия[СтрокаПоСотруднику.ДокументОснование];
								Если ЗначениеЗаполнено(ДатаСобытия) Тогда
									Если ДатаУвольнения < ДатаСобытия Тогда
										НоваяСтрока = СтрокиДляКорректировки.Добавить();
										ЗаполнитьЗначенияСвойств(НоваяСтрока, СтрокаПоСотруднику);
										НоваяСтрока.СтатьяРасходов = СтатьяРасходов264;
									КонецЕсли;
								Иначе
									Если ДатаУвольнения <= КонецМесяцаРегистрации И ДатаУвольнения < СтрокаПоСотруднику.ДатаНачала Тогда
										// Уволен в месяце начисления пособия или раньше и раньше даты начала оплаты.
										НоваяСтрока = СтрокиДляКорректировки.Добавить();
										ЗаполнитьЗначенияСвойств(НоваяСтрока, СтрокаПоСотруднику);
										НоваяСтрока.СтатьяРасходов = СтатьяРасходов264;
									КонецЕсли;
			...
			Иначе
				...
				|		ИНАЧЕ СтрокиДляКорректировки.СтатьяРасходов
				|	КОНЕЦ КАК СтатьяРасходов,
				|	Таблица.СпособОтраженияЗарплатыВБухучете КАК СпособОтраженияЗарплатыВБухучете,
				|	Таблица.ОблагаетсяЕНВД КАК ОблагаетсяЕНВД
				|ПОМЕСТИТЬ ВТБухучетНачисленийБезРаспределяемыхПоБазе
	...
	Если Не РаспределятьПоБазовымРасчетам Тогда
		...
		ЗарплатаКадры.СоздатьВТПоТаблицеЗначений(Запрос.МенеджерВременныхТаблиц, ТаблицаБухучет, "ВТБухучетНачисленийПоБазовымРасчетам");
	Иначе
		СоздатьВТБухучетНачисленийПоБазовымРасчетам(Запрос, ИмяВТНачисленияИсходная, ИсходныеДанные, ПараметрыРаспределенияБюджет);
	КонецЕсли;
...
Процедура ЗаполнитьБазуПоКатегории(База, НачисленияРКиСН, КатегорияНачисления, СтрокиБазы)

	НачисленияОтбора = НачисленияРКиСН[КатегорияНачисления];
	Если ЗначениеЗаполнено(НачисленияОтбора) Тогда
		Для каждого СтрокаТЗ Из СтрокиБазы Цикл
			Если НачисленияОтбора[СтрокаТЗ.Начисление] = Истина Тогда
	...
	Иначе
		...
		Для каждого КлючИЗначение Из НачисленияРКиСН Цикл
			НачисленияПоКатегории = КлючИЗначение.Значение;
			Для каждого ЭлементКоллекции Из НачисленияПоКатегории Цикл
				ИсключаемыеНачисления.Вставить(ЭлементКоллекции.Ключ, Истина);
			КонецЦикла;
		КонецЦикла;
		Для каждого СтрокаТЗ Из СтрокиБазы Цикл
...
Функция БазаСреднегоЗаработкаПоКатегорииНачисления(НачисленияРКиСН, КатегорияНачисления, СтрокиБазы)
	...
	ЗаполнитьБазуПоКатегории(База, НачисленияРКиСН, КатегорияНачисления, СтрокиБазы);
...
Функция ВзносыДляРасчетаОценочныхОбязательствОтпусков(Организация, Период, ТаблицаВзносов)
...
Процедура ПересчитатьСуммыФОТПоСохраняемомуЗаработку(ТаблицаФОТ, БазовыеНачисленияОтпуска, Организация, Период)
	...
	|		ПО НачисленияУдержания.НачислениеУдержание = Начисления.Ссылка
	|			И (Начисления.КатегорияНачисленияИлиНеоплаченногоВремени В (ЗНАЧЕНИЕ(Перечисление.КатегорииНачисленийИНеоплаченногоВремени.РайонныйКоэффициент), ЗНАЧЕНИЕ(Перечисление.КатегорииНачисленийИНеоплаченногоВремени.СевернаяНадбавка)))
	|ГДЕ
	|	НачисленияУдержания.Организация = &Организация
	|	И НачисленияУдержания.Период МЕЖДУ &НачалоПериода И &КонецПериода
	|	И НачисленияУдержания.Сотрудник В(&Сотрудники)
	|
	|СГРУППИРОВАТЬ ПО
...
Процедура СоздатьВТБухучетНачисленийСторно(МенеджерВременныхТаблиц, ИмяВТНачисления, СтрокиБухучетСторноНачислений)
	...
	Если ИспользоватьСтатьиФинансирования И СтрокиБухучетСторноНачислений.Количество() > 0 Тогда
		...
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "ВТНачисленияДляОтраженияВБухучете", ИмяВТНачисления);
		Если МенеджерВременныхТаблиц.Таблицы[ИмяВТНачисления].Колонки.Найти("ИдентификаторСтрокиНачисления") = Неопределено Тогда
			Запрос.Текст = СтрЗаменить(Запрос.Текст, "Начисления.ИдентификаторСтрокиНачисления", "НЕОПРЕДЕЛЕНО");
		КонецЕсли;
...
Процедура СоздатьВТБухучетНачисленийСотрудников(МенеджерВТ, ОписаниеФильтра, ПараметрыПостроения = Неопределено, ИмяТаблицы = "", УдалятьВТ = Истина)
	...
	|ГДЕ
	|	БухучетРаспределение.НомерСтроки ЕСТЬ NULL
	|	И (Бухучет.СтатьяФинансирования <> ЗНАЧЕНИЕ(Справочник.СтатьиФинансированияЗарплата.ПустаяСсылка)
	|			ИЛИ Бухучет.СтатьяРасходов <> ЗНАЧЕНИЕ(Справочник.СтатьиРасходовЗарплата.ПустаяСсылка)
	|			ИЛИ Бухучет.СпособОтраженияЗарплатыВБухучете <> ЗНАЧЕНИЕ(Справочник.СпособыОтраженияЗарплатыВБухучете.ПустаяСсылка)
	|			ИЛИ Бухучет.ОтношениеКЕНВД <> ЗНАЧЕНИЕ(Перечисление.ОтношениеКЕНВДЗатратНаЗарплату.ПустаяСсылка))
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	|	&ИменаПолей,
	|	БухучетРаспределение.СтатьяФинансирования,
	|	БухучетРаспределение.СтатьяРасходов,
	|	БухучетРаспределение.СпособОтраженияЗарплатыВБухучете,
	|	БухучетРаспределение.ОтношениеКЕНВД,
	|	БухучетРаспределение.ДоляРаспределения
	|ИЗ
	|	ВТБухучетНачисленийСотрудниковИсходныеЗаписи КАК Бухучет
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.БухучетНачисленийСотрудниковРаспределение КАК БухучетРаспределение
	|		ПО Бухучет.ИдентификаторЗаписи = БухучетРаспределение.ИдентификаторЗаписи";
	Запрос.Текст = СтрЗаменить(Запрос.Текст,"ИмяВТ", ИмяВТ);
	Запрос.Текст = СтрЗаменить(Запрос.Текст,"&ИменаПолей КАК ИменаПолей", "Бухучет.*");
	Запрос.Текст = СтрЗаменить(Запрос.Текст,"&ИменаПолей", "Бухучет.*");
...
Функция ИсторияБухучетаНачисленийСотрудника(Сотрудник) Экспорт
	...
	Запрос.Текст = 
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ЕСТЬNULL(Начисления.РеквизитДопУпорядочивания, 0) КАК РеквизитДопУпорядочивания,
	|	Бухучет.Сотрудник КАК Сотрудник,
	|	Бухучет.Начисление КАК Начисление,
	|	Бухучет.ДокументОснование КАК ДокументОснование,
	|	Бухучет.РегистраторСобытия КАК Регистратор,
	...
	|
	|УПОРЯДОЧИТЬ ПО
	|	ЕСТЬNULL(Начисления.РеквизитДопУпорядочивания, 0),
...
//   Статья расходов - тип СправочникСсылка.СтатьиРасходовЗарплата.
//
Функция СтатьяРасходовДляСохраняемогоЗаработкаНаПериодТрудоустройства(ПериодРегистрации)
...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "ОтражениеЗарплатыВБухучетеРасширенный.ПереместитьБухучетДоговоровГПХИспр";
	Обработчик.РежимВыполнения = ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.ОсновнойРежимВыполненияОбновления();
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("955ad92b-8033-46f3-81e1-4f88615b5d24");
	Обработчик.Комментарий = НСтр("ru = 'Перемещение данных Испр-регистра в основной ""Бухучет договоров ГПХ"".'");
...
Процедура ПереместитьБухучетДоговоровГПХИспр(ПараметрыОбновления = Неопределено) Экспорт
	
	Завершено = ИсправлениеПериодическихСведений.ПереместитьДанныеРегистраИспр("УдалитьБухучетДоговоровГПХИспр", "БухучетДоговоровГПХ");
	
	ОбновлениеИнформационнойБазыЗарплатаКадрыБазовый.УстановитьПараметрОбновления(ПараметрыОбновления, "ОбработкаЗавершена", Завершено);
	
КонецПроцедуры

#КонецОбласти

#Область ДанныеДляОтраженияЗарплатыВБухучетеАвансом

Функция ДанныеДляЗаполненияТаблицДокументаАвансом(ПараметрыДляЗаполнения)
	
	Организация 	 	= ПараметрыДляЗаполнения.Организация;
	ПериодРегистрации 	= ПараметрыДляЗаполнения.ПериодРегистрации;
	ДокументСсылка 		= ПараметрыДляЗаполнения.ДокументСсылка;
	
	РезультатЗаполнения = ДанныеДляОтраженияЗарплатыВБухучетеАвансом(Организация, ПериодРегистрации);
	Если ОбщегоНазначения.ПодсистемаСуществует("ЗарплатаКадрыПриложения.ОрганизационнаяСтруктура") Тогда 
		Модуль = ОбщегоНазначения.ОбщийМодуль("ОрганизационнаяСтруктура");
		Модуль.ДополнитьДанныеДокументаМестомВСтруктуреПредприятия(РезультатЗаполнения, "НачисленнаяЗарплатаИВзносы,УдержаннаяЗарплата");
	КонецЕсли;
...
Функция ДанныеДляОтраженияЗарплатыВБухучетеАвансом(Организация, ПериодРегистрации)
	
	ДанныеДляОтражения = ОтражениеЗарплатыВБухучете.НоваяСтруктураДанныеДляОтраженияЗарплатыВБухучете();
	
	ДанныеДляОтражения.НачисленнаяЗарплатаИВзносы = БухучетНачисленийПоСтатьямАвансом(Организация, ПериодРегистрации);
	ДанныеДляОтражения.НачисленныйНДФЛ 		= БухучетНДФЛПоСтатьямАвансом(Организация, ПериодРегистрации);
	ДанныеДляОтражения.УдержаннаяЗарплата 	= БухучетУдержанийПоСтатьямАвансом(Организация, ПериодРегистрации);
	
	Возврат ДанныеДляОтражения;
	
КонецФункции

Функция БухучетНачисленийПоСтатьямАвансом(Организация, Период)
	...
	|	БухучетНачислений.ДатаНачала КАК ДатаНачала,
	|	БухучетНачислений.ДокументОснование КАК ДокументОснование,
	|	ИСТИНА КАК РасчетПервойПоловиныМесяца,
	|	СУММА(БухучетНачислений.Сумма) КАК Сумма
	|ИЗ
	|	РегистрНакопления.БухучетНачисленияУдержанияПоСотрудникамАвансом КАК БухучетНачислений
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТНачислениеУдержаниеВидОперации КАК НачислениеУдержаниеВидОперации
	|		ПО БухучетНачислений.НачислениеУдержание = НачислениеУдержаниеВидОперации.НачислениеУдержание
	|ГДЕ
	|	БухучетНачислений.Организация = &Организация
	...
	Для каждого СтрокаТЗ Из БухучетНачислений Цикл
		...
		НоваяСтрока = Таблица.Добавить();
		ЗаполнитьЗначенияСвойств(НоваяСтрока, СтрокаТЗ);
		НоваяСтрока.ВидНачисленияОплатыТрудаДляНУ = НачислениеВидТрудаДляНУ[СтрокаТЗ.Начисление];
	КонецЦикла;
...
Функция БухучетНДФЛПоСтатьямАвансом(Организация, ПериодРегистрации)
	...
	|	СУММА(БухучетНДФЛ.Сумма) КАК Сумма
	|ИЗ
	|	РегистрНакопления.БухучетНачисленияУдержанияПоСотрудникамАвансом КАК БухучетНДФЛ
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.РегистрацииВНалоговомОргане КАК РегистрацииВНалоговомОргане
	|		ПО БухучетНДФЛ.РегистрацияВНалоговомОргане = РегистрацииВНалоговомОргане.Ссылка
	|ГДЕ
	|	БухучетНДФЛ.Организация = &Организация
...
Функция БухучетУдержанийПоСтатьямАвансом(Организация, ПериодРегистрации)
	...
	|	СУММА(БухучетУдержаний.Сумма) КАК Сумма
	|ИЗ
	|	РегистрНакопления.БухучетНачисленияУдержанияПоСотрудникамАвансом КАК БухучетУдержаний
	|		ЛЕВОЕ СОЕДИНЕНИЕ ПланВидовРасчета.Удержания КАК Удержания
	|		ПО БухучетУдержаний.НачислениеУдержание = Удержания.Ссылка
	|ГДЕ
	|	БухучетУдержаний.Организация = &Организация
