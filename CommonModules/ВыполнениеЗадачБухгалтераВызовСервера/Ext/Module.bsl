...
Функция ПеренестиВАрхив(Знач ПараметрыКоманды) Экспорт
	...
	ВыполнениеЗадачБухгалтера.ЗаписатьРучнойСтатусЗадачи(ПараметрыКоманды, "", Неопределено, Истина);
...
Процедура ВключитьАвтоматическоеОбновлениеЗадачБухгалтера() Экспорт
	...
	ВыполнениеЗадачБухгалтераПереопределяемый.ПриВключенииАвтоматическогоОбновленияЗадачБухгалтера();
	
КонецПроцедуры

Процедура ЗаписатьРучнойСтатусЗадачи(Задача, Статус, Комментарий) Экспорт
	
	ВыполнениеЗадачБухгалтера.ЗаписатьРучнойСтатусЗадачи(Задача, Статус, Комментарий);
	
КонецПроцедуры

Функция ВернутьАвтоматическийСтатусЗадачи(Задача) Экспорт
	
	Возврат ВыполнениеЗадачБухгалтера.ВернутьАвтоматическийСтатусЗадачи(Задача);
	
КонецФункции

Функция ИмяФормыНалогиОтчеты() Экспорт
	
	ИмяФормы = "";
	ВыполнениеЗадачБухгалтераПереопределяемый.ПриОпределенииИмениФормыНалогиОтчеты(ИмяФормы);
	Возврат ИмяФормы;

КонецФункции

Функция ИмяФормыВводНачальныхОстатков() Экспорт
	
	ИмяФормы = "";
	ВыполнениеЗадачБухгалтераПереопределяемый.ПриОпределенииИмениФормыВводНачальныхОстатков(ИмяФормы);
	Возврат ИмяФормы;
