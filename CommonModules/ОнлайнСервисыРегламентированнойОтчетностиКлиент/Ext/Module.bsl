...
Процедура ПоказатьУведомлениеОБлокировкеУтвержденнойФормы(ВыполняемоеОповещение, Объект, СведенияПоБлокировке) Экспорт
	...
	ПараметрыФормы.Вставить("ПредлагатьКонвертацию",							Ложь);
	Если ТипЗнч(Объект) = Тип("ФормаКлиентскогоПриложения") 
		И ЗначениеЗаполнено(СтрНайти(Объект.ИмяФормы, "Отчет.РегламентированныйОтчет")) Тогда 
		
		СвойстваФормы = Новый Структура("СтруктураРеквизитовФормы");
		ЗаполнитьЗначенияСвойств(СвойстваФормы, Объект);
		Если ТипЗнч(СвойстваФормы.СтруктураРеквизитовФормы) = Тип("Структура") Тогда 
			ПараметрыФормы.Вставить("ИмяФормыОтчета", Объект.ИмяФормы);
			ПараметрыФормы.Вставить("ПредлагатьКонвертацию", ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(
				СвойстваФормы.СтруктураРеквизитовФормы, "ПредлагатьКонвертацию", Ложь));
			ПараметрыФормы.Вставить("ЕстьАктуальныеФормы", ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(
				СвойстваФормы.СтруктураРеквизитовФормы, "ЕстьАктуальныеФормы", Ложь));
			ПараметрыФормы.Вставить("мСохраненныйДок", ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(
				СвойстваФормы.СтруктураРеквизитовФормы, "мСохраненныйДок"));
			ПараметрыФормы.Вставить("ДоступныеДляКонвертацииФормы", ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(
				СвойстваФормы.СтруктураРеквизитовФормы, "ДоступныеДляКонвертацииФормы", Новый Массив));
			ПараметрыФормы.Вставить("АктуальныеФормы", ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(
				СвойстваФормы.СтруктураРеквизитовФормы, "АктуальныеФормы", Новый Массив));
			ПараметрыФормы.Вставить("СтруктураРеквизитовФормы",
				ПоместитьВоВременноеХранилище(СвойстваФормы.СтруктураРеквизитовФормы, Новый УникальныйИдентификатор));
		КонецЕсли;
	КонецЕсли;
	...
	ОткрытьФорму("Обработка.ОнлайнСервисыРегламентированнойОтчетности.Форма.УведомлениеОБлокировкеФормыИЛИФормата",
