...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("ЗаполнитьПланВидовРасчета");
	Методы.Вставить("ДобавитьРолиПВРНачисления");
	Методы.Вставить("УстановитьПорядокОпределенияМесяцаДоходаВВидеОплатыТрудаПоУмолчанию");
	Методы.Вставить("УстановитьРежимРасчетаДокументовПриРедактировании");
КонецПроцедуры
