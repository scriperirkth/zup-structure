...
//	* Токен - Строка
//
Функция ОсновныеСвойстваРасшифровыванияПодписания()
...
//
// Параметры:
//	Сертификат - Строка, Структура - данные содержащие идентификатор сертификата:
...
//    
// Возвращаемое значение:
//  см. ОсновныеСвойстваРасшифровыванияПодписания
//
Функция СвойстваРасшифровыванияПодписанияСертификата(Сертификат) Экспорт
	
	Результат 					= ОсновныеСвойстваРасшифровыванияПодписания();
...
Процедура УстановитьСвойстваРасшифровыванияПодписания(Сертификат) Экспорт
	...
	НовыеНастройки 				= ОсновныеСвойстваРасшифровыванияПодписания();
...
Процедура НастроитьИспользованиеДолговременногоТокена(СпособПодтвержденияКриптоопераций, Сертификат) Экспорт
	...
	ИначеЕсли СпособПодтвержденияКриптоопераций = Перечисления.СпособыПодтвержденияКриптоопераций.ДолговременныйТокен Тогда
		УстановитьСвойстваРасшифровыванияПодписания(ИдентификаторСертификата);
		
	Иначе
		УдалитьСвойстваРасшифровыванияПодписания(ИдентификаторСертификата);
