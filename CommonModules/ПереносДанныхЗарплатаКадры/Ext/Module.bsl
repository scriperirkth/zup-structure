...
Функция СоздатьНачислениеДолиРКСН(КатегорияОсновногоВидРасчета, КатегорияНачисления) Экспорт

	Возврат ПланыВидовРасчета.Начисления.СоздатьНачислениеДолиРКСН(КатегорияОсновногоВидРасчета, КатегорияНачисления);
...
Процедура ЗагрузитьВходящийФайлФСС(Объект, ПараметрыОбъекта, Параметры) Экспорт
...
Процедура ЗагрузитьФайлыИВложенияФСС(Объект, ПараметрыОбъекта, Параметры) Экспорт
...
Процедура НастройкиРасчетаРезервов_ПослеЗагрузки(Объект, Отказ) Экспорт
